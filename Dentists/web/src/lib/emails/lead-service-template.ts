/**
 * Service-email shell for Dentists lead-nurture follow-ups.
 *
 * Renders a centred white card on a #f6f7f8 canvas with the Dental Finance
 * Partners wordmark, 16px/1.6 body, green-accented signature block, quiet
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">DENTAL&nbsp;FINANCE</div>
...
<div style="font-size:16px;font-weight:600;color:#0f172a;line-height:1.5;">The team at Dental Finance Partners</div>
<div style="font-size:14px;font-weight:600;color:#059669;line-height:1.5;">Dental Finance Partners</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://www.dentalfinancepartners.co.uk" style="color:#64748b;text-decoration:none;">dentalfinancepartners.co.uk</a></div>
</td>
</tr>
</table>
</td>
...
<div style="border-top:1px solid #e5e7eb;padding-top:14px;font-family:${FONT};font-size:12px;line-height:1.6;color:#64748b;">${esc(e.footerNote)}${e.optOutUrl ? "<br>To opt out, just reply STOP." : ""}</div>
  ...
  const textLines = [
    ...
    e.signoff,
    "",
    "The team at Dental Finance Partners",
