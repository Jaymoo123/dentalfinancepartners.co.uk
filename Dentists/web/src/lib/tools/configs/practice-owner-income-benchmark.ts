...
export const practiceOwnerIncomeBenchmarkTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      "The starting point is the official dental earnings and expenses estimates published annually for the UK, which report average taxable income and expense ratios for self-employed dentists who hold a contract (providing-performers, broadly practice owners). The 2024/25 release put the average across all self-employed dentists (owners and associates together) in England at £83,000; owners sit above that combined figure, historically in the roughly £110,000 to £130,000 taxable-income range, with clear differences by NHS/private mix: mainly-NHS owners typically sit lower, and mixed and mainly-private owners higher, with wider spreads.",
