...
export const practiceOwnerIncomeBenchmarkTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      "The starting point is the official dental earnings and expenses estimates published annually for the UK, which report average taxable income and expense ratios for self-employed dentists who hold a contract (providing-performers, broadly practice owners). Recent releases put average owner taxable income in the £140,000 to £160,000 territory, with clear differences by NHS/private mix: mainly-NHS owners typically sit lower, and mixed and mainly-private owners higher, with wider spreads.",
      ...
      "It also shows the benchmark expense-to-earnings ratio for your practice type, roughly 66% for mainly-NHS practices rising to around 72% for mainly-private, and the whole-practice profit your turnover would imply at that ratio. If you enter your own profit, the tool places you against the benchmark range and computes your actual expense ratio for comparison.",
      "Worked example 1: a mixed NHS and private practice in England turning over £750,000 with 4 chairs and 30% of clinical work delivered by associates. No adjustments apply (England basis, mid-size, delegation under 50%), so the owner benchmark range is the mixed-practice band of £145,000 to £180,000, midpoint £162,500. At the mixed-practice benchmark expense ratio of 69%, £750,000 of turnover implies whole-practice profit of £232,500. The gap between that and the per-owner range is normal: associate pay and any second owner's share come out of practice profit before the owner's own income.",
      "Worked example 2: a single-handed, mainly-NHS practice in Wales turning over £520,000 with 2 chairs and no associates, where the owner enters a profit of £118,000. The mainly-NHS band of £125,000 to £155,000 is adjusted by 0.95 for Wales and 0.90 for a small practice, giving a benchmark range of £106,875 to £132,525 with a midpoint of £119,700. The £118,000 profit sits within the range, close to the midpoint. However, the owner's actual expense ratio is 77.3% against a mainly-NHS benchmark of 66%, suggesting costs are running well above typical for the practice type and that a cost review could move income toward the top of the band.",
  ...
  faqs: [
    {
      ...
      answer:
        "The official dental earnings and expenses estimates put average taxable income for self-employed practice owners (providing-performer dentists) broadly in the £140,000 to £160,000 range, before tax. The spread is wide: mainly-NHS owners of small practices can sit around £100,000 to £130,000, while owners of larger mixed or private practices commonly exceed £180,000. Mix, size, region and how much work associates deliver all shift the number materially.",
    },
    {
