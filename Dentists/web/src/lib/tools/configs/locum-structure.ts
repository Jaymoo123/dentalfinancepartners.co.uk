...
export const locumStructureTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      "The sole-trader model applies income tax and Class 4 NI directly to trading profit (gross income minus expenses). Class 2 NI was removed from 6 April 2024 and is not charged.",
      ...
      "Worked example: James locums at £450 per day for 180 days per year (£81,000 gross) and has £6,000 of deductible expenses, giving trading profit of £75,000. As a sole trader he pays income tax of £17,432 and Class 4 NI of £2,757, with no Class 2 NI, leaving a net take-home of approximately £54,811. Through a limited company with a £12,570 salary and dividends on the remaining post-CT profit, his net is approximately £51,729 after the £1,800 admin cost. Via an umbrella (5% margin, 15% employer NI on the balance) his net falls to approximately £48,929. Sole trader wins by around £3,100 over limited company at this income level.",
    ],
  },
  faqs: [
    {
