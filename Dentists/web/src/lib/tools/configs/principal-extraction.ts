...
export const principalExtractionTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "Worked example: a principal extracts £150,000 of practice profit with no additional pension contribution. As a sole trader (partnership), income tax at 2026/27 rates on £150,000 is £53,703 (the personal allowance is fully tapered away at this income; the £150,000 taxable is charged 20% on the £37,700 basic band, 40% on the £87,440 higher band to £125,140, and 45% on the £24,860 above); Class 4 NI is £4,257; Class 2 NI is £179. Net take-home is approximately £91,861. Through a limited company (£12,570 salary plus dividends, employer NI of £1,136 on the salary, corporation tax of approximately £32,368 on the remaining profit, dividend tax of approximately £29,612, and £2,500 admin cost), net take-home is approximately £84,384. The partnership route is worth roughly £7,477 more in pure tax terms. For an NHS-active principal, the loss of pension accrual on the £103,926 dividend further widens the gap against incorporation.",
    ],
  },
  faqs: [
    {
