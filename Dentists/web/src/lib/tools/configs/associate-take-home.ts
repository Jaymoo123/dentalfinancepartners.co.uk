...
export const associateTakeHomeTool: GenericTool = {
  ...
  compute(values) {
    ...
    return {
      headline: {
        ...
        value: gbp(r.netCash),
        sub: `After income tax, Class 4 NI and pension. Effective rate: ${pct(r.effectiveRate)}`,
        tone: "good" as const,
      },
      rows: [
        ...
        { label: "Class 2 NI (not payable from 6 Apr 2024)", value: gbp(r.class2Ni) },
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "The resulting taxable profit is run through 2026/27 income tax (20% up to £50,270, 40% up to £125,140, 45% above; personal allowance £12,570 tapering above £100,000), and Class 4 NI (6% on profits between £12,570 and £50,270, 2% above). Class 2 NI is not payable: the liability was removed from 6 April 2024, and profits at or above the small profits threshold are treated as having paid it.",
