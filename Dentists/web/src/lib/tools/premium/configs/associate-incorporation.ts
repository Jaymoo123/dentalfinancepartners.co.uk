 ...
 * (20.6% employer rate + 6.3% administration levy = 26.9% of pensionable pay)
 * against the headline incorporation tax saving and gives a verdict on the
 * pension-adjusted position.
 *
 ...
 * - NHS employer-equivalent 26.9%: an ESTIMATE, scheme-rule caveats in copy.
 *
  ...
  compute({ values }): PremiumResult {
    ...
    return {
      ...
      breakdown: [
        ...
        { label: "NHS Pension employer value at stake (26.9%)", value: gbp(r.pensionEmployerValue) },
        {
...
export const associateIncorporationPageCopy = {
  ...
  methodology: [
    ...
    "Step 4, the pension layer. Pensionable earnings are estimated as the NHS share of your net fees (or your own override). As a sole-trader practitioner member, the employer side of your NHS Pension, a 20.6% contribution plus the 6.3% administration levy, 26.9% in total, is funded on that pay. Incorporating generally forfeits it, so the tool counts 26.9% of pensionable pay as an annual cost of the Ltd route.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The employer side of the scheme is worth roughly 26.9% of your pensionable pay each year: a 20.6% employer contribution plus a 6.3% administration levy. An associate with £70,000 of pensionable NHS earnings is therefore receiving around £18,800 a year of employer-funded pension value on top of fee income. That is the benchmark any incorporation tax saving has to beat, and on typical NHS-weighted figures it does not come close.",
    },
    {
    ...
    {
      question: "Are the 20.6% and 6.3% figures fixed?",
      answer:
        "No. Employer-side NHS Pension rates are set by the Department of Health and Social Care and move between scheme years, and how the employer cost is met for dental practitioners depends on the commissioning arrangements. The tool uses 20.6% plus the 6.3% levy as a reasonable current estimate of the employer-equivalent value; the strategic conclusion is not sensitive to a point or two either way, but check the current NHSBSA rates before making a final decision.",
    },
    {
