/**
 * Shared lead-nurture enrolment for the Dentists site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Dentists
 * sequence names.
 */
...
import {
  buildDentistsLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildDentistsLeadNurtureConfig(variant);
