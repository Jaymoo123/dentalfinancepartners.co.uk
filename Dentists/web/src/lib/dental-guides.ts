 ...
 * Dentists/web/content/dental-guides/ instead of /blog/. Each .md file is a
 * 3,500-5,000 word long-form guide; the route renders at /dental-guides/[slug].
 */
import fs from "fs";
...
const guidesDirectory = path.join(process.cwd(), "content", "dental-guides");
...
function parseGuideFile(filePath: string): Guide {
  ...
  return {
    ...
    date: fm.date ?? "",
    author: fm.author ?? "Dental Finance Partners Editorial Team",
