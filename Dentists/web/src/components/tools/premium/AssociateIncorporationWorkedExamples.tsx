  ...
  return (
    <section aria-label="Worked examples">
            ...
            <div className="p-5 sm:p-6">
              ...
              <dl className="mt-4 space-y-1.5 text-sm">
                {[
                  ...
                  ["NHS Pension employer value forgone (23.78%)", gbp(r.pensionEmployerValue)],
                ].map(([label, value]) => (
      ...
      <p className="mt-4 text-xs text-[var(--muted)]">
        ...
        loss of NHS Pension accrual on incorporation. The 23.78% employer-equivalent rate
        (23.7% employer contribution, in force from 1 April 2024, plus 0.08% administration levy) is an estimate; scheme
