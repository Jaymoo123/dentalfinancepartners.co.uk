...
/**
 * Dependency-free premium calculator renderer for the Dentists site.
 *
 ...
 *
 * TOKEN DISCIPLINE: Dentists does NOT define --primary. Every token here uses
 * the defined Dentists design system:
...
export function PremiumCalculator({
  ...
  return (
    <>
      ...
      >
        {/* Top accent bar -- gold brand token (Dentists: no --primary defined) */}
