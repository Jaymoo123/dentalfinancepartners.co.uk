 ...
 * default under legitimate interest (opt-out posture); this lets a visitor
 * opt out (or back in). Opting out writes "denied" to localStorage, which
 * the SDK honours live. The cookie policy at /cookie-policy promises a
 * "Do not track me" link in the footer -- this component fulfils that promise.
 */
