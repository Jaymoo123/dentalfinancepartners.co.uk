 ...
 *
 * Wave-2 CRO parity: intent-aware personalisation is ON unconditionally. The
 * legacy scroll-30% stub is replaced with the wave-1 intent-aware pattern.
 *
 * Visibility rules:
 ...
 *
 * Storage key: dfp_sticky_dismissed (dfp prefix FROZEN).
...
export function StickyCTA() {
  ...
  return (
    <div
      role="region"
      aria-label="Talk to a specialist dental accountant"
