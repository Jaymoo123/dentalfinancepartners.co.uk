 ...
 * House style: sharp corners, navy/gold, no em-dashes in copy.
 */
...
// ponytail: navy/gold chips — border uses CSS var so it adapts if brand tokens shift
const chipBase =
  "flex min-h-12 touch-manipulation flex-col items-center justify-center border-2 px-1.5 sm:px-3 py-2 text-sm font-bold transition-all duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--gold)]";
const chipIdle =
  "border-[var(--navy)]/20 bg-white text-[var(--navy)] hover:border-[var(--gold)] hover:bg-[var(--gold-soft)]";
const chipSelected =
...
export default function BookingPicker({ token }: { token: string }) {
  ...
  if (status === "done") {
    return (
      <div className="border-2 border-[var(--gold)] bg-[var(--gold-soft)] p-6 text-center">
        <p className="text-lg font-bold text-[var(--navy)]">Callback booked</p>
        <p className="mt-2 text-base text-[var(--navy)]/80">
          {confirmedLabel ? (
            <>
          ...
          A dental accountant will call you then. If your plans change, just reply to any of our
          messages.
        </p>
        <p className="mt-3 text-sm text-[var(--navy)]/60">
  ...
  return (
    <div className="text-left">
      <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-[var(--navy)]/50">
        1. Pick a day
      </p>
      ...
      <p className="mb-3 mt-6 text-sm font-semibold uppercase tracking-wide text-[var(--navy)]/50">
      ...
      <div className="mt-6 text-center">
        ...
        <p className="mt-3 text-xs text-[var(--navy)]/50">
          No obligation. A dental accountant will call you in your chosen window.
        </p>
      </div>
    </div>
  );
