 ...
 *
 * Styled with Dental Finance Partners brand tokens: navy #001b3d + gold #b8975d.
 */
...
const inputClass =
  "mt-1 w-full min-h-12 touch-manipulation border border-[var(--border)] bg-[var(--surface)] px-3.5 py-3 text-base text-[var(--ink)] placeholder:text-[var(--muted)] shadow-sm focus:border-[var(--gold)] focus:outline-none focus:ring-2 focus:ring-[var(--gold)]/25 transition-colors";
...
export function MiniCapture({
  ...
  className = "my-8 rounded-2xl border-l-4 border-[var(--gold)] bg-[var(--surface)] p-6 sm:p-8",
  experimentKey,
  exposeOnView = true,
  messageMinLength = 10,
  messageMinWords = 0,
  ...
  role?: string;
  /** Prefix for the lead message, e.g. "[Calculator: locum-structure] ". */
