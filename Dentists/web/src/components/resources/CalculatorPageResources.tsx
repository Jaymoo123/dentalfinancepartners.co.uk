/**
 * Additive resource-gate island for Dental Finance Partners calculator pages.
 *
 ...
 * Dentists uses a single dynamic [slug] route (no per-slug static pages), so this is
 * a single wiring point.
 *
 * TOKEN HARDENING: no var(--gold), no orange-*.
 * The label eyebrow chip uses bg-[var(--navy)] text-[var(--gold)].
 */
  ...
  return (
    <div className="mt-10">
      <div className="flex items-center gap-3">
        <span className="inline-block bg-[var(--navy)] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-[var(--gold)]">
          Go deeper
        </span>
