/**
 * Resend webhook sink for lead-nurture email engagement events (Dentists).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.dentalfinancepartners.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Dentists lead-nurture system.</p>
</div>`,
