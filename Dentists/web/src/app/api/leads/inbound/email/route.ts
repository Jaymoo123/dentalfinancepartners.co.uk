/**
 * Inbound email webhook for Resend: processes replies to Dentists nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Dentists lead,
 ...
 *   Inbound routing domain: dentalfinancepartners.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.dentalfinancepartners.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Dentists lead (most recent match wins).
