  ...
  return (
    <>
      <section className="bg-[var(--navy)] text-white">
        <div className={`${siteContainerLg} ${sectionYLoose}`}>
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <h1 className="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Terms of use</h1>
      ...
      <div className={`${contentNarrow} ${sectionY} prose-blog space-y-6 text-[var(--ink-soft)]`}>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">1. About us</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">2. No advice provided on the Site</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">3. Accuracy and changes</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">4. Acceptable use</h2>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">5. Intellectual property</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">6. Third-party links</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">7. Limitation of liability</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">8. Disclaimer of warranties</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">9. Indemnity</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">10. Governing law and jurisdiction</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">11. Changes to these terms</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">12. Severability</h2>
        <p>
          If any provision of these terms is found to be invalid or unenforceable, the remaining provisions shall continue in full force and effect.
        </p>

        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">13. Contact us</h2>
        <p>
