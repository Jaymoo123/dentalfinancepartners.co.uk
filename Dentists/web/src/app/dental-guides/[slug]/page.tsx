    ...
    <>
      ...
      <section className="bg-[var(--surface)]">
        <div className={`${siteContainerLg} ${sectionY}`}>
          <article className="prose-dental mx-auto max-w-3xl text-base leading-relaxed text-[var(--ink-soft)] sm:text-lg">
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {otherGuides.map((g) => (
                  ...
                  >
                    ...
                    <h3 className="font-serif text-base font-semibold text-[var(--ink)] group-hover:text-[var(--gold-strong)]">
                      {g.title}
                    </h3>
