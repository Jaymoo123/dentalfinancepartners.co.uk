...
const CheckIcon = () => (
  <div className="inline-block bg-[var(--navy)] p-6 mb-8">
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className={`${siteContainerLg} text-center`}>
          <div className="mx-auto max-w-2xl">
            <CheckIcon />
            <h1 className="text-2xl font-bold text-[var(--navy)] sm:text-4xl">
        ...
        <div className={`${siteContainerLg} text-center`}>
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Link href="/calculators" className="inline-flex items-center justify-center border-2 border-[var(--navy)]/20 bg-white px-8 py-3.5 text-base font-bold text-[var(--navy)] transition-all hover:border-[var(--gold)] hover:bg-[var(--gold-soft)]">
  ...
  return (
    <section className="bg-white py-20 sm:py-24">
      <div className={`${siteContainerLg} text-center`}>
        <div className="mx-auto max-w-2xl">
          <CheckIcon />
          <h1 className="text-4xl font-bold text-[var(--navy)] sm:text-5xl">Thank you</h1>
          {nurtureArmed ? (
            <>
              <p className="mt-6 text-lg leading-relaxed text-[var(--navy)]/70">
              ...
              <p className="mt-4 text-base text-[var(--navy)]/60">
                We will contact you directly about your enquiry. We aim to respond within 24 hours, usually same day.
              </p>
            ...
            <p className="mt-6 text-lg leading-relaxed text-[var(--navy)]/70">
              Your enquiry has been received. We will contact you directly about your enquiry, within one working day, usually the same day. You can also pick a callback time below.
            </p>
          )}
          ...
          <ol className="mx-auto mt-8 flex max-w-xl flex-col gap-3 text-left sm:flex-row sm:items-center sm:justify-center sm:gap-6">
            <li className="flex items-center gap-2">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center bg-[var(--navy)]">
                <svg className="h-4 w-4 text-[var(--gold)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </span>
              <span className="text-sm font-semibold text-[var(--navy)]/60">1. Enquiry received</span>
            </li>
            <li className="flex items-center gap-2">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center bg-[var(--navy)]">
                <svg className="h-4 w-4 text-[var(--gold)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <span className="text-sm font-semibold text-[var(--navy)]/60">2. Details received</span>
            </li>
            <li aria-current="step" className="flex items-center gap-2">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center border-2 border-[var(--gold)] bg-white text-xs font-bold text-[var(--navy)]">
                3
              </span>
          ...
          {bookingToken ? (
            <div className="mt-8 border-2 border-[var(--navy)]/10 bg-white p-3 text-left sm:p-8">
              <p className="mb-6 text-center text-base font-semibold text-[var(--navy)]">
            ...
            <div className="mt-8">
              <p className="mb-4 text-sm font-semibold text-[var(--navy)]/70">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Link href="/" className="inline-flex items-center justify-center border-2 border-[var(--navy)]/20 bg-white px-8 py-3.5 text-base font-bold text-[var(--navy)] transition-all hover:border-[var(--gold)] hover:bg-[var(--gold-soft)]">
              Back to home
            </Link>
            <Link href="/calculators" className="inline-flex items-center justify-center border-2 border-[var(--navy)]/20 bg-white px-8 py-3.5 text-base font-bold text-[var(--navy)] transition-all hover:border-[var(--gold)] hover:bg-[var(--gold-soft)]">
            ...
            {returnPath && (
              <Link href={returnPath} data-cta="thankyou-return-article" data-cta-placement="thank_you" className="inline-flex items-center justify-center border-2 border-[var(--navy)]/20 bg-white px-8 py-3.5 text-base font-bold text-[var(--navy)] transition-all hover:border-[var(--gold)] hover:bg-[var(--gold-soft)]">
