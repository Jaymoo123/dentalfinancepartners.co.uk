  ...
  return (
    <>
      <section className="bg-[var(--navy)] text-white">
        <div className={`${siteContainerLg} ${sectionYLoose}`}>
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <h1 className="mt-3 text-3xl font-semibold leading-tight text-white sm:text-4xl">Privacy policy</h1>
      ...
      <div className={`${contentNarrow} ${sectionY} prose-blog space-y-6 text-[var(--ink-soft)]`}>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">1. Who we are (data controller)</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">2. What information we collect</h2>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            you are about to leave a page), we collect your name, email address, phone number, the type of dental
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">3. Why we use your information</h2>
        <ul className="list-disc space-y-2 pl-6">
          <li>
          ...
          <li>
            ...
            tax and accounting updates until you unsubscribe.
          </li>
          <li>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">4. Our lawful basis</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">5. Who we share your information with</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">6. How long we keep your information</h2>
        <p>
          We keep enquiry data for <strong>{company.enquiryRetentionMonths} months</strong> from the date of your enquiry.
          After that we permanently strip out everything that identifies you: your name, email address, telephone
          number, your message and the records of our messages to you are removed or replaced, and what is left
          cannot be traced back to you. If you subscribe to our email updates, we keep your email address until you
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">7. Your rights</h2>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">8. Cookies and analytics</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">9. How we protect your data and international transfers</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">10. Changes to this policy</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-[var(--ink)] sm:text-2xl">11. Contact us</h2>
        <p>
