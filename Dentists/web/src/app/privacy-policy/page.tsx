    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong>Contact form submissions:</strong> When you submit an enquiry through our contact form, we collect your full name, email address, phone number, role (e.g., associate dentist, practice owner), practice name (optional), message content, and the URL of the page you submitted from.
          </li>
          <li>
