/**
 * Dentists analytics console — main dashboard.
 *
  ...
  const experimentsSection = (
    <div className="space-y-6">
      <NotOperatedPanel
        ...
        reason="Not operated on this site. Dentists does not currently run A/B tests."
      />
      <NotOperatedPanel
        feature="Personalisation"
        reason="Not operated on this site. Behavioural personalisation is a deferred workstream."
      />
    </div>
  );
  ...
  const conversionSection = (
    <div className="space-y-8">
      ...
      <NotOperatedPanel
        ...
        reason="Not operated on this site. No newsletter surface on Dentists (confirmed at Phase D audit)."
      />
