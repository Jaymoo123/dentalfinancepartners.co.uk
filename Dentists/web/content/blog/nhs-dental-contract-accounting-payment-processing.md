---
title: "NHS Dental Contract Accounting: Payment Processing & Management"
slug: "nhs-dental-contract-accounting-payment-processing"
date: "2026-04-01"
author: "Dental Finance Partners"
category: "Practice accounting"
metaTitle: "NHS Dental Contract Accounting: Payment Processing Guide"
metaDescription: "Complete guide to NHS dental contract accounting, payment processing, and financial management for UK dental practices. Expert advice from specialist accountants."
altText: "UK dental practice accountant reviewing NHS contract payment statements and UDA calculations"
image: ""
...
faqs:
  ...
  - question: "What happens if I don't deliver my contracted UDAs?"
    answer: "Under-delivery can trigger clawback, where NHS England recovers overpaid amounts from your future payments. Most contracts include a tolerance level (typically 4% under-delivery), but beyond this, you may face financial penalties. The clawback amount depends on your specific contract terms and delivery shortfall."
  - question: "How should I account for NHS payments received in advance?"
    answer: "NHS advance payments should be recorded as deferred income (a creditor) until you deliver the corresponding UDAs. As you complete treatments, transfer the appropriate amount from deferred income to earned revenue. This ensures your accounts accurately reflect work completed versus payments received."
...
<p>NHS dental contract accounting presents unique challenges that many practice owners underestimate. The payment structure, reconciliation requirements, and compliance obligations differ significantly from private work, requiring specialist knowledge to manage effectively.</p>

<p>This guide covers the essential elements of NHS dental contract accounting that every practice owner needs to understand, from payment processing to year-end reporting.</p>
...
<h2>Year-End Reconciliation Process</h2>

<p>The NHS contract year typically runs April to March, requiring specific year-end procedures beyond standard accounting practices. Your final reconciliation determines whether additional payments are due or clawback applies.</p>

<p>Year-end NHS dental contract accounting involves comparing total UDAs delivered against contracted amounts, calculating any adjustment required, and ensuring proper cut-off procedures for work spanning the year-end.</p>

<p>Treatment courses started before year-end but completed after create particular complexity. The UDA value typically belongs to the year when treatment began, requiring careful tracking through your practice management system.</p>

<h2>Accounting for Mixed NHS and Private Income</h2>

<p>Most dental practices operate mixed models, combining NHS contract work with private treatments. This requires separate tracking systems to ensure accurate reporting and optimal tax planning.</p>

<p>Your accounting system should clearly separate NHS and private income streams. This separation proves essential for VAT purposes (NHS work is exempt), profit analysis, and strategic decision-making about service mix.</p>

<p>For detailed guidance on managing mixed income models, our article on <a href="/blog/nhs-private-mix-dental-accounts">NHS and private mix dental accounts</a> provides comprehensive coverage of the accounting implications.</p>
...
<p>NHS dental contract accounting requires extensive record keeping beyond standard business requirements. You must maintain detailed records of all UDA calculations, treatment plans, and patient interactions for potential NHS audit purposes.</p>

<p>Your records should support every UDA claimed and demonstrate compliance with contract terms. This includes clinical records, treatment plans, and evidence of patient pathways through your practice systems.</p>

<p>Digital record keeping through integrated practice management systems provides the best approach, ensuring automatic UDA calculations and comprehensive audit trails.</p>

<h2>Getting Professional Support</h2>

<p>The complexity of NHS dental contract accounting makes professional support highly valuable. Specialist dental accountants understand the unique requirements and can help optimize your financial management.</p>

<p>Consider professional support particularly important if you hold multiple contracts, operate mixed income models, or face potential clawback situations. Early intervention can often prevent significant financial losses.</p>

<p>For comprehensive support with your dental practice finances, our <a href="/services">services</a> include specialist NHS contract accounting guidance tailored to your specific circumstances.</p>
