...
metaTitle: "Payment on Account for UK Dentists | Guide 2026/27"
metaDescription: "POA payments are due in January and July, based on last year's tax bill. How to calculate, reduce, or claim back overpayments — with HMRC deadlines."
...
faqs:
  ...
  - question: "When do I stop making payment on account payments?"
    answer: "Payment on account continues as long as your tax liability meets the threshold criteria. If your income drops significantly or you move to full PAYE employment, you may fall below the thresholds and payments will stop automatically."
---
...
<p>You can reduce POA payments if you expect your current year's tax bill to be lower than last year's. This commonly happens when:</p>

<ul>
<li>Your income has dropped significantly</li>
<li>You're taking a career break or reducing hours</li>
<li>Business profits are lower due to increased expenses or investments</li>
<li>You're changing from self-employed to PAYE employment</li>
</ul>
...
<p>Payment on account creates significant cash flow challenges, particularly the "triple hit" of 31 January when you pay:</p>

<ul>
<li>Final balance for the previous year</li>
<li>First payment on account for the current year</li>
<li>Potentially a large combined sum</li>
</ul>
...
<p>Dentists frequently struggle with these payment on account issues:</p>

<p><strong>Forgetting the July payment:</strong> The 31 July deadline often catches people unprepared, especially if they've just dealt with January payments.</p>

<p><strong>Over-reducing payments:</strong> Being too aggressive with reduction claims leads to penalties and interest charges.</p>

<p><strong>Ignoring the system:</strong> Some dentists assume they can deal with tax "next year" without realising POA brings forward payment dates.</p>

<p><strong>Poor record-keeping:</strong> Without proper tracking, it's difficult to estimate whether reductions are justified.</p>
...
<ul>
<li>Facing your first POA payments</li>
<li>Dealing with fluctuating income patterns</li>
<li>Managing practice transitions or partnerships</li>
<li>Unsure about claiming reductions</li>
</ul>
