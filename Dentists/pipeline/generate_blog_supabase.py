...
This shim is kept so existing callers (generate_all_automated.py,
generate_phase*.py, generate_all_blogs.ps1, etc.) continue to work
without changes.
"""
import sys
...
def main() -> int:
    result = generate_blog_for("dentists")
