...
export const divorceCostCalculator: GenericTool = {
  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: "contested", label: "Contested court proceedings (£292 court fee)" },
      ],
    },
    {
      id: "hwfLikely",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Under no-fault divorce the divorce itself can no longer really be contested. The expensive fights are about money. Contested financial remedy proceedings involve a £292 court application, compulsory disclosure on Form E, up to three court hearings and often barristers. Each side commonly spends £10,000 to £30,000 or more to reach a final hearing, which is why over 90% of cases settle before one.",
    },
    {
