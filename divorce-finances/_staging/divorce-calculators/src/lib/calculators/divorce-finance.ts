 ...
 *   Fee uplift 13 July 2026   - screener rule-churn evidence (divorce application £612 to £628, consent order £60 to £62)
...
/** Contested financial order (Form A, not by consent) court fee (was £275). */
export const CONTESTED_FINANCIAL_ORDER_FEE = 292;
...
export const HWF = {
  ...
  coupleIncomeThreshold: 2145,
  /** Added to the threshold per dependent child. */
  childPremium: 710,
