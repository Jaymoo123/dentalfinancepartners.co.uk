...
export const metadata: Metadata = {
  title: "UK Child Maintenance Tracker | CMS caseload, compliance and arrears | {{BRAND}}",
  ...
  openGraph: {
    title: "UK Child Maintenance Tracker | {{BRAND}}",
          ...
          <div className="max-w-4xl">
            ...
            <div className="rounded-2xl border border-orange-500/20 bg-orange-50/60 p-6 sm:p-8">
              ...
              <p className="mt-4 text-xs text-neutral-500">
                ...
                be cited with attribution to {"{{BRAND}}"}.
              </p>
            </div>
