...
// Site-specific categoryPhrase fallbacks; everything else is shared logic.
...
// Site-specific category phrase map (STUB: divorce-neutral).
const CATEGORY_PHRASE_MAP: Record<string, string> = {
  financial_settlement: "work out a fair financial settlement",
  pension_sharing: "understand how your pensions get split",
  tax_on_divorce: "get the tax side of your split straight",
 ...
 * category. Falls back to a generic phrase.
 */
export function categoryPhrase(
  ...
  return "get your situation reviewed";
}
