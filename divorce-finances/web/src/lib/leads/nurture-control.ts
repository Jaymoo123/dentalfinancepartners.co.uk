/**
 * Kill-switch control library for the divorce-finances lead-nurture system.
 *
 * Reads and writes the lead_nurture_control table, keyed by
 * site_key='divorce-finances'. All reads are FAIL-OPEN: a missing table,
...
const SITE_KEY = "divorce-finances";
...
export async function getNurtureControl(): Promise<NurtureControl> {
  try {
    ...
    console.error("[nurture-control/divorce] getNurtureControl error, failing open", err);
...
export async function pauseNurture(reason: string, by: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/divorce] pauseNurture write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/divorce] pauseNurture error", err);
  }
}
...
export async function resumeNurture(by: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/divorce] resumeNurture write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/divorce] resumeNurture error", err);
  }
}
...
export async function recordGuardrailAlert(key: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/divorce] recordGuardrailAlert write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/divorce] recordGuardrailAlert error", err);
  }
}
...
export async function recordCronHeartbeat(): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/divorce] recordCronHeartbeat write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/divorce] recordCronHeartbeat error", err);
  }
}
...
export async function recordDigestHeartbeat(): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/divorce] recordDigestHeartbeat write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/divorce] recordDigestHeartbeat error", err);
  }
}
