/**
 * Journey model for divorce-finances -- deterministic,
 * client-side, instant. Ported from Dentists/Property with the dvf storage
 * prefix.
 *
 ...
 *
 * Storage key: dvf_journey (never ptp_/dfp_/cfp_/bfp_/wpc_).
 * Special-page flags: /about, /services, /contact -- all three routes exist on
 * this site (confirmed), so all flags are kept (no drops).
 *
