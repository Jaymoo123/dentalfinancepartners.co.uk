/**
 * Service-email shell for divorce-finances lead-nurture follow-ups.
 *
 * Renders a centred white card on a #f6f7f8 canvas with the brand
...
const BRAND = niche.display_name;
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">${esc(BRAND.toUpperCase())}</div>
<div style="display:inline-block;border-top:2px solid #059669;margin-top:5px;padding-top:5px;font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;"></div>
</td>
</tr>
<tr>
...
<div style="font-size:16px;font-weight:600;color:#0f172a;line-height:1.5;">The team at ${esc(BRAND)}</div>
<div style="font-size:14px;font-weight:600;color:#059669;line-height:1.5;">${esc(BRAND)}</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://${DOMAIN}" style="color:#64748b;text-decoration:none;">${esc(DOMAIN)}</a></div>
</td>
</tr>
</table>
</td>
