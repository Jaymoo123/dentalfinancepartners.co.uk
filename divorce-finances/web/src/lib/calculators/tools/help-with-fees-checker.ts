...
export const helpWithFeesChecker: GenericTool = {
  ...
  fields: [
    ...
    },
    {
      ...
      min: 0,
      max: 10,
      help: `Each dependent child aged 0 to 13 adds ${gbp(HWF.childPremium)} to your monthly income threshold; a child aged 14 or over adds £710. This checker uses the ${gbp(HWF.childPremium)} figure.`,
    },
  ],
  compute: (v) => {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "Then the income test. If you receive a qualifying benefit (Universal Credit within the scheme's earnings limit, income-based JSA or ESA, Income Support or Guarantee Credit), you pass automatically and pay nothing. Otherwise your gross monthly income is compared to a threshold: £1,420 for a single applicant, £2,130 if you live with a partner, plus £425 per dependent child aged 0 to 13 (or £710 for a child aged 14 or over). At or below the threshold, the whole fee is remitted.",
  ...
  workedExamples: [
    ...
    },
    {
      ...
      description:
        "A single parent with two dependent children under 14 earns £2,900 gross per month and has £2,000 in savings, applying for the £628 divorce fee.",
      inputs: { fee: 628, grossMonthlyIncome: 2900, children: 2, disposableCapital: 2000 },
      result: {
        threshold: "£1,420 + 2 × £425 = £2,270 (a child aged 14 or over would add £710 instead)",
        excess: "£2,900 - £2,270 = £630 over threshold",
        contribution: "50% of £630 = £315",
        outcome: "Partial remission: pays £315 of the £628 fee, £313 remitted",
      },
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes. Each fee needs its own application, but the £62 consent order fee and the £321 contested financial order fee are both covered by the scheme on the same tests as the £628 divorce fee.",
    },
    {
