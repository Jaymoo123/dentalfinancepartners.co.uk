 ...
 *
 * STUB (scaffold phase): the machinery is fully wired and compiling, but all
 * step copy is neutral placeholder text. Real niche copy lands with the brand.
 *
 ...
 * individual). No credential claims. No cross-vertical bleed.
 */
...
// STUB COPY: neutral service-only placeholder wording, no niche claims.
...
const STEPS: LeadNurtureStep[] = [
  ...
  },
  {
    ...
    buildMessages: (c) => [
      smsMsgWithGen(
        c,
        "t0_sms",
        `Hi ${c.firstName}, this is ${COMPANY}. Thanks for your enquiry. Reply YES and a member of the team will call you. ${c.optOutText}`,
      ),
    ...
    buildMessages: (c) => {
      ...
      return [
        smsMsgWithGen(
          c,
          "vip_sameday",
          `Hi ${c.firstName}, ${COMPANY} again. Enquiries like yours are exactly what the team handles every day, so we have set time aside this week. Reply YES and we will call you. ${c.optOutText}`,
        ),
      ];
    },
  },
  {
    ...
    buildMessages: (c) => [
      smsMsgWithGen(
        c,
        "day1_sms",
        `Hi ${c.firstName}, following up on your enquiry. We have kept some time free this week for a short call. Reply YES and we will call you. ${c.optOutText}`,
      ),
  ...
  },
  {
    ...
    buildMessages: (c) => [
      emailMsg(
        c,
        `A quick pointer while your enquiry is with us, ${c.firstName}`,
        "A quick pointer from the team while your enquiry is with us.",
        [
          "A quick pointer while your enquiry is with us. Getting the numbers clear early usually saves both time and money later.",
  ...
  },
  {
    ...
    buildMessages: (c) => [
      smsMsgWithGen(
        c,
        "day4_sms",
        `Hi ${c.firstName}, ${COMPANY} here. Most people we speak to had a question just like yours, and one short call usually clears up months of uncertainty. Reply YES and we will call you. ${c.optOutText}`,
      ),
      whatsappTemplate("lead_reminder", [c.firstName, c.bookingUrl]),
    ],
  },
    ...
    buildMessages: (c) => [
      emailMsg(
        ...
        [
          ...
          "If something is holding you back, a one line reply is all it takes. Tell us a day and time, or ask whatever is on your mind, and the team will take it from there.",
        ],
        "day7_email",
        { cta: null, secondary: null },
      ),
    ...
    buildMessages: (c) => [
      emailMsg(
        ...
        [
          ...
          "If your situation changes, just reply to this email, even months from now, and the team will pick it straight back up.",
          "All the best.",
        ],
        "breakup_day11",
        { cta: null, secondary: null },
    ...
    buildMessages: (c) => {
      ...
      return [
        emailMsg(
          ...
          [
            "One quick pointer while your enquiry sits with us. Getting a clear picture of the numbers early usually pays for itself many times over.",
      ...
      return [
        emailMsg(
          ...
          [
            ...
            `If you would still like a free review, just reply with ${ask}, whether that is next week or next year.`,
            "All the best.",
          ],
          "detail_capture_day7",
          {
