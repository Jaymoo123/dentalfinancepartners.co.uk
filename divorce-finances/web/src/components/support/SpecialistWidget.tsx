...
/**
 * Phase-0 deterministic specialist widget for divorce-finances.
 *
 ...
 *
 * Storage prefix: dvf. Never ptp_/dfp_/cfp_/bfp_/wpc_.
 ...
 * Pass through to submitSiteLead. Server stores the row flagged.
 *
...
export function SpecialistWidget() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await submitSiteLead(payload, honeypot);
    if (!result.success) {
      setStatus("error");
  ...
  return (
    <div className="fixed bottom-24 right-4 z-[55] flex flex-col items-end print:hidden">
      {open && (
        <div
          role="dialog"
          aria-label="Specialist assistant"
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-3 text-white" style={{ background: "#1e293b" }}>
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-bold leading-tight">Specialist team</p>
