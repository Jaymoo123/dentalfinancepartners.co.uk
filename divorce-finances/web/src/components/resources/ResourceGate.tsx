/**
 * Qualified lead-capture form for divorce-finances resource slots.
 *
...
export function ResourceGate({
  ...
  return (
    <MiniCapture
      ...
      blurb="Tell us about your situation and a specialist will review it and the most practical next step, with no obligation."
