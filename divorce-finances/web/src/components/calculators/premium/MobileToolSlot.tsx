...
/**
 * Mobile tool slot for the divorce-finances premium calculator tier.
 *
 ...
 *   - blurb = fixed tool-is-desktop copy (site-specific)
...
export function MobileToolSlot({ topic }: { topic: TopicKey }) {
  ...
  return (
    <MiniCapture
      ...
      blurb="Our interactive tool is built for a larger screen. Tell us your situation and a specialist will send your figure and the sensible next step, with no obligation."
      submitLabel="Send me my figure"
