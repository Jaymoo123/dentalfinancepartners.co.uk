...
/**
 * Result-gate interstitial for the divorce-finances premium calculator tier.
 *
    ...
    >
      ...
      >
        ...
        <MiniCapture
          ...
          className="mt-2"
          messagePlaceholder="The more detail the better. Tell us about your situation, rough figures, and what you are trying to work out. A couple of sentences is ideal."
          messageMinLength={40}
          messageMinWords={8}
          onSuccess={onReveal}
        />
