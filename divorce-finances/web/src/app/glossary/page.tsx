...
export const metadata: Metadata = {
  ...
  description:
    "Plain-English definitions of the financial and legal terms that come up in divorce and separation.",
  alternates: { canonical: `${siteConfig.url}/glossary` },
  openGraph: {
    title: "Glossary | Divorce Finance Terms Explained",
    description:
      "Plain-English definitions for people divorcing or separating in the UK.",
        ...
        <div className={siteContainerLg}>
          ...
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
              Divorce and money glossary
            </h1>
            <p className="mt-4 text-lg text-neutral-300 leading-relaxed">
              {entries.length > 0
                ? `${entries.length} plain-English definitions of the terms that come up in divorce and separation.`
                : "Plain-English definitions of the terms that come up in divorce and separation. Definitions being added now."}
            </p>
          </div>
        </div>
      </section>
            ...
            {entries.length === 0 ? (
              <div className="border border-neutral-200 bg-white p-10 text-center">
                ...
                <p className="text-neutral-600 max-w-md mx-auto">
                  We are adding plain-English definitions
