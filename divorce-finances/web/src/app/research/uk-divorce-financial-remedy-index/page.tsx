...
export const metadata: Metadata = {
  title: `UK Divorce and Financial Remedy Index | Divorce timings and financial remedy trends | ${siteConfig.name}`,
  ...
  openGraph: {
    title: `UK Divorce and Financial Remedy Index | ${siteConfig.name}`,
          ...
          <div className="max-w-4xl">
            ...
            <div className="rounded-2xl border border-orange-500/20 bg-orange-50/60 p-6 sm:p-8">
              ...
              <p className="mt-4 text-xs text-neutral-500">
                ...
                attribution to {siteConfig.name}.
              </p>
            </div>
