...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: `How ${siteConfig.name} uses cookies and analytics, and how you can control them when browsing our site.`,
};
    ...
    <section className="bg-white">
      <div className={`${contentNarrow} ${sectionYLoose}`}>
        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <ul>
            <li>Understand which pages are most useful to our readers</li>
