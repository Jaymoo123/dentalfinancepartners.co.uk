...
export const metadata: Metadata = {
  title: "Free Divorce Finance Calculators",
  description:
    "Free calculators for the money side of divorce and separation in the UK.",
      ...
      <section className="bg-slate-900 py-14 sm:py-20">
        <div className={siteContainerLg}>
          ...
          <h1 className="mt-6 max-w-3xl text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
            Free divorce finance calculators
          </h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-300">
            Free tools for people divorcing or separating in the UK. Calculators are being built now.
          </p>
        </div>
      </section>
        ...
        <div className={siteContainerLg}>
          ...
          <div className="mt-10 space-y-2 text-center">
            <p>
              ...
              >
                Run a relevant site? Embed any of these calculators for free &rarr;
              </Link>
            </p>
          </div>
