...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `${cat.name} | Divorce and Money Guides`;
  const description = `Practical guides on ${cat.name.toLowerCase()} for people divorcing or separating in the UK. Explained in plain English.`;
      ...
      <section className="border-b border-neutral-200 bg-neutral-900 py-14 sm:py-18">
        <div className={siteContainerLg}>
          ...
          <p className="mt-4 text-base text-neutral-300">
            Practical guides on {cat.name.toLowerCase()} for people divorcing or separating in the UK.
          </p>
        </div>
      </section>
