/**
 * Operator "mark as forwarded to the partner firm" one-click route.
 *
 ...
 * for the data-sharing agreement's delivery log). 'forwarded' therefore means the
