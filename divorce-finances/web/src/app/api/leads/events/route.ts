/**
 * Resend webhook sink for lead-nurture email engagement events.
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://<this site's domain>/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the lead-nurture system.</p>
</div>`,
