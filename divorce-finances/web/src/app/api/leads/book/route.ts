...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[leads/book/divorce] event insert failed", err);
  ...
  try {
    ...
    console.error("[leads/book/divorce] nurture state promote failed (non-fatal)", err);
  }
  try {
    await adminUpdate(
      "leads",
    ...
    console.error("[leads/book/divorce] lead promote failed (non-fatal)", err);
  }
