/**
 * Estate console login page (OB-01).
 *
 * Renders a key form that POSTs to /api/login. The credential travels in a
 * form body, never in the URL. On success the handler sets an HttpOnly
 * session cookie and redirects to the estate overview.
 */
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50">
      <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-lg font-bold text-slate-900">Estate console</h1>
        <p className="mt-1 text-sm text-slate-500">
          Enter the admin key to access the estate dashboard.
        </p>
        ...
        <form action="/api/login" method="POST" className="mt-5 space-y-4">
          <div>
            <label
              htmlFor="key"
