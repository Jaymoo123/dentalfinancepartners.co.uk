...
<p>You have a choice when a car first enters the business. You can either claim <strong>simplified mileage rates</strong> (55p per mile for the first 10,000 business miles in the tax year, then 25p per mile) or claim <strong>actual running costs plus capital allowances</strong>. You cannot mix the two methods for the same car.</p>
...
<p>From 6 April 2027 the finance-cost reducer is given at the new property basic rate of 22% (Finance Act 2026), up from 20%, but this concerns interest, not car allowances. For the full mechanics of the interest restriction, see our <a href="/blog/section-24-and-tax-relief/section-24-tax-relief-complete-guide">complete guide to Section 24</a> and our overview of <a href="/blog/property-types-and-specialist-tax/capital-allowances-on-property">capital allowances and landlord tax relief</a>.</p>
