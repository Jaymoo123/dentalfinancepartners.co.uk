---
title: "How Will 2027 Tax Rate Changes Affect Your Property Incorporation Decision?"
...
metaTitle: "2027 Tax Rates vs Corporation Tax: Incorporate Now?"
metaDescription: "From April 2027, property income faces 22% basic rate vs 19% corporation tax. Should you incorporate before the changes? Analysis for UK landlords."
altText: "UK landlord reviewing tax documents and calculator showing 2027 property tax rates vs corporation tax comparison"
image: ""
h1: "How Will 2027 Tax Rate Changes Affect Your Property Incorporation Decision?"
summary: "From April 2027, property income will be taxed at separate rates (22% basic, 42% higher) rather than general income tax rates. This fundamentally changes the incorporation decision for many landlords."
schema: ""
faqs:
  - question: "What are the new property tax rates from April 2027?"
    answer: "From April 2027, property income will be taxed at 22% basic rate, 42% higher rate, and 47% additional rate. These are separate from general income tax rates and represent an increase from the current 20%, 40%, and 45% rates that apply to all income types."
  - question: "Is corporation tax still better than the new 22% property tax rate?"
    answer: "Corporation tax at 19% is lower than the 22% property tax rate, but you must also pay dividend tax on profits extracted from the company. For basic rate taxpayers, the overall tax burden is often similar, but company ownership provides other benefits like full mortgage interest relief and better cash flow management."
...
<p>From 6 April 2027, property income will be subject to dedicated tax bands rather than following general income tax rates:</p>
<ul>
<li><strong>22% basic rate</strong> on property income (replacing 20%)</li>
...
<p>The <strong>22% basic rate vs corporation tax</strong> comparison becomes crucial for landlords currently paying basic rate tax on rental income. Here's how the numbers work:</p>
...
<p>The question of whether to <strong>incorporate before 2027</strong> depends on several factors beyond just the tax rate comparison. Timing considerations include transferring properties before the new rates take effect, spreading CGT liability over multiple tax years if needed, establishing company structures and banking relationships, and benefiting from the current 20% basic rate on any retained income.</p>
<p>Property transfers to a company trigger Capital Gains Tax (CGT) at 18% (basic rate) or 24% (higher rate). With only a £3,000 annual exempt amount, significant gains could create substantial tax bills. However, this one-time cost needs weighing against annual tax savings from 2027 onwards. For properties with modest gains but strong rental yields, incorporation often makes sense.</p>
...
<p>Before making the <strong>2027 tax rates incorporation decision</strong>, consider the ongoing compliance burden:</p>
<ul>
<li>Annual corporation tax returns and accounts filing</li>
<li>Quarterly MTD submissions for property income</li>
<li>Dividend paperwork and planning</li>
<li>Potential IR35 considerations for active property management</li>
</ul>
<p>These costs and time commitments need factoring into your decision, particularly for smaller portfolios where tax savings might be modest.</p>

<h2>Key Decisions Timeline and Professional Advice</h2>

<p>If you're considering incorporation, the key timeline is:</p>
<ul>
<li><strong>Now to March 2027:</strong> Evaluate your position and complete any property transfers</li>
<li><strong>April 2026:</strong> <a href="/blog/making-tax-digital-mtd/making-tax-digital-landlords-april-2026-deadline">MTD for Income Tax</a> becomes mandatory for relevant landlords</li>
<li><strong>April 2027:</strong> New property tax rates take effect</li>
</ul>
<p>Acting early gives you more options and time to implement tax-efficient structures before the rates change.</p>
<p>The 2027 changes create complex interactions between income tax, corporation tax, dividend tax, and CGT. Each landlord's situation is unique, and the optimal structure depends on current and projected rental income levels, other income sources, capital gains position, long-term investment and exit strategies, and family circumstances. A <a href="/blog/property-accountant-services/what-does-a-property-accountant-do">specialist property accountant</a> can model different scenarios and help you make informed decisions before the 2027 changes take effect.</p>

<h2>Conclusion</h2>

<p>The 2027 property tax rate changes represent a fundamental shift in UK landlord taxation. While basic rate taxpayers see a smaller advantage from incorporation, higher rate taxpayers face a clear incentive to move properties into company structures. The <strong>2027 tax rates incorporation decision</strong> requires careful analysis of your specific circumstances, including current tax position, capital gains liability, and long-term investment goals. With the changes approaching rapidly, now is the time to model different scenarios and make informed decisions about your property portfolio structure.</p>
