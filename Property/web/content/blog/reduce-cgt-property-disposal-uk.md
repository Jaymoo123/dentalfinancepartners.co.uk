...
faqs:
  ...
  - question: "Can I reduce CGT by improving the property before sale?"
    answer: "Genuine improvements that enhance the property's value can be deducted from your capital gain, reducing CGT liability. However, repairs and maintenance cannot be deducted. Keep detailed records and receipts for any improvement work, and ensure the improvements genuinely add value."
  - question: "What costs can I deduct to reduce my capital gain?"
    answer: "You can deduct the original purchase price, acquisition costs (legal fees, survey, stamp duty), capital improvements that enhance value, and disposal costs (estate agent fees, legal costs). Routine repairs and maintenance don't qualify, only genuine enhancements."
  - question: "Is it worth moving property into a company to reduce CGT?"
    answer: "Transferring property to a company typically triggers CGT at the time of transfer, so it doesn't avoid the liability. However, companies pay 19% CGT versus up to 24% for individuals. Incorporation might benefit future growth but requires careful planning and professional advice due to complex rules and potential incorporation relief."
  - question: "When should I start planning for property disposal tax?"
    answer: "Start property disposal tax planning at least 12 months before you intend to sell. Many strategies, such as transferring ownership between spouses or relocating to claim PPR relief, need time to implement effectively. Early planning gives you more options to minimise CGT."
  - question: "Is it better to sell properties individually or as a portfolio?"
    answer: "This depends on your CGT position on each property and your income in different tax years. Selling individually allows you to use annual CGT allowances multiple times and potentially optimise tax rates. However, portfolio sales might attract better prices from investors."
  - question: "How does company ownership affect property disposal planning?"
...
<p>If you own multiple properties, property disposal tax planning becomes more complex but offers greater opportunities. You might stagger sales across multiple tax years to optimise tax bands and allowances. Consider which properties to sell first based on their individual CGT positions. Properties with lower gains or higher allowable costs might be prioritised to preserve CGT allowances for higher-gain disposals. The order of disposals can also impact your eligibility for certain reliefs or your ability to utilise losses against gains effectively.</p>
