---
title: "Gifts with Reservation of Benefit on Property: s.102 FA 1986 Walkthrough"
slug: "iht-gifts-with-reservation-of-benefit-property"
canonical: "https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/iht-gifts-with-reservation-of-benefit-property"
date: "2026-05-22"
author: "Property Tax Partners Editorial Team"
category: "Landlord Tax Essentials"
metaTitle: "GROB on Property Gifts: s.102 FA 1986 Explained"
metaDescription: "Gifts with reservation of benefit on UK property: how s.102 FA 1986 traps home gifts, the rent-payment escape, POAT back-stop, Sch 20 carve-outs."
altText: "Hand holding house keys representing a UK property gift between family members"
...
faqs:
  - question: "What does section 102 Finance Act 1986 actually say?"
    answer: "Section 102 catches gifts of property made on or after 18 March 1986 where either (a) the donee does not assume bona fide possession and enjoyment of the property at or before the beginning of the relevant period, or (b) at any time during the relevant period the property is not enjoyed to the entire exclusion, or virtually to the entire exclusion, of the donor and of any benefit to him by contract or otherwise. The 'relevant period' is the seven years immediately before death, or the period from the gift to death if that is shorter. Under s.102(3), property subject to a reservation immediately before death is treated as property to which the donor was beneficially entitled, so it remains in the estate for IHT despite the gift."
  - question: "If I gift my home to my children but keep living there, does the seven-year clock still help?"
    answer: "Almost certainly not. The lifetime transfer fails the s.102(1)(b) test because the property is not enjoyed to the entire exclusion of you (the donor). The property remains in your estate for IHT under s.102(3) at its open-market value at the date of death, not at the gift-date value. The PET protection that the seven-year survival rule normally gives is illusory because the gift was never effective for IHT purposes. HMRC's IHTM14301 sets out the standard worked example: parent gifts house, parent continues to live there, parent dies seven-plus years later, house remains in the estate at full market value at death."
  - question: "How much rent do I need to pay to escape GROB on a home gift?"
    answer: "Full open-market rent. HMRC's position, set out in IHTM14333 onward, is that the rent must be commercial, periodically reviewed (typically every two to three years against current market evidence), and demonstrably paid (bank evidence). A peppercorn rent or a rent set well below the local market does not break the reservation. The rent is taxable rental income for the donee. The arrangement should be documented in a tenancy agreement that would survive scrutiny if the property went onto the open market."
  - question: "Does paying some rent below market help at all?"
    answer: "No, not for s.102 purposes. The reservation continues to apply where the donor receives any benefit, and continuing to occupy at below-market rent is a benefit. HMRC's enquiry pattern is to compare the rent paid against contemporaneous market evidence and treat any shortfall as a reservation. The all-or-nothing nature of the test is deliberate, you cannot proportion the gift between exempt and reserved on the basis of partial rent. Either pay full market rent or accept that the gift is a GROB."
  - question: "Can my children and I both live in the gifted property without triggering GROB?"
    answer: "Possibly, under the narrow Schedule 20 paragraph 6 FA 1986 co-ownership carve-out. The carve-out applies where the donor and the donee both occupy the property after the gift, and the donor bears their share of the property's running costs (council tax, utilities, repairs, maintenance) proportionate to their use. HMRC scrutinises co-ownership arrangements closely, especially where the family relationship is parent-child. The carve-out is real but narrow, and the documentary trail (proportionate cost contributions, contemporaneous records) has to be solid. If the donor stops occupying, the carve-out ends and you need to check whether GROB then bites again."
  - question: "What is Pre-Owned Assets Tax and when does it apply?"
    answer: "Pre-Owned Assets Tax (POAT) is an income tax charge under s.84 plus Schedule 15 Finance Act 2004, introduced to catch arrangements that escape s.102 but still leave the donor enjoying the asset. The classic case: a cash gift to children, the children buy the property, the donor lives there rent-free. No reservation under s.102 (the gift was of cash, not the property), but the donor enjoys the benefit. POAT charges the donor an annual income tax amount based on the deemed market rent of the property. The charge runs every tax year while the donor enjoys the benefit, and is calculated on Form IHT500-related guidance or via self-assessment."
  - question: "When can I elect to be treated as GROB instead of paying POAT?"
    answer: "Where POAT would otherwise apply, the donor can make an election under paragraph 21 of Schedule 15 FA 2004 to be treated as making a gift with reservation instead. The election is made on form IHT500 by 31 January after the tax year in which the donor first enjoys the benefit. The trade-off: no annual income tax charge, but the property is in the donor's estate for IHT (potentially at higher overall cost). The election is irrevocable for the period it covers. Whether to elect depends on the donor's age, expected survival, and the IHT-versus-POAT comparative cost."
  - question: "Does GROB apply to gifts of buy-to-let properties?"
    answer: "Usually no, on the standard fact pattern. The donor was never living in the BTL property and does not take its rental income after the gift. The donee receives the rents from the date of legal transfer and reports them on their own self-assessment. The s.102(1) tests are not met because the donor enjoys no benefit. GROB does apply where the donor continues to take the rent through the donee, uses the property as a personal holiday home, or has retained any right to live there. Genuine arms-length gifts of let property are normally clean for s.102 purposes."
  - question: "What happens if I stop living in the gifted property after, say, five years?"
    answer: "Under s.102(4), the reservation ceases at the moment the benefit ends, and the donor is treated as having made a PET at that date. The PET clock then starts running from the cessation date, not from the original gift date. So a donor who gifted at age 65, lived there for five years rent-free, moved out at 70, would need to survive seven years from age 70 (i.e. to age 77) for the gift to fall fully out of the estate. The donor's executors must report cessation on form IHT100c when the death occurs within seven years of cessation."
  - question: "Are gifts between spouses or civil partners subject to GROB?"
    answer: "No. Section 102(5) excludes gifts that qualify under specified exempt-transfer provisions of the IHT Act 1984, which include transfers between UK-resident spouses or civil partners under s.18 IHTA 1984. The donor can transfer property to a spouse or civil partner and continue to occupy or enjoy it without triggering s.102. The exemption applies regardless of who holds the legal title afterwards. The same applies to gifts to charity (s.23), political parties (s.24), housing associations (s.24A), gifts in consideration of marriage or civil partnership (s.22), and small gifts (£250 per donee under s.20)."
  - question: "Can a trust be used to avoid GROB on the family home?"
    answer: "Not easily. A gift into a discretionary trust where the donor is a potential beneficiary is a GROB under s.102(1)(b) because the donor retains the contingent right to a benefit. A gift into a trust where the donor and spouse are specifically excluded as beneficiaries does break the reservation, but the gift is then a chargeable lifetime transfer (CLT) for IHT (20% lifetime rate above the nil-rate band) and the donor cannot occupy the property at all. The 'home loan' or 'double trust' schemes that proliferated pre-2003 are now mostly caught by POAT or by anti-avoidance legislation. Specialist advice is essential before any trust arrangement on the home."
  - question: "What's the difference between section 102 and sections 102A, B, and C?"
...
<p>Section 102 Finance Act 1986 applies to gifts of property made on or after 18 March 1986. A gift is "subject to a reservation" where either of two conditions is met during the relevant period (defined as the seven years ending with the donor's death, or the period from the gift to death if shorter):</p>

<ul>
<li><strong>s.102(1)(a):</strong> The donee does not assume bona fide possession and enjoyment of the property at or before the beginning of the relevant period.</li>
<li><strong>s.102(1)(b):</strong> At any time during the relevant period the property is not enjoyed to the entire exclusion, or virtually to the entire exclusion, of the donor and of any benefit to him by contract or otherwise.</li>
</ul>
...
<p>The IHT consequence: roughly £820,000 brought back into the estate, against a couple's combined nil-rate band of (typically) £650,000 with full RNRB lost where the gift broke the direct-descendant condition. Tax exposure: in the order of £200,000 to £280,000 that the family thought had been planned away.</p>

<p>The seven-year clock did its work; it simply was the wrong clock. The PET never had effect.</p>
...
<li><strong>s.24 / 24A IHTA 1984:</strong> gifts to qualifying political parties and housing associations.</li>
</ul>

<p>Sections 102A, 102B and 102C were inserted by FA 1999 to extend the reservation concept to gifts of an interest in land made after 9 March 1999. They catch arrangements where the donor retains a significant right or interest in the land (s.102A), participates in a significant arrangement relating to the land (s.102B), or where the donee makes the property subject to a reservation in favour of the donor (s.102C). For most family-home and BTL-portfolio cases, s.102 itself suffices. The extension provisions come into play with complex shared-ownership, lease-back, and family-trust-into-land structures.</p>
...
<aside>
<p>Each of the four patterns above has a documentation trail that decides the outcome.</p>
