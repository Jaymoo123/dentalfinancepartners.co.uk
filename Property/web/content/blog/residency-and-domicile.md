---
title: "UK Tax Residency and Domicile for Property Investors: The Statutory Residence Test, the End of the Domicile Concept for Income and CGT, the New Long-Term Resident Test for IHT, and How Each Drives Your UK Property Tax Position"
slug: "residency-and-domicile"
canonical: "https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/residency-and-domicile"
date: "2026-05-26"
author: "Property Tax Partners Editorial Team"
category: "Property Types & Specialist Tax"
metaTitle: "Residency and Domicile: SRT, LTR Test, Property Tax 2026"
metaDescription: "UK tax residency and domicile primer: FA 2013 Sch 45 SRT cascade, IHTA 1984 ss.6A-6C LTR test, split-year, FIG, TRF, NRCGT for property investors."
...
faqs:
  ...
  - question: "What is split-year treatment and when does it apply?"
    answer: "Cases 1 to 8 under FA 2013 Sch 45 Part 3. The tax year is split into a UK-resident part and a non-resident part where one of the eight Cases is met. Cases 1 to 3 cover departure scenarios (full-time work abroad; partner moving abroad; ceasing UK home). Cases 4 to 8 cover arrival scenarios (full-time UK work; partner moving to UK; acquiring UK home). The split must be claimed in the self-assessment return; it does NOT apply automatically."
  - question: "What was the historic domicile concept and what is its current operation?"
    answer: "A common-law concept from private international law: domicile of origin (acquired at birth), dependence (under 16s follow the parent), choice (acquired by adult through long-term residence plus intention to remain indefinitely). Pre-6-April-2025, UK domicile or deemed-dom status drove the UK tax position on foreign income, gains, and IHT. Post-6-April-2025, domicile has substantially ended its operation for income tax and CGT (FA 2025 Sch 9) and substantially for IHT (replaced by the LTR test). Residual operation: trust attribution under pre-FA-2025 architectures, private international law, and certain DTAs."
  - question: "What is the Long-Term Resident (LTR) test for IHT?"
    answer: "IHTA 1984 ss.6A-6C inserted by FA 2025. An individual is long-term UK resident, and therefore within IHT on worldwide-situs assets, if UK-resident for 10 of the preceding 20 tax years (with s.6B young-person variation for under-20s, and a tail period for departure under s.6C). The 10-of-20 test replaces the historic deemed-dom 15-of-20 architecture. The reform is residence-based, not domicile-based."
  - question: "How does residency interact with UK property?"
    answer: "UK-source rental income is taxed regardless of residence. Non-UK-resident landlords use the NRL scheme under ITA 2007 Part 14 Chapter 5 and SI 1995/2902. UK property capital gains are taxed regardless of residence under NRCGT (TCGA 1992 Sch 4ZZB) with 60-day reporting. ATED applies to companies regardless of company residence. The residence question matters most for the worldwide-asset position: a UK-resident landlord with overseas-property income or gains is taxed on the worldwide picture (subject to FIG if eligible); a non-resident UK-property owner is taxed only on UK-source income and gains."
  - question: "What happens if I leave the UK: what are the residency cliffs?"
    answer: "Three operative tests on departure. First, the SRT day-count plus ties test for the current tax year, with split-year claim possible under Cases 1 to 3 if conditions are met. Second, the NRL scheme 'usual place of abode' trigger, which operates ahead of SRT in some scenarios. Third, TCGA 1992 s.10A 'temporary period of non-residence' anti-avoidance: gains realised during a temporary period of non-residence (typically up to 5 years away from the UK) are taxed in the year of return. If you return within 5 years, s.10A may catch gains realised during the absence."
  - question: "What happens if I arrive in the UK: what are the planning windows?"
    answer: "Three planning windows. First, split-year claim under SRT Cases 4 to 8 to limit UK tax to the post-arrival period. Second, FIG regime claim under ITTOIA 2005 s.845A: 4 years of full foreign-income and gains exemption if the 10-year-prior-non-residence gateway is met, though the claim forfeits personal allowance and CGT annual exempt amount. Third, the IHT LTR clock: the 10-of-20 test starts ticking from the first UK-resident year. Planning around the 10-year horizon is critical for high-net-worth arrivals."
  - question: "How do residency and domicile interact in 2026?"
...
<p>If neither automatic test gives a result, the cascade moves to Stage 3.</p>
...
<li><strong>Accommodation tie:</strong> available UK accommodation used for at least one night in the year.</li>
<li><strong>Work tie:</strong> 40 or more days worked in the UK in the year (3 hours' work in a UK day counts as a workday).</li>
...
<li><strong>Case 2:</strong> partner of someone starting full-time work overseas, joining them partway through the year.</li>
<li><strong>Case 3:</strong> ceasing to have a UK home during the year.</li>
<li><strong>Case 4:</strong> starting to have a UK home only, after a period without one.</li>
<li><strong>Case 5:</strong> starting full-time work in the UK during the year.</li>
<li><strong>Case 6:</strong> ceasing full-time work overseas during the year.</li>
<li><strong>Case 7:</strong> partner of someone ceasing full-time work overseas, joining them in the UK.</li>
...
<p>Three operative tests apply on departure:</p>
...
<p>Three planning windows apply:</p>
...
<p>Domicile has not been abolished as a legal concept. It continues to operate in three contexts:</p>

<ul>
<li><strong>Trust attribution under s.48ZA transitional architecture.</strong> The boundary between excluded-property trusts created before LTR onset and those created after turns on the settlor's status at trust creation, which references domicile in some transitional fact patterns.</li>
<li><strong>Private international law.</strong> Cross-border succession, family law, conflict of laws. The Domicile and Matrimonial Proceedings Act 1973 architecture continues to apply.</li>
