---
title: "SIPP and SSAS Rental Property in MTD ITSA: The Trustee Exclusion Mechanic"
slug: "mtd-itsa-pension-funds-sipp-ssas-holding-rental-property-treatment"
canonical: "https://www.propertytaxpartners.co.uk/blog/making-tax-digital-mtd/mtd-itsa-pension-funds-sipp-ssas-holding-rental-property-treatment"
date: "2026-05-23"
author: "Property Tax Partners Editorial Team"
category: "Making Tax Digital (MTD)"
metaTitle: "SIPP / SSAS Property + MTD ITSA: The Trustee Exclusion"
metaDescription: "SIPP and SSAS-held rental property sits outside MTD ITSA. Personal portfolio still tests on its own. The pension rent does not add to your £50k threshold."
altText: "Front view of a blue and grey metal warehouse exterior with large industrial doors, representing commercial property typically held inside a SIPP or SSAS"
...
h1: "SIPP and SSAS-Held Rental Property in MTD ITSA: The Trustee Exclusion"
summary: "Landlords with a Self-Invested Personal Pension (SIPP) or Small Self-Administered Scheme (SSAS) holding commercial rental property arrive at Making Tax Digital with a recurring question: does the pension-held rental aggregate with my personal portfolio for the £50,000 threshold test, and do I file the pension property's quarterly updates inside MTD ITSA? Both answers are no. Pension trustees are outside MTD ITSA entirely under the §19.3 excluded categories, and the rental income within the pension wrapper is generally exempt from income tax inside a registered pension scheme. This page walks the trustee-exclusion mechanic, the SIPP-versus-SSAS distinction, the arm's-length rent discipline HMRC enforces via PTM121000, why residential property in a pension is the heavily restricted edge, the parallel-streams worked example (personal portfolio plus pension-held unit), and what changes when you start drawing pension income."
schema: ""
faqs:
  - question: "Does the rent from a commercial property held inside my SIPP count toward the £50,000 MTD ITSA threshold?"
    answer: "No. Rental income arising on property held inside a registered pension scheme (SIPP or SSAS) is income of the pension scheme, not of you the member. It does not appear on your personal self-assessment return as your rental income, and it does not feed the qualifying-income figure used for the MTD ITSA threshold test. House position §19.12 confirms this explicitly. A member with £40,000 of personal residential rents and a £35,000 SIPP-held commercial rent tests £40,000 only against the threshold, not £75,000."
  - question: "Who actually files the quarterly updates for a SIPP-held rental property?"
    answer: "Nobody, in the MTD ITSA sense. Pension scheme trustees are not in scope for MTD ITSA at all (per the §19.3 excluded categories, MTD ITSA covers individuals and partnerships, not trustees of registered pension schemes). The scheme administrator (the SIPP provider or the SSAS practitioner) handles the scheme's own statutory reporting via the Pension Schemes Online service, the event report, and the registered pension scheme return where relevant. That is a separate regime from MTD ITSA and is not on a quarterly cycle."
  - question: "Is the rental income inside my SIPP genuinely tax-free?"
    answer: "Within the wrapper, broadly yes. Rental income earned by a registered pension scheme is exempt from income tax under the Finance Act 2004 Part 4 regime that governs registered schemes. The exemption is not unconditional; it depends on the scheme remaining a registered pension scheme, the property being held in compliance with the investment-regulated-schemes rules, and any tenant connected to the scheme paying market rent (see the arm's-length question below). The exemption applies to income inside the wrapper. When you eventually draw pension income, that income is taxed in your hands at marginal income tax rates, subject to the 25% tax-free lump sum entitlement."
  - question: "What is the difference between a SIPP and a SSAS for property purposes?"
    answer: "A SIPP is a personal pension scheme set up by one individual, typically with a regulated SIPP provider acting as scheme administrator and trustee. A SSAS is an occupational pension scheme, usually set up by a private company for its directors, with the company sponsoring and the directors acting as member-trustees alongside a professional trustee. SSAS is more flexible (it can lend back to the sponsoring employer, hold a wider asset range including the employer's premises, and pool multiple members' contributions). SIPP is simpler administratively but less flexible. Both can hold commercial property; both sit outside MTD ITSA on the rental income side."
  - question: "Can my SIPP own a residential buy-to-let?"
    answer: "Almost never, in practical terms. Residential property held in a registered pension scheme is classified as taxable property under the Finance Act 2004 investment-regulated rules and attracts punitive tax charges (an unauthorised payment charge of 40% plus a scheme sanction charge of typically 15% on the value of the residential interest). The combined charge can exceed 55% of the property's value, plus an annual chargeable-asset tax. The rules effectively prohibit residential buy-to-let inside a SIPP or SSAS. Commercial property (offices, industrial units, retail premises, hotels in some structures) is the workable use case."
  - question: "My SIPP owns the commercial unit my business rents. What rent should the business pay?"
    answer: "Market rent. HMRC's Pensions Tax Manual at PTM121000 makes clear that where the sponsoring employer or a scheme member rents commercial property from the pension scheme, the rent paid must be the commercial market amount. Paying less than market rent triggers an unauthorised payment tax charge on the shortfall (typically 40%) plus a scheme sanction charge on the administrator (typically 15%). The market rent should be supported by an independent valuation refreshed periodically, the rent reviews should follow standard commercial-lease cycles, and the lease should be on arm's-length terms. Treat this the way HMRC's Property Income Manual treats connected-party transactions in conventional landlord-tenant relationships."
  - question: "If the SIPP rent does not count toward my MTD ITSA threshold, does anything inside the SIPP appear on my self-assessment?"
    answer: "Nothing while the property is held inside the SIPP and you are still in accumulation. Your self-assessment return reports your personal income (employment, self-employment, your personal rentals outside the pension, dividends, savings interest, etc), not the pension scheme's income. The SIPP's rents, gains, and expenses are inside the wrapper and do not pass through your tax return. When you start drawing pension income in retirement, the pension drawdown or annuity payments appear on your self-assessment under the pension income section, taxed at marginal rates, which is a different mechanic from rental income reporting."
  - question: "Can I add property to a SIPP after the rental has already been letting personally?"
    answer: "Yes, in principle, but the route is operationally heavy. The pension scheme buys the property from you at market value (or you make an in-specie contribution within your annual allowance), funded by your existing pension assets or fresh contributions. The transfer is a disposal for CGT purposes (TCGA 1992 s.17 deems the disposal at market value because pension trustees are connected to the member), so you face a CGT bill on the gain accrued during personal ownership. Stamp duty land tax is payable by the pension scheme on the acquisition. Most SIPP transfers of property need 6 to 12 months lead time, professional valuations, and careful sequencing with the annual allowance and the lifetime allowance replacement (lump sum allowance) rules introduced in April 2024."
  - question: "Does a SSAS pension renting property to the sponsoring company have different MTD ITSA implications?"
    answer: "No, the MTD ITSA position is the same. The SSAS trustee is not in MTD ITSA. The sponsoring company is a corporate tenant (it deducts the rent as a business expense in its corporation tax computation), the SSAS receives the rent tax-free inside the wrapper, and neither generates MTD ITSA obligations. The directors who are also members of the SSAS file their personal MTD ITSA returns based only on their personal property income (if any) plus self-employment, salary, dividends, etc. The SSAS rent does not feed any of those streams while it stays inside the wrapper."
  - question: "What if my SIPP has a small amount of cash rental income from a sub-let or licence?"
    answer: "Still inside the wrapper, still tax-exempt at the scheme level, still outside MTD ITSA at the member level. The amount does not change the position. A SIPP holding a multi-tenanted commercial unit with five sub-lets simply receives five rent streams into the scheme's bank account, all exempt at the wrapper, all reported via the scheme administrator's processes (not your personal MTD return). Small does not push it back across the line."
  - question: "Are the scheme administrator obligations themselves digital under MTD?"
    answer: "Not under MTD ITSA. The Pension Schemes Online service is a separate HMRC digital service that pension scheme administrators use for the scheme's statutory reporting (registration changes, event reports, accounting for tax returns, scheme administrator declarations). It is digital but it is not part of MTD ITSA, and it operates on a different rhythm (event-driven reporting plus an annual accounting for tax return, where due). A SIPP provider or SSAS practitioner handles this end. Members do not interact with Pension Schemes Online for routine compliance."
  - question: "If I'm drawing pension income from a SIPP that holds rental property, does the income shift to MTD ITSA?"
    answer: "No. Pension drawdown income and annuity income are not property income; they are pension income, reported on the self-assessment SA101 pages (or via PAYE codings where applicable). They sit outside MTD ITSA, which covers self-employment turnover and rental income only. A retiree with no personal rentals and only SIPP drawdown income is fully outside MTD ITSA regardless of how much of that drawdown originally came from rental investments inside the wrapper. If the same retiree also owns personal residential rentals above the threshold, the personal rentals (only) are in MTD ITSA."
  - question: "Where do I check whether my SIPP property is being handled correctly for the trustee-exclusion route?"
    answer: "Two angles. First, confirm with your SIPP provider or SSAS practitioner that the scheme is registered with HMRC under Finance Act 2004 Part 4 (the standard position; any provider holding scheme property will be) and that they handle the scheme's HMRC reporting (Pension Schemes Online, event reports). Second, on your self-assessment, ensure the SIPP rental income is not being entered on your SA105 (UK property pages). If your accountant has ever included pension-held rents on your personal return, that is an error that needs unwinding, ideally before you cross the MTD ITSA mandate date so the threshold test runs on the correct figure."
dateModified: "2026-05-23"
reviewedBy: "Property Tax Partners Editorial Team"
reviewerCredentials: "UK-based tax advisers specialising in property income, MTD ITSA implementation, and the SIPP / SSAS commercial-property edge case. Position aligned with house position §19.12 (pension funds + rental property, Wave 4 extension, locked 2026-05-23) and §19.3 (excluded categories)."
