---
title: "Land Transaction Tax: A Complete Guide to Welsh LTT for Buyers, Investors, and Their Advisers"
slug: "land-transaction-tax-a-complete-guide"
canonical: "https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/land-transaction-tax-a-complete-guide"
date: "2026-05-26"
...
faqs:
  - question: "What is Land Transaction Tax and when did it start?"
    answer: "Land Transaction Tax (LTT) is the Welsh property-transfer tax that replaced Stamp Duty Land Tax (SDLT) in Wales on 1 April 2018 under the Wales Act 2014 devolution. It is administered by the Welsh Revenue Authority (not HMRC) under the Land Transaction Tax and Anti-avoidance of Devolved Taxes (Wales) Act 2017 ('LTTA 2017'). LTT has its own statute, rate tables, reliefs, return regime, and tribunal route. SDLT no longer applies anywhere in Wales. The four-nation property-transfer-tax landscape is now: England and Northern Ireland use SDLT (under FA 2003); Wales uses LTT (under LTTA 2017); Scotland uses LBTT (under LBTT(S)A 2013)."
  ...
  - question: "What are LTT non-residential rates?"
    answer: "Non-residential LTT bands (unchanged from 22 December 2020 and in force for 2026/27) are: 0% on £0 to £225,000; 1% on £225,001 to £250,000; 5% on £250,001 to £1,000,000; 6% above £1,000,000. The bands apply to commercial property, mixed-use property, and certain edge cases. Wales has NO equivalent to FA 2003 s.116(7) (the SDLT six-dwellings automatic non-residential rule), so portfolio buyers acquiring 6+ Welsh dwellings cannot use the non-residential rates as an alternative to MDR; the residential higher-rates table or MDR is the only route."
  - question: "Does Wales have a non-resident surcharge?"
    answer: "No. Unlike England and Northern Ireland, which apply a 2% SDLT non-resident surcharge under FA 2003 Sch 9A from 1 April 2021, Wales has not introduced an LTT non-resident surcharge. Non-UK-resident buyers in Wales pay the same main rates or higher rates as Welsh-resident buyers, with no additional 2%. The cross-border planning angle for non-UK-resident buyers between England and Wales is real but secondary to the main-residence and additional-dwelling tests."
  - question: "Does Wales have first-time buyer relief?"
    answer: "No. Wales has not introduced a separate first-time buyer regime because the universal £225,000 main residential nil band already covers most starter purchases. England's SDLT regime gives FTBs a £300,000 nil band (withdrawn fully above £500,000); Scotland's LBTT regime gives FTBs a £175,000 nil-band uplift (no upper cap, £600 maximum saving). At £200,000, a Welsh buyer (FTB or not) pays £0, an English FTB pays £0 (against £1,500 standard SDLT), and a Scottish FTB pays £500. At £300,000, a Welsh buyer pays £3,750, an English FTB pays £0, a Scottish FTB pays £2,500. The Welsh policy-absence framing is a deliberate trade-off, not an oversight."
  - question: "What reliefs are available under LTT?"
    answer: "Headline reliefs in LTTA 2017: multiple dwellings relief (subject to the 2025 and 2026 modifications); group relief (Sch 16, transfers between members of the same corporate group, mirrors FA 2003 Sch 7); partnership relief (Sch 7, genuine pre-existing letting-partnership incorporation, mirrors FA 2003 Sch 15); charities relief (Sch 19, charity acquiring property for charitable use); sub-sale relief (Sch 2 Part 4, narrow); derelict-property refund (for properties uninhabitable at the effective date). Each relief has its own evidential bar and time limit, and the Welsh tests are not identical to the SDLT or LBTT equivalents."
...
<ul>
<li><strong>England and Northern Ireland:</strong> SDLT under FA 2003, administered by HMRC.</li>
<li><strong>Wales:</strong> LTT under LTTA 2017, administered by the Welsh Revenue Authority.</li>
<li><strong>Scotland:</strong> LBTT under LBTT(S)A 2013, administered by Revenue Scotland.</li>
</ul>

<h2>Main residential rates for 2026/27</h2>

<p>The Welsh main residential band table, in force from 10 October 2022 and unchanged for 2026/27:</p>

<ul>
<li>£0 to £225,000: 0%</li>
...
<p><strong>£200,000 purchase:</strong> within the £225,000 nil band. LTT due: £0.</p>

<p><strong>£275,000 purchase:</strong> £0 + 6% on £50,000 (£225,001 to £275,000) = £3,000.</p>

<p><strong>£400,000 purchase:</strong> £0 + 6% on £175,000 = £10,500.</p>

<p><strong>£600,000 purchase:</strong> £0 + 6% on £175,000 + 7.5% on £200,000 = £10,500 + £15,000 = £25,500.</p>
...
<p>The choice between main and higher rates is binary (a single joint buyer with another dwelling triggers higher rates on the whole purchase) and the cash difference can be tens of thousands of pounds. We help Welsh buyers and their advisers model the correct rate table before missives. Use the form at the foot of the page.</p>
</aside>
...
<p>Welsh non-residential LTT bands (unchanged from 22 December 2020 and in force for 2026/27):</p>

<ul>
<li>£0 to £225,000: 0%</li>
<li>£225,001 to £250,000: 1%</li>
<li>£250,001 to £1,000,000: 5%</li>
<li>Above £1,000,000: 6%</li>
</ul>
...
<aside>
<p>Cross-border landlord with property in England and Wales, or considering a Welsh portfolio acquisition?</p>
<p>The cross-border returns architecture (separate filings to HMRC and the Welsh Revenue Authority on apportioned consideration), the MDR-survives-in-Wales position, and the higher-rate joint-buyer aggregation rule all require careful planning before missives or exchange. Talk to us early in the process.</p>
</aside>
...
<li><strong>FA 2003 s.48A:</strong> apportionment for the English portion under SDLT.</li>
...
<p>LTTA 2017 Part 7 s.66 introduces a Welsh-specific General Anti-avoidance Rule (GAAR) covering all devolved Welsh taxes (LTT and landfill disposals tax). The Welsh GAAR sits alongside the SDLT-specific anti-avoidance provisions in FA 2003 and the Scottish LBTT GAAR in LBTT(S)A 2013. The three-jurisdiction GAAR landscape means an artificial arrangement spanning Welsh, English, or Scottish land may face challenge in different forms depending on where the land is. Welsh Tax Tribunal caseload on GAAR is still building, but the rule is operationally live for every LTT transaction.</p>

<h2>Refunds, repayments, and time limits</h2>

<p>Two main routes to recover overpaid LTT:</p>

<ul>
<li><strong>Amendment of return within 12 months:</strong> the LTT return can be amended within 12 months of the original return under LTTA 2017. Common amendment scenarios: missed MDR claim on a portfolio purchase; missed relief identification; arithmetic correction.</li>
