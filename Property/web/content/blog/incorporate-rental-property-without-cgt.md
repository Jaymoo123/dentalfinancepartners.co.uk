...
faqs:
  ...
  - question: "What is the difference between incorporation relief and holdover relief?"
    answer: "Incorporation relief (s.162) is automatic to claim where the whole business is transferred for shares, and it rolls the gain into the share value. Gift holdover relief (s.165) is a different mechanism, used where business assets are gifted, that holds the gain over into the recipient's base cost. For a genuine property business transferred for shares, s.162 is usually the cleaner route. We cover the s.165 alternative in our guide to incorporation holdover relief for property."
