...
faqs:
  ...
  - question: "What are the alternatives if my rental portfolio doesn't qualify for incorporation relief?"
    answer: "If incorporation relief doesn't apply, you can still incorporate but will face immediate CGT. Strategies to minimise this include: using annual CGT allowances (£3,000 for 2025/26) by transferring partial interests over several years, timing transfers during lower income years to benefit from lower CGT rates (18% vs 24%), or using gift and loan back arrangements where you gift properties and receive a director's loan in return."
---
...
<li>Develop or substantially improve properties for rental</li>
...
<li><strong>Prepare incorporation relief claim:</strong> Submit the claim with your next Self Assessment return</li>
