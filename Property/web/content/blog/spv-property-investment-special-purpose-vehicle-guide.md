---
title: "What Is a Special Purpose Vehicle (SPV) for Property Investment?"
...
metaTitle: "SPV Property Investment: Guide to Special Purpose Vehicles"
metaDescription: "Learn what an SPV is for property investment, how special purpose vehicle structures work for landlords, and when to use SPV company structures."
altText: "Professional diagram showing SPV property investment structure with company holding multiple rental properties"
image: ""
h1: "What Is a Special Purpose Vehicle (SPV) for Property Investment?"
summary: "A Special Purpose Vehicle (SPV) is a limited company created specifically to hold and manage property investments, offering tax advantages and limited liability protection for landlords."
schema: ""
faqs:
  - question: "What is the difference between an SPV and a regular limited company?"
    answer: "An SPV (Special Purpose Vehicle) is a limited company created for the specific purpose of holding property investments, while a regular limited company can engage in various business activities. In practice, most property SPVs are standard limited companies with a focused investment purpose rather than specialist legal structures."
  - question: "Can I transfer my existing rental properties to an SPV?"
    answer: "Yes, but transferring existing properties to an SPV triggers Capital Gains Tax at market value and Stamp Duty (including the 5% surcharge) for the company. You'll also need mortgage lender consent. Many landlords use SPVs for new purchases to avoid these transfer costs."
  - question: "How much does it cost to run an SPV for property investment?"
    answer: "Annual costs typically include £1,500-3,000 in additional accountancy fees, £13 Companies House filing fee, and potential higher mortgage rates. However, tax savings for higher-rate taxpayers often exceed these costs by several thousand pounds annually."
  - question: "Do I need separate SPVs for each property?"
    answer: "No, most landlords use one SPV to hold multiple properties, which is more cost-effective and administratively efficient. Single-property SPVs are typically only used for high-value properties or those carrying specific risks requiring maximum liability protection."
---

<p>A Special Purpose Vehicle (SPV) for <strong>SPV property investment</strong> is a limited company created specifically to hold and manage property investments. Unlike general trading companies, an SPV has a single, focused purpose: owning rental properties and generating rental income.</p>
...
<li>Properties are purchased by the company, not you personally</li>
<li>Rental income flows to the company</li>
...
<li>Tax relief on mortgage interest: £2,400 (£12,000 × 20%)</li>
<li>Taxable income: £16,000 (full rental income minus non-interest expenses)</li>
<li>Income tax: £6,720 (42% from April 2027)</li>
<li>Less mortgage interest relief: £2,400</li>
<li>Net tax: £4,320</li>
