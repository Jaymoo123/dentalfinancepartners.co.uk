 ...
 * already emits (section_view, scroll_depth, calc_*, form_error). Property-
 * specific (uses the Property taxonomy + page conventions); storage key is the
 * frozen `ptp` prefix used estate-wide for this site.
 */
