...
export const rentalIncomeTaxCalculator: GenericTool = {
  ...
  metaDescription:
    "Free landlord tax calculator for UK rental income. Work out income tax on rental profit using the 2026/27 bands, including the Section 24 mortgage-interest restriction, and your take-home.",
  intro:
