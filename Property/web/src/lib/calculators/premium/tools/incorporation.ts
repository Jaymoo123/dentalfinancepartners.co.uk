...
export const incorporationPremiumTool: PremiumToolConfig = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "The company's money is not your money. Unless you retain and reinvest it, taking profit out as dividends is taxed again in your hands (10.75% / 35.75% / 39.35%), which is why the tool lets you toggle extraction. Company buy-to-let mortgages typically cost more, a £500k-plus dwelling brings ATED (relieved for genuine commercial lets but the return must still be filed), and there is ongoing company admin. Use this as a first-pass model, then get your actual portfolio run property by property.",
    ],
  },
};
