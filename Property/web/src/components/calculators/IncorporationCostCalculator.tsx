  ...
  return (
    <div className="bg-white border-l-4 border-emerald-600 p-8 sm:p-10">
      <div className="mb-8">
        ...
        <h3 className="text-3xl font-bold text-slate-900">Incorporation Cost Calculator</h3>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr]">
        <div className="space-y-6">
          <div>
            <label htmlFor="property-value" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 border-b-2 border-slate-300 bg-transparent px-2 py-3 text-2xl font-bold text-slate-900 focus:border-emerald-600 focus:outline-none transition-colors"
              />
            </div>
          </div>

          <div>
            <label htmlFor="purchase-price" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="mortgage-balance" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="rental-income-inc" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="mortgage-interest-inc" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="tax-band-inc" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
            ...
            <select
              ...
              className="w-full border-2 border-slate-300 bg-white px-4 py-3 text-base font-semibold text-slate-900 focus:border-emerald-600 focus:outline-none transition-colors"
            >
        ...
        <div className="bg-slate-900 p-8 text-white space-y-8">
          <div>
            <div className="text-sm font-bold text-amber-400 uppercase tracking-wider mb-2">Upfront cost</div>
          ...
          <div className="border-t border-slate-700 pt-6">
            <div className="text-sm font-bold text-emerald-400 uppercase tracking-wider mb-2">Annual saving</div>
            <div className="text-4xl font-bold text-white font-mono">
              £{annualSaving.toLocaleString("en-GB", { maximumFractionDigits: 0 })}
            </div>
            <div className="mt-2 text-sm text-slate-300">per year after incorporating</div>
          </div>

          <div className="border-t border-slate-700 pt-6">
            <div className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-2">Break-even</div>
