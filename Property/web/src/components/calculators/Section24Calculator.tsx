  ...
  return (
    <div className="bg-white border-l-4 border-emerald-600 p-8 sm:p-10">
      <div className="mb-8">
        ...
        <h3 className="text-3xl font-bold text-slate-900">Section 24 Tax Calculator</h3>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr]">
        <div className="space-y-6">
          <div>
            <label htmlFor="rental-income" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="mortgage-interest" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
          ...
          <div>
            <label htmlFor="other-expenses" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
              Other expenses
            </label>
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold text-slate-900">£</span>
          ...
          <div>
            <label htmlFor="tax-band" className="block text-sm font-bold text-slate-900 uppercase tracking-wider mb-2">
        ...
        <div className="bg-slate-900 p-8 text-white">
          <div className="mb-6">
            <div className="text-sm font-bold text-emerald-400 uppercase tracking-wider mb-2">Your result</div>
            <div className="text-5xl font-bold text-white font-mono">
              £{extraTax.toLocaleString("en-GB", { maximumFractionDigits: 0 })}
            </div>
            <div className="mt-2 text-sm text-slate-300 uppercase tracking-wider">Extra tax per year</div>
          </div>
          ...
          <div className="border-t border-slate-700 pt-6 space-y-4">
            ...
            <div className="flex justify-between items-baseline">
              <span className="text-sm text-slate-300">Old system tax</span>
              <span className="text-lg font-semibold text-slate-400">
                £{oldSystemTax.toLocaleString("en-GB", { maximumFractionDigits: 0 })}
              </span>
            </div>
            <div className="flex justify-between items-baseline">
              <span className="text-sm text-slate-300">Section 24 tax</span>
              <span className="text-lg font-semibold text-slate-400">
