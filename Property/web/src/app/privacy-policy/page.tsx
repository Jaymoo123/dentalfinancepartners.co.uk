      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            you are about to leave a page), we collect your name, email address, phone number, the type of landlord or
            investor you are, your message, and the page you submitted from.
          </li>
          <li>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            property tax information until you unsubscribe.
          </li>
          <li>
