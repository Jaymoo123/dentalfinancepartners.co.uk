        ...
        <div className={siteContainerLg}>
          <div className="max-w-3xl">
            ...
            {tool.workedExamples && tool.workedExamples.length > 0 && (
              <div className="mt-12">
                <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">Worked examples</h2>
                    ...
                    return (
                      <div key={i}>
                        ...
                        {typeof inputs === "string" && (
                          <p className="mt-2 text-base leading-relaxed text-slate-600">{inputs}</p>
                        )}
            ...
            {tool.related && tool.related.length > 0 && (
              <div className="mt-12">
                <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">Related reading</h2>
                <ul className="mt-6 space-y-2 text-base leading-relaxed">
                  {tool.related.map((r) => (
                    <li key={r.href}>
                      <a href={r.href} className="text-emerald-700 underline hover:text-emerald-800">
                        {r.label}
                      </a>
                    </li>
                  ))}
