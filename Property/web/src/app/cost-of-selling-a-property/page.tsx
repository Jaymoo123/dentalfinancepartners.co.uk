  ...
  return (
    <>
      ...
      <TopicHero
        ...
        title="The cost of selling a house in the UK"
        standfirst={
          <>
            Selling an average English home, £293,000 on the Land Registry index, costs about £5,500. Commission is
            roughly £4,160 of it. If the place has not been your own home throughout, there is a seventh line, and it
            is the biggest.
          </>
        }
        primary={
      ...
      <TopicSection
        ...
        title="What does it cost to sell a house in 2026?"
      >
        <p>
      ...
      {/* Anchor for the hero primary and the mid-page ask. The CTASection this
          replaces pushed the reader to the calculator, which is already linked
          five times above and once in the hero secondary; the panel asks for the
          thing only a person can do. Proof points are the trio already claimed
          in niche.config.json, /about and the four service pages, so nothing
          here is a new factual claim (rule 30). */}
      ...
      <FaqSection title="Cost of selling: common questions" faqs={faqs} />
    </>
  );
}
