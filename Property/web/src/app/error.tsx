    ...
    <div className={`${siteContainer} py-16 sm:py-24`}>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-lg border-2 border-slate-300 bg-white px-6 py-3 text-base font-semibold text-slate-900 transition-colors hover:border-slate-400 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2"
          >
            Go home
          </Link>
        </div>
