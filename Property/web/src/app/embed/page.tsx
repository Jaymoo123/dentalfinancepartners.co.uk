...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Free, always-current property tax calculators you can add to your own site in one line of HTML.",
...
function iframeSnippet(slug: string, name: string, height: number): string {
  return `<iframe
  src="${base}/embed/${slug}"
  title="${name} by Property Tax Partners"
          ...
          <div className="max-w-3xl">
            ...
            <ol className="mt-6 space-y-4 text-base leading-relaxed text-slate-700">
              <li>
                ...
                and paste it into your page where you want it to appear.
              </li>
              <li>
                <strong>2. Add the resize script once.</strong> Paste the small script below anywhere on the
                same page. It lets each calculator grow or shrink to fit its content, so there is no awkward
                scrollbar.
              </li>
            </ol>
            <div className="mt-6">
