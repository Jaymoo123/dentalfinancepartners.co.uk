/**
 * Resend webhook sink for nurture-email engagement events (Property).
 *
 * Uses Svix signature verification (the shared standard, SEC-05 uplift over
 * the old plain-secret check in the previous version of this route).
 *
 * Configure in Resend dashboard:
 *   Endpoint URL: https://www.propertytaxpartners.co.uk/api/nurture/events
