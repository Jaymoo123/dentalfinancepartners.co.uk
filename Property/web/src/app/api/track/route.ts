...
// Site key from config, never a literal (PF-07). Canonical key is "property"
// (the sites-registry key that web_sessions.site_key is FK-constrained to).
export const POST = createTrackHandler({ siteKey: niche.content_strategy.source_identifier });
