...
<li>"Reverse charge: VAT Act 1994 Section 55A applies"</li>
</ul>
...
<p>As <a href="/about">experienced accountants</a>, we deal with reverse charge issues regularly. The most common pattern is a contractor who has been applying the reverse charge to all invoices regardless of the customer's status. That is almost always wrong. End users, non-VAT-registered clients, and supplies of materials without labour should all be standard-rated. Only subcontractor-to-contractor supplies within the CIS scope should use the reverse charge.</p>
