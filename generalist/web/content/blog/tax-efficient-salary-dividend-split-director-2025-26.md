---
title: "What Is The Most Tax Efficient Salary And Dividend Split For A Director In 2026/27?"
slug: "tax-efficient-salary-dividend-split-director-2025-26"
canonical: "https://www.hollowaydavies.co.uk/blog/director-pay-and-dividends/tax-efficient-salary-dividend-split-director-2025-26"
date: "2026-07-28"
generator: unverified/claude-era
author: "Holloway Davies Editorial Team"
category: "Director Pay and Dividends"
metaTitle: "Tax efficient salary dividend split 2026/27 for UK directors"
metaDescription: "The most tax efficient salary dividend split 2026/27 for a UK limited company director. We explain the numbers, the traps, and when the standard advice"
altText: "UK limited company director reviewing salary and dividend calculations on a laptop in a modern office in Manchester."
image: "/blog/tax-efficient-salary-dividend-split-director-2025-26.jpg"
imageCredit:
  ...
  source: "Pexels"
h1: "What Is The Most Tax Efficient Salary And Dividend Split For A Director In 2026/27?"
...
faqs:
  ...
  - question: "What happens if I take more dividends than the company has profits?"
    answer: "That creates a director's loan account debit. If the loan exceeds £10,000, it is a benefit in kind (taxable on you, Class 1A NI on the company). If not repaid within 9 months and 1 day of the year-end, the company pays S455 tax at 35.75%. That tax is refundable when the loan is repaid, but it ties up cash. Never take dividends in excess of available profits."
keyTakeaways:
  - "For most director-only companies in 2026/27, the efficient split is a £12,570 salary plus dividends up to £37,700, filling the basic rate band to £50,270."
  - "The 2026/27 dividend rates are 10.75% basic, 35.75% higher, and 39.35% additional, each up two percentage points under Finance Act 2026, with a £500 dividend allowance."
  - "Without the Employment Allowance, a £12,570 salary triggers employer NIC of 15% on the £7,570 above the £5,000 secondary threshold, costing £1,135.50."
  - "Employing someone unlocks the £10,500 Employment Allowance, which covers the employer NIC on a £12,570 director salary and makes the full salary free of employer NIC."
  - "Surplus company profit often goes further as a pension contribution than a higher rate dividend, since it avoids both corporation tax and NIC and grows tax-free."
---

<p>Every director of a UK limited company asks this question. And the answer has shifted for 2026/27 because the dividend tax rates rose under the Finance Act 2026 (each rate up two percentage points) while the tax bands stayed frozen. The most tax efficient salary dividend split 2026/27 for most director-only companies is a salary of £12,570 and dividends of up to £37,700 (the basic rate band). But that simple answer hides a lot of detail. And for many directors, the standard split is not actually the best option.</p>

<p>Let us work through the numbers, the traps, and the scenarios where you should do something different. This is general guidance, not personal advice. Your specific numbers depend on your company's profit, your personal tax position, and whether you have other income.</p>

<h2>The Standard Split: £12,570 Salary Plus Dividends to £50,270</h2>

<p>The logic is straightforward. You take a salary equal to your personal allowance (£12,570). That salary is tax-free for you (no income tax) and counts as an allowable expense for the company, reducing corporation tax. You then take dividends from the company's post-tax profits up to the basic rate income tax band (£50,270). After deducting your salary, you have £37,700 of dividend capacity at basic rate.</p>

<p>The dividend tax rates for 2026/27 are 10.75% (basic rate), 35.75% (higher rate), and 39.35% (additional rate). The dividend allowance is £500. That means the first £500 of dividends is tax-free. The next £37,200 is taxed at 10.75%.</p>
...
<li>Dividends: £37,700. First £500 tax-free. Remaining £37,200 taxed at 10.75% = £3,999.</li>
<li>Total personal tax: £3,999.</li>
...
<p>That is the baseline. But the numbers change fast once you add other income, a spouse, or employees.</p>

<h2>When the Standard Split Stops Working</h2>
...
<p>Many husband-and-wife companies split income to use both personal allowances and basic rate bands. If your spouse has no other income, you can pay them a salary of £12,570 and dividends of £37,700. That doubles the tax-free and basic rate capacity. The total tax bill for two directors could be as low as £7,998 (two lots of £3,999) on combined income of £100,540.</p>

<p>But there is a trap. If your spouse holds shares but does not do any genuine work, HMRC can apply the settlements legislation. That means the dividends are re-allocated back to you for tax purposes. To avoid this, your spouse must be genuinely involved in the business. Alphabet shares (different classes for different shareholders) can help, but only if the underlying economic reality supports the dividend split.</p>
...
<p>Once your total income exceeds £50,270, dividends are taxed at 35.75% (higher rate) and 39.35% (additional rate). At those rates, the tax efficiency of dividends versus salary narrows sharply. Compare:</p>

<ul>
<li>Dividend at higher rate: 35.75% tax. The company has already paid corporation tax on the profits (19% or 25%). The effective total tax rate is roughly 48% to 52%.</li>
<li>Salary at higher rate: 40% income tax plus 2% employee NI plus 15% employer NI. The effective total tax rate is roughly 50%.</li>
</ul>

<p>The difference is now marginal in both directions. If your company pays the small profits rate, dividends still edge ahead because employer NI is avoided. But at the main rate, the 2026/27 dividend increase means salary and dividends are broadly equivalent, and the old basic-rate advantage has largely gone at the top. If your company profits are high, consider retaining profits in the company and taking them as dividends in a future year when your income is lower. Or use a pension contribution instead (see below).</p>

<h2>Pension Contributions: Often Better Than Dividends</h2>
<p>If you have surplus profit in the company, a pension contribution is often more tax efficient than taking dividends. Company pension contributions are an allowable expense (reducing corporation tax) and are not subject to NI. The pension grows tax-free. And you get 25% of the pension pot tax-free on withdrawal.</p>

<p>Compare taking £10,000 of profit as a dividend versus a pension contribution:</p>

<ul>
<li>Dividend: company pays 19% corporation tax (£1,900), leaving £8,100. You pay 10.75% dividend tax on the net (£871), leaving £7,229 in your pocket.</li>
<li>Pension: company pays £10,000 directly into your pension. No corporation tax, no NI. You get £10,000 in the pension. At withdrawal, 25% is tax-free (£2,500), and the remaining £7,500 is taxed at your marginal rate. If you are a basic rate taxpayer in retirement, that is £1,500 tax, leaving £8,500 net. If you are a higher rate taxpayer, it is £3,000 tax, leaving £6,500 net.</li>
</ul>

<p>The pension wins in most scenarios, especially if you are a higher rate taxpayer now but expect to be basic rate in retirement. The annual allowance is £60,000 (tapered for high earners above £260,000).</p>
...
<h2>Corporation Tax Rate and Profit Level</h2>
<p>The tax efficient salary dividend split 2026/27 also depends on your company's profit level. The corporation tax rates are:</p>
...
<p>The dividend allowance dropped from £1,000 to £500 from 6 April 2024. That remains for 2026/27. It means the first £500 of dividends is tax-free, not £1,000. The impact is small for most directors (the smaller allowance costs about £53.75 in extra dividend tax at basic rate), but it makes the tax efficient salary dividend split 2026/27 slightly less generous than previous years.</p>

<p>If you have a spouse, you can each use the £500 allowance, giving £1,000 of tax-free dividends between you.</p>
...
<p>Our <a href="/calculators">calculators page</a> has a salary and dividend calculator that works through these numbers for your specific situation.</p>

<h2>When to Review Your Split</h2>
<p>You should review your salary and dividend split at least once a year, ideally before the start of the tax year (6 April). But also review it if:</p>

<ul>
<li>Your company's profit changes significantly.</li>
<li>You start employing staff.</li>
<li>Your personal tax position changes (new rental income, second job, marriage).</li>
<li>Tax rates change (they do, every year).</li>
<li>You approach retirement.</li>
</ul>

<p>The tax efficient salary dividend split 2026/27 is not a set-and-forget decision. It needs annual attention. If you want us to run the numbers for your specific company, <a href="/contact">get in touch</a>. Our experienced team can model the optimal split for your situation.</p>
