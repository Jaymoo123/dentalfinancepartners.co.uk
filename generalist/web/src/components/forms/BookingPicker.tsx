 ...
 * on /book (linked from every nurture email/SMS).
 *
 ...
 * House style: sharp corners, orange/ink, no em-dashes in copy.
 */
...
const chipIdle = "border-neutral-300 bg-white text-neutral-900 hover:border-orange-500 hover:bg-orange-50";
    ...
    return (
      <div className="border-2 border-orange-500 bg-orange-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-neutral-700">
          ...
          An accountant will call you then. If your plans change, just reply to any of our messages.
        </p>
