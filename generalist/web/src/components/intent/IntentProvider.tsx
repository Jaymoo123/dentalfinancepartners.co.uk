 ...
 * infrastructure has been wound down estate-wide; this site adopts the
 * always-on posture from the start.
 */
 ...
 *
 * Personalisation is unconditionally ON for every visitor. No experiment arms.
 * Measurement events (personalization_shown/clicked/dismissed) keep flowing so
 * the dashboard can track which topics and surfaces drive conversions.
 */
