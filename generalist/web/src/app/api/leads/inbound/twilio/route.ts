 ...
 * resolve the sender to a generalist lead, and either record their reply as a
 * contactability signal or honour a STOP opt-out.
 *
 * No concierge AI reply-drafting layer on this site (estate-central, not
 * ported); a positive reply always takes the plain acknowledgeReply branch.
 *
