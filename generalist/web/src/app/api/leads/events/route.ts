/**
 * Resend webhook sink for lead-nurture email engagement events (generalist).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.hollowaydavies.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Holloway Davies lead-nurture system.</p>
</div>`,
