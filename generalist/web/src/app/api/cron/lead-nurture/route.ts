/**
 * Lead-nurture cron for Holloway Davies: fires due follow-up steps for leads
 * that have not yet responded. Driven by Vercel Cron (hourly).
 *
 * Dormancy (two layers):
...
import { buildGeneralistLeadNurtureConfigs, buildLeadMessageContext } from "@/config/lead-nurture";
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  const configs = buildGeneralistLeadNurtureConfigs();
