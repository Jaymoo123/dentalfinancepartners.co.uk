 ...
 * redirects to the console. On mismatch: redirects back to the login page
 * with an error flag.
 *
 * Rate-limiting posture (SEC-06): in-process reject after 10 failures per
 * 10-minute window per IP, using the x-forwarded-for / x-real-ip headers
 * present in Vercel edge deployments. This is a lightweight guard; for a
 * hardened deployment use Vercel Firewall rules in addition.
 *
