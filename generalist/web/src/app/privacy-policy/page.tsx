      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            you are about to leave a page), we collect your name, email address, phone number, the type of business you
            run, your message, and the page you submitted from.
          </li>
          <li>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            business tax and accounting information until you unsubscribe.
          </li>
          <li>
        ...
        <p>
          ...
          email sign-ups{partner ? ", and to share your enquiry with our specialist partner firm as described below" : ""}. You can withdraw
        ...
        {partner ? (
          <p>
            When you submit an enquiry, we share the details you provide with a specialist partner firm in our{" "}
            <strong>specialist partner network</strong>, so that they can respond and provide the advice you asked for. That
            firm acts as an <strong>independent data controller</strong> of the information it receives, and its own use of
            your data is governed by its own privacy policy. We share your enquiry only for the purpose of responding to it.
          </p>
        ) : (
          <p>
