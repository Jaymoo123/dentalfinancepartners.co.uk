...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "generalist_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@smallbusiness.co.uk",
  phone: "+447700900123",
  role: "Sole trader",
  message: "Looking for help getting my bookkeeping sorted before the tax return deadline.",
  source: "generalist",
};
