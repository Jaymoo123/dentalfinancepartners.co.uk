 ...
 * booking is a commitment signal plus a call window the team should aim for).
 *
 * A slot is a WEEKDAY within the next 21 days plus one of three call windows.
 * No availability logic: the team calls the lead, the window just tells them
 ...
 * fine: a same-day booking is always meaningful to the team).
 */
...
/** "Tue 14 Jul, morning (9am to 12pm)" -- the human slot label stored + shown to the team. */
