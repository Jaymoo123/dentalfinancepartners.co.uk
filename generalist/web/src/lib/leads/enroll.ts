/**
 * Shared lead-nurture enrolment for Holloway Davies.
 * Ported from Property/web/src/lib/leads/enroll.ts with generalist config wiring.
 *
...
import {
  buildGeneralistLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildGeneralistLeadNurtureConfig(variant);
