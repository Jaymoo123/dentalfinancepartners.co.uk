 ...
 * prefixes. Every marker below is load-bearing (see Dentists/web's 2026-07-03
 * incident notes for why): a Hotmail reply kept the entire quoted original
 * (including our own "reply STOP" footer) when only the Gmail markers were
 * handled, and the opt-out matcher then read our footer as the lead's words.
 */
