/**
 * Journey model for Holloway Davies (generalist site) — deterministic,
 * client-side, instant. Ported from Property with the `hd` storage prefix.
 *
 ...
 *
 * Storage key: `hd_journey` (site prefix `hd`, never `ptp`).
 */
