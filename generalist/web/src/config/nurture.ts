...
function buildWelcomeBody(unsubUrl: string) {
  const html = [
    ...
    `<p style="margin:0 0 14px;">First, bookmark the 2026/27 UK tax rates page. It's the canonical reference we use internally for corporation tax, dividend tax, BADR, VAT, MTD ITSA dates, R&D rates, employer NI, everything. Updated when HMRC changes anything.</p>`,
...
function buildPillarBody(unsubUrl: string) {
  const html = [
    ...
    `<li>If you are in scope for MTD ITSA (mandatory for £50k+ qualifying income since April 2026; threshold drops to £30k+ from April 2027): Making Tax Digital for Income Tax.</li>`,
  ...
  return {
    ...
    text: [
      ...
      "- If MTD ITSA applies to you (mandatory for £50k+ qualifying income since April 2026; £30k+ from April 2027): Making Tax Digital for Income Tax.",
...
function buildMtdBody(unsubUrl: string) {
  const html = [
    ...
    `<p style="margin:0 0 14px;">From 6 April 2026, Making Tax Digital for Income Tax Self Assessment (MTD ITSA) is now mandatory for sole traders and landlords whose qualifying income exceeds £50,000 a year. From April 2027 the threshold drops to £30,000. From April 2028, £20,000.</p>`,
    ...
    `<p style="margin:0 0 14px;">If your qualifying income crossed £50,000 in 2024/25 or 2025/26, you are already in scope and should be making quarterly updates now. If your qualifying income is between £30,000 and £50,000, you will be in scope from April 2027 and need to register and set up HMRC-recognised software before then.</p>`,
    `<p style="margin:0 0 14px;">The pillar guide below covers the timeline, what counts as qualifying income, the software shortlist and the practical setup steps.</p>`,
  ...
  return {
    ...
    text: [
      ...
      "",
      "From 6 April 2026, Making Tax Digital for Income Tax Self Assessment (MTD ITSA) is now mandatory for sole traders and landlords whose qualifying income exceeds £50,000 a year. From April 2027 the threshold drops to £30,000. From April 2028, £20,000.",
      "",
      ...
      "",
      "If your qualifying income crossed £50,000 in 2024/25 or 2025/26, you are already in scope and should be making quarterly updates now. If your qualifying income is between £30,000 and £50,000, you will be in scope from April 2027.",
      "",
...
function buildFreeCallBody(unsubUrl: string) {
  const html = [
    ...
    `<p style="margin:0 0 14px;">It is on a video call, with a senior accountant on our team. You get a written summary by email afterwards with anything specific we would recommend. No sales pitch. About half the businesses we speak to we tell to stay with their current accountant and just change one thing.</p>`,
...
const GENERALIST_STEPS: NurtureStep[] = [
  ...
  },
  {
    key: "mtd_itsa",
    delayDays: 9,
    subject: "MTD ITSA: what it requires and whether you are in scope",
