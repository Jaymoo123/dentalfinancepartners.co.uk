...
export const siteConfig = {
  ...
  // NOTE: contact.email and contact.phone are internal-routing values only
  // (e.g. nurture reply-to). They are intentionally NOT displayed publicly and
  // contact.phone is never emitted to JSON-LD. Public contact goes via /contact.
  ...
  // Holloway Davies (and every estate brand) is a trading name of Ashfield Trading Ltd.
  company: {
    legalName: niche.legal_name, // "Ashfield Trading Ltd"
    tradingName: niche.display_name, // brand, e.g. "Holloway Davies"
