...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "hospitality_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@theharbourkitchen.co.uk",
  phone: "+447700900123",
  role: "Restaurant or cafe owner",
  message: "We run two restaurants and want to set up a proper tronc for the tips.",
  source: "hospitality",
};
