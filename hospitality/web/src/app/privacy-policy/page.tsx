    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <p>
          ...
          UK GDPR)
          {partner
            ? " to handle your enquiry and to share it with our specialist partner firm, so that you can be connected with the specialist hospitality accounting help you have asked for"
        ...
        {partner ? (
          <p>
            ...
            <strong>{partner.name}</strong>, so that they can contact you and provide the advice you asked for.{" "}
            {partner.name} acts as an <strong>independent data controller</strong> of the information it receives and
            uses it under its own{" "}
