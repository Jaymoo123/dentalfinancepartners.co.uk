    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <p>
          ...
          partner network, so that you can be connected with the specialist hospitality accounting help you have
        ...
        <p>
          ...
          <strong>consent</strong>. You can withdraw your consent at any time (see your rights in section 7);
        ...
        <p>
          ...
          <strong>specialist partner network</strong>, so that they can respond and, if you want it, provide the
          advice you asked for. The receiving firm acts as an <strong>independent data controller</strong> of the
          information it receives, will tell you who it is when it first contacts you, and its own use of your
          data is governed by its own privacy policy. If that firm is unable to help, we may pass your enquiry to
          another firm in the same network for the same purpose. We share your enquiry only for the purpose of
          responding to it, relying on our legitimate interests, and you can object at any time (see section 7).
        </p>
