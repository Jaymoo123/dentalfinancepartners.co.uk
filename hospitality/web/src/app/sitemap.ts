...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/research/uk-hospitality-insolvency-index`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/research/uk-hospitality-food-hygiene-map`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/research/hospitality-openings-closures-index`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
  ...
  const serviceRoutes: MetadataRoute.Sitemap = hospitalityServices.map((s) => ({
  ...
  const forRoutes: MetadataRoute.Sitemap = hospitalityHubs.map((h) => ({
    url: `${base}/for/${h.slug}`,
    lastModified: now,
    changeFrequency: "monthly" as const,
    priority: 0.75,
