/**
 * Hospitality daily lead-nurture digest cron: fires at 07:00 UTC and sends a
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("[lead-nurture-digest/hospitality] heartbeat write failed", err);
  }
  ...
  try {
    ...
    console.error("[lead-nurture-digest/hospitality] unexpected error", err);
