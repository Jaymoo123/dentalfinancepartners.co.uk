/**
 * Inbound email webhook for Resend: processes replies to Hospitality nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Hospitality lead,
 ...
 *   Inbound routing domain: hospitalitytax.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.hospitalitytax.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Hospitality lead (most recent match wins).
