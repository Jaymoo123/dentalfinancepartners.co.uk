/**
 * Resend webhook sink for lead-nurture email engagement events (Hospitality).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.hospitalitytax.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Hospitality lead-nurture system.</p>
</div>`,
