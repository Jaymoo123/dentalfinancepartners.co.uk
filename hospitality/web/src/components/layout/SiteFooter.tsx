      ...
      <div className={`${siteContainerLg} pb-10 pt-16 sm:pb-12 sm:pt-20`}>
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr] md:gap-10">
          <div className="min-w-0">
            <div className="font-mono text-xs uppercase tracking-widest text-[#b0532f]">
            ...
            <p className="mt-6 text-sm text-neutral-500">
              <Link
                href="/contact"
                className={`text-[#b0532f] hover:text-[#8f421f] underline underline-offset-2 ${focusRing}`}
              >
                Contact us
              </Link>
            </p>
        ...
        <div className="mt-16 space-y-4 border-t border-neutral-200 pt-6">
