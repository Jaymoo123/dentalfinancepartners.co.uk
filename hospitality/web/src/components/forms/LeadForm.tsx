...
const fieldClass =
  "mt-2 w-full min-h-12 touch-manipulation rounded-md border border-neutral-300 bg-white px-3.5 py-3 text-base text-neutral-900 placeholder:text-neutral-400 transition-colors focus:border-[var(--brand,#b0532f)] focus:outline-none";
          ...
          <div>
            <label htmlFor="consent" className="flex items-start gap-3 text-xs leading-relaxed text-neutral-600">
              <input
                ...
                className="mt-0.5 h-4 w-4 shrink-0 accent-[#b0532f]"
