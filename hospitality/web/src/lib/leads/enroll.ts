/**
 * Shared lead-nurture enrolment for the Hospitality site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Hospitality
 * sequence names.
 */
...
import {
  buildHospitalityLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildHospitalityLeadNurtureConfig(variant);
