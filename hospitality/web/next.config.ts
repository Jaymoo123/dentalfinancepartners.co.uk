...
// Repo root is two levels up: hospitality/web -> hospitality -> Accounting (repo root).
...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      {
        source: "/:path*",
        has: [{ type: "host", value: "brand-tbd-hospitality.invalid" }],
        destination: "https://www.brand-tbd-hospitality.invalid/:path*",
        permanent: true,
      },
    ];
  },
