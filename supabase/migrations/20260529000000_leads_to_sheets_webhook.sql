-- ============================================================================
-- LEADS -> GOOGLE SHEETS WEBHOOK
-- ============================================================================
-- Migration: 20260529000000_leads_to_sheets_webhook.sql
-- Date: 2026-05-29
-- Purpose: On every INSERT into public.leads, POST the new row to the lead-sync
--          endpoint, which appends it to a Google Sheet (phone-readable log).
...
create or replace function public.leads_to_sheets()
returns trigger
language plpgsql
security definer
...
begin
  perform net.http_post(
    ...
    headers := jsonb_build_object(
      ...
      'x-webhook-secret', '__LEADS_SYNC_SECRET__'
    ),
