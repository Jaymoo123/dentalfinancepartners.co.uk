    ...
    <section className="bg-white">
      <div className={container}>
        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <h2>1. About us</h2>
          <p>
            The Site is operated by {siteConfig.company.legalName}, a company registered in{" "}
            {siteConfig.company.placeOfRegistration} under company number {siteConfig.company.number}, with its
          ...
          <p>
            Formal engagements for any services are subject to separate written agreements. No client relationship is
            created by your use of this Site or submission of an enquiry form.
          </p>

          <h2>3. Accuracy and changes</h2>
          <p>
            While we aim to keep information on the Site accurate and up to date, we make no representations or
            warranties regarding the accuracy, completeness, or currency of any content.
          </p>
          <p>
          ...
          <p>
            You may view and print pages from the Site for your personal, non-commercial use, provided you do not
            modify any content and you retain all copyright and proprietary notices. Any other use requires our prior
            written permission.
          </p>

          <h2>6. Third-party links</h2>
          <p>
            The Site may contain links to third-party websites. We do not control or endorse these websites and are not
            responsible for their content, privacy practices, or terms of use. You access third-party websites at your
            own risk.
          </p>

          <h2>7. Limitation of liability</h2>
          <p>
            To the fullest extent permitted by law, {siteConfig.company.legalName} excludes all liability for any loss
            or damage arising from your use of the Site, including but not limited to:
          </p>
          <ul>
          ...
          <p>
            ...
            agents from any claims, losses, damages, liabilities, and expenses (including legal fees) arising from your
          ...
          <p>
            ...
            shows when they were last revised. Your continued use of the Site after changes are posted constitutes your
          ...
          <h2>13. Contact us</h2>
          <p>
            Questions about these terms? Contact us via our <Link href="/contact" className={link}>contact page</Link>.
          </p>
        </div>
      </div>
    </section>
