/**
 * Shared lead-nurture enrolment for the Pharmacies site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Pharmacies
 * sequence names.
 */
...
import {
  buildPharmaciesLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildPharmaciesLeadNurtureConfig(variant);
