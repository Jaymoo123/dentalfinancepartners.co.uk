...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "pharmacies_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@highstreetpharmacy.co.uk",
  phone: "+447700900123",
  role: "Pharmacy owner (independent)",
  message:
    "Buying a second branch next year and the FP34 reimbursement lag is making the cash flow hard to plan.",
  source: "pharmacies",
};
