      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            want it, provide the specialist pharmacy accounting advice you have requested.
          </li>
          <li>
        ...
        <p>
          ...
          partner network, so that you can be connected with the specialist pharmacy accounting help you have
          asked for. Where we need to take steps at your request to deal with your enquiry, we also rely on{" "}
        ...
        <p>
          ...
          firm from our <strong>specialist partner network</strong>, so that they can contact you directly and,
          if you want it, provide the advice you asked for. As well as the details you give us (your name,
          contact details and your enquiry), this may include any messages you send us in response and a note of
          how you used our website in connection with your enquiry. We do this on the basis of our{" "}
          <strong>legitimate interests</strong> (see section 4), and you can object at any time (see section 7).
          The receiving firm acts as an <strong>independent data controller</strong> of the information it
          receives, will tell you who it is when it first contacts you, and uses your information under its own
          privacy policy. If that firm is unable to help, we may pass your enquiry to another firm in the same
          network for the same purpose. We share this information only for the purpose of arranging and providing
