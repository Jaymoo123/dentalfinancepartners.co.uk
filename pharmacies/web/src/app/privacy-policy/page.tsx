    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            {partner
              ...
              : "to deal with your enquiry and provide the specialist pharmacy accounting advice you have requested."}
          </li>
          <li>
        ...
        <p>
          ...
          UK GDPR)
          {partner
            ? " to handle your enquiry and to share it with our specialist partner firm, so that you can be connected with specialist pharmacy accounting help"
            : " to handle it, so that we can respond and provide the specialist pharmacy accounting help you have asked for"}
        ...
        {partner ? (
          <p>
            ...
            connection with your enquiry, and any call time you book. We do this on the basis of our{" "}
            <strong>legitimate interests</strong> (see section 4), and you can object at any time (see section 7).{" "}
            {partner.name} acts as an <strong>independent data controller</strong> of the information it receives
            and uses it under its own{" "}
