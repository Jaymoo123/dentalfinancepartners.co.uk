/**
 * Resend webhook sink for lead-nurture email engagement events (Pharmacies).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.pharmacytax.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Pharmacies lead-nurture system.</p>
</div>`,
