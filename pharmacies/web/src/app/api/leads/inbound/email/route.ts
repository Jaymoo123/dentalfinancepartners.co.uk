/**
 * Inbound email webhook for Resend: processes replies to Pharmacies nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Pharmacies lead,
 ...
 *   Inbound routing domain: pharmacytax.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.pharmacytax.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Pharmacies lead (most recent match wins).
