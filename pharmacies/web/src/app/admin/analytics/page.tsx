...
export default async function AdminAnalyticsPage({
  ...
  const experimentsSection = (
    <div className="space-y-6">
      <NotOperatedPanel feature="A/B experiments" reason="Not operated on this site. This site does not currently run A/B tests." />
      <NotOperatedPanel feature="Personalisation" reason="Not operated on this site. Behavioural personalisation is a deferred workstream." />
    </div>
  );

  const behaviourSection = (
    <div className="space-y-8">
      <NotOperatedPanel feature="Calculators" reason="Not operated on this site. Calculator tools are a deferred workstream." />
  ...
  const conversionSection = (
    <div className="space-y-8">
      <NotOperatedPanel feature="Lead-intent enrichment" reason="Not operated on this site. Lead-intent classification is a deferred workstream." />
      <NotOperatedPanel feature="Nurture engine" reason="Not operated on this site. No newsletter surface on this site." />
