 ...
 * is telling us when an agency finance specialist should call, and the act of
 * booking is the contactability signal that promotes them for handoff.
 */

export const metadata: Metadata = {
  title: "Book your free review",
  description: "Pick a time for your free agency finance review call.",
