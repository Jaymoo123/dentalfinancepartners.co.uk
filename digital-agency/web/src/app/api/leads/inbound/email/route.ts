/**
 * Inbound email webhook for Resend: processes replies to Agency Founder Finance nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to an Agency Founder Finance lead,
 ...
 *   Inbound routing domain: agencyfounderfinance.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.agencyfounderfinance.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to an Agency Founder Finance lead (most recent match wins).
