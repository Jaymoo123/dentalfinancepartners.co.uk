/**
 * Resend webhook sink for lead-nurture email engagement events (Agency Founder Finance).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.agencyfounderfinance.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Agency Founder Finance lead-nurture system.</p>
</div>`,
