    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <p>
          ...
          firm acts as an <strong>independent data controller</strong> of the information it receives, will tell you
          who it is when it first contacts you, and its own use of your data is governed by its own privacy policy.
          If that firm is unable to help, we may pass your enquiry to another firm in the same network for the same
          purpose. We share your enquiry only for the purpose of responding to it.
        </p>
