 ...
 * from the site-local @/lib/markdown-utils (which also exports extractHeadings,
 * unlike the generalist site). Both are imported directly from the local module.
 *
 ...
 *
 * aff divergence C: use @/lib/markdown-utils (site-local, verified to export
 * both addHeadingIds and extractHeadings). Do NOT route through web-shared.
 */
import fs from "fs";
