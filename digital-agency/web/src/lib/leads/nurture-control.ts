/**
 * Kill-switch control library for the Agency Founder Finance lead-nurture system.
 *
 * Reads and writes the lead_nurture_control table keyed on site_key='agency'
...
/**
 * Read the agency control row (site_key='agency'). FAIL-OPEN: returns the
...
export async function getNurtureControl(): Promise<NurtureControl> {
  try {
    ...
    console.error("[nurture-control/agency] getNurtureControl error, failing open", err);
...
export async function pauseNurture(reason: string, by: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/agency] pauseNurture write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/agency] pauseNurture error", err);
  }
}
...
export async function resumeNurture(by: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/agency] resumeNurture write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/agency] resumeNurture error", err);
  }
}
...
export async function recordGuardrailAlert(key: string): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/agency] recordGuardrailAlert write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/agency] recordGuardrailAlert error", err);
  }
}
...
export async function recordCronHeartbeat(): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/agency] recordCronHeartbeat write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/agency] recordCronHeartbeat error", err);
  }
}
...
export async function recordDigestHeartbeat(): Promise<void> {
  ...
  try {
    ...
    if (!res.ok) {
      console.error("[nurture-control/agency] recordDigestHeartbeat write failed", res.status);
    }
  } catch (err) {
    console.error("[nurture-control/agency] recordDigestHeartbeat error", err);
  }
}
