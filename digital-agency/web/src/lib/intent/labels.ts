 ...
 * for Agency Founder Finance. Mirrors construction-cis canonical shape.
 *
 * Imported by client surfaces (to stamp `label` onto events) and the admin
 * dashboard (to render journeys). Keep additions in sync with rule ids produced
 * in src/lib/intent/engine.ts and the Surface union there.
 */
