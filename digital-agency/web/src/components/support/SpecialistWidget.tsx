            ...
            {status === "success" ? (
              <div className="flex items-start gap-2">
                ...
                <div className="max-w-[82%] rounded-2xl rounded-tl-sm border border-indigo-100 bg-indigo-50 px-3 py-2 text-sm font-medium text-[var(--ink)] shadow-sm">
                  Thanks, a specialist has your message and will be in touch by email. Please keep an
                  eye on your inbox, and your spam or junk folder, so our reply is not missed.
                </div>
              </div>
            ) : !composing ? (
