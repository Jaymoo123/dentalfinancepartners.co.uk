 ...
 *
 * House style: indigo/slate tokens, no em-dashes in copy.
 */
    ...
    return (
      <div className="border-2 border-indigo-600 bg-indigo-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-slate-700">
          An agency finance specialist will be in touch shortly. If you would like to pick a time
          that suits you, you can book a callback below.
        </p>
        {bookingToken && (
  ...
  return (
    <form onSubmit={onSubmit} className="text-left" noValidate aria-busy={status === "loading"}>
      ...
      <p className="mt-3 text-xs text-slate-600">
        We only use this to arrange your free agency finance review. See our{" "}
        <a
          href="/privacy-policy"
          target="_blank"
