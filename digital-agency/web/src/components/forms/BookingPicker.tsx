 ...
 * House style: sharp corners, indigo/slate, no em-dashes in copy.
 */
...
const chipBase =
  "flex min-h-12 touch-manipulation flex-col items-center justify-center border-2 px-1.5 sm:px-3 py-2 text-sm font-bold transition-all duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600";
const chipIdle =
  "border-slate-300 bg-white text-slate-900 hover:border-indigo-600 hover:bg-indigo-50";
const chipSelected = "border-indigo-800 bg-indigo-600 text-white";
...
export default function BookingPicker({ token }: { token: string }) {
    ...
    return (
      <div className="border-2 border-indigo-600 bg-indigo-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-slate-700">
          ...
          An agency finance specialist will call you then. If your plans change, just reply to any
          of our messages.
        </p>
  ...
  return (
    <div className="text-left">
      ...
      <p className="mb-3 mt-6 text-sm font-semibold uppercase tracking-wide text-slate-600">
      ...
      <div className="mt-6 text-center">
        ...
        <p className="mt-3 text-xs text-slate-600">
          No obligation. An agency finance specialist will call you in your chosen window.
        </p>
      </div>
    </div>
  );
