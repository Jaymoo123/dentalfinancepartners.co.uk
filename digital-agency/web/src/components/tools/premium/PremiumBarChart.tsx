...
/**
 * Dependency-free inline SVG bar chart for the Agency Founder Finance premium
 * calculator tier.
 *
 ...
 * --dark. Any ported code using those tokens is a defect. Bar colours come from
 * the ChartSpec.series[].color field (set in each tool config).
 *
 * Bar rendering:
