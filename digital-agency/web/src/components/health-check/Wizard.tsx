...
const CONSENT_TEXT =
  "I agree that Agency Founder Finance may use the information I have provided to generate this report and contact me about relevant services, and may share my details with regulated firms in its specialist partner network so they can answer my enquiry. I have read the privacy policy.";
    ...
    <>
      ...
      <label className="mt-6 flex cursor-pointer items-start gap-3 rounded-md border border-slate-200 bg-slate-50 p-4">
        ...
        <span className="text-sm text-slate-700">
          ...
          this report and contact me about relevant services, and may share my details with regulated
          firms in its specialist partner network so they can answer my enquiry. I have read the{" "}
