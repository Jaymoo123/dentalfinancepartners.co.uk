# Property Wave 8, Session A, start here (FIG / non-dom IHT / leaving-UK depth)
...
When raising a Q to manager, append to `C:/Users/user/Documents/Accounting/docs/property/wave8_questions_session_A.md` via **ABSOLUTE PATH** from your worktree. **NEVER** append to your worktree's relative-path copy. Manager polls main's path only. Same discipline for tracker (`wave8_page_tracker.md`), flags (`wave8_site_wide_flags.md`), discovery (`wave8_discovery_log_session_A.md`). Waves 6 + 7 held this discipline with zero violations; Wave 8 must preserve.

## Worktree

You run inside `C:/Users/user/Documents/Accounting-wt-property-wave8-a/` on branch `property-wave8-a`. **Stay inside that worktree.** Sessions B/C are in their own worktrees; you will never collide.
...
3. **`docs/property/house_positions.md`** — for Session A: **§17** (full expat cluster Wave 2 lock plus §17.8 FIG depth + §17.9 TRF mechanics + §17.10 CGT rebasing — all Wave 8 mini-locks) + **§15.6** (IHT LTR headline) + **§22.5** (spouse exemption refresh — SPOUSAL s.267ZC not generic) + **§22.X** (NEW IHT LTR operational depth — full cluster Wave 8) + **§16** (DTAs for dual-residence tie-breakers).
4. **Your assigned briefs** at `briefs/property/wave8/*.md` per the table below.
5. **`docs/property/wave8_page_tracker.md`** — your A1-A10 rows.
...
## CRITICAL drift watchpoints (51 catches surfaced through Wave 8 prep — read all 11 below before writing)
...
| Pos | Slug | Brief at |
|---|---|---|
| A1 | `fig-regime-qualifying-new-resident-10-year-non-residence-test-landlords` | briefs/property/wave8/ |
| A2 | `fig-election-mechanics-per-year-claim-personal-allowance-cgt-aea-cost` | briefs/property/wave8/ |
| A3 | `fig-year-5-cliff-post-fig-arising-basis-planning-non-doms-landlords` | briefs/property/wave8/ |
| A4 | `temporary-repatriation-facility-trf-designation-mechanics-12-15-percent-rates` | briefs/property/wave8/ |
| A5 | `trf-qualifying-overseas-capital-what-can-be-designated-non-doms` | briefs/property/wave8/ |
| A6 | `cgt-rebasing-election-fa-2025-schedule-11-narrow-eligibility-non-doms` | briefs/property/wave8/ |
| A7 | `iht-long-term-resident-test-section-6a-tail-period-table-landlords` | briefs/property/wave8/ |
| A8 | `excluded-property-trust-long-term-resident-settlor-pivot-landlords` | briefs/property/wave8/ |
| A9 | `iht-spouse-exemption-long-term-resident-section-18-section-267zc-election` | briefs/property/wave8/ |
| A10 | `returning-to-uk-after-non-residence-section-10a-recapture-fig-eligibility` | briefs/property/wave8/ |
