# hospitality (Hospitality Finance Partners) site state
...
> name **Hospitality Finance Partners** (`www.hospitalityfinancepartners.co.uk`). Final brand +
...
- site_key `hospitality` | display **"Hospitality Finance Partners"** | working domain `www.hospitalityfinancepartners.co.uk`
...
- Brand: WORKING-BRAND LOCKED (Hospitality Finance Partners). Final brand pending owner confirmation at G1; deploy held.

## Launch state

- [x] S1 brand lock (WORKING brand, 2026-07-14): `brand_locked: true`; working brand Hospitality Finance Partners / www.hospitalityfinancepartners.co.uk. Final brand still owner's at G1 (deploy gate); swap = 3-file config edit.
