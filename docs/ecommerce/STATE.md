...
- **OPEN:** blog_topics wave-2 head keywords not yet marked used (mark before next blog-generator run); deploy held on owner G1, which includes the migrate-vs-fence ruling on the 5 HIRE hubs.
