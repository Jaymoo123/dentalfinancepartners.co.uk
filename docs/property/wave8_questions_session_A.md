...
For everything else, use flags (`wave8_site_wide_flags.md`) or discovery log (`wave8_discovery_log_session_A.md`). Flags do not block; questions block; discovery logs are FYI.
