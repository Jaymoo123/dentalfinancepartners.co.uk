# Wave 12 Q&A — Session A

**Created:** 2026-08-21.

**§16.15 / §16.37 critical Q&A discipline:** when raising a Q to manager, append HERE via ABSOLUTE PATH from your worktree: `C:/Users/user/Documents/Accounting/docs/property/wave12_questions_session_A.md`. NEVER append to your worktree relative-path copy of this file. Manager polls main path only; questions written to the worktree relative-path copy are NOT seen by the monitor and require manual user-side propagation.
...
For everything else, use flags (`wave12_site_wide_flags.md`) or discovery log (`wave12_discovery_log_session_A.md`). Flags do not block; questions block; discovery logs are FYI.
...
## [Q-1] wave12_page_tracker.md describes a DIFFERENT Wave 12 — stale header + no rows for the live picks
