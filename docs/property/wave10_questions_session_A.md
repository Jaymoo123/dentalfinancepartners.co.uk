# Wave 10 Q&A — Session A

**Created:** 2026-07-08.

**§16.15 / §16.37 critical Q&A discipline:** when raising a Q to manager, append HERE via ABSOLUTE PATH from your worktree: `C:/Users/user/Documents/Accounting/docs/property/wave10_questions_session_A.md`. NEVER append to your worktree relative-path copy of this file. Manager polls main path only; questions written to the worktree relative-path copy are NOT seen by the monitor and require manual user-side propagation.
...
For everything else, use flags (`wave10_site_wide_flags.md`) or discovery log (`wave10_discovery_log_session_A.md`). Flags do not block; questions block; discovery logs are FYI.
