...
Merged candidates: 6627  
Pillar-overlap rejected: 385  
**Survivors (scored): 6242**
...
- gsc: 195 candidates excluded (serving page < 60d old)
- sitemap: 1357 URLs dropped (<3 slug tokens)
- dfs_intersection: paid-only, 0 in dry-run (no distinguishable persisted rows)
- bing_kw: 149 candidates dropped (lane gate, no topical token match) — e.g. hmrc cgt login; european transfer deadlines 2026; sa109; hm revenue and customs forms to download; sa100 2026; hmrc forms; ukpa; rightmove property for sale; property news; houses
- dfs_ranked: 4472 candidates dropped (lane gate, no topical token match) — e.g. letting hub; lettings hub; contact hmrc phone number; hmrc call number; hmrc helpline number; hmrc number contact; hmrc phone numbers; hmrc telephone number; calculate take home salary; take home pay calculator
- sitemap: 11013 candidates dropped (lane gate, no topical token match) — e.g. 122 consultation cchtest; 2024 autumn budget summary for landlords; 2024 spring budget landlords; 5 changes to property taxes in 2020 21; a complete guide to let property campaign; a guide for directors of limited companies know your boundaries before you act; a landlords guide to the trading property allowances; abolition furnished holiday lettings tax; meet the team; smoke and carbon monoxide alarms
- SERP winnability verified for top 40 of 6242 by provisional score (N=40); rest use neutral placeholder 0.75
- report truncated to top 150 of 6242 survivors

## Per-source ingest detail

- **sitemap**: {'file_found': True, 'raw_urls': 16380, 'kept': 15023, 'dropped_short_tokens': 1357}
- **dfs_ranked**: {'paid_calls': 0, 'errors': 0, 'persisted_rows': 8332}
- **dfs_intersection**: {'paid_calls': 0, 'errors': 0}
- **gsc**: {'immature_excluded': 195, 'age_unknown': 328, 'junk_queries': 20}
...
|---|---|---|---|---|---:|---:|---:|---|---:|---:|---:|
| 1 | stamp duty estimator | sdlt | dfs_ranked | dfs_ranked | 246000 | - | 0.37 | informational | 1.0 | 0.5 | 123000.0 |
| 2 | calculate stamp duty | sdlt | dfs_ranked | dfs_ranked | 246000 | - | 0.37 | informational | 1.0 | 0.5 | 123000.0 |
...
| 5 | mortgage repayment calculator | finance_mortgages | dfs_ranked | dfs_ranked,bing_kw | 90500 | - | 0.86 | transactional | 1.0 | 0.75 | 101812.5 |
| 6 | stamp duty calculator | sdlt | sitemap | sitemap,dfs_ranked | 246000 | - | 0.37 | transactional | 0.5 | 0.5 | 92250.0 |
| 7 | inheritance tax | iht_estate | dfs_ranked | dfs_ranked | 110000 | - | 1.59 | informational | 1.0 | 0.5 | 55000.0 |
| 8 | stamp duty calculator england | sdlt | dfs_ranked | dfs_ranked | 60500 | - | 0.28 | transactional | 1.0 | 0.6 | 54450.0 |
| 9 | sdlt calculator | sdlt | dfs_ranked | dfs_ranked,gsc | 40500 | - | 0.84 | transactional | 1.0 | 0.667 | 40520.25 |
| 10 | tenancy deposit scheme | compliance_licensing | sitemap | sitemap,dfs_ranked | 49500 | - | 1.76 | informational | 1.0 | 0.667 | 33016.5 |
| 11 | self assessment return | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 1.0 | 0.4 | 29600.0 |
| 12 | self assessment returns | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 1.0 | 0.4 | 29600.0 |
| 13 | self assessment tax return | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 1.0 | 0.4 | 29600.0 |
| 14 | tax return self assessment | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 1.0 | 0.4 | 29600.0 |
| 15 | h m r c self assessment | landlord_ops | dfs_ranked | dfs_ranked | 110000 | - | 4.28 | informational | 0.5 | 0.5 | 27500.0 |
| 16 | england stamp duty calculator | sdlt | dfs_ranked | dfs_ranked | 60500 | - | 0.28 | transactional | 0.5 | 0.6 | 27225.0 |
| 17 | calculate sdlt | sdlt | dfs_ranked | dfs_ranked | 40500 | - | 0.84 | informational | 1.0 | 0.667 | 27013.5 |
| 18 | find vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 19 | finding vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 20 | check vat id | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 21 | ltd | incorporation_structures | dfs_ranked | dfs_ranked | 33100 | - | 15.31 | informational | 1.0 | 0.75 | 24825.0 |
| 22 | validate a vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 23 | validating vat numbers | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 24 | vat number check | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 1.0 | 0.75 | 24825.0 |
| 25 | stamp duty calculator uk | sdlt | dfs_ranked | dfs_ranked | 60500 | - | 0.28 | transactional | 0.5 | 0.5 | 22687.5 |
| 26 | uk stamp duty calculator | sdlt | dfs_ranked | dfs_ranked | 60500 | - | 0.28 | transactional | 0.5 | 0.5 | 22687.5 |
| 27 | self assessment | landlord_ops | dfs_ranked | dfs_ranked | 90500 | - | 5.99 | informational | 0.5 | 0.5 | 22625.0 |
| 28 | vat number checker | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.75 | 18618.75 |
| 29 | vat number lookup | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.75 | 18618.75 |
| 30 | vat number verification | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.75 | 18618.75 |
| 31 | verify vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.75 | 18618.75 |
| 32 | file self assessment tax return | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 0.5 | 0.5 | 18500.0 |
| 33 | stamp duty | sdlt | dfs_ranked | dfs_ranked | 74000 | - | 0.34 | informational | 0.75 | 0.333 | 18481.5 |
| 34 | stamp duty land tax calculator | sdlt | dfs_ranked | dfs_ranked | 40500 | - | 0.84 | transactional | 0.5 | 0.6 | 18225.0 |
| 35 | check vat registration number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.714 | 17725.05 |
| 36 | vat registration number check | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.75 | 0.714 | 17725.05 |
| 37 | mortgage pay calculator | finance_mortgages | dfs_ranked | dfs_ranked | 18100 | - | 1.41 | transactional | 0.75 | 0.75 | 15271.875 |
| 38 | paying mortgage calculator | finance_mortgages | dfs_ranked | dfs_ranked | 18100 | - | 1.41 | transactional | 0.75 | 0.75 | 15271.875 |
| 39 | repayment calculator mortgage uk | finance_mortgages | dfs_ranked | dfs_ranked | 18100 | - | 1.38 | transactional | 0.75 | 0.75 | 15271.875 |
| 40 | licensing | compliance_licensing | dfs_ranked | dfs_ranked | 40500 | - | 3.98 | informational | 0.75 | 0.5 | 15187.5 |
| 41 | calculate stamp duty uk | sdlt | dfs_ranked | dfs_ranked | 60500 | - | 0.28 | informational | 0.5 | 0.5 | 15125.0 |
| 42 | tax return | landlord_ops | dfs_ranked | dfs_ranked | 60500 | - | 4.85 | informational | 0.5 | 0.5 | 15125.0 |
| 43 | self assessment tax returns | landlord_ops | sitemap | sitemap,dfs_ranked | 74000 | - | 7.35 | informational | 0.5 | 0.4 | 14800.0 |
| 44 | tax return and self assessment | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 0.5 | 0.4 | 14800.0 |
| 45 | self-assessment tax return | landlord_ops | dfs_ranked | dfs_ranked | 74000 | - | 7.35 | informational | 0.5 | 0.4 | 14800.0 |
| 46 | vat check | vat_commercial | dfs_ranked | dfs_ranked | 27100 | - | 6.39 | informational | 0.75 | 0.667 | 13556.775 |
| 47 | vat checker | vat_commercial | dfs_ranked | dfs_ranked | 27100 | - | 6.39 | informational | 0.75 | 0.667 | 13556.775 |
| 48 | vat checks | vat_commercial | dfs_ranked | dfs_ranked | 27100 | - | 6.39 | informational | 0.75 | 0.667 | 13556.775 |
| 49 | isa accounts | landlord_ops | dfs_ranked | dfs_ranked | 40500 | - | 8.65 | informational | 0.5 | 0.667 | 13506.75 |
| 50 | cgt uk | cgt_disposal | dfs_ranked | dfs_ranked | 22200 | - | 2.40 | informational | 0.75 | 0.75 | 12487.5 |
| 51 | find a vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.5 | 0.75 | 12412.5 |
| 52 | check a vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.5 | 0.75 | 12412.5 |
| 53 | check vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.5 | 0.75 | 12412.5 |
| 54 | search vat number | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.5 | 0.75 | 12412.5 |
| 55 | vat no checker | vat_commercial | dfs_ranked | dfs_ranked | 33100 | - | 6.74 | informational | 0.5 | 0.75 | 12412.5 |
...
| 65 | buy to let mortgage calculator | - | sitemap | sitemap,dfs_ranked,gsc,bing_kw | 22200 | - | 1.96 | transactional | 0.75 | 0.4 | 9990.0 |
...
| 88 | interest only mortgage calculator | finance_mortgages | sitemap | sitemap,dfs_ranked,bing_kw | 12100 | - | 2.10 | transactional | 0.75 | 0.571 | 7772.737 |
...
| 128 | register a ltd company | incorporation_structures | dfs_ranked | dfs_ranked | 8100 | - | 54.73 | commercial | 0.75 | 0.75 | 5923.125 |
| 129 | register ltd company | incorporation_structures | dfs_ranked | dfs_ranked | 8100 | - | 54.73 | commercial | 0.75 | 0.75 | 5923.125 |
| 130 | ltd company registration | incorporation_structures | dfs_ranked | dfs_ranked | 8100 | - | 54.73 | commercial | 0.75 | 0.714 | 5638.815 |
| 131 | company ltd registration | incorporation_structures | dfs_ranked | dfs_ranked | 8100 | - | 54.73 | commercial | 0.75 | 0.714 | 5638.815 |
...
| 134 | check uk vat number | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 135 | check vat number uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 136 | find vat number uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 137 | search vat number uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 138 | uk search vat number | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 139 | uk vat number checker | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 140 | uk vat number validation | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 141 | vat number check uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 142 | vat number validation uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 143 | verify uk vat number | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 144 | verify vat number uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.75 | 5568.75 |
| 145 | hmrc contact address self assessment | landlord_ops | dfs_ranked | dfs_ranked | 9900 | - | 6.99 | informational | 0.75 | 0.714 | 5301.45 |
| 146 | check vat registration number uk | vat_commercial | dfs_ranked | dfs_ranked | 9900 | - | 4.06 | informational | 0.75 | 0.714 | 5301.45 |
| 147 | interest only mortgage formula | finance_mortgages | dfs_ranked | dfs_ranked | 12100 | - | 2.10 | informational | 0.75 | 0.571 | 5181.825 |
| 148 | hmrc self assessment number | landlord_ops | dfs_ranked | dfs_ranked | 9900 | - | 6.99 | informational | 0.75 | 0.667 | 4952.475 |
| 149 | hmrc self assessment phone | landlord_ops | dfs_ranked | dfs_ranked | 9900 | - | 6.99 | informational | 0.75 | 0.667 | 4952.475 |
| 150 | how much inheritance tax | iht_estate | dfs_ranked | dfs_ranked | 9900 | - | 1.45 | informational | 0.75 | 0.667 | 4952.475 |
