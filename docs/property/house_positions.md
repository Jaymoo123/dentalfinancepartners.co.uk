...
- **FTT (Property Chamber) fees: VERIFIED (was verify-at-write; A14 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2026/642/schedule/6/made).** From **13 July 2026** the fee schedule is replaced by SI 2026/642 art 12 + Sch 6 (substituting Sch 1 to the 2013 Fees Order, SI 2013/1179): an LTA 1985 **s.27A(1) or (3) application = £114 application fee + £227 hearing fee**. Do not use the old £100/£200 figures still on the SERP; "fees changed 13 July 2026" is a freshness signal.
