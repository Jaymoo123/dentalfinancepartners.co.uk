...
- **Genuine partnership incorporation** under FA 2003 Sch 15 **para 18** (transfer FROM a partnership to a partner or connected person, chargeable consideration = MV × (100 − SLP)%, SLP at para 20). Para 10 is the mirror rule for transfers INTO a partnership (SLP at para 12) and is frequently misquoted as the incorporation rule; see §1.A. The portfolio must already be held in a real, pre-existing letting partnership (with partnership tax returns, partnership accounting, joint borrowing) for HMRC to accept the chargeable consideration is reduced to nil under the connected-party formula. Heavily scrutinised; not a quick fix for a husband-and-wife joint-ownership portfolio.
...
- **Section 162 incorporation relief:** CGT roll-over on incorporation of a business (including a property letting business) where ALL assets (other than cash) are transferred in exchange wholly or partly for shares. **NO LONGER AUTOMATIC: since FA 2026 it must be CLAIMED for transfers on/after 6 April 2026** (new TCGA 1992 s.162(1)(b); claim by the first anniversary of the 31 January following the tax year of the transfer). FA 2026 s.39 **repealed the old s.162A election** to disapply the relief, so the position is now claim-or-no-relief. HMRC's position on whether residential letting constitutes a "business" requires evidence of business activity — usually a portfolio of multiple properties under active management. Ramsay v HMRC [2013] sets the threshold. [Locked 2026-06-01, source-verified at legislation.gov.uk]
...
**Do not write:** "CGT rate is 28%" (was, until 30 October 2024). "Letting Relief is available for all rental periods" (only shared-occupation since April 2020). "60-day applies to all UK residents' disposals regardless of tax due" (only where tax is due). "Section 162 incorporation relief is automatic / you do not claim it" (false since FA 2026 — must be claimed for transfers on/after 6 Apr 2026; the s.162A disapplication election was repealed).
...
**Locked framing:** Separate property income tax rates were **announced at the Autumn Budget 2025 (26 November 2025)** and **enacted by Finance Act 2026 (Royal Assent 18 March 2026)**, ss.6-7, taking effect from **6 April 2027**. They apply to property income in **England, Wales and Northern Ireland** for 2027/28 (HMRC measure paper "Changes to Tax rates for Property, Savings and Dividend Income": "This will apply to England, Wales and Northern Ireland"). **Only Scotland is carved out** (Scottish taxpayers pay Holyrood-set rates on property income). The power for Wales AND Scotland to set their OWN property rates (FA 2026 s.8 / Sch 2) is a **future enabling power** for a Treasury-appointed tax year **after 2026-27** and is **NOT in force for 2027/28** — so do NOT write "England + NI only" or "Wales sets its own" for 2027/28 (corrected 2026-05-30). FA 2026 has Royal Assent — state the rates as enacted law, not as a proposal, surcharge-to-come, or draft.
...
For **2027/28 onwards**, property income (England, Wales and NI; Scotland excluded) is taxed at **22% basic, 42% higher, 47% additional**, and — critically — FA 2026 Sch 1 gives the **Section 24 finance-cost reducer at the new property basic rate of 22%** (amending ITTOIA 2005 ss.274AA/274C and ITA 2007 s.399B). The reducer is NOT frozen at 20%.
...
**Do not write:** "the reducer/credit stays at 20% in 2027/28" (it rises to 22%). "a new basic-rate wedge opens in 2027/28" (it does not — the reducer tracks the 22% rate). "FA 2026 is draft / awaiting Royal Assent / a proposal" (enacted 18 March 2026). "announced at the Autumn Budget 2024" for these property income rates (that was Budget 2025; the 30 October 2024 budget did the SDLT 5% surcharge and CGT 18/24). "Property income is taxed at 20/40/45 in 2027/28" (it is 22/42/47 in England, Wales and NI). "the 2027 rates apply to England and NI only" or "Scotland and Wales set their own property rates" for 2027/28 (WRONG on Wales: only Scotland is carved out for 2027/28; the Welsh/Scottish self-setting power is a future s.8/Sch 2 power not yet in force).
...
- **Debts against relieved property (VERIFIED AT STATUTE 2026-08-21):** under **IHTA 1984 s.162B** (inserted FA 2013 Sch 36 para 3), a liability incurred to finance the acquisition, maintenance or enhancement of BPR property (s.162B(1)-(2)) or APR property (s.162B(3)-(4)) is "so far as possible, to be taken to reduce the value attributable to" THAT property BEFORE the s.104/s.116 relief is applied. Practical effect: a farm loan secured for the land's purchase comes off the relievable value first, so it shrinks the relief, not the rest of the taxable estate. Do not write worked examples that net the debt against the non-relieved estate. Full page treatment = rural delta list. unused s.124D allowance IS transferable between spouses/civil partners under **IHTA 1984 s.124E "Transfer of unused 100% relief allowance"** (verified direct at legislation.gov.uk 2026-08-21): CLAIM-BASED (s.124E(5), like the transferable NRB, a claim must be made), conditions in s.124E(1) (spouse/civil partner immediately before death + unused allowance), quantum via the **unused-percentage mechanism** in s.124E(6) (unused allowance divided by the deceased's final allowance amount, applied to the survivor's allowance). Headline couples view **£5,000,000**. Do not write "automatic" (it needs a claim) and do not write "fixed to each estate / not transferable" (superseded; two shipped lines on iht-april-2026-bpr-apr-cap-property-impact carried this and were back-patched 2026-08-21).
...
- Mixed estates with both an active trading business (e.g. a farm) and a BTL portfolio — the trading element competes with farmland for the £2.5m allowance. *(Figure corrected 2026-08-21: this bullet still carried the pre-F-102 £1m quantum.)*
...
- **[08-21 precision, agents1 factual QA vs gov.uk]** £200 is charged **on reaching 4 points** (i.e. the fourth miss itself triggers £200), then **£200 for each further missed submission** while at threshold. Never write it as "each further miss after the threshold" alone; that reads the fourth miss as free.
...
- **[08-21 additions, agents1 factual QA vs gov.uk MTD penalties guidance]** (a) **First-year concession:** in a filer's first year of the new penalties, gov.uk gives **30 days from the payment due date** before the day-15 charge applies ("3% of the tax owed at day 15, or no penalty if it's your first year" per the 2026-27 table). State it when writing to the April 2026 cohort. (b) The rates step to **4%/4%/10% for 2027-28** per gov.uk, so never write the 3%/3%/10% schedule open-ended "from 6 April 2026"; bound it to 2026-27.
...
Verified against legislation.gov.uk (RRA 2025 contents page, SI 2025/1354, SI 2026/421) on 2026-05-22. **RE-VERIFIED 2026-08-21** (agents1 pre-write pass, per-section annotations + title search on legislation.gov.uk): additions marked [08-21] below. The Act is enacted; substantive provisions arrive in waves via Statutory Instrument, PLUS a self-commencement layer under s.145 that the 05-22 table missed.

**[08-21] Self-commencement under s.145 (no SI involved):**
- **s.145(2): the whole Act came into force "for the purposes of making regulations" at Royal Assent (27 October 2025).** So the regulation-making powers in Pt.2 Ch.2 (redress, ss.64-73) and Pt.2 Ch.3 (database, incl. the s.77 fee power) ARE in force even though the substantive duties are not. Never write "none of Part 2 is in force"; write "in force for regulation-making only; no regulations made".
- s.111 + Part 5 (general): in force at Royal Assent, 27 October 2025 (s.145).
- Pt.1 Ch.2 (ss.31-32), s.59, s.110, Pt.4 Ch.3 (ss.114-136 investigatory powers): in force 27 December 2025 (two months after RA, by the Act itself).
...
- **SI 2026/421** (Commencement No. 2 and Transitional and Saving Provisions Regulations 2026): made 16 April 2026, appointed day **1 May 2026**. This is the major substantive commencement. **[08-21] Reg 2's heading confines the whole 1 May tenancy-reform wave to assured tenancies that are NOT social-housing assured tenancies (s.145(8) definition). Social housing follows in Phase 2 (roadmap expectation 2027). Quote this carve-out in any "does this apply to me" content.** [08-21 precision] Schedule 5 (financial-penalties procedure) commenced via **reg 3 attached to s.102**, not via the ss.15-16 line (ss.15-16 commenced under reg 2 as part of Ch.1 Pt.1).
- **[08-21] SI 2026/638** (Commencement No. 3 Regulations 2026): made 16 June 2026, in force **22 June 2026**. Commences s.100(1),(5) for further purposes ("qualifying residential premises" definition inserted as s.2B Housing Act 2004), s.100(6) in part, and Sch 4 Pt 1 paras 1, 2(1), 2(3), 6, 32, 34 (paras 6 + 34 limited to category 1 hazards) and 42. Effect: local housing authorities can impose civil penalties **up to £7,000 for category 1 hazards**; para 42 lets penalty proceeds fund enforcement involving superior landlords. This is HHSRS enforcement plumbing, NOT the substantive Decent Homes Standard.
- **[08-21] Four implementing SIs, all in force 1 May 2026, previously unrecorded:**
  - **SI 2026/321**: definition of legal representative (Housing Act 1988 assured tenancies).
  - **SI 2026/324** (Written Statement of Terms etc and Information Sheet): the statutory duty behind the government "information sheet". Existing tenancies had a **31 May 2026** deadline for landlords to give the information sheet; new tenancies get written statement of terms + sheet.
  - **SI 2026/325** (Consequential Amendments): sweeps s.21 references out of ~9 instruments incl. MEES SI 2015/962 (see §26.3) and Smoke/CO Alarm regs 2015, and **REVOKES the Assured Shorthold Tenancy Notices and Prescribed Requirements (England) Regulations 2015** — legacy content citing the prescribed-requirements regime as a s.21 precondition now describes a revoked instrument.
  - **SI 2026/354** (Prescribed Forms): **Form 4A** is the prescribed s.13(2) rent-increase notice (Form 5A for assured agricultural occupancies). The s.8 possession notice ("Form 3A") is **the version published by the Secretary of State having effect at the time** — a live document, not a scheduled form. Never link or describe a static snapshot as "the" s.8 form.
- No Commencement No. 4 exists as of 2026-08-21 (title search). Wales: SI 2026/6; Scotland: SI 2026/113 (revoked) + SI 2026/125 — all out of PTP scope.

**Status by provision as of 2026-05-22 (updated 2026-08-21 where marked):**
...
| Landlord Redress Scheme / PRS Ombudsman (Ch.2 Pt.2, ss.64-74) | Pt.2 Ch.2 | **Partial** (s.74 fully; ss.64-73 for regulation-making only since Royal Assent per s.145(2)) [08-21] | 1 May 2026 / 27 Oct 2025 | SI 2026/421 reg.3 + s.145(2) |
| PRS Database (Ch.3 Pt.2, ss.75-96) | Pt.2 Ch.3 | **Pending** (s.75 marked Prospective on legislation.gov.uk; regulation-making powers incl. s.77 fees in force since Royal Assent per s.145(2); NO fee regulations made, no fee figure citable) [08-21] | not yet appointed | s.145(2); no commencement SI |
| Decent Homes Standard for PRS (Pt.3, ss.100-101) | Pt.3 | **Partial, two preliminary tranches** (27 Dec 2025 + 22 Jun 2026); substantive PRS standard uncommenced, government proposes **2035 or 2037** [08-21] | 27 Dec 2025 + 22 Jun 2026 + pending | SI 2025/1354 + SI 2026/638 + pending |
...
**Practical writing rule for sessions (updated 2026-08-21):**
- Section 21 abolition, periodic tenancies, reformed Section 8, Section 13 rent-rise procedure, advance-rent ban, bidding-wars ban, pet rights, financial penalties: **write in present tense as in force from 1 May 2026, for private (non-social-housing) assured tenancies** (the SI 2026/421 reg 2 carve-out; social housing = Phase 2, roadmap expectation 2027).
- PRS Database: s.75 is Prospective; regulation-making powers in force since Royal Assent; **no commencement SI and no fee regulations**. gov.uk roadmap (13 Nov 2025) expects "regional rollout from late 2026" — cite as expectation only. **Never publish a fee figure; none exists in law.**
- Landlord redress: s.74 in force; ss.64-73 regulation-making only; **no landlord redress scheme SI exists at all** (title search 2026-08-21). Roadmap expects mandatory membership "in 2028" — expectation only. (Agents' own 2014 regime under SI 2014/2359 is separate; §26.5.)
- Decent Homes Standard: preliminary provisions in force in two tranches (27 Dec 2025, 22 Jun 2026); **the substantive standard for PRS awaits a further commencement order**; government proposes 2035 or 2037.
- Section 13 notices: name **Form 4A** (SI 2026/354) for post-1-May rent increases; pre-1-May notices are protected by SI 2026/421 regs 7-8 transitional provisions.

**Source-of-truth re-check:** before any session writes a definite-tense claim about an RRA 2025 provision, re-verify against `https://www.legislation.gov.uk/ukpga/2025/26/contents` and the SI commencement table (operative England orders as of **2026-08-21**: SIs 2025/1354, 2026/421, 2026/638, plus implementing SIs 2026/321, 2026/324, 2026/325, 2026/354; new SIs may have appointed further sections after that date).
...
- **CT rates 2026/27 (confirmed gov.uk 2026-05-23):** 19% small profits rate (≤ £50k profits), 25% main rate (≥ £250k profits), marginal relief tapered band £50k-£250k effective 26.5% rate. Unchanged from 2025/26; Spring Statement 2025 confirmed no CT rate changes. **Marginal-relief citation (verified 2026-05-30):** the current regime (FY2023 onward) is **CTA 2010 Part 3A** — relief computed under **s.18B**, with the standard fraction (currently **3/200**) set by Parliament under **s.18**; the £50k/£250k limits + associated-company divisor are **ss.18D/18E**, CIHC definition **s.18N** with the small-profits-rate denial at **s.18A(1)(b)**. **Do NOT cite CTA 2010 s.19/s.20 for marginal relief** — that Part 3 regime was OMITTED by Finance Act 2014 (the section number resolves but its wording no longer supports the claim: the F-8 trap).
...
- **[08-21 additive, agents1 pre-write verification] SI 2015/962 amendment log:** SI 2026/325 reg 9 (in force 1 May 2026, RRA consequential) deleted "or section 21" from reg 9(1)(c)(i) of SI 2015/962. Does not touch reg 24 or the band E standard, but stop writing "unamended since 2019". Title search 2026-08-21 confirms NO other 2025/2026 amendment and no instrument imposing an EPC band C minimum.
- **[08-21 additive] Policy layer hardened; enacted position unchanged.** Government response to "Improving the energy performance of privately rented homes" (updated **21 January 2026**) confirms the policy intent: compliance **by 1 October 2030** against new dual metrics (fabric primary, then heating-system or smart-readiness), investment cap **"up to £10,000"**, 10-year validity for revised cost-cap/property-value/negative-impacts exemptions, grandparenting requiring an EPC C (EER) **before 1 October 2029**. Critically, the response itself states government **"will seek new powers by Act of Parliament"** and only then lay an SI, "with the aim of it coming into force in 2027". That is the citation to use whenever tempted to repeat gov.uk's indicative-mood "must achieve EPC C by 2030": primary legislation does not yet exist, so it is not law and the government says so. A gov.uk news page (30 Apr 2026, /government/news/when-will-the-renters-right-act-come-into-force, re-verified 2026-08-21) states verbatim: "By 2030, all privately rented homes must meet new energy efficiency standards (EPC rating C or better) unless exempt." — if quoted, quote THAT exact wording (any paraphrase must not be presented as a quote), and cite only as policy with the 21 Jan 2026 response behind it, never as an enacted duty. The same page gives "A new Decent Homes Standard by 2035 for private rentals".
...
- **Statutory hook:** RRA 2025 Part 2 Chapter 2, ss.64-74. **Partially in force from 1 May 2026** per SI 2026/421 reg.3 (specifically s.74 only; the broader chapter awaits further commencement orders). **[08-21 re-verified]** ss.64-73 have been in force **for regulation-making purposes only** since Royal Assent (s.145(2), per-section annotations); **no landlord redress scheme SI exists at all** (legislation.gov.uk title search "Landlord Redress" returns no results, 2026-08-21). gov.uk roadmap expects mandatory membership **"in 2028"** — expectation only, cite as such.
...
- **[08-21] What s.74 actually is (locked; our two existing pages described it two different ways, both loosely).** Heading: "Local Commissioners' investigation of complaints by persons who are not tenants". It amends s.26 Local Government Act 1974 to adjust the boundary between Local Commissioner (local government ombudsman) investigations and the Housing Act 1996 housing ombudsman scheme, excluding investigation of certain housing matters where the complainant is eligible for the housing ombudsman route. It is a jurisdictional boundary provision, NOT "interpretation and consequential provisions" and not an extension of landlord redress. Verified legislation.gov.uk 2026-08-21.
...
- **Pre-existing letting-agent redress regime — DO NOT CONFLATE.** Letting and managing agents have been required to join an approved redress scheme since **1 October 2014 under SI 2014/2359** (The Redress Schemes for Lettings Agency Work and Property Management Work (Requirement to Belong to a Scheme etc) (England) Order 2014). **[corrected 08-21, agents1 factual QA]** Two approved schemes currently operate: The Property Ombudsman (TPO) and Property Redress (the rebranded Property Redress Scheme; verified live 2026-08-21, theprs.co.uk redirects to propertyredress.co.uk). Ombudsman Services: Property exited the sector in 2018 and nothing succeeded it. The pre-correction text listed "three schemes" by double-counting PRS and Property Redress; the frozen sibling page publishes the same error and is delta-queued. The **agent regime under SI 2014/2359 is separate from the new RRA 2025 landlord scheme**; sessions writing on Wave 7 A6 must distinguish (a) agent membership (pre-existing, since 2014) from (b) landlord membership (new under RRA 2025, awaiting full commencement).

### 26.6 Private Rented Sector Database — RRA 2025 Part 2 Chapter 3 (ss.75-96)

- **Statutory hook:** RRA 2025 Part 2 Chapter 3, ss.75-96. **NO commencement order as of 2026-05-24; RE-VERIFIED 2026-08-21, still none** (Commencement No. 3, SI 2026/638, touches only s.100/Sch 4 — not this Chapter). **Precision [08-21]:** s.75 (the database duty) is marked **Prospective** on legislation.gov.uk; the Chapter's **regulation-making powers, including the s.77 fee power, have been in force since Royal Assent** under s.145(2). **No fee regulations made; no fee figure is citable** (the £30-£50 numbers in commentary are invented). gov.uk roadmap (13 Nov 2025): "regional rollout of the database for landlords and local councils" **from late 2026** — expectation only.
...
- **Practical writing rule for sessions (superseded 2026-08-21; use the [08-21] framing).** Frame the PRS Database as **"no commencement order and s.75 Prospective; regulation-making powers in force since Royal Assent; gov.uk roadmap expects regional rollout from late 2026, cite as expectation only"**. The pre-patch "expected before April 2027" phrasing is retired (the roadmap's own date is late 2026 for regional rollout). Do not assert "landlords must register from 1 May 2026" or "the database is live"; both remain false as of 2026-08-21.
...
- **MEES energy improvement spend.** CORRECTED 2026-08-21 (Wave 11 QA, PIM2030 verbatim; the pre-correction text had double glazing backwards): replacing a part of the building with the nearest modern equivalent is a **revenue repair**, and PIM2030's own example is single glazing replaced with double glazing ("generally treated as an allowable repair ... For example, when single glazing is replaced with double glazing"). A like-for-like boiler replacement is likewise repair. **Capital improvement** (CGT base-cost addition under TCGA 1992 s.38(1)(b)) is reserved for genuine additions or upgrades beyond the modern equivalent: insulation installed where none existed, first-time central heating, extending the system, or a specification uplift a repair would not deliver. Government grant receipts under ECO4 / GBIS / BUS reduce the CGT base cost (HMRC general principle: grants matched against the expenditure they fund).
...
- "The landlord cap is now £10,000" (false; cap remains £3,500 including VAT under SI 2015/962 reg 24 as amended; £10,000 is a consulted-on figure not yet legislated).
...
- [08-21] "Database registration costs £X" (false; no fee regulations made under s.77; any circulating figure is invented).
- [08-21] "Download Form 3A here" pointing at a static snapshot (the s.8 possession form is the Secretary of State's live published version per SI 2026/354 reg 3(1)(c); link gov.uk's current version, never embed a copy).
- [08-21] Citing the AST Notices and Prescribed Requirements (England) Regulations 2015 as a live s.21 precondition (revoked by SI 2026/325 with effect from 1 May 2026).
...
### 31.3a LFRA 2024 in-force table — VERIFIED 2026-08-08 (BMV_FACTS.md, HomeOwners Alliance + Homehold cross-checked); re-verified 2026-08-15 (Stage 2, A16 brief: commencement register re-exhausted, exactly three SIs exist: SI 2024/1018, SI 2025/57, SI 2025/131, no Commencement No. 4 or later); RE-VERIFY after 23 Sep 2026 (valuation-rates consultation closes) and before any wave touching leasehold
...
| Service-charge transparency (standardised demands, annual reports, information rights) | **NOT IN FORCE**: ss.53-58 (Part 4); no commencement SI (SI 2024/1018 explicitly excludes Part 4). Added at Stage 2b from the A16 brief, verified 2026-08-15 (Stage 2) | LTA 1985 + SI 2003/1987 remain the operative regime (full lock: §31.D) |
| Extension/enfranchisement costs reform (s.60 repeal) | **NOT IN FORCE**: ss.38-39; no commencement SI; the LRHUDA 1993 s.60 repeal is annotated "changes yet to be applied" (https://www.legislation.gov.uk/ukpga/1993/28/section/60, version 15 Aug 2026). Added at Stage 2b from the A16 brief, verified 2026-08-15 (Stage 2) | Leaseholders still pay the freeholder's s.60 costs on extension claims, but NOT on RTM claims (ss.87A-87B, §31.C): the sharpest illustration of phased commencement |
| Building-safety amendments (ss.114-116, s.120) | **IN FORCE** (31 Oct 2024, SI 2024/1018 reg 2). Added at Stage 2b from the A16 brief, verified 2026-08-15 (Stage 2) | Remediation-order machinery live |
...
Context: the freeholders' judicial review is **R (ARC Time Freehold Income Authorised Fund and others) v Secretary of State for Housing, Communities and Local Government [2025] EWHC 2751 (Admin)** (Divisional Court, Holgate LJ and Foxton J), A1P1 challenges to the marriage-value abolition, ground-rent and costs provisions **dismissed 24 Oct 2025**. The Court of Appeal has since granted the freeholders permission to appeal (round two pending, reported Apr 2026). Neither the dismissal nor the pending appeal commences or suspends anything; commencement remains a purely governmental act under s.124. Citation and appeal status verified 2026-08-15 (Stage 2, A16 brief). Realistic commencement of the valuation provisions: **2027-28 at the earliest** (Homehold: late 2028 at the very earliest). Treat any specific commencement date found online as unreliable.
...
- **Inherited interests (Sch 4ZA para 16):** an interest inherited in the previous 3 years is disregarded ONLY where the beneficial share does not exceed 50% (spouse's or civil partner's share aggregated for the test); the disregard is lost if the share rises above half within those 3 years. Interests inherited longer ago, or majority shares, are counted. (Condition verified at legislation.gov.uk 2026-08-17; earlier wording here omitted the 50% test.)
...
- **Statutory hooks.** ITTOIA 2005 s.271 (property business charge); s.271E (GAAP calculation); **s.272 (Application of trading income rules: GAAP — the operative import gateway)**; s.34 (wholly-and-exclusively, imported); **s.94H NOT imported for property businesses (CORRECTED 2026-08-21: s.94H opens "a trade"; s.272/s.272ZA import only s.94C and ss.94D-94G vehicle rates; BIM47825 scopes to trades; PIM2100 offers only actual-cost apportionment - the old "imported" claim here was wrong)**; TCGA 1992 s.224(1) (PPR business-use restriction); ITEPA 2003 ss.316A-317 (Ltd Co employer-provided home-working allowance); CTA 2009 s.54 (Ltd Co rental-paid-to-director route).
...
- **§34.2 Home-office route (CORRECTED 2026-08-21; the old two-route framing was WRONG - route (a) does not exist for a property business).** The ONLY route for an individual landlord is **ITTOIA s.34 actual-cost apportionment on a reasonable basis** (PIM2100). The s.94H fixed-rate home-working deduction applies to TRADES only and is NOT imported into property income (s.272/s.272ZA import s.94C and ss.94D-94G vehicle flat rates, deliberately omitting s.94H; verified against legislation.gov.uk x4 + BIM47825 + PIM2100, evidence in briefs/property/rental/qa/FACTUAL_rentalbatch.md). CGT discipline unchanged: exclusive-business-use characterisation triggers TCGA 1992 s.224(1) PPR restriction on disposal; documented mixed/non-exclusive use avoids it. Do not write: any flat-rate/simplified-expenses home-office claim for an unincorporated property business.
...
- **§34.4 Ltd Co-landlord home-office mechanic.** ITEPA 2003 ss.316A-317 (employer-provided home-working allowance £6/week / £312/year) vs formal home-office rental between director and company (CTA 2009 s.54 + ITTOIA s.272 + director's individual-side ITTOIA s.272/s.34 (s.94H not available, see 34.2) + TCGA s.224(1) on director's PPR). Cross-reference §21.3.
...
- **New 40% first-year allowance.** FA 2026 **s.29** ("First-year allowance for main rate expenditure on plant or machinery"): a 40% FYA on **main-rate, new and unused** plant and machinery, expenditure incurred **on or after 1 January 2026**. **Excludes cars, second-hand/used assets, and assets for leasing overseas.** **NOT restricted by incorporation status** (the inserted CAA 2001 **s.45U** sets no company/unincorporated limit — manager-verified at legislation.gov.uk 2026-05-30: its qualifying-expenditure conditions contain no incorporation test). In practice it is the route for **unincorporated businesses (sole traders, partnerships, individual landlords) and for leasing**, because a company investing in qualifying new main-rate plant will normally claim **100% full expensing** (s.45S) instead, and full expensing is unavailable for leasing. **Do NOT write that the 40% FYA is "unincorporated-only" or that "companies cannot claim it"** (that is wrong law); frame it as the practical route for those who cannot or would not use full expensing. (Cite FA 2026 s.29 / CAA 2001 s.45U; never invent a section number.)
...
- **SBA (structures and buildings allowance): 3%** (uplifted from 2%), set by CAA 2001 **s.270AA(5)**; the 2% to 3% uplift was enacted by **Finance Act 2020**, effective 1 April 2020 (CT) / 6 April 2020 (IT) (consistent with §25.4/§25.5). NB **FA 2021 Sch 22 para 7(4) is the Freeport 10% SBA**, not the standard 3% rate (corrected 2026-05-30).
...
- "Full expensing is available to individual landlords" (companies only; unincorporated businesses use the new 40% FYA instead, though that 40% FYA is not itself restricted to unincorporated persons).
...
- **Statutory hooks:** The Electrical Safety Standards in the Private Rented Sector (England) Regulations 2020 (SI 2020/312).
  ...
  - **reg 11 (financial penalty): "must not exceed £40,000"** (CORRECTED at RUN, 2026-08-15: the £30,000 figure locked at Stage 1b was the pre-amendment sum; SI 2025/1043, the Extension to the Social Rented Sector Regulations 2025, substituted £40,000 in reg 11(2)(b) with effect 1 Nov 2025, fully 1 May 2026 - F3 annotation verified twice at https://www.legislation.gov.uk/uksi/2020/312/regulation/11). Cap is **PER BREACH**, multiple breaches can stack. The SI is also renamed "...Private Rented Sector and Social Rented Sector (England) Regulations 2020" and Sch 1's social-housing exclusion was removed (moveable structures class added).
...
- **TWO-REGIME PENALTY DISCIPLINE (live SERP error we exploit, REVISED at RUN 2026-08-15).** The EICR cap is now **£40,000 per breach under SI 2020/312 reg 11 as amended by SI 2025/1043** (was £30,000 before 1 Nov 2025). The Housing Act 2004 licensing civil penalty is **£40,000 per offence under s.249A** from 1 May 2026 (§26.9, SI 2026/319 uplift). Separate regimes, now IDENTICAL caps, both can hit the same landlord (unlicensed AND uncertified). The exploit: SERP pages quoting £30,000 describe the old law; state the amendment, the two regimes, and the stacking explicitly.
...
- **Sch 1 excluded tenancies: VERIFIED (was verify-at-write; resolved by the A1 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2020/312/schedule/1/made).** Eight excluded classes: (1) landlord is a private registered provider of social housing; (2) shared accommodation with the landlord or landlord's family (occupier shares amenities: toilet, washing facilities, kitchen or living room); (3) long leases (long lease under LRHUDA 1993, or a tenancy granting a right of occupation for a term of 7 years or more); (4) student halls of residence; (5) hostels and refuges; (6) care homes (Care Standards Act 2000 definition); (7) hospitals and hospices; (8) other accommodation relating to healthcare provision (NHS-provided). Writers may state the exclusion list with this citation. Re-verify the £30,000 cap at write per standing rule.
...
- **Do not write:**
  - "EICR penalty capped at £30,000" (stale: £40,000 per breach since SI 2025/1043, in force 1 Nov 2025).
  - "Penalty capped at £40,000 in total" (per breach; breaches stack).
...
- **reg 36 sub-provisions: VERIFIED (were verify-at-write; resolved by the A5 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/1998/2451/regulation/36):**
  - **12-month cycle, reg 36(3)(a):** each appliance and flue checked within 12 months of installation and at intervals of not more than 12 months since the last check.
  - **Record retention, reg 36(3)(c):** record retained until there have been two further checks of the appliance or flue; for a removed appliance/flue, 2 years from the date of the last check. HSE's plain-English gloss is "keep a record for 2 years" (https://www.hse.gov.uk/gas/domestic/faqlandlord.htm, verified 2026-08-15 (Stage 2)); cite the SI, use HSE for the gloss.
  - **Supply deadlines, reg 36(6):** copy to each existing tenant within 28 days of the check (reg 36(6)(a)); copy of the last record to any new tenant before occupation (reg 36(6)(b)).
  - **MOT-style flexibility: reg 36A, inserted by SI 2018/139** (corrected at Stage 2b: was reg 36(3A)). Verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2018/139/made. reg 36A(1): a check completed within the 2 months ending with the deadline date is treated as made on the deadline date, so a check up to 2 months early keeps the renewal date (the "10-12 month" shorthand); the next 12 months run from the deadline date.
- **Penalty framing: VERIFIED (was verify-at-write; A5 brief, HSE landlord FAQ fetched 2026-08-15 (Stage 2)).** No fixed fine figure exists in HSE guidance; enforcement is HSE prosecution under the HSWA 1974 backdrop ("substantial fine and/or a custodial sentence", unlimited fines on indictment). The framing stands; the circulating "£6,000 fine" style numbers stay banned.
...
- **Statutory hooks:**
  ...
  - Fire Safety (England) Regulations 2022 (SI 2022/547), regs 3-10: high-rise definition, secure information box, external walls, floor plans, lifts, wayfinding signage, information to residents, fire doors. Verified at https://www.legislation.gov.uk/uksi/2022/547/contents on 2026-08-15. **Height thresholds VERIFIED (were verify-at-write; A3 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2022/547/made):** reg 3 "high-rise residential building" = 2+ sets of domestic premises AND at least 18 metres above ground level OR at least 7 storeys; regs 4-8 (information box, external walls, floor plans, lifts, wayfinding) apply to high-rise buildings ONLY; **reg 9 = information to residents** (any building with 2+ sets of domestic premises and common parts through which residents would evacuate); **reg 10 = fire doors** (information duty for any such 2+-premises building; the checking duty applies to buildings above 11 metres, writer confirms the quarterly/annual cadence from the reg 10 text at write). (Corrected at Stage 2b: the seed had reg 9 and reg 10 transposed, reg 9 as fire doors and reg 10 as resident information.)
- **Residential scope boundary (state in the first screen, this is the differentiator):** the RRFSO applies to the **common parts of blocks of flats and to HMOs**, NOT inside a single self-contained dwelling let to one household. A single-let house needs no RRFSO fire risk assessment; the smoke and CO alarm regulations apply instead: **SI 2015/1693 VERIFIED (was verify-at-write; A3 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2015/1693/made):** Smoke and Carbon Monoxide Alarm (England) Regulations 2015, reg 4(1)(a)(i) smoke alarm on each storey with living accommodation, reg 4(1)(a)(ii) CO alarm in rooms with a solid fuel combustion appliance, reg 4(1)(b) working-order check on the day the tenancy begins, reg 5 remedial notices, **reg 8(2) penalty cap £5,000**. STILL verify-at-write: the SI 2022/707 amendment (CO duty extended to any fixed combustion appliance other than a gas cooker) was NOT verified; writers must fetch the current reg 4 text before stating the CO scope. Competitors blur this constantly.
- **Stage 1b verify-at-write items now VERIFIED (A3 brief, Stage 2):**
  - **Fire Safety Act 2021 s.1: VERIFIED 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/ukpga/2021/24/section/1.** Amends art 6 RRFSO: in a building with 2+ sets of domestic premises the Order applies to the building's structure and external walls (including doors, windows and anything attached, cladding and balconies), the common parts, and all doors between the domestic premises and common parts (flat entrance doors). Commencement: England 16 May 2022 (Wales 1 Oct 2021).
  - **BSA 2022 s.156: VERIFIED 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/ukpga/2022/30/section/156.** In force 1 October 2023: art 9 recording duty extended, the responsible person records the fire risk assessment IN FULL (significant-findings-only threshold removed); fire safety arrangements must be recorded; new **art 21A** (comprehensible fire safety information to residents of buildings with 2+ domestic premises); new **art 22A** (outgoing responsible person hands fire safety information to successor); art 22/new **art 22B** strengthened cooperation duties including with accountable persons in higher-risk buildings.
...
- **Do not write:**
  ...
  - Any SI 2022/707 CO-scope proposition without write-time verification of the amended reg 4 text (the FSA 2021 and BSA 2022 s.156 citations are now Stage 2 verified above).
...
- **Enforcement:** reg 34 (local weights and measures authorities), reg 36 (penalty charge notices), reg 38 (the penalty-amount provision). **PENALTY AMOUNTS: VERIFIED TWICE INDEPENDENTLY (A6 and A17 briefs, both verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2012/3118/regulation/38, A17 additionally against https://www.legislation.gov.uk/uksi/2012/3118/regulation/38/made; the Stage 1 504 blocker is cleared; amounts unamended by the F1-F5 notes):**
  - **Dwellings: £200 fixed** (reg 38(1)(a)) for breaches of reg 6(2), 6(5), 7(2)-(5), 7A(2)-(3).
  - **Non-dwellings: 12.5% of the rateable value of the hereditament, minimum £500, maximum £5,000** (reg 38(3)); **default £750** where no rateable value can be determined (reg 38(2)(d) cases). Writer rule: quote the formula, never a single flat figure.
  - Supporting amounts: DEC breaches £1,000 (reg 14(3)(a)) / £500 (reg 14(3)(b)); air-conditioning duties (regs 18(1), 20(1)-(2), 21) £300; reg 35(5) failure to produce documents £200.
  - Re-fetch reg 38 at write per standing rule.
- **10-year validity = reg 9(2)** (corrected at Stage 2b: was reg 11 per the A17 seed). Verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2012/3118/regulation/9: an EPC is valid for reg 6 purposes only if entered on the register no more than 10 years before it is made available (reg 9(2)(a)). reg 11 is the advertisement statement duty, cite it for that only. **Assessor accreditation = reg 22**, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2012/3118/regulation/22 (membership of an approved accreditation scheme, reg 22(1); scheme duties reg 22(3)).
- **TWO-REG-38 TRAP (record from the A19/A17 briefs, Stage 2):** SI 2012/3118 reg 38 = EPC penalty AMOUNTS (this lock); SI 2015/962 reg 38 = MEES penalty notices (different subject, §26.3/§26.3a regime). Every reg 38 mention on any page must name its SI; a bare "reg 38" cross-contaminates the two regimes.
...
- **Do not write:**
  - Any reg 38 penalty figure that departs from the verified amounts above without a write-time re-fetch (figures from competitor packs do not count as sources), and never a bare "reg 38" without naming its SI (two-reg-38 trap above).
...
- **Domestic reg 40 penalty ladder (cross-note for the split, from the A8 brief; verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2015/962/regulation/40, cross-checked against gov.uk domestic MEES landlord guidance same date):** breach under 3 months up to **£2,000** (reg 40(2)(a)); 3 months or more up to **£4,000** (reg 40(3)(a)); false or misleading register information up to **£1,000** (reg 40(4)(a)); failure to comply with a compliance notice up to **£2,000** (reg 40(5)(a)); **aggregate cap £5,000 in total per property (reg 40(6))**. The widely quoted £5,000 is the AGGREGATE cap, not a per-breach figure; state the structure, then the cap. Also verified: the temporary "recently became a landlord" exemption is **6 months** from becoming the landlord (gov.uk guidance, fetched 2026-08-15), not the 5 years of the other classes.
...
- **Model articles: SI 2009/2767** (RTM Companies (Model Articles) (England) Regulations 2009), prescribed for RTM companies (limited by guarantee, no share capital); they apply automatically and prevail over inconsistent bespoke articles. Verified at https://www.legislation.gov.uk/uksi/2009/2767/contents/made on 2026-08-15. **As amended by SI 2025/130** (RTM Companies (Model Articles) (England) (Amendment) Regulations 2025, in force alongside the 3 Mar 2025 reforms; added at Stage 2b from the A12 brief, reg 2 verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2025/130/regulation/2/made): inserts a definition of "lease" and replaces article 33(3)(f) so that **landlord votes are capped at one third of the votes exercisable by qualifying tenants**. Cite the articles as SI 2009/2767 as amended by SI 2025/130.
...
- **Day-counts inside ss.78-90: VERIFIED from section text (were verify-at-write; A13 brief, all fetched 2026-08-15 (Stage 2) at legislation.gov.uk/ukpga/2002/15/section/78, /79, /80, /84, /87 and /90):**
  - **s.78(5):** participation notice must offer inspection of the articles for at least two hours on each of at least three days within the **seven days** beginning with the day after the notice is given (invalid if not, s.78(6)).
  - **s.79(2):** claim notice may not be given until each required participation notice was given **at least 14 days** before. s.79(5): membership at service = qualifying tenants of not less than half the flats (both where only two).
  - **s.80(6):** counter-notice date specified in the claim notice must be **not earlier than one month** after the relevant date.
  - **s.80(7):** intended acquisition date at least **three months** after the s.80(6) date.
  - **s.84:** counter-notice by the s.80(6) date; if entitlement is disputed, tribunal application within **two months** of the counter-notice (FTT first instance since 3 Mar 2025, s.52). s.87: deemed withdrawal if no tribunal application in the two months, on withdrawal of the application, or on company insolvency/strike-off events.
  - **s.90 acquisition-date variants:** uncontested = the claim-notice date (s.90(2)); tribunal-determined = three months after the determination becomes final (s.90(4)); late written agreement = three months after agreement (s.90(5)); s.85 court-order cases = the date in the order (s.90(6)).
- **Costs regime: VERIFIED (was verify-at-write; A13 brief, verified 2026-08-15 (Stage 2)).** LFRA 2024 s.50 inserts CLRA 2002 **s.87A** (no liability for the landlord's costs, general rule) and **s.87B** (tribunal may award the landlord's reasonably incurred NON-litigation costs only where the claim notice is withdrawn or ceases to have effect AND the company acted unreasonably), and **repeals ss.88-89**. All in force 3 Mar 2025, SI 2025/131 reg 2(b). The old "you pay the freeholder's process costs win or lose" warnings are dead law.
- **Prescribed forms: VERIFIED (was verify-at-write; A13 brief, checked 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2010/825).** SI 2010/825 carries "no known outstanding effects", last amended 1 Jul 2013 (tribunal-name changes); the 2010 forms were NOT updated post-LFRA and remain the prescribed forms for s.78/s.79 notices in England.
- **HMRC and trust references: RESOLVED with a correction (A12 brief, verified 2026-08-15 (Stage 2)).** The mutual-trading/flat-management pointer is **BIM24000** (mutual trading contents, https://www.gov.uk/hmrc-internal-manuals/business-income-manual/bim24000) plus **TSEM5710** (flat management companies, s.42 LTA 1987 trusts, https://www.gov.uk/hmrc-internal-manuals/trusts-settlements-and-estates-manual/tsem5710) (corrected at Stage 2b: was "CTM40145 area"; CTM40145 = Community Interest Companies, wrong manual page, never cite it). TSEM5710's own title also settles the LTA 1987 **s.42** trust-money citation: service charge funds are held on s.42 trust.
- **Verify at write (remaining):** Companies House fees and penalty bands (current figures live in the A12 brief, verified 2026-08-15; writer re-verifies the gov.uk fees page at write, fee levels moved recently).
...
- **Do not write:**
  ...
  - "The 35-day counter-notice window" (a SERP/solicitor-content figure with no statutory basis; s.80(6) sets a MINIMUM of ONE MONTH from the claim notice, and pages state one month as law, noting only that claim notices commonly allow a little longer).
...
- **LFRA 2024 Part 4 transparency provisions: VERIFIED NOT COMMENCED (hardened from "as far as verified"; A14 brief, verified 2026-08-15 (Stage 2)).** Part 4 "Regulation of leasehold" = **ss.53-71**; the service-charge transparency block = **ss.53-58** (fixed service charges, notice of future demands, standardised demands, accounts and annual reports, information on request, enforcement). Source: https://www.legislation.gov.uk/ukpga/2024/22/contents. Only three commencement SIs exist: **SI 2024/1018** (ss.114-116 + s.120, building safety, and it does NOT bring any provision of Part 4 into force), **SI 2025/57** (s.27), **SI 2025/131** (ss.49-52 + s.64 only "insofar as it inserts section 20J of the Landlord and Tenant Act 1985 as regards the right to manage", reg 2 verbatim, https://www.legislation.gov.uk/uksi/2025/131/regulation/2/made). Conclusion: **ss.53-58 are NOT IN FORCE as at 15 Aug 2026**, the narrow s.64/s.20J RTM insertion aside; the operative regime remains LTA 1985 ss.18-30 + SI 2003/1987. Safe formulation per §31.9: "LFRA 2024 provides for X, but that provision is not yet in force." Writers re-check the commencement register at write, §31.3a discipline.
...
- **FTT (Property Chamber) fees: VERIFIED (was verify-at-write; A14 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2026/642/schedule/6/made).** From **6 July 2026** (CORRECTED at RUN 2026-08-15: SI 2026/642 art 1(2) verbatim "comes into force on 6th July 2026"; the Stage 2 note's 13 July had no basis in the SI) the fee schedule is replaced by SI 2026/642 art 12 + Sch 6 (substituting Sch 1 to the 2013 Fees Order, SI 2013/1179): an LTA 1985 **s.27A(1) or (3) application = £114 application fee + £227 hearing fee**. Do not use the old £100/£200 figures still on the SERP; the 6 July 2026 change is a freshness signal.
- **PIM references: CORRECTED (A14 brief, verified 2026-08-15 (Stage 2)).** Use **PIM2078** "Costs due to common ownership" (service-charge-type costs; writer verifies the leaf page at write) + **PIM2205** "Rent paid out" (verified live 2026-08-15) (corrected at Stage 2b: was "PIM2068/PIM2100 area"; PIM2100 = expenses for own home, PIM2068 is only the index page).
- **Daejan v Benson: VERIFIED (was verify-at-write; A14 brief, verified 2026-08-15 (Stage 2)).** **Daejan Investments Ltd v Benson [2013] UKSC 14; [2013] 1 WLR 854** (Supreme Court, 6 Mar 2013, 3-2): s.20ZA dispensation turns on prejudice to leaseholders, not the seriousness of the landlord's breach, and can be granted on terms. The £250 non-consultation cap is not a guaranteed windfall.
- **LTA 1987 s.42 trust status: VERIFIED** via TSEM5710 (HMRC's own manual title confirms the s.42 trust basis; detail in §31.C, verified 2026-08-15 (Stage 2)).
...
- **Do not write:**
  ...
  - "LFRA 2024 transparency reforms now require..." (ss.53-58 verified NOT commenced as at 15 Aug 2026, evidence above; writers re-check the register at write, §31.3a discipline).
...
- **The three-state ledger (the lock; most consumer coverage collapses these and keeping them separate IS the page):**
  1. **LAW for NEW leases:** new regulated (qualifying) residential long leases carry peppercorn ground rent only. **Commencement VERIFIED (was verify-at-write; A15 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/uksi/2022/694/contents/made): SI 2022/694 commenced the Act on 30 June 2022** for leases other than retirement-home leases, and **1 April 2023 for retirement-home leases**. Cite SI 2022/694, not secondary sources.
...
- **Enforcement penalties: VERIFIED, and the figures live in s.9, not s.8** (corrected at Stage 2b: was "s.8/enforcement penalty figures"; s.8 = enforcement authorities). A15 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/ukpga/2022/1/section/9/enacted: **s.9 financial penalties, not less than £500 and not more than £30,000 per qualifying breach** of s.3(1), imposed by an enforcement authority satisfied beyond reasonable doubt; plus **s.10 refund orders** (recovery of prohibited rent, verified same date); s.7 automatically converts a prohibited term to a peppercorn. Never attribute the figures to s.8.
- **HA 1988 Sch 1 ground-rent AST trap: CLOSED for leases over 21 years (was verify-at-write; A15 brief, verified 2026-08-15 (Stage 2) at https://www.legislation.gov.uk/ukpga/1988/50/schedule/1, revised text dated 14 Aug 2026).** The historic trap was real: para 3A excludes only tenancies at £250 or less a year (£1,000 or less in Greater London), so a long lease with higher ground rent could technically be an assured (shorthold) tenancy with Ground 8 exposure. **Para 3D, inserted by RRA 2025 s.31 and in the APPLIED text since 27 Dec 2025, excludes fixed-term tenancies exceeding 21 years from assured status regardless of rent level** (para 3E covers a closed 7-to-21-year transitional cohort). Consistent with §20.3 and §20.12. Frame as a correction of record: the trap existed, drove doubling-clause panic and lender caution, and is now closed; writer re-fetches Sch 1 at write per §16.35.
...
## 5.B Disposal date + incidental costs of disposal — TCGA 1992 ss.17/22/28/38 — Wave 12 mini-lock (added 2026-08-21, Stage 1 verified at legislation.gov.uk)

- **s.38(1)(c) + s.38(2), the EXHAUSTIVE selling-costs list** (exhaustiveness per CG15250: "The definition is exhaustive"): fees, commission or remuneration for the professional services of any **surveyor, valuer, auctioneer, accountant, agent or legal adviser**; costs of transfer or conveyance **including stamp duty or SDLT**; **advertising** and **valuation/apportionment costs** are ON THE FACE OF THE STATUTE and direction-specific **[F-171 precision, verified verbatim 2026-08-21]**: s.38(2)(a) advertising to find a SELLER (acquisition side), s.38(2)(b) advertising to find a BUYER plus costs reasonably incurred in making any valuation or apportionment required for the computation (disposal side); cite the section, not the manual. s.38(1)(b) separately allows enhancement expenditure reflected in the state of the asset at disposal AND costs of establishing, preserving or defending title (the §39.A SP2/04 peg). **Removals, mortgage redemption/ERC fees, storage, cleaning and cosmetic pre-sale spend are NOT incidental disposal costs.** That correction is the single most useful line the cost-of-selling cluster can carry.
- **Disposal DATE = exchange, not completion (s.28(1))**: "the time at which the disposal and acquisition is made is the time the contract is made (and not, if different, the time at which the asset is conveyed or transferred)". **s.28(2)**: conditional contract = date the condition is satisfied. At a traditional auction the contract is made on the fall of the hammer.
- **The two-date trap:** the s.28 disposal date (exchange; fixes the tax year) and the **FA 2019 Sch 2 para 3(1)(b)** 60-day reporting trigger (**completion**) are DIFFERENT dates. A late-March exchange with May completion = disposal in the earlier tax year, 60-day clock from completion. **Citation precision: the 60-day figure was substituted by FA 2022 s.23(2)** (the §17.4 attribution to the 27 Oct 2021 announcement is right on timing; cite FA 2022 s.23(2) as the enacting provision).
- **s.17(1) market-value substitution applies only to non-arm's-length bargains**; a genuine discount to an unconnected buyer (auction hammer, developer part-exchange allowance) is NOT re-based to market value.
- **s.22(1)(c)**: capital sums for forfeiture/surrender of rights are a disposal timed at receipt (a forfeited buyer's deposit RECEIVED BY THE SELLER). **[Stage 2 conditional, F-177]: a modern-method retained reservation fee is typically NOT paid to the seller** (iamsold FAQ verbatim: retained fees cover auction/marketing costs and are "not paid to the seller"); s.22(1) requires a capital sum DERIVED BY the owner, so the analysis applies only where the seller actually receives the sum. Write it conditionally.
- **s.38(3):** "Except as provided by section 40, no payment of interest shall be allowable under this section." Mortgage interest and early redemption charges never reduce the gain.
- **VAT on disposal expenses [F-167, CG14300 verified twice 2026-08-21]:** deducted **exclusive of VAT** only where the VAT "is available for set-off in the vendor's VAT account"; where no set-off is available "the expense inclusive of VAT is to be allowed". A private seller therefore deducts the **GROSS** agent fee. The authority is **CG14300**, not CG15250/CG15260 (both silent on VAT); every fee-figure table states inc-VAT figures for private sellers.
- **Letting-agent MANAGEMENT fees are revenue** against rental income (ITTOIA 2005 s.272 applying s.34), never base cost; only the SALE commission is s.38(1)(c) capital. The A6-style page carries both halves.
- **Seller's EPC [08-21 wave-close position, A9-2]:** s.38(2)'s named-professions list does not include a domestic energy assessor, and HMRC nowhere lists the EPC expressly. House position: the seller's EPC may be included in the deductible bucket ONLY via the s.38(2)(b) marketing limb (it is legally required before marketing under SI 2012/3118 reg 6) and ALWAYS with a one-clause hedge ("usually accepted as part of the cost of marketing the property; HMRC's list does not name it"), never as a bare assertion. Applies to every surface carrying the bucket split (Wave 12 pages, cost-of-selling calculator, epc-certificate-cost-uk).
- Do not write: "you can deduct removal costs against the gain"; "all the costs of selling are deductible" (the s.38(2) list is exhaustive); "mortgage interest / ERCs reduce the gain" (s.38(3)); "the 60-day clock runs from exchange"; "auction sales are taxed at completion".

## 1.Q SDLT part-exchange, property-trader and chain-break reliefs — FA 2003 Schedule 6A — Wave 12 mini-lock (added 2026-08-21, Stage 1 verified)

- **Para 1 (house-builder part-exchange):** the builder's acquisition of the old dwelling from an individual is **exempt from charge** where the individual acquires a new dwelling from that builder, occupied the old dwelling as only/main residence within the previous 2 years, intends to occupy the new one as only/main residence, **the two acquisitions are entered into in consideration of each other**, and the land does not exceed the permitted area.
- **Para 2 (property trader, "assisted move")**, **para 3 (property trader acquiring from PERSONAL REPRESENTATIVES, the statutory probate cash-buyer relief, SDLTM21040)** and **para 4 (chain-break)**: parallel reliefs with refurbishment-cap, no-lease/licence and no-principal/employee-occupation conditions. **[Stage 2 correction, F-174: the original lock numbered chain-break as para 3; chain-break is para 4.]** Gateway FA 2003 s.58A; HMRC map SDLTM21000-21070; relief code 28.
- **THE FRAMING RULE: this is the DEVELOPER'S relief, not the seller's.** A consumer part-exchanging pays no SDLT on their disposal in any event. Never write "you get SDLT relief on part-exchange"; the relief is why the offer is economically viable for the builder (a negotiating fact).
- Permitted-area collision **[RESOLVED at Stage 2, 2026-08-21]:** the two tests are **NOT drafted identically**. Same 0.5 hectare baseline, but TCGA 1992 s.222(3) qualifies the extension "as a residence, having regard to the size and character of the dwelling-house"; FA 2003 Sch 6A para 7(3)(b) carries no such qualifier. No page may assert they are the same test.

## 26.14 Sales-agent regulation — EAA 1979 + SI 1991/859 + SI 2008/1712 + DMCCA 2024 — Wave 12 mini-lock (added 2026-08-21, Stage 1 verified)

- **EAA 1979 s.1(1)** defines estate agency work (business, on instructions from a disponor/acquirer, introducing/securing); a private seller of their own home is outside it. **s.1(4)**: pure advertisers/information-disseminators/direct buyer-seller channels are OUTSIDE the Act (the portal boundary; the most drift-prone fact in the cluster). **s.1(2)** excludes practising solicitors in the course of the profession, CCA credit brokerage, distinct survey/valuation contracts.
- **s.18 fee information before contract** (when payable, amount or method, additional payments); **s.18(5)** breach = contract unenforceable by the agent except by court order; **s.18(6)** court may reduce/discharge.
- **SI 1991/859 reg 5 + Schedule**: prescribed explanations of **sole selling rights**, **sole agency**, **ready, willing and able purchaser**; reg 6 prominence.
- **SALES-agent redress = EAA 1979 s.23A + SI 2008/1712 art 2** ("Every person who engages in relevant estate agency work shall be required to be a member of an approved redress scheme"). **DRIFT WATCH: this is a DIFFERENT instrument from SI 2014/2359 (§26.5, LETTINGS agency work). Never cite the 2014 Order for a selling agent.** [08-21 Stage 2, F-166] Approved sales schemes per gov.uk: The Property Ombudsman Limited + Property Redress Scheme (now trading as Property Redress; gov.uk carries the pre-rebrand name). **Non-membership penalty is £1,000 per SI 2008/1713 reg 2 + EAA 1979 s.23B(1), unamended since 2008. gov.uk's own redress page wrongly states "£5,000 and licence revoked" (lettings figures + there is no sales-agent licence); never copy gov.uk's figure here.**
- **DMCCA 2024 Part 4 Ch.1 in force 6 April 2025** (SI 2025/272 reg 2(1)(3)): s.225 prohibition (trader defined s.225(3)), s.226 misleading actions, s.227 misleading omissions, s.230 invitation-to-purchase material information incl. total price (s.230(2)(b); definition s.230(10)).
- **CPUTR 2008 (SI 2008/1277) REVOKED by DMCCA 2024 s.251(1) from 6 April 2025.** TRAP: legislation.gov.uk's SI 2008/1277 contents page still shows "no known outstanding effects"; the revocation is only visible on the DMCCA side. Do not write: "CPUTR 2008 applies" (as current law), "Property Misdescriptions Act 1991" (repealed), "letting agents and estate agents share one redress instrument".
- **[08-21 wave-close addition] Guide-price rules: DMCCA 2024 Sch 20 paras 5 and 7** (banned-practice list; the auction guide-price claims on the Wave 12 pages rest on these, brief-verified at Stage 2).
- **DIY-conveyancing boundary (A3/A4) [caution CLOSED at Stage 2, F-168]:** LSA 2007 s.12(1)(c) + Sch 2 para 5(1)(a) (preparing transfer instruments = reserved), s.13 (authorised/exempt only), **Sch 3 para 3(10)** (individual acting otherwise than for fee/gain/reward = exempt) with its own internal ceiling at **Sch 3 para 3(3)(d)** (no supervisory reach for the unpaid exemption). Practice layer: **HMLR Practice Guide 67** (updated 2 Mar 2026) + gov.uk ID1/ID2 guidance ("Private individuals must complete form ID1"; identity evidence for any party not legally represented; £6,000 low-value carve-out). Note: EAA 1979 s.1(4) is a 2013 substitution; cite the current text.
- **Distance/off-premises contracts (A5):** SI 2013/3134 reg 30 (14-day cancellation for service contracts; most agency agreements are signed in the home = off-premises), reg 31 (extension for information breach), reg 36 (supply in cancellation period; reg 36(2) loss of the right on full performance after express request; reg 36(4) proportionate charge; reg 36(6) nothing payable where the trader failed to give the cancellation information).
- Do not write: "there is a legal cap on estate agent commission" (none exists in England and Wales); commission ranges are market convention and every published range needs a named dated source.

## 26.15 New-build consumer redress is NON-STATUTORY — BSA 2022 ss.136-138 uncommenced — Wave 12 mini-lock (added 2026-08-21, Stage 1 verified)

- **BSA 2022 ss.136-138 (new homes ombudsman scheme) have NEVER been commenced**: "S. 136 not in force at Royal Assent, see s. 170(5)", no commencement SI (verified 2026-08-21). Mirrors the §26.5 landlord-redress pattern: enacted-but-uncommenced chapter next to a live voluntary regime; expect the same drift.
- The live regime is voluntary: **New Homes Quality Board** operating the **New Homes Quality Code** (V2, March 2026, for reservations from 2 March 2026; V1 Oct 2023 before that), redress via the **New Homes Ombudsman Service** for buyers of REGISTERED developers only.
- Do not write: "the New Homes Ombudsman is a statutory scheme"; "all developers must belong"; "BSA 2022 gives new-build buyers a statutory right of redress".
- Stage 2 open item: confirm whether the Consumer Code for Home Builders still operates alongside the NHQB code, and for which developers, before naming either on a page.

## 39.A Probate property selling-process floor — AEA 1925 ss.1-2 — Wave 12 mini-lock (added 2026-08-21, Stage 1 verified)

- **AEA 1925 s.1(1)+(3)**: the deceased's real estate devolves on the personal representatives; the beneficiaries do not own the house.
- **s.2(2), the operative rule that stalls sales:** with more than one PR, **a conveyance of real estate, or a contract for one, requires ALL PRs to concur or a court order**, EXCEPT where probate was granted to only some of the named executors, in which case the proving executor(s) may convey alone. Not written anywhere else on the site; the most common cause of a collapsed probate sale.
- **There is NO statutory pre-grant sale bar.** The constraint is procedural/registrational. Quote gov.uk "Applying for probate" verbatim ("You should not make any financial plans or put property on the market until you've got probate"; "You'll normally have to start paying Inheritance Tax before probate is granted") rather than inventing a statutory prohibition.
- **PRs' cost of establishing title [UPGRADED at Stage 2, 2026-08-21, F-175]:** the **SP2/04 scale is published and live** at gov.uk/government/publications/statement-of-practice-2-2004--2/statement-of-practice-2-2004--4 (published 20 Aug 2004; scale runs 1.8% under £50,000 down to 0.16% capped at £10,000 over £5m; full transcription in the A13 Stage 2 brief). **HMRC's own statutory peg for this expenditure is s.38(1)(b)** (costs of establishing title), NOT s.38(1)(c); cite it that way.
- **PR AEA fork (selling decision made before listing):** PRs get the estate AEA (year of death + two following tax years) at the PR rate; assenting to beneficiaries first gives each beneficiary their own AEA and possibly the 18% band. **Statutory basis PINNED at Stage 2: TCGA 1992 s.1K(7)** (verified verbatim 2026-08-21). PR rate: gov.uk states trustees/PRs pay 24% from 6 April 2026 (citable for 2026/27 only; re-verify each year).
- **[F-176 watch]** Two live pages still cite the REPEALED TCGA 1992 s.3(7) for the PR AEA (Part 1 substituted by FA 2019 Sch 1): `cgt-inherited-rental-property-calculation-uk` (ARMED cgt1 page, back-patch only after its window) and `inheriting-uk-rental-property-executors-step-by-step` (check window before patching). Correct citation is s.1K(7).
