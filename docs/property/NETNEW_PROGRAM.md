...
**Wave 1 + Wave 2 + Wave 3 + Wave 4 are NOT deployed.** User holds deploy pending review of the full 121-page batch.
...
**Program totals (Wave 4 closed):** ~485 total target (~285 net-new + ~231 legacy rebuilds). After Wave 1 (31) + Wave 2 (30) + Wave 3 (30) + Wave 4 (30) = **121 net-new on `main`**. ~164 candidates remain in the user-narrowed pool. Wave 4 discovery surfaced a much larger expanded pool (`docs/property/topic_gaps_delta_2026-05-23.md`, ~1,136 net-new + 817 partial-overlap across 25 named clusters in the 243-domain v2 competitor universe); subsequent waves mine this expanded pool with bucket rotation per the Wave 4 strategy decision.
