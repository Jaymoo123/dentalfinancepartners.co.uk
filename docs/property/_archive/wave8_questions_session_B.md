# Wave 8 Q&A — Session B

**Created:** 2026-05-25.

**§16.15 / §16.37 critical Q&A discipline:** when raising a Q to manager, append HERE via ABSOLUTE PATH from your worktree: `C:/Users/user/Documents/Accounting/docs/property/wave8_questions_session_B.md`. NEVER append to your worktree relative-path copy of this file. Manager polls main path only; questions written to the worktree relative-path copy are NOT seen by the monitor and require manual user-side propagation.
...
For everything else, use flags (`wave8_site_wide_flags.md`) or discovery log (`wave8_discovery_log_session_B.md`). Flags do not block; questions block; discovery logs are FYI.
