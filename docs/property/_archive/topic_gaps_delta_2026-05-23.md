# Property -- topic gaps delta (Wave 4 prep, 2026-05-23)
...
**Net-new candidates (Jaccard < 0.30):** 1136 (excluding `Other` cluster, see JSON for full dump)
**Partial-overlap (Jaccard 0.30-0.55, flagged for manager review):** 817 (excluding `Other`)
...
| `vat-debt-relief-british-telecom-plc-vs-hmrc` | https://www.taxaccountant.co.uk/vat-debt-relief-british-telecom-plc-vs-hmrc/ | 0.11 | 0.11 | tokens: british, debt, hmrc, plc, relief, telecom |
| `online-agent-authorisation-hmrc-stops-service-for-vat-clients` | https://www.ukpropertyaccountants.co.uk/online-agent-authorisation-hmrc-stops-service-f... | 0.1 | 0.14 | tokens: agent, authorisation, clients, for, hmrc, online |
...
| `solicitor-client-account-interest-and-hidden-vat-issues` | https://www.geraldedelman.com/insights/solicitor-client-account-interest-and-hidden-vat... | 0.11 | 0.14 | tokens: account, and, client, hidden, interest, issues |
| `ubers-1-3bn-vat-victory-travel-tax-rules-now-apply-to-ride-apps` | https://www.ukpropertyaccountants.co.uk/ubers-1-3bn-vat-victory-travel-tax-rules-now-ap... | 0.14 | 0.12 | tokens: 1, 3bn, apply, apps, now, ride |
| `court-of-appeal-sides-with-hmrc-in-75k-vat-dispute` | https://www.ukpropertyaccountants.co.uk/court-of-appeal-sides-with-hmrc-in-75k-vat-disp... | 0.13 | 0.15 | tokens: 75k, appeal, court, dispute, hmrc, in |
...
| `vat-threshold-vehicle-leasing-companies-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-vehicle-leasing-companies-uk | 0.15 | 0.14 | tokens: companies, leasing, threshold, uk, vat, vehicle |
| `hmrc-updates-a-new-vat-penalty-regime-changing-policy-for-museums-and-galleries-and-new-legislation-to-energy-support-schemes` | https://hwfisher.co.uk/hmrc-updates-a-new-vat-penalty-regime-changing-policy-for-museum... | 0.1 | 0.16 | tokens: a, and, changing, energy, for, galleries |
| `the-isle-of-wight-nhs-trust-locum-doctors-vat-case-what-it-means-for-gp-practices` | https://bhp.co.uk/news-events/blog/the-isle-of-wight-nhs-trust-locum-doctors-vat-case-w... | 0.09 | 0.16 | tokens: case, doctors, for, gp, isle, it |
| `ai-companies-zero-rate-vat-supplies` | https://www.business-accounting.co.uk/blog/ai-companies-zero-rate-vat-supplies | 0.14 | 0.17 | tokens: ai, companies, rate, supplies, vat, zero |
...
| `tech-companies-zero-rate-vat-supplies` | https://www.business-accounting.co.uk/blog/tech-companies-zero-rate-vat-supplies | 0.14 | 0.17 | tokens: companies, rate, supplies, tech, vat, zero |
| `vat-and-fundraising-some-good-news` | https://bhp.co.uk/news-events/charity/vat-and-fundraising-some-good-news/ | 0.14 | 0.17 | tokens: and, fundraising, good, news, some, vat |
| `vat-threshold-amazon-sellers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-amazon-sellers-uk | 0.17 | 0.17 | tokens: amazon, sellers, threshold, uk, vat |
| `vat-threshold-beauty-salons-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-beauty-salons-uk | 0.17 | 0.17 | tokens: beauty, salons, threshold, uk, vat |
| `vat-threshold-bed-breakfasts-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-bed-breakfasts-uk | 0.17 | 0.17 | tokens: bed, breakfasts, threshold, uk, vat |
| `vat-threshold-childcare-providers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-childcare-providers-uk | 0.17 | 0.17 | tokens: childcare, providers, threshold, uk, vat |
| `vat-threshold-cleaning-companies-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-cleaning-companies-uk | 0.17 | 0.17 | tokens: cleaning, companies, threshold, uk, vat |
| `vat-threshold-cosmetics-brands-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-cosmetics-brands-uk | 0.17 | 0.17 | tokens: brands, cosmetics, threshold, uk, vat |
| `vat-threshold-dog-groomers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-dog-groomers-uk | 0.17 | 0.17 | tokens: dog, groomers, threshold, uk, vat |
| `vat-threshold-ebay-sellers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-ebay-sellers-uk | 0.17 | 0.17 | tokens: ebay, sellers, threshold, uk, vat |
| `vat-threshold-estate-agents-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-estate-agents-uk | 0.17 | 0.17 | tokens: agents, estate, threshold, uk, vat |
| `vat-threshold-fashion-retailers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-fashion-retailers-uk | 0.17 | 0.17 | tokens: fashion, retailers, threshold, uk, vat |
| `vat-threshold-food-retailers-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-food-retailers-uk | 0.17 | 0.17 | tokens: food, retailers, threshold, uk, vat |
| `vat-threshold-furniture-shops-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-furniture-shops-uk | 0.17 | 0.17 | tokens: furniture, shops, threshold, uk, vat |
| `vat-threshold-gift-shops-uk` | https://www.business-accounting.co.uk/blog/vat-threshold-gift-shops-uk | 0.17 | 0.17 | tokens: gift, shops, threshold, uk, vat |
| *(+266 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `when-do-i-owe-cgt-if-i-sell-my-house` | https://taxfix.com/en-uk/landlord-tax-returns/when-do-i-owe-cgt-if-i-sell-my-house/ | 0.13 | 0.14 | tokens: cgt, do, house, i, if, my |
...
| `secure-hmrc-advance-approval-and-avoid-costly-tax-surprises` | https://www.taxaccountant.co.uk/secure-hmrc-advance-approval-and-avoid-costly-tax-surpr... | 0.14 | 0.17 | tokens: advance, and, approval, avoid, costly, hmrc |
...
| `cgt-and-foreign-exchange-fluctuations` | https://www.taxaccountant.co.uk/cgt-and-foreign-exchange-fluctuations/ | 0.12 | 0.2 | tokens: and, cgt, exchange, fluctuations, foreign |
...
| `cgt-return-60-days` | https://www.ukpropertyaccountants.co.uk/cgt-return-60-days/ | 0.22 | 0.2 | tokens: 60, cgt, days, return |
...
| `potential-uk-property-tax-overhaul-navigating-uncertainty-as-the-budget-approaches` | https://hwfisher.co.uk/potential-uk-property-tax-overhaul-navigating-uncertainty-as-the... | 0.23 | 0.2 | tokens: approaches, as, budget, navigating, overhaul, potential |
| `why-banking-your-capital-gains-could-save-you-tax-act-now` | https://www.shipleystax.com/2023/01/why-banking-your-capital-gains-could-save-you-tax-a... | 0.23 | 0.2 | tokens: act, banking, capital, could, gains, now |
| *(+32 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `list-of-mtd-benefits-beyond-just-hmrc-compliance` | https://www.ukpropertyaccountants.co.uk/list-of-mtd-benefits-beyond-just-hmrc-compliance/ | 0.13 | 0.15 | tokens: benefits, beyond, compliance, hmrc, just, list |
| `mtd-and-office-rentals-how-businesses-must-comply` | https://rentalbux.com/blogs/mtd-and-office-rentals-how-businesses-must-comply | 0.14 | 0.15 | tokens: and, businesses, comply, how, mtd, must |
...
| `mtd-digital-readiness-agent-services-accounts-tips-agents` | https://ciot-att.lndo.site/mtd-digital-readiness-agent-services-accounts-tips-agents | 0.17 | 0.14 | tokens: accounts, agent, agents, digital, mtd, readiness |
...
| `agent-and-business-access-digital-mtd-vat-services` | https://ciot-att.lndo.site/agent-and-business-access-digital-mtd-vat-services | 0.18 | 0.15 | tokens: access, agent, and, business, digital, mtd |
| `mtd-for-joint-owners-how-separate-filings-work` | https://rentalbux.com/guides/mtd-for-joint-owners-how-separate-filings-work | 0.18 | 0.17 | tokens: filings, for, how, joint, mtd, owners |
...
| `250000-sign-up-for-mtd-but-most-landlords-still-arent-ready` | https://www.ukpropertyaccountants.co.uk/250000-sign-up-for-mtd-but-most-landlords-still... | 0.14 | 0.2 | tokens: 250000, arent, but, for, landlords, most |
...
| `mtd-compatible-software-that-supports-foreign-income` | https://rentalbux.com/blogs/mtd-compatible-software-that-supports-foreign-income | 0.2 | 0.18 | tokens: compatible, foreign, income, mtd, software, supports |
| `understanding-rentalbux-your-complete-landlord-software-mtd` | https://rentalbux.com/guides/understanding-rentalbux-your-complete-landlord-software-mtd | 0.2 | 0.18 | tokens: complete, landlord, mtd, rentalbux, software, understanding |
...
| `top-5-mtd-questions-every-landlord-has-answered` | https://rentalbux.com/blogs/top-5-mtd-questions-every-landlord-has-answered | 0.14 | 0.21 | tokens: 5, answered, every, has, landlord, mtd |
...
| `mtd-and-vat-integration` | https://www.mytaxaccountant.co.uk/post/mtd-and-vat-integration | 0.2 | 0.22 | tokens: and, integration, mtd, vat |
...
| `mtd-for-construction-workers-cis-subcontractor-guide` | https://rentalbux.com/blogs/mtd-for-construction-workers-cis-subcontractor-guide | 0.17 | 0.22 | tokens: cis, construction, for, guide, mtd, subcontractor |
...
| `mtd-what-are-digital-links` | https://bhp.co.uk/news-events/blog/mtd-what-are-digital-links/ | 0.22 | 0.22 | tokens: are, digital, links, mtd, what |
...
### LtdCo_Incorporation (112 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `tenants-tales-fictitious-characters-legal-aspects-leasehold` | https://www.boltburdon.co.uk/blogs/tenants-tales-fictitious-characters-legal-aspects-le... | 0.08 | 0.09 | tokens: aspects, characters, fictitious, leasehold, legal, tales |
...
| `tenant-survey-energy-efficiency` | https://www.nrla.org.uk/research/deep-insight/tenant-survey-energy-efficiency | 0.1 | 0.14 | tokens: efficiency, energy, survey, tenant |
...
| `persons-with-significant-control-how-the-new-rules-on-corporate-transparency-will-affect-your-company` | https://www.boltburdon.co.uk/blogs/persons-with-significant-control-how-the-new-rules-o... | 0.11 | 0.15 | tokens: affect, company, control, corporate, how, new |
| `were-expanding-our-rd-tax-reliefs-support-new-office-sheffield` | https://www.djh.co.uk/latest-news/news-insights/were-expanding-our-rd-tax-reliefs-suppo... | 0.13 | 0.15 | tokens: expanding, new, office, our, rd, reliefs |
| `hmrc-v-bluecrest-capital-management-uk-llp-court-of-appeal-rules-on-significant-influence-for-llp-members` | https://hwfisher.co.uk/hmrc-v-bluecrest-capital-management-uk-llp-court-of-appeal-rules... | 0.11 | 0.16 | tokens: appeal, bluecrest, capital, court, for, hmrc |
| `hands-off-retirement-income-and-family-legacy-fic` | https://www.tlpi.co.uk/case-studies/hands-off-retirement-income-and-family-legacy-fic | 0.17 | 0.17 | tokens: and, family, fic, hands, income, legacy |
...
| `should-i-change-my-btl-limited-company-year-end` | https://uklandlordtax.co.uk/should-i-change-my-btl-limited-company-year-end/ | 0.15 | 0.17 | tokens: btl, change, company, end, i, limited |
...
| `fic-for-income-returns-and-protected-legacy` | https://www.tlpi.co.uk/case-studies/fic-for-income-returns-and-protected-legacy | 0.18 | 0.18 | tokens: and, fic, for, income, legacy, protected |
...
| `protecting-a-late-husbands-property-legacy-with-a-fic` | https://www.tlpi.co.uk/case-studies/protecting-a-late-husbands-property-legacy-with-a-fic | 0.17 | 0.18 | tokens: a, fic, husbands, late, legacy, property |
...
| `trust-gains-court-rules-on-badr-for-beneficiaries-with-interests` | https://www.taxaccountant.co.uk/trust-gains-court-rules-on-badr-for-beneficiaries-with-... | 0.08 | 0.18 | tokens: badr, beneficiaries, court, for, gains, interests |
...
| `is-company-incorporation-of-your-dental-practice-the-right-financial-choice` | https://www.djh.co.uk/latest-news/specialisms/is-company-incorporation-of-your-dental-p... | 0.12 | 0.19 | tokens: choice, company, dental, financial, incorporation, is |
...
| *(+82 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |

### IHT (92 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `att-budget-representation-iht-reliefs-shares-which-have-lost-value-0` | https://ciot-att.lndo.site/technical/submissions/att-budget-representation-iht-reliefs-... | 0.07 | 0.11 | tokens: 0, att, budget, have, iht, lost |
| `att-budget-representation-iht-reliefs-shares-which-have-lost-value` | https://ciot-att.lndo.site/technical/submissions/att-budget-representation-iht-reliefs-... | 0.07 | 0.12 | tokens: att, budget, have, iht, lost, reliefs |
...
| `inheritance-tax-on-inherited-pensions-planning-today-can-avoid-future-tax-charges` | https://hwfisher.co.uk/inheritance-tax-on-inherited-pensions-planning-today-can-avoid-f... | 0.13 | 0.14 | tokens: avoid, can, charges, future, inheritance, inherited |
| `farm-inheritance-tax-how-many-farms-will-be-affected` | https://www.ukpropertyaccountants.co.uk/farm-inheritance-tax-how-many-farms-will-be-aff... | 0.15 | 0.17 | tokens: affected, be, farm, farms, how, inheritance |
...
| `iht-changes-draft-legislation` | https://www.rpgcrouchchapman.co.uk/resources/blog/iht-changes-draft-legislation/ | 0.12 | 0.17 | tokens: changes, draft, iht, legislation |
...
| `inheritance-tax-mitigation-under-10-year-tailing-rule` | https://www.mytaxaccountant.co.uk/post/inheritance-tax-mitigation-under-10-year-tailing... | 0.17 | 0.18 | tokens: 10, inheritance, mitigation, rule, tailing, tax |
...
| `inheritance-tax-receipts-up-1bn-on-previous-tax-year-your-top-10-questions-answered` | https://hwfisher.co.uk/inheritance-tax-receipts-up-1bn-on-previous-tax-year-your-top-10... | 0.12 | 0.18 | tokens: 10, 1bn, answered, inheritance, on, previous |
...
| `can-i-give-money-to-my-children-without-paying-inheritance-tax` | https://www.towerstone.co.uk/can-i-give-money-to-my-children-without-paying-inheritance... | 0.13 | 0.2 | tokens: can, children, give, i, inheritance, money |
...
| `charity-begins-at-home-how-including-a-charitable-gift-in-your-will-can-reduce-inheritance-tax` | https://www.boltburdon.co.uk/blogs/charity-begins-at-home-how-including-a-charitable-gi... | 0.11 | 0.2 | tokens: a, at, begins, can, charitable, charity |
...
| `how-farmers-can-avoid-high-inheritance-tax` | https://www.taxaccountant.co.uk/how-farmers-can-avoid-high-inheritance-tax/ | 0.18 | 0.2 | tokens: avoid, can, farmers, high, how, inheritance |
...
| `reclaiming-inheritance-tax-after-stock-market-crashes` | https://www.taxaccountant.co.uk/reclaiming-inheritance-tax-after-stock-market-crashes/ | 0.18 | 0.2 | tokens: after, crashes, inheritance, market, reclaiming, stock |
...
| `5-ways-a-financial-adviser-can-help-build-your-inheritance-tax-strategy` | https://www.rpgcrouchchapman.co.uk/resources/blog/5-ways-a-financial-adviser-can-help-b... | 0.12 | 0.21 | tokens: 5, a, adviser, build, can, financial |
...
| `a-t-p-avoid-the-pitfall-i-want-to-transfer-my-house-to-my-children-to-avoid-inheritance-tax` | https://www.boltburdon.co.uk/blogs/a-t-p-avoid-the-pitfall-i-want-to-transfer-my-house-... | 0.11 | 0.22 | tokens: a, avoid, children, house, i, inheritance |
| `deed-of-variation-inheritance-tax-1` | https://www.mytaxaccountant.co.uk/post/deed-of-variation-inheritance-tax-1 | 0.2 | 0.22 | tokens: 1, deed, inheritance, of, tax, variation |
| `do-pensions-count-towards-inheritance-tax` | https://www.towerstone.co.uk/do-pensions-count-towards-inheritance-tax | 0.2 | 0.22 | tokens: count, do, inheritance, pensions, tax, towards |
...
| *(+62 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |

### SDLT (87 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `mdr-application-in-properties-with-unique-features-nicholas-rowe-v-hmrc-case` | https://www.ukpropertyaccountants.co.uk/mdr-application-in-properties-with-unique-featu... | 0.07 | 0.11 | tokens: application, case, features, hmrc, in, mdr |
| `scottish-lbtt-consultation-changes-additional-dwelling-supplement` | https://ciot-att.lndo.site/technical/submissions/scottish-lbtt-consultation-changes-add... | 0.09 | 0.11 | tokens: additional, changes, consultation, dwelling, lbtt, scottish |
...
| `i-own-our-current-home-my-wife-has-never-owned-a-property-can-we-get-a-first-time-buyer-mortgage-6995` | https://www.charcol.co.uk/ask-the-mortgage-experts/i-own-our-current-home-my-wife-has-n... | 0.08 | 0.14 | tokens: 6995, a, buyer, can, current, first |
| `understanding-sdlt-when-buying-a-home-with-your-partner` | https://www.ukpropertyaccountants.co.uk/understanding-sdlt-when-buying-a-home-with-your... | 0.08 | 0.14 | tokens: a, buying, home, partner, sdlt, understanding |
| `navigating-sdlt-reliefs-proceed-with-caution` | https://www.property-tax-advice.co.uk/knowledge-centre/navigating-sdlt-reliefs-proceed-... | 0.11 | 0.15 | tokens: caution, navigating, proceed, reliefs, sdlt, with |
...
| `possible-property-tax-shake-up-stamp-duty-could-be-on-the-way-out` | https://www.ukpropertyaccountants.co.uk/possible-property-tax-shake-up-stamp-duty-could... | 0.13 | 0.17 | tokens: be, could, duty, on, out, possible |
...
| `bowen-v-hmrc-applying-the-multi-factorial-test-in-sdlt-for-residential-property` | https://www.ukpropertyaccountants.co.uk/bowen-v-hmrc-applying-the-multi-factorial-test-... | 0.12 | 0.18 | tokens: applying, bowen, factorial, for, hmrc, in |
| `less-than-a-year-until-higher-stamp-duty-comes-knocking-at-your-door` | https://hwfisher.co.uk/less-than-a-year-until-higher-stamp-duty-comes-knocking-at-your-... | 0.12 | 0.18 | tokens: a, at, comes, door, duty, higher |
...
| `woodland-as-residential-property-for-sdlt-mihalakis-michael-v-hmrc` | https://www.ukpropertyaccountants.co.uk/woodland-as-residential-property-for-sdlt-mihal... | 0.15 | 0.18 | tokens: as, for, hmrc, michael, mihalakis, property |
| `angela-rayners-stamp-duty-scandal-how-underpayment-sparks-political-firestorm` | https://www.ukpropertyaccountants.co.uk/angela-rayners-stamp-duty-scandal-how-underpaym... | 0.15 | 0.19 | tokens: angela, duty, firestorm, how, political, rayners |
| `ive-inherited-a-property-could-i-raise-a-first-time-buyer-mortgage-on-it-9149` | https://www.charcol.co.uk/ask-the-mortgage-experts/ive-inherited-a-property-could-i-rai... | 0.12 | 0.19 | tokens: 9149, a, buyer, could, first, i |
| `brzezicki-v-hmrc-sdlt-carrier-stream-in-commercial-vs-residential` | https://www.ukpropertyaccountants.co.uk/brzezicki-v-hmrc-sdlt-carrier-stream-in-commerc... | 0.15 | 0.2 | tokens: brzezicki, carrier, commercial, hmrc, in, residential |
...
| `how-are-uk-homebuyers-missing-out-on-thousands-in-stamp-duty-refunds` | https://www.ukpropertyaccountants.co.uk/how-are-uk-homebuyers-missing-out-on-thousands-... | 0.13 | 0.2 | tokens: are, duty, homebuyers, how, in, missing |
...
| *(+57 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |

### Mortgage_BTL (75 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `can-i-remortgage-within-6-months-of-purchase-4910` | https://www.charcol.co.uk/ask-the-mortgage-experts/can-i-remortgage-within-6-months-of-... | 0.07 | 0.12 | tokens: 4910, 6, can, i, months, of |
| `im-buying-a-house-with-my-mother-can-we-get-a-mortgage-10601` | https://www.charcol.co.uk/ask-the-mortgage-experts/im-buying-a-house-with-my-mother-can... | 0.08 | 0.12 | tokens: 10601, a, buying, can, get, house |
...
| `can-i-take-my-brother-and-sister-in-law-off-the-mortgage-so-i-dont-have-to-sell-6266` | https://www.charcol.co.uk/ask-the-mortgage-experts/can-i-take-my-brother-and-sister-in-... | 0.09 | 0.14 | tokens: 6266, and, brother, can, dont, have |
...
| `we-live-in-tied-accommodation-but-have-a-flat-with-a-repayment-mortgage-for-when-we-retire-do-we-pay-tax-on-the-rental-income-received-9040` | https://www.charcol.co.uk/ask-the-mortgage-experts/we-live-in-tied-accommodation-but-ha... | 0.12 | 0.15 | tokens: 9040, a, accommodation, but, do, flat |
...
| `can-i-sell-part-of-my-land-if-i-have-a-mortgage-5948` | https://www.charcol.co.uk/ask-the-mortgage-experts/can-i-sell-part-of-my-land-if-i-have... | 0.08 | 0.17 | tokens: 5948, a, can, have, i, if |
...
| `can-i-sell-a-house-with-a-mortgage` | https://www.towerstone.co.uk/can-i-sell-a-house-with-a-mortgage | 0.12 | 0.18 | tokens: a, can, house, i, mortgage, sell |
| `mortgage-product-transfer-vs-remortgaging` | https://www.charcol.co.uk/mortgages/best-buys/remortgage/mortgage-product-transfer-vs-r... | 0.17 | 0.18 | tokens: mortgage, product, remortgaging, transfer, vs |
...
| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `ir35-would-batman-pass-or-fail-the-business-entity-test` | https://www.qaccounting.com/ir35-would-batman-pass-or-fail-the-business-entity-test/ | 0.07 | 0.08 | tokens: batman, business, entity, fail, ir35, or |
| `ir35-tip-compile-your-evidence` | https://www.qaccounting.com/ir35-tip-compile-your-evidence/ | 0.0 | 0.09 | tokens: compile, evidence, ir35, tip, your |
| `ir35-enquiry-carried` | https://www.qaccounting.com/ir35-enquiry-carried/ | 0.0 | 0.1 | tokens: carried, enquiry, ir35 |
| `ir35-increasing-enquiries` | https://www.qaccounting.com/ir35-increasing-enquiries/ | 0.0 | 0.1 | tokens: enquiries, increasing, ir35 |
| `ir35-look-contract` | https://www.qaccounting.com/ir35-look-contract/ | 0.0 | 0.1 | tokens: contract, ir35, look |
| `ir35-reform-challenges-public-sector-contractors` | https://gorillaaccounting.com/blog/ir35-reform-challenges-public-sector-contractors/ | 0.08 | 0.1 | tokens: challenges, contractors, ir35, public, reform, sector |
| `eamonn-holmes-in-hmrc-ir35-dispute` | https://gorillaaccounting.com/blog/eamonn-holmes-in-hmrc-ir35-dispute/ | 0.1 | 0.11 | tokens: dispute, eamonn, hmrc, holmes, in, ir35 |
...
| `ir35-public-sector-reform-contractors` | https://gorillaaccounting.com/blog/ir35-public-sector-reform-contractors/ | 0.08 | 0.11 | tokens: contractors, ir35, public, reform, sector |
| `s-l-barnes-ltd-v-hmrc-ir35-case-law` | https://www.taxaccountant.co.uk/s-l-barnes-ltd-v-hmrc-ir35-case-law/ | 0.07 | 0.11 | tokens: barnes, case, hmrc, ir35, l, law |
...
| `how-will-ir35-changes-affect-me` | https://taxfix.com/en-uk/tax-changes/ir35/how-will-ir35-changes-affect-me/ | 0.11 | 0.12 | tokens: affect, changes, how, ir35, me, will |
...
| `ir35-clients-and-recruiters-must-act` | https://www.qaccounting.com/ir35-clients-and-recruiters-must-act/ | 0.09 | 0.12 | tokens: act, and, clients, ir35, must, recruiters |
| `ir35-enquiries-risk` | https://www.qaccounting.com/ir35-enquiries-risk/ | 0.0 | 0.12 | tokens: enquiries, ir35, risk |
| `ir35-independent-contractors-and-small-businesses` | https://www.taxaccountant.co.uk/ir35-independent-contractors-and-small-businesses/ | 0.09 | 0.12 | tokens: and, businesses, contractors, independent, ir35, small |
| `ir35-reform-plans-revealed` | https://www.qaccounting.com/ir35-reform-plans-revealed/ | 0.09 | 0.12 | tokens: ir35, plans, reform, revealed |
...
| `ir35-compliance-review-img` | https://www.taxpartnersuk.com/contractor-accountants/ir35-compliance-review-img/ | 0.11 | 0.14 | tokens: compliance, img, ir35, review |
...
| `ir35-government-ups-ante-contractors-working-public-sector` | https://hwfisher.co.uk/ir35-government-ups-ante-contractors-working-public-sector/ | 0.0 | 0.14 | tokens: ante, contractors, government, ir35, public, sector |
...
| `reporting-overseas-income-under-fig-regime` | https://www.mytaxaccountant.co.uk/post/reporting-overseas-income-under-fig-regime | 0.15 | 0.12 | tokens: fig, income, overseas, regime, reporting, under |
...
| `overseas-income-may-be-taxable-why-hmrcs-nudge-letters-and-disclosure-facility-matter` | https://www.ukpropertyaccountants.co.uk/overseas-income-may-be-taxable-why-hmrcs-nudge-... | 0.11 | 0.17 | tokens: and, be, disclosure, facility, hmrcs, income |
...
| `hmrc-overseas-bank-accounts-reporting-and-tax-implications` | https://www.ukpropertyaccountants.co.uk/hmrc-overseas-bank-accounts-reporting-and-tax-i... | 0.17 | 0.18 | tokens: accounts, and, bank, hmrc, implications, overseas |
...
| `rd-tax-reliefs-new-contracting-out-rules-and-overseas-restrictions-draft` | https://ciot-att.lndo.site/technical/submissions/rd-tax-reliefs-new-contracting-out-rul... | 0.13 | 0.19 | tokens: and, contracting, draft, new, out, overseas |
...
| `hmrc-overseas-bank-accounts` | https://www.ukpropertyaccountants.co.uk/category/hmrc-overseas-bank-accounts/ | 0.11 | 0.2 | tokens: accounts, bank, hmrc, overseas |
| `overseas-workday-relief` | https://www.mytaxaccountant.co.uk/post/overseas-workday-relief | 0.17 | 0.2 | tokens: overseas, relief, workday |
| `overseas-workday-relief-the-new-regime` | https://hwfisher.co.uk/overseas-workday-relief-the-new-regime/ | 0.11 | 0.2 | tokens: new, overseas, regime, relief, the, workday |
...
| `overseas-workday-relief-still-a-perk-for-global-talent` | https://www.geraldedelman.com/insights/overseas-workday-relief-still-a-perk-for-global-... | 0.14 | 0.21 | tokens: a, for, global, overseas, perk, relief |
...
| `why-the-uk-leads-the-investment-table-for-overseas-companies` | https://hwfisher.co.uk/why-the-uk-leads-the-investment-table-for-overseas-companies/ | 0.18 | 0.23 | tokens: companies, for, investment, leads, overseas, table |
| `can-i-transfer-an-overseas-pension-to-the-uk` | https://taxfix.com/en-uk/the-tax-basics/can-i-transfer-an-overseas-pension-to-the-uk/ | 0.21 | 0.25 | tokens: an, can, i, overseas, pension, the |
| `disclosure-of-overseas-income-or-gains` | https://www.rpgcrouchchapman.co.uk/resources/blog/disclosure-of-overseas-income-or-gains/ | 0.11 | 0.25 | tokens: disclosure, gains, income, of, or, overseas |
...
| `thinking-about-diversifying-into-holiday-lets` | https://www.alanboswell.com/resources/thinking-about-diversifying-into-holiday-lets/ | 0.09 | 0.1 | tokens: about, diversifying, holiday, into, lets, thinking |
...
| `epc-requirements-in-holiday-lets` | https://www.alanboswell.com/resources/epc-requirements-in-holiday-lets/ | 0.11 | 0.12 | tokens: epc, holiday, in, lets, requirements |
...
| `7-reasons-landlords-are-switching-to-holiday-lets` | https://taxfix.com/en-uk/blog/7-reasons-landlords-are-switching-to-holiday-lets/ | 0.14 | 0.15 | tokens: 7, are, holiday, landlords, lets, reasons |
...
| `holiday-lets-switch-accountants` | https://www.business-accounting.co.uk/blog/holiday-lets-switch-accountants | 0.11 | 0.17 | tokens: accountants, holiday, lets, switch |
...
| `legal-requirements-for-holiday-lets` | https://www.alanboswell.com/resources/legal-requirements-for-holiday-lets/ | 0.11 | 0.18 | tokens: for, holiday, legal, lets, requirements |
...
| `unlock-fhl-tax-savings-before-this-key-deadline` | https://www.taxaccountant.co.uk/unlock-fhl-tax-savings-before-this-key-deadline/ | 0.18 | 0.19 | tokens: before, deadline, fhl, key, savings, tax |
...
| `holiday-let-market-sees-dwindling-bookings-amidst-market-shifts` | https://www.ukpropertyaccountants.co.uk/holiday-let-market-sees-dwindling-bookings-amid... | 0.17 | 0.23 | tokens: amidst, bookings, dwindling, holiday, let, market |
...
| `the-importance-of-capital-allowances-in-the-hospitality-industry` | https://www.djh.co.uk/latest-news/client-stories/the-importance-of-capital-allowances-i... | 0.22 | 0.25 | tokens: allowances, capital, hospitality, importance, in, industry |
...
| `update-changes-requirements-relating-tenancy-deposit-schemes-assured-shorthold-tenancies` | https://www.boltburdon.co.uk/blogs/update-changes-requirements-relating-tenancy-deposit... | 0.13 | 0.14 | tokens: assured, changes, deposit, relating, requirements, schemes |
...
| `the-end-of-no-fault-evictions-inches-closer-but-landlords-tenants-are-still-waiting` | https://www.ukpropertyaccountants.co.uk/the-end-of-no-fault-evictions-inches-closer-but... | 0.11 | 0.17 | tokens: are, but, closer, end, evictions, fault |
...
| `renters-rights-act-new-government-guidelines-on-what-tenancy-agreements-must-include` | https://www.ukpropertyaccountants.co.uk/renters-rights-act-new-government-guidelines-on... | 0.19 | 0.24 | tokens: act, agreements, government, guidelines, include, must |
| `the-end-of-no-fault-evictions-and-what-it-means-for-landlords` | https://www.alanboswell.com/resources/the-end-of-no-fault-evictions-and-what-it-means-f... | 0.12 | 0.24 | tokens: and, end, evictions, fault, for, it |
| `renters-rights-act-impact-on-rental-property-held-in-trusts-and-estates` | https://www.boltburdon.co.uk/blogs/renters-rights-act-impact-on-rental-property-held-in... | 0.19 | 0.25 | tokens: act, and, estates, held, impact, in |
...
| `update-landlords-agents-tenancy-deposit-protection-schemes` | https://www.boltburdon.co.uk/blogs/update-landlords-agents-tenancy-deposit-protection-s... | 0.1 | 0.27 | tokens: agents, deposit, landlords, protection, schemes, tenancy |
...
| `inaccurate-self-assessment-tax-returns-leaves-property-owner-with-100k-penalties` | https://www.ukpropertyaccountants.co.uk/inaccurate-self-assessment-tax-returns-leaves-p... | 0.21 | 0.27 | tokens: 100k, assessment, inaccurate, leaves, owner, penalties |
| `hmrc-notifies-wealthy-taxpayers-to-submit-self-assessment-tax-returns` | https://www.ukpropertyaccountants.co.uk/hmrc-notifies-wealthy-taxpayers-to-submit-self-... | 0.23 | 0.29 | tokens: assessment, hmrc, notifies, returns, self, submit |
...
| `draft-guidance-research-and-development-rd-tax-reliefs` | https://ciot-att.lndo.site/technical/submissions/draft-guidance-research-and-developmen... | 0.15 | 0.18 | tokens: and, development, draft, guidance, rd, reliefs |
| `how-will-research-and-development-tax-relief-be-affected-by-the-upcoming-finance-bill` | https://bhp.co.uk/news-events/blog/how-will-research-and-development-tax-relief-be-affe... | 0.15 | 0.18 | tokens: affected, and, be, bill, by, development |
| `rd-tax-reliefs-for-innovative-software-development-businesses` | https://www.djh.co.uk/latest-news/news-insights/rd-tax-reliefs-for-innovative-software-... | 0.15 | 0.18 | tokens: businesses, development, for, innovative, rd, reliefs |
...
| `stability-in-research-and-development-rd-tax-reliefs-following-the-budget-speech` | https://bhp.co.uk/news-events/blog/stability-in-research-and-development-rd-tax-reliefs... | 0.13 | 0.2 | tokens: and, budget, development, following, in, rd |
...
| `research-and-development-rd-tax-relief` | https://www.taxaccountant.co.uk/research-and-development-rd-tax-relief/ | 0.22 | 0.27 | tokens: and, development, rd, relief, research, tax |
...
| `hmrc-ated-online-service-explained` | https://www.ukpropertyaccountants.co.uk/hmrc-ated-online-service-explained/ | 0.11 | 0.17 | tokens: ated, explained, hmrc, online, service |
...
| `hmrc-defeated-recent-ir35-case` | https://www.qaccounting.com/hmrc-defeated-recent-ir35-case/ | 0.1 | 0.17 | tokens: case, defeated, hmrc, ir35, recent |
...
| `the-uk-real-estate-market-and-its-related-taxes` | https://www.ukpropertyaccountants.co.uk/the-uk-real-estate-market-and-its-related-taxes/ | 0.14 | 0.21 | tokens: and, estate, its, market, real, related |
...
| `buying-luxury-property-in-the-uk-through-the-company-understand-ated-and-the-tax-costs` | https://www.ukpropertyaccountants.co.uk/buying-luxury-property-in-the-uk-through-the-co... | 0.21 | 0.24 | tokens: and, ated, buying, company, costs, in |
| `residential-property-in-a-company-beware-the-ated-tax-rules%ef%bf%bc` | https://www.shipleystax.com/2022/05/residential-property-in-a-company-beware-the-ated-t... | 0.21 | 0.24 | tokens: a, ated, bc, beware, bf, company |
...
| `from-snails-to-tax-scales-do-not-underestimated-the-voas-role-in-inheritance-tax` | https://www.boltburdon.co.uk/blogs/from-snails-to-tax-scales-do-not-underestimated-the-... | 0.16 | 0.25 | tokens: do, from, in, inheritance, not, role |
...
| `uk-tax-compliance-to-get-more-complicated-for-some-non-resident-companies` | https://www.landlordstax.co.uk/uk-tax-compliance-to-get-more-complicated-for-some-non-r... | 0.19 | 0.29 | tokens: companies, compliance, complicated, for, get, more |

### Trusts_Estates (24 candidates)
...
| `beis-consultation-restoring-trust-audit-and-corporate-governance` | https://ciot-att.lndo.site/technical/submissions/beis-consultation-restoring-trust-audi... | 0.08 | 0.12 | tokens: and, audit, beis, consultation, corporate, governance |
| `high-court-trust-dispute-over-dna-involving-14-5-million-estate` | https://www.boltburdon.co.uk/blogs/high-court-trust-dispute-over-dna-involving-14-5-mil... | 0.06 | 0.12 | tokens: 14, 5, court, dispute, dna, estate |
| `hmrc-helpsheets-trust-registration-service` | https://ciot-att.lndo.site/technical/hmrc-helpsheets-trust-registration-service | 0.11 | 0.14 | tokens: helpsheets, hmrc, registration, service, trust |
...
| `trust-tax-charges-dont-miss-the-10-year-anniversary-charges` | https://bhp.co.uk/news-events/blog/trust-tax-charges-dont-miss-the-10-year-anniversary-... | 0.14 | 0.15 | tokens: 10, anniversary, charges, dont, miss, tax |
...
| `trust-registration-service-opens-for-non-taxable-trusts` | https://www.geraldedelman.com/insights/trust-registration-service-opens-for-non-taxable... | 0.08 | 0.18 | tokens: for, non, opens, registration, service, taxable |
| `trust-and-estates` | https://bhp.co.uk/news-events/category/service-insights/trust-and-estates/ | 0.12 | 0.2 | tokens: and, estates, trust |
| `holiday-pay-implications-of-harpur-trust-v-brazel` | https://www.taxaccountant.co.uk/holiday-pay-implications-of-harpur-trust-v-brazel/ | 0.08 | 0.22 | tokens: brazel, harpur, holiday, implications, of, pay |
...
| `additional-guidance-on-registering-non-uk-trusts-on-the-trust-registration-service` | https://www.geraldedelman.com/insights/additional-guidance-on-registering-non-uk-trusts... | 0.12 | 0.23 | tokens: additional, guidance, non, on, registering, registration |
...
| `trusts-and-estate-planning` | https://hwfisher.co.uk/services/tax-advisory/trusts-and-estate-planning/ | 0.22 | 0.25 | tokens: and, estate, planning, trusts |
...
| `form-17-and-deed-of-trust-uk-property-ownership-tax-planning-guide` | https://www.ukpropertyaccountants.co.uk/form-17-and-deed-of-trust-uk-property-ownership... | 0.29 | 0.2 | tokens: 17, and, deed, form, guide, of |
| `transferring-property-into-a-trust-as-a-gift-or-to-children-tax-implications` | https://buytolettaxaccountants.co.uk/transferring-property-into-a-trust-as-a-gift-or-to... | 0.2 | 0.29 | tokens: a, as, children, gift, implications, into |
...
| `how-do-i-handle-service-charges-and-ground-rent-in-my-accounts` | https://www.towerstone.co.uk/how-do-i-handle-service-charges-and-ground-rent-in-my-acco... | 0.1 | 0.12 | tokens: accounts, and, charges, do, ground, handle |
...
| `ground-rent-pay-landlords-costs-seeking-payment` | https://www.boltburdon.co.uk/blogs/ground-rent-pay-landlords-costs-seeking-payment/ | 0.15 | 0.17 | tokens: costs, ground, landlords, pay, payment, rent |
| `multi-unit-freehold-block-mortgages` | https://www.thebuytoletbroker.co.uk/multi-unit-freehold-block-mortgages/ | 0.09 | 0.17 | tokens: block, freehold, mortgages, multi, unit |
...
| `flying-freehold-mortgages` | https://www.charcol.co.uk/mortgages/specialist-property-mortgages/flying-freehold-mortg... | 0.0 | 0.25 | tokens: flying, freehold, mortgages |
| `freehold-purchase-leasehold-reform-act` | https://www.boltburdon.co.uk/blogs/freehold-purchase-leasehold-reform-act/ | 0.22 | 0.25 | tokens: act, freehold, leasehold, purchase, reform |
...
| `unlocking-the-value-of-property-accountants-in-real-estate-finance-a-detailed-exploration` | https://www.ukpropertyaccountants.co.uk/unlocking-the-value-of-property-accountants-in-... | 0.12 | 0.24 | tokens: a, accountants, detailed, estate, exploration, finance |
...
| `the-role-of-property-accountants-in-maximising-real-estate-investments` | https://www.djh.co.uk/latest-news/news-insights/the-role-of-property-accountants-in-max... | 0.13 | 0.29 | tokens: accountants, estate, in, investments, maximising, of |
...
| `scottish-tenancy-reform` | https://www.nrla.org.uk/research/deep-insight/scottish-tenancy-reform | 0.12 | 0.14 | tokens: reform, scottish, tenancy |
| `scotlands-property-tax-revenue-raises-questions-over-long-term-strategy` | https://www.ukpropertyaccountants.co.uk/scotlands-property-tax-revenue-raises-questions... | 0.17 | 0.08 | tokens: long, over, property, questions, raises, revenue |
| `assignation-of-leases-and-lbtt-getting-the-rent-and-premium-calculations-right` | https://www.ukpropertyaccountants.co.uk/assignation-of-leases-and-lbtt-getting-the-rent... | 0.06 | 0.19 | tokens: and, assignation, calculations, getting, lbtt, leases |
...
| `ads-key-facts-for-buying-additional-property-in-scotland` | https://www.ukpropertyaccountants.co.uk/ads-key-facts-for-buying-additional-property-in... | 0.17 | 0.21 | tokens: additional, ads, buying, facts, for, in |
...
| `buying-multiple-properties-in-scotland-the-key-to-saving-on-lbtt` | https://www.ukpropertyaccountants.co.uk/buying-multiple-properties-in-scotland-the-key-... | 0.13 | 0.25 | tokens: buying, in, key, lbtt, multiple, on |
| `is-scotlands-699-million-property-tax-take-helping-or-hurting-the-market` | https://www.ukpropertyaccountants.co.uk/is-scotlands-699-million-property-tax-take-help... | 0.14 | 0.25 | tokens: 699, helping, hurting, is, market, million |
| `urgent-registration-required-for-short-term-let-landlords-in-scotland` | https://www.ukpropertyaccountants.co.uk/urgent-registration-required-for-short-term-let... | 0.15 | 0.25 | tokens: for, in, landlords, let, registration, required |

### Partnership_LLP (7 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `cooke-sc-properties-ltd-vs-hmrc-taxation-partnership-dispute` | https://www.ukpropertyaccountants.co.uk/cooke-sc-properties-ltd-vs-hmrc-taxation-partne... | 0.08 | 0.18 | tokens: cooke, dispute, hmrc, ltd, partnership, properties |
| `hybrid-llp-tax-structures` | https://www.ukpropertyaccountants.co.uk/services/hybrid-llp-tax-structures/ | 0.17 | 0.2 | tokens: hybrid, llp, structures, tax |
...
| `buxton-accounting-llp` | https://www.ukaccountingfirms.co.uk/3916/buxton-accounting-llp | 0.2 | 0.25 | tokens: accounting, buxton, llp |
| `the-tax-faculty-llp` | https://www.ukaccountingfirms.co.uk/4620/the-tax-faculty-llp | 0.17 | 0.25 | tokens: faculty, llp, tax, the |
| `does-an-llp-pay-corporation-tax` | https://www.towerstone.co.uk/does-an-llp-pay-corporation-tax | 0.22 | 0.27 | tokens: an, corporation, does, llp, pay, tax |
...
| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Quick rationale |
|---|---|---:|---:|---|
| `company-strike-off-can-you-just-let-a-company-be-struck-off-by-not-filing-at-companies-house` | https://uklandlordtax.co.uk/company-strike-off-can-you-just-let-a-company-be-struck-off... | 0.1 | 0.12 | tokens: a, at, be, by, can, companies |
...
| `what-are-all-my-first-year-deadlines-with-hmrc-and-companies-house` | https://www.towerstone.co.uk/what-are-all-my-first-year-deadlines-with-hmrc-and-compani... | 0.11 | 0.17 | tokens: all, and, are, companies, deadlines, first |
| `companies-house-security-glitch-what-happened-and-what-your-company-needs-to-review` | https://www.boltburdon.co.uk/blogs/companies-house-security-glitch-what-happened-and-wh... | 0.12 | 0.19 | tokens: and, companies, company, glitch, happened, house |
| `how-do-i-close-a-company-at-companies-house` | https://www.towerstone.co.uk/how-do-i-close-a-company-at-companies-house | 0.17 | 0.2 | tokens: a, at, close, companies, company, do |
...
| `hmrc-favouring-new-rules-for-the-tax-penalty-system` | https://www.ukpropertyaccountants.co.uk/hmrc-favouring-new-rules-for-the-tax-penalty-sy... | 0.15 | 0.27 | tokens: favouring, for, hmrc, new, penalty, rules |
| `high-value-properties-in-the-uk-tax-liabilities-penalty-risks` | https://www.ukpropertyaccountants.co.uk/high-value-properties-in-the-uk-tax-liabilities... | 0.15 | 0.29 | tokens: high, in, liabilities, penalty, properties, risks |
...
| `rental-yields-across-england-and-wales` | https://www.ukpropertyaccountants.co.uk/rental-yields-across-england-and-wales/ | 0.11 | 0.12 | tokens: across, and, england, rental, wales, yields |
...
| `new-welsh-ltt-refund-for-properties-leased-to-local-authorities` | https://www.ukpropertyaccountants.co.uk/new-welsh-ltt-refund-for-properties-leased-to-l... | 0.14 | 0.21 | tokens: authorities, for, leased, local, ltt, new |
| `thousands-of-welsh-property-buyers-could-be-owed-land-transaction-tax-refunds` | https://www.ukpropertyaccountants.co.uk/thousands-of-welsh-property-buyers-could-be-owe... | 0.14 | 0.24 | tokens: be, buyers, could, land, of, owed |
| `understanding-land-transaction-tax-ltt-and-the-subsidiary-dwelling-exception-sde` | https://www.ukpropertyaccountants.co.uk/understanding-land-transaction-tax-ltt-and-the-... | 0.08 | 0.27 | tokens: and, dwelling, exception, land, ltt, sde |
...
|---|---|---:|---:|---|
| `what-is-postponed-vat-accounting-and-how-does-it-work` | https://www.towerstone.co.uk/what-is-postponed-vat-accounting-and-how-does-it-work | 0.17 | 0.54 | accounting, and, does, how, is, it |
...
| `vat-on-uk-residential-commercial-property-a-complete-guide` | https://www.ukpropertyaccountants.co.uk/vat-on-uk-residential-commercial-property-a-com... | 0.36 | 0.45 | a, commercial, complete, guide, on, property |
...
| `vat-on-commercial-property-what-you-need-to-know` | https://www.ukpropertyaccountants.co.uk/vat-on-commercial-property-what-you-need-to-know/ | 0.27 | 0.42 | commercial, know, need, on, property, to |
...
| `new-penalties-and-interest-for-late-payment-and-submission-of-vat-returns` | https://www.geraldedelman.com/insights/new-penalties-and-interest-for-late-payment-and-... | 0.2 | 0.38 | and, for, interest, late, new, of |
...
| `vat-calculation-under-tour-operators-margin-scheme` | https://www.ukpropertyaccountants.co.uk/vat-calculation-under-tour-operators-margin-sch... | 0.25 | 0.36 | calculation, margin, operators, scheme, tour, under |
| `vat-on-property-service-charges-a-guide-for-landlords` | https://www.ukpropertyaccountants.co.uk/vat-on-property-service-charges-a-guide-for-lan... | 0.25 | 0.36 | a, charges, for, guide, landlords, on |
| `are-vat-penalties-tax-deductible` | https://www.towerstone.co.uk/are-vat-penalties-tax-deductible | 0.33 | 0.25 | are, deductible, penalties, tax, vat |
| `cis-tax-from-vat-invoice` | https://www.mytaxaccountant.co.uk/post/cis-tax-from-vat-invoice | 0.33 | 0.2 | cis, from, invoice, tax, vat |
| *(+34 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `do-i-have-to-pay-capital-gains-tax-on-classic-cars` | https://taxfix.com/en-uk/investor-capital-gains-tax-returns/do-i-have-to-pay-capital-ga... | 0.23 | 0.5 | capital, cars, classic, do, gains, have |
| `do-i-have-to-pay-capital-gains-tax-on-inherited-property` | https://www.towerstone.co.uk/do-i-have-to-pay-capital-gains-tax-on-inherited-property | 0.33 | 0.5 | capital, do, gains, have, i, inherited |
| `do-i-pay-capital-gains-tax-when-selling-a-rental-property` | https://www.towerstone.co.uk/do-i-pay-capital-gains-tax-when-selling-a-rental-property | 0.5 | 0.29 | a, capital, do, gains, i, pay |
...
| `how-to-avoid-cgt-on-buy-to-let-property` | https://www.mytaxaccountant.co.uk/post/how-to-avoid-cgt-on-buy-to-let-property | 0.45 | 0.27 | avoid, buy, cgt, how, let, on |
| *(+120 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `mtd-deadlines-penalties-what-you-need-to-know` | https://rentalbux.com/guides/mtd-deadlines-penalties-what-you-need-to-know | 0.29 | 0.55 | deadlines, know, mtd, need, penalties, to |
...
| `making-tax-digital-ai-companies` | https://www.business-accounting.co.uk/blog/making-tax-digital-ai-companies | 0.33 | 0.5 | ai, companies, digital, making, tax |
| `making-tax-digital-for-income-tax-self-assessment` | https://rentalbux.com/blogs/making-tax-digital-for-income-tax-self-assessment | 0.36 | 0.5 | assessment, digital, for, income, making, self |
...
| `making-tax-digital-jointly-owned-property` | https://fhpaccounting.co.uk/making-tax-digital-jointly-owned-property/ | 0.4 | 0.5 | digital, jointly, making, owned, property, tax |
...
| `making-tax-digital-tech-companies` | https://www.business-accounting.co.uk/blog/making-tax-digital-tech-companies | 0.33 | 0.5 | companies, digital, making, tax, tech |
...
| `making-tax-digital-mtd-for-income-tax-self-assessment` | https://www.geraldedelman.com/insights/making-tax-digital-mtd-for-income-tax-self-asses... | 0.33 | 0.45 | assessment, digital, for, income, making, mtd |
| `making-tax-digital-mtd-for-jointly-owned-properties` | https://rentalbux.com/blogs/making-tax-digital-mtd-for-jointly-owned-properties | 0.25 | 0.45 | digital, for, jointly, making, mtd, owned |
...
| `what-is-making-tax-digital-for-income-tax` | https://taxfix.com/en-uk/tax-changes/what-is-making-tax-digital-for-income-tax/ | 0.36 | 0.44 | digital, for, income, is, making, tax |
...
| `mtd-for-income-tax` | https://rentalbux.com/blogs/mtd-for-income-tax | 0.33 | 0.43 | for, income, mtd, tax |
...
### LtdCo_Incorporation (76 candidates)
...
| `buying-hmo-property-through-a-limited-company-pros-and-cons` | https://www.ukpropertyaccountants.co.uk/buying-hmo-property-through-a-limited-company-p... | 0.23 | 0.54 | a, and, buying, company, cons, hmo |
...
| `the-tax-pros-and-cons-for-transferring-property-into-a-limited-company` | https://buytolettaxaccountants.co.uk/the-tax-pros-and-cons-for-transferring-property-in... | 0.25 | 0.47 | a, and, company, cons, for, into |
...
| `incorporate-your-hmo-into-a-limited-company` | https://www.ukpropertyaccountants.co.uk/services/incorporate-your-hmo-into-a-limited-co... | 0.3 | 0.44 | a, company, hmo, incorporate, into, limited |
...
| `furnished-holiday-lettings-incorporation` | https://www.ukpropertyaccountants.co.uk/services/furnished-holiday-lettings-incorporation/ | 0.25 | 0.43 | furnished, holiday, incorporation, lettings |
| `landlord-sole-trader-vs-limited-company` | https://www.business-accounting.co.uk/blog/landlord-sole-trader-vs-limited-company | 0.27 | 0.43 | company, landlord, limited, sole, trader, vs |
...
| `sole-trader-vs-limited-company-tax` | https://taxfix.com/en-uk/self-assessment-basics/sole-trader-vs-limited-company-tax/ | 0.4 | 0.43 | company, limited, sole, tax, trader, vs |
...
| `benefits-of-hiring-a-limited-company-accountant` | https://www.qaccounting.com/benefits-of-hiring-a-limited-company-accountant/ | 0.18 | 0.4 | a, accountant, benefits, company, hiring, limited |
| `cleaning-companies-register-limited-company` | https://www.business-accounting.co.uk/blog/cleaning-companies-register-limited-company | 0.22 | 0.4 | cleaning, companies, company, limited, register |
| `courier-companies-register-limited-company` | https://www.business-accounting.co.uk/blog/courier-companies-register-limited-company | 0.22 | 0.4 | companies, company, courier, limited, register |
...
| `removal-companies-register-limited-company` | https://www.business-accounting.co.uk/blog/removal-companies-register-limited-company | 0.22 | 0.4 | companies, company, limited, register, removal |
| `shipping-companies-register-limited-company` | https://www.business-accounting.co.uk/blog/shipping-companies-register-limited-company | 0.22 | 0.4 | companies, company, limited, register, shipping |
| `choosing-a-limited-company-accountant` | https://www.qaccounting.com/choosing-a-limited-company-accountant/ | 0.22 | 0.38 | a, accountant, choosing, company, limited |
| *(+46 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `inheritance-tax-on-jointly-owned-property` | https://www.mytaxaccountant.co.uk/post/inheritance-tax-on-jointly-owned-property | 0.33 | 0.5 | inheritance, jointly, on, owned, property, tax |
| `what-is-inheritance-tax` | https://www.towerstone.co.uk/what-is-inheritance-tax | 0.5 | 0.29 | inheritance, is, tax, what |
| `do-you-have-to-pay-inheritance-tax-before-probate` | https://www.ukpropertyaccountants.co.uk/do-you-have-to-pay-inheritance-tax-before-probate/ | 0.19 | 0.45 | before, do, have, inheritance, pay, probate |
| `inheritance-tax-what-business-owners-need-to-know` | https://www.tlpi.co.uk/inheritance-tax-what-business-owners-need-to-know | 0.29 | 0.45 | business, inheritance, know, need, owners, tax |
...
| `do-expats-pay-uk-inheritance-tax` | https://www.boltburdon.co.uk/tag/do-expats-pay-uk-inheritance-tax/ | 0.33 | 0.44 | do, expats, inheritance, pay, tax, uk |
| `how-to-reduce-your-inheritance-tax` | https://www.shipleystax.com/2020/03/how-to-reduce-your-inheritance-tax/ | 0.27 | 0.44 | how, inheritance, reduce, tax, to, your |
| `navigating-the-new-inheritance-tax-landscape` | https://www.djh.co.uk/latest-news/news-insights/navigating-the-new-inheritance-tax-land... | 0.2 | 0.44 | inheritance, landscape, navigating, new, tax, the |
...
| `iht-transferable-nil-rate-band` | https://www.taxaccountant.co.uk/iht-transferable-nil-rate-band/ | 0.4 | 0.43 | band, iht, nil, rate, transferable |
| `isas-and-inheritance-tax` | https://www.mytaxaccountant.co.uk/post/isas-and-inheritance-tax | 0.25 | 0.43 | and, inheritance, isas, tax |
...
| `spouse-and-inheritance-tax` | https://www.mytaxaccountant.co.uk/post/spouse-and-inheritance-tax | 0.25 | 0.43 | and, inheritance, spouse, tax |
...
| `family-investment-company-inheritance-tax-and-freezing-value` | https://uklandlordtax.co.uk/family-investment-company-inheritance-tax-and-freezing-value/ | 0.27 | 0.4 | and, company, family, freezing, inheritance, investment |
| `inheritance-tax-hmrc-and-the-7-year-rule` | https://hwfisher.co.uk/inheritance-tax-hmrc-and-the-7-year-rule/ | 0.23 | 0.4 | 7, and, hmrc, inheritance, rule, tax |
...
| `smart-gifting-strategies-for-inheritance-tax-planning` | https://www.saltus.co.uk/the-financial-planning-blog/smart-gifting-strategies-for-inher... | 0.23 | 0.4 | for, gifting, inheritance, planning, smart, strategies |
...
| `accountants-charges-for-inheritance-tax` | https://www.mytaxaccountant.co.uk/post/accountants-charges-for-inheritance-tax | 0.22 | 0.38 | accountants, charges, for, inheritance, tax |
| `blended-families-and-inheritance-tax` | https://hwfisher.co.uk/blended-families-and-inheritance-tax/ | 0.22 | 0.38 | and, blended, families, inheritance, tax |
...
| `estate-and-inheritance-tax-planning` | https://www.elsbyandco.co.uk/services/accounting-advisory/tax-returns-and-planning/esta... | 0.22 | 0.38 | and, estate, inheritance, planning, tax |
| *(+65 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |

### SDLT (68 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `a-complete-guide-to-sdlt-probate-property-relief-for-property-traders` | https://www.ukpropertyaccountants.co.uk/a-complete-guide-to-sdlt-probate-property-relie... | 0.25 | 0.54 | a, complete, for, guide, probate, property |
| `cladding-crisis-and-sdlt-relief-what-affected-property-owners-need-to-know` | https://www.ukpropertyaccountants.co.uk/cladding-crisis-and-sdlt-relief-what-affected-p... | 0.16 | 0.54 | affected, and, cladding, crisis, know, need |
| `do-limited-companies-pay-stamp-duty` | https://www.towerstone.co.uk/do-limited-companies-pay-stamp-duty | 0.22 | 0.5 | companies, do, duty, limited, pay, stamp |
| `linked-transactions-and-sdlt-what-property-investors-need-to-know` | https://www.property-tax-advice.co.uk/knowledge-centre/linked-transactions-and-sdlt-wha... | 0.2 | 0.5 | and, investors, know, linked, need, property |
| `sdlt-and-first-time-buyers` | https://www.taxaccountant.co.uk/sdlt-and-first-time-buyers/ | 0.15 | 0.5 | and, buyers, first, sdlt, time |
| `sdlt-first-time-buyers-relief` | https://www.ukpropertyaccountants.co.uk/services/sdlt-first-time-buyers-relief/ | 0.25 | 0.5 | buyers, first, relief, sdlt, time |
...
| `stamp-duty-land-tax-for-property-developers` | https://www.ukpropertyaccountants.co.uk/stamp-duty-land-tax-for-property-developers/ | 0.22 | 0.5 | developers, duty, for, land, property, stamp |
| `stamp-duty-rates` | https://www.ukpropertyaccountants.co.uk/stamp-duty-rates/ | 0.33 | 0.5 | duty, rates, stamp |
| `stamp-duty-land-tax-mixed-property-purchases-and-multiple-dwellings-relief` | https://ciot-att.lndo.site/technical/submissions/stamp-duty-land-tax-mixed-property-pur... | 0.21 | 0.46 | and, duty, dwellings, land, mixed, multiple |
| `new-stamp-duty-surcharge-for-overseas-property-buyers` | https://www.provestor.co.uk/blog/new-stamp-duty-surcharge-for-overseas-property-buyers | 0.27 | 0.45 | buyers, duty, for, new, overseas, property |
| `sdlt-advice-for-landlords-and-property-investors` | https://www.geraldedelman.com/insights/sdlt-advice-for-landlords-and-property-investors/ | 0.22 | 0.45 | advice, and, for, investors, landlords, property |
| `stamp-duty-for-first-time-buyers` | https://www.charcol.co.uk/mortgages/best-buys/first-time-buyer/stamp-duty-for-first-tim... | 0.22 | 0.44 | buyers, duty, first, for, stamp, time |
...
| `multiple-dwellings-relief-scrapped-for-property-investors` | https://www.taxaccountant.co.uk/multiple-dwellings-relief-scrapped-for-property-investors/ | 0.22 | 0.43 | dwellings, for, investors, multiple, property, relief |
...
| `stamp-duty-land-tax-relief-for-first-time-buyers` | https://www.ukpropertyaccountants.co.uk/stamp-duty-land-tax-relief-for-first-time-buyers/ | 0.19 | 0.42 | buyers, duty, first, for, land, relief |
| `the-complete-guide-to-overpayment-relief-in-sdlt` | https://www.ukpropertyaccountants.co.uk/the-complete-guide-to-overpayment-relief-in-sdlt/ | 0.27 | 0.42 | complete, guide, in, overpayment, relief, sdlt |
...
| `complete-guide-stamp-duty-on-uninhabitable-property` | https://www.ukpropertyaccountants.co.uk/complete-guide-stamp-duty-on-uninhabitable-prop... | 0.33 | 0.4 | complete, duty, guide, on, property, stamp |
...
| `stamp-duty-capital-gains-tax-advice` | https://uklandlordtax.co.uk/what-we-do/tax-for-landlords/stamp-duty-capital-gains-tax-a... | 0.38 | 0.27 | advice, capital, duty, gains, stamp, tax |
| *(+38 more in this cluster, see `_topic_gaps_delta_2026-05-23.json`)* | | | | |
...
| `mortgages-next-to-commercial-property` | https://www.charcol.co.uk/mortgages/specialist-property-mortgages/mortgages-next-to-com... | 0.25 | 0.3 | commercial, mortgages, next, property, to |
...
| `non-resident-uk-company-tax-return` | https://uklandlordtax.co.uk/non-resident-uk-company-tax-return/ | 0.3 | 0.44 | company, non, resident, return, tax, uk |
...
| `a-complete-guide-on-non-resident-company-tax-return` | https://www.ukpropertyaccountants.co.uk/a-complete-guide-on-non-resident-company-tax-re... | 0.36 | 0.42 | a, company, complete, guide, non, on |
...
| `the-register-of-overseas-entities-and-the-impact-on-property-transactions` | https://www.geraldedelman.com/insights/the-register-of-overseas-entities-and-the-impact... | 0.17 | 0.4 | and, entities, impact, of, on, overseas |
...
| `corporation-tax-guide-for-overseas-traders` | https://www.taxaccountant.co.uk/corporation-tax-guide-for-overseas-traders/ | 0.22 | 0.38 | corporation, for, guide, overseas, tax, traders |
...
| `what-are-the-new-reporting-rules-for-overseas-entities-owning-uk-property` | https://www.ukpropertyaccountants.co.uk/what-are-the-new-reporting-rules-for-overseas-e... | 0.19 | 0.38 | are, entities, for, new, overseas, owning |
...
| `a-guide-to-tax-for-non-resident-landlords-tenants-or-those-managing-a-landlords-uk-properties` | https://buytolettaxaccountants.co.uk/a-guide-to-tax-for-non-resident-landlords-tenants-... | 0.24 | 0.33 | a, for, guide, landlords, managing, non |
| `considerations-for-expats-buying-rental-property-in-the-uk` | https://www.charcol.co.uk/blog/considerations-for-expats-buying-rental-property-in-the-uk/ | 0.27 | 0.33 | buying, considerations, expats, for, in, property |
...
| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `end-of-furnished-holiday-lettings` | https://www.taxaccountant.co.uk/end-of-furnished-holiday-lettings/ | 0.22 | 0.5 | end, furnished, holiday, lettings, of |
| `furnished-holiday-let` | https://www.taxaccountant.co.uk/tag/furnished-holiday-let/ | 0.5 | 0.29 | furnished, holiday, let |
| `furnished-holiday-lettings` | https://uklandlordtax.co.uk/tax-guide/furnished-holiday-lettings/ | 0.29 | 0.5 | furnished, holiday, lettings |
...
| `impact-of-fhl-tax-abolition-transition-to-company-structure-key-insights` | https://www.ukpropertyaccountants.co.uk/impact-of-fhl-tax-abolition-transition-to-compa... | 0.21 | 0.47 | abolition, company, fhl, impact, insights, key |
| `abolition-furnished-holiday-lettings-tax` | https://uklandlordtax.co.uk/abolition-furnished-holiday-lettings-tax/ | 0.38 | 0.44 | abolition, furnished, holiday, lettings, tax |
...
| `abolition-of-furnished-holiday-lets-regime` | https://www.rpgcrouchchapman.co.uk/resources/blog/abolition-of-furnished-holiday-lets-r... | 0.33 | 0.44 | abolition, furnished, holiday, lets, of, regime |
| `009-fhl-tax-changes` | https://www.provestor.co.uk/propertytaxshow/009-fhl-tax-changes | 0.43 | 0.2 | 009, changes, fhl, tax |
| `furnished-holiday-letting` | https://www.landlordstax.co.uk/resources/guide-for-non-resident-landlords/furnished-hol... | 0.29 | 0.43 | furnished, holiday, letting |
| `furnished-holiday-lettings-accountants` | https://uklandlordtax.co.uk/furnished-holiday-lettings-accountants/ | 0.25 | 0.43 | accountants, furnished, holiday, lettings |
...
| `furnished-holiday-lettings-regime-abolished` | https://fhpaccounting.co.uk/furnished-holiday-lettings-regime-abolished/ | 0.22 | 0.38 | abolished, furnished, holiday, lettings, regime |
| `furnished-holiday-lets-here-is-what-you-need-to-know` | https://hwfisher.co.uk/furnished-holiday-lets-here-is-what-you-need-to-know/ | 0.25 | 0.36 | furnished, here, holiday, is, know, lets |
...
| `what-you-need-to-know-when-running-a-furnished-holiday-let` | https://hwfisher.co.uk/what-you-need-to-know-when-running-a-furnished-holiday-let/ | 0.24 | 0.33 | a, furnished, holiday, know, let, need |
| `how-do-i-pay-tax-on-airbnb-or-holiday-lets` | https://www.towerstone.co.uk/how-do-i-pay-tax-on-airbnb-or-holiday-lets | 0.21 | 0.31 | airbnb, do, holiday, how, i, lets |
...
| `guide-to-renting-out-a-holiday-let` | https://www.alanboswell.com/resources/guide-to-renting-out-a-holiday-let/ | 0.27 | 0.3 | a, guide, holiday, let, out, renting |
...
| `capital-allowances-a-guide-for-authors` | https://hwfisher.co.uk/capital-allowances-a-guide-for-authors/ | 0.29 | 0.33 | a, allowances, authors, capital, for, guide |
...
| `landlord-amnesty-change-tenancy-deposits` | https://www.boltburdon.co.uk/blogs/landlord-amnesty-change-tenancy-deposits/ | 0.2 | 0.33 | amnesty, change, deposits, landlord, tenancy |
...
| `self-assessment-tax-returns-and-rental-income` | https://www.provestor.co.uk/help/property-taxes/self-assessment-tax-returns-and-rental-... | 0.38 | 0.5 | and, assessment, income, rental, returns, self |
...
| `self-assessment-income-tax-returns` | https://www.taxaccountant.co.uk/self-assessment-income-tax-returns/ | 0.38 | 0.44 | assessment, income, returns, self, tax |
...
| `introduction-to-self-assessment-tax-returns` | https://www.provestor.co.uk/help/property-taxes/introduction-to-self-assessment-tax-ret... | 0.33 | 0.4 | assessment, introduction, returns, self, tax, to |
| `self-assessment-tax-payments-and-payments-on-account` | https://www.provestor.co.uk/help/property-taxes/self-assessment-tax-payments-and-paymen... | 0.3 | 0.36 | account, and, assessment, on, payments, self |
| `self-assessment-tax-returns-for-company-directors` | https://www.qaccounting.com/self-assessment-tax-returns-for-company-directors/ | 0.3 | 0.36 | assessment, company, directors, for, returns, self |
| `understanding-self-assessment-tax-faqs-for-landlords-in-the-uk` | https://www.ukpropertyaccountants.co.uk/understanding-self-assessment-tax-faqs-for-land... | 0.23 | 0.36 | assessment, faqs, for, in, landlords, self |
...
| `income-tax-self-assessment-registration-self-employed-and-landlords` | https://ciot-att.lndo.site/technical/submissions/income-tax-self-assessment-registratio... | 0.27 | 0.33 | and, assessment, employed, income, landlords, registration |
...
| `over-40000-file-self-assessment-tax-returns-during-holiday` | https://www.ukpropertyaccountants.co.uk/over-40000-file-self-assessment-tax-returns-dur... | 0.25 | 0.31 | 40000, assessment, during, file, holiday, over |

### PropertyDev_Trading (14 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `top-15-tax-planning-strategies-for-uk-property-developers` | https://www.ukpropertyaccountants.co.uk/top-15-tax-planning-strategies-for-uk-property-... | 0.29 | 0.45 | 15, developers, for, planning, property, strategies |
...
| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `what-landlords-need-to-know-about-annual-tax-on-enveloped-dwellings-ated` | https://www.provestor.co.uk/blog/what-landlords-need-to-know-about-annual-tax-on-envelo... | 0.22 | 0.5 | about, annual, ated, dwellings, enveloped, know |
| `reminder-annual-tax-on-enveloped-dwellings-calculate-the-value-of-your-property` | https://hwfisher.co.uk/reminder-annual-tax-on-enveloped-dwellings-calculate-the-value-o... | 0.18 | 0.42 | annual, calculate, dwellings, enveloped, of, on |
...
| `how-is-inheritance-tax-calculated-in-the-uk` | https://www.towerstone.co.uk/how-is-inheritance-tax-calculated-in-the-uk | 0.3 | 0.36 | calculated, how, in, inheritance, is, tax |
...
| `tax-relief-for-work-related-expenses` | https://www.taxaccountant.co.uk/tax-relief-for-work-related-expenses/ | 0.22 | 0.3 | expenses, for, related, relief, tax, work |

### Trusts_Estates (2 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `using-a-trust-for-tax-planning` | https://www.shipleystax.com/2023/03/using-a-trust-for-tax-planning/ | 0.2 | 0.3 | a, for, planning, tax, trust, using |
...
| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `a-case-study-tax-implications-on-the-lease-extensions-in-the-uk` | https://www.ukpropertyaccountants.co.uk/a-case-study-tax-implications-on-the-lease-exte... | 0.2 | 0.36 | a, case, extensions, implications, in, lease |
| `freehold-and-leasehold` | https://www.charcol.co.uk/guides/freehold-and-leasehold/ | 0.12 | 0.33 | and, freehold, leasehold |
...
| `land-building-transaction-tax-lbtt-calculator` | https://www.ukpropertyaccountants.co.uk/calculators/land-building-transaction-tax-lbtt-... | 0.29 | 0.33 | building, calculator, land, lbtt, tax, transaction |
| `sub-sale-development-relief-in-lbtt-a-practical-guide-for-property-transactions` | https://www.ukpropertyaccountants.co.uk/sub-sale-development-relief-in-lbtt-a-practical... | 0.21 | 0.31 | a, development, for, guide, in, lbtt |
...
| `file-llp-accounts-tax-return` | https://www.ukpropertyaccountants.co.uk/services/file-llp-accounts-tax-return/ | 0.25 | 0.4 | accounts, file, llp, return, tax |
...
| `taxation-of-property-partnerships-and-joint-ownership` | https://www.taxinsider.co.uk/tax-reports/taxation-of-property-partnerships-and-joint-ow... | 0.27 | 0.3 | and, joint, of, ownership, partnerships, property |
...
| `what-is-a-dormant-company-on-companies-house` | https://www.towerstone.co.uk/what-is-a-dormant-company-on-companies-house | 0.18 | 0.3 | a, companies, company, dormant, house, is |

### Penalties_HMRC (4 candidates)

| Candidate slug | Source competitor URL | Best Jaccard (existing) | Best Jaccard (candidate pool) | Tokens |
|---|---|---:|---:|---|
| `corporation-tax-compliance-avoiding-penalties` | https://www.taxaccountant.co.uk/corporation-tax-compliance-avoiding-penalties/ | 0.25 | 0.43 | avoiding, compliance, corporation, penalties, tax |
| `corporation-tax-guidelines-to-avoid-penalties` | https://www.taxaccountant.co.uk/corporation-tax-guidelines-to-avoid-penalties/ | 0.22 | 0.38 | avoid, corporation, guidelines, penalties, tax, to |
| `penalties-for-late-corporation-tax-payment` | https://www.towerstone.co.uk/penalties-for-late-corporation-tax-payment | 0.3 | 0.38 | corporation, for, late, payment, penalties, tax |
