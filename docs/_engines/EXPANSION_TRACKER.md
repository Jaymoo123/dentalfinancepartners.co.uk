...
| hospitality | Restaurants/pubs/takeaways/hotels | 1 | **R4 + S2-S4 done 2026-07-12** (t1 migration pair APPLIED live; 1,257 topics seeded; machinery green, checker 11 PASS); next S5 niche build | shortlist ready (rec: Hospitality Finance Partners, prefix hfp) | R3 done | | | | pick brand (can batch with others) |
