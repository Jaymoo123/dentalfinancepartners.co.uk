...
| care | Care homes + domiciliary | 1 | **R4 + S2-S4 done 2026-07-12** (652 topics seeded; machinery green, checker 11 PASS; deploy-only hold ~08-03); next S5 niche build | shortlist ready (rec: Care Finance Partners, prefix carf) | R3 done | | | | pick brand |
