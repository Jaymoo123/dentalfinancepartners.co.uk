...
| care | Care homes + domiciliary | 1 | **R4 + S2-S3 done 2026-07-12** (652 topics seeded; deploy-only hold ~08-03); next S4 machinery | shortlist ready (rec: Care Finance Partners, prefix carf) | R3 done | | | | pick brand |
