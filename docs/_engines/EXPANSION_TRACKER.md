...
| hospitality | Restaurants/pubs/takeaways/hotels | 1 | **R4 + S2 done 2026-07-12** (scaffold + check 1+8 pass + build green; t1 migration pair emitted, NOT applied); next S3 seeding | shortlist ready (rec: Hospitality Finance Partners, prefix hfp) | R3 done | | | | pick brand (can batch with others) |
