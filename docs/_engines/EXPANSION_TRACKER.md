...
Last updated: 2026-07-15 (startups-tech = site 5 launch core BUILT + committed, deploy held; build order now care next, ecommerce last)
...
| care | Care homes + domiciliary | 1 | **R4 + S2-S5 done 2026-07-12** (18 tests green; Care Provider Business Index run for real, 67,261 companies / 57,725 CQC locations; house_positions checker-verified; deploy-only hold ~08-03); next wave-1 briefs | shortlist ready (rec: Care Finance Partners, prefix carf) | R3 done | | | | pick brand |
