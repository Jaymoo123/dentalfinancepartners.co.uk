...
| hospitality | Restaurants/pubs/takeaways/hotels | 1 | **R4 + S2 + S3 done 2026-07-12** (t1 migration pair APPLIED live incl. care/startups-tech rows active=false; 1,257 topics seeded); next S4 machinery | shortlist ready (rec: Hospitality Finance Partners, prefix hfp) | R3 done | | | | pick brand (can batch with others) |
