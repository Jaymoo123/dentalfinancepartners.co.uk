...
startups-tech, care). Care = commit `847d97dd`, working brand **Care Home Tax**
(www.carehometax.co.uk, prefix carf, tranche 1): 22 briefs, home + 5 /for hubs + 6 services
...
- S2 scaffold DONE 2026-07-15: `spinup_site --niche ecommerce --skip-db`, working brand **Ecommerce
  Tax Partners** (www.ecommercefinance.co.uk, prefix ectp, tranche 3); npm build smoke green.
  UNCOMMITTED.
...
- **Site 1 — Charities** (commit `2a501b52`): working brand **Trustee Tax**
  (www.trusteetax.co.uk). 29 assets: home + 5 services + 2 sector + 6 pillar guides +
  12 blogs + 3 calculators. Build green (49 pages, 33 tests).
- **Site 2 — Hospitality** (commit `39202375`): working brand **Hospitality Tax**
  (www.hospitalitytax.co.uk). 24 pages: home + 6 /for sub-trade hubs + 5 services +
  12 blogs + 3 tools + Openings/Closures Index. Build green (54 pages, 30 tests).
- **Site 3 — Crypto** (commit `a516e497`): working brand **Crypto Tax Partners**
  (www.cryptotaxpartners.co.uk, prefix datp, tranche 2). 24 assets: home + 6 /for hubs +
...
- **Site 4 — Pharmacies** (commit THIS): working brand **Pharmacy Tax**
  (www.pharmacytax.co.uk, prefix phfp, tranche 2). 27 assets: home + 5 /for hubs +
...
### 3. Crypto — working brand **Crypto Tax Partners** (datp)
...
### 4. Pharmacies — working brand **Pharmacy Tax** (phfp)
...
### 5. Startups/tech — working brand **Founder Tax Partners** (ffp)
...
### 6. Care — working brand **Care Home Tax** (carf)
...
### 7. Ecommerce — working brand **Ecommerce Finance** (ectp), BUILD LAST
