...
**Hits: 18 breaches across 14 files.** TD-13 (6) and TD-14 (12). **Three of the eighteen are in
...
**Hits: 13 breaches.** TD-10 (10), TD-11, TD-12, TD-04.
...
uncaveated, 13 surfaces). `src/app/glossary/[slug]/data.ts` and
