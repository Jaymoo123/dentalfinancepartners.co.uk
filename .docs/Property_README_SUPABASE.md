# Blog Generation with Anthropic + Supabase (Property/Landlord Niche)

Simplified blog generation pipeline using Anthropic Claude and Supabase for property/landlord accounting content.
...
Click **Table Editor > blog_topics_property** and add rows:

| topic | secondary_keyword_1 | secondary_keyword_2 | category | priority | used |
|-------|-------------------|-------------------|----------|----------|------|
| Your property/landlord topic here | keyword 1 | keyword 2 | Landlord tax | 10 | false |
...
3. Export it to `../web-property/content/blog/{slug}.md`
...
**Production:** https://propertyaccountants.co.uk/blog/{slug}
