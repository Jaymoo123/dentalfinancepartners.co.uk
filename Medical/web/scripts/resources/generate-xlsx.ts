/**
 * Excel model generator for the Medical Accountants UK gated resources system.
 *
 ...
 *
 *   npm run resources:xlsx --workspace Medical/web
 *
...
// scripts/resources -> Medical/web/public/resources
