...
<li>your pension input amount in the NHS scheme alone <strong>exceeds the standard £60,000</strong> annual allowance.</li>
</ul>
...
<p>The input test looks at the pension input amount in the NHS scheme <strong>alone</strong>, not aggregated across all of your pensions. For a defined benefit scheme like the NHS one, the input amount is the capitalised growth in your benefits over the year, not the contributions you paid. If that NHS-only input exceeds £60,000, the input limb of the mandatory test is satisfied. If your combined input across several schemes is over £60,000 but your NHS input alone is not, the mandatory route is still closed.</p>
...
<li><strong>Leaving the election until after taking all benefits</strong>, by which point no election can be made.</li>
