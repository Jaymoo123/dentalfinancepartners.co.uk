...
<p>The core prices are national, so they can be read rather than guessed: for 2026/27 the Global Sum is <strong>£130.07 per weighted patient</strong> and a QOF achievement point is <strong>£227.95</strong>, both set in the Statement of Financial Entitlements Directions 2026. What should not be hard-coded is either of those rates, because both are uplifted each April, or the volumes behind them, because your weighted patient count and your achievement move during the year. Set the software up to capture the actual amounts received and reconcile them against the current Directions and your own statements. GP practices are funded under GMS, PMS or APMS contracts and <strong>do not use UDAs or dental banding</strong>, so any template borrowed from a dental practice needs its income side rebuilt from scratch. For how these streams are taxed and accounted for, see <a href="/blog/qof-income-gp-practice-accounting-explained">QOF income</a>, <a href="/blog/enhanced-services-gp-practice-income-tax">enhanced services income</a>, <a href="/blog/how-gms-funding-works-global-sum-carr-hill-explained">how GMS funding works</a> and <a href="/blog/pcn-funding-network-contract-des-explained">PCN and Network Contract DES funding</a>.</p>
...
<p>Medical professionals have specific deductible costs that generic software does not anticipate. Pre-configure expense categories for indemnity (MDU, MPS or MDDUS subscriptions), the GMC annual retention fee, Royal College subscriptions on HMRC's approved list, the BMA subscription (give it its own category, because relief on it is restricted to 85%), relevant CPD, and equipment (usually relieved via capital allowances). Note the medical-specific nuance: NHS GP clinical negligence is state-indemnified through CNSGP from 1 April 2019, so a GP's own paid indemnity is now mainly for private or non-clinical and regulatory cover.</p>
