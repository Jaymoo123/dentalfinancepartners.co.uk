...
- "Employer secondary Class 1 NIC is 15% on earnings above the £5,000 secondary threshold for 2026/27, and a typical NHS GP practice cannot net off the £10,500 Employment Allowance because its activities are wholly or mainly of a public nature."
...
- question: How much employer National Insurance does a GP practice pay on staff?
  answer: Employer (secondary Class 1) NIC is 15% on earnings above the £5,000 secondary threshold for 2026/27. Budget the full amount, because a typical NHS GP practice cannot claim the £10,500 Employment Allowance. The allowance is barred to an employer whose activities are wholly or mainly of a public nature, meaning 50% or more, and HMRC's National Insurance Manual (NIM06530) lists GP services where NHS patients take up the majority of the work as exactly that. A registered charity is not caught by the exclusion even where its functions are public in nature, and a separate PCN company or GP federation turns on its own facts, so ask about that entity specifically rather than assuming either answer.
...
<p>The <strong>Employment Allowance is £10,500</strong> for 2026/27, but a typical NHS GP practice <strong>cannot claim it</strong>, and this is the single most common budgeting error in practice staffing plans. The allowance is not available to an employer whose activities are <strong>wholly or mainly of a public nature</strong>, a test met at 50% or more, and HMRC's National Insurance Manual at NIM06530 lists among functions of a public nature "NHS services, general practitioner (GP) services where NHS patients take up the majority of a GP's work". The same manual page draws the contrast that settles it, treating "independent pharmacies that include dispensing NHS prescriptions as part of their business" as not of a public nature. The gov.uk eligibility guidance puts the same test plainly: you can claim if "you do less than half your work in the public sector (such as for local councils and NHS services)". The statutory hook is section 2(1) to (2) of the National Insurance Contributions Act 2014.</p>

<p>Two qualifications matter. A <strong>registered charity</strong> is not excluded even where its functions are of a public nature. And a <strong>separate PCN company or GP federation</strong> is fact-sensitive, turning on what that entity actually does, so it needs its own answer rather than a general yes or no. For the ordinary NHS partnership, though, the practical rule is simple: budget employer NIC on practice staff at the full 15% above £5,000 and do not net off £10,500.</p>
