...
<p>Expenses being a single cell is the model's biggest usability compromise. Building that total is most of the work of a locum's return, and the <a href="/calculators/doctor-expenses-tax-relief">doctor expenses calculator</a> exists to produce it. Two figures to have in mind while you do: business mileage between sites runs at 55p a mile for the first 10,000 business miles in 2026/27 and 25p after that, and the journey from home to your first site of the day is commuting rather than business travel. Your GMC retention fee, medical indemnity and relevant Royal College fees are deductible in full, and your BMA subscription is deductible at 85% of the annual amount, which is the restriction HMRC records against the BMA on List 3. Our guide to <a href="/blog/locum-doctor-expenses-what-you-can-claim">what a locum doctor can claim</a> works through the rest.</p>
