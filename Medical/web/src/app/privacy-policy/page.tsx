...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: `/api/og?title=${encodeURIComponent("Privacy Policy | Medical Accountants UK")}`, width: 1200, height: 630, alt: "Privacy Policy | Medical Accountants UK" }],
  },
  twitter: {
      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            medical accounting and tax information until you unsubscribe.
          </li>
          <li>
        ...
        <p>
          ...
          email sign-ups{partner ? ", and to share your enquiry with our specialist partner firm as described below" : ""}. You can withdraw your consent at any time (see your rights in section 7); withdrawing consent does not affect any
        ...
        {partner ? (
          <p>
            ...
            partner network, so that they can respond and provide the advice you asked for. That partner firm
