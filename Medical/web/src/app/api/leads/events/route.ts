/**
 * Resend webhook sink for lead-nurture email engagement events (Medical).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.medicalaccounts.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Medical lead-nurture system.</p>
</div>`,
