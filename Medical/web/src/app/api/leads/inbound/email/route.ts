/**
 * Inbound email webhook for Resend: processes replies to Medical nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Medical lead,
 ...
 *   Inbound routing domain: medicalaccounts.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.medicalaccounts.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Medical lead (most recent match wins).
