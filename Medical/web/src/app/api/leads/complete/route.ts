/**
 * "Complete your details" endpoint for Medical Accountants UK.
 *
 * Slim adaptation: no phone-verify (accept saved phone as-is). Otherwise
 * follows the same contract as the wave-1 sites:
