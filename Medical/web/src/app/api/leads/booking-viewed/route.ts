 ...
 * browser. Originates from BookingPicker on mount; email-link scanners (bare
 * server GET, no JS) never trigger it.
 *
 * Dedupes to once per 24 hours per lead. Always returns { ok: true }.
 */
