/**
 * Medical analytics console — main dashboard.
 *
 ...
 * console routes.
 *
 * Medical-specific system state:
 *   - No A/B experiments operated: experiments tab shows explicit "not operated"
 *   - No nurture/subscriber engine: Medical has no newsletter surface (no newsletter = n/a)
...
export default async function AdminAnalyticsPage({
  ...
  // Medical does not operate A/B experiments, personalisation, or nurture (no newsletter surface).
  ...
  const conversionSection = (
    <div className="space-y-8">
      <NotOperatedPanel
        ...
        reason="Not operated on this site. The lead-intent classifier (Opus enrichment + vw_lead_intent_mix) has not been enabled for Medical. This is a Phase 5 / Phase 8 play."
      />
      <NotOperatedPanel
        feature="Nurture engine"
        reason="Not operated on this site. Medical has no newsletter surface, so the marketing opt-in and drip nurture engine (Resend sequences) is n/a."
      />
