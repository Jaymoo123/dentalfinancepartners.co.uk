  ...
  return (
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-5 text-base leading-relaxed text-[var(--ink-soft)] sm:text-lg">
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">1. About us</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">2. No advice provided on the Site</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">3. Accuracy and changes</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">4. Acceptable use</h2>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">5. Intellectual property</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">6. Third-party links</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">7. Limitation of liability</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">8. Disclaimer of warranties</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">9. Indemnity</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">10. Governing law and jurisdiction</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">11. Changes to these terms</h2>
        <p>
        ...
        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">12. Severability</h2>
        <p>
          If any provision of these terms is found to be invalid or unenforceable, the remaining provisions shall continue in full force and effect.
        </p>

        <h2 className="mt-10 text-2xl font-bold text-[var(--ink)] sm:text-3xl">13. Contact us</h2>
        <p>
