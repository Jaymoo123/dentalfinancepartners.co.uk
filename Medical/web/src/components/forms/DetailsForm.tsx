...
/**
 * "Complete your details" form for Medical Accountants UK. A lead who arrived
 ...
 *
 * House style: navy/copper palette, rounded-full CTA, no em-dashes in copy.
 */
    ...
    return (
      <div className="rounded-xl border-2 border-[var(--navy)] bg-[var(--navy)]/5 p-6 text-center">
        ...
        <p className="mt-2 text-base text-[var(--muted)]">
          A specialist medical accountant will be in touch shortly. If you would like to
