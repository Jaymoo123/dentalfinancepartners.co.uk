...
/**
 * Dependency-free inline SVG bar chart for the Medical Accountants UK premium calculator tier.
 *
 ...
 * var(--ink-soft). Medical tokens: navy #001b3d + copper #b87333. var(--gold)
 * resolves to copper (alias). NEVER var(--primary).
 *
 * Bar rendering:
