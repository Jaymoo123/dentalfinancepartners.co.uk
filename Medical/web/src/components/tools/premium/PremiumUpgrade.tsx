...
/**
 * Topic to premium tool bridge for the Medical Accountants UK site.
 *
 ...
 * no config for the topic, so the injection wiring can be added unconditionally
 * to BlogPostRenderer and lights up only for mapped categories.
 *
 * Layout:
 ...
 * The "Free interactive tool" eyebrow chip uses bg-[var(--navy)] (dark brand fill)
 * with white text. Loading placeholder skeleton uses var(--gold) accent bar and
 * var(--border) pulses. No var(--primary) anywhere.
 *
...
function ToolLoading() {
  return (
    <div
      ...
      aria-busy="true"
    >
      {/* Gold/copper accent bar (alias: var(--gold) -> copper on Medical). NEVER var(--primary). */}
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        {/* Navy chip: Medical brand fill, white label. No --primary. */}
        <span className="inline-block bg-[var(--navy)] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-white rounded">
