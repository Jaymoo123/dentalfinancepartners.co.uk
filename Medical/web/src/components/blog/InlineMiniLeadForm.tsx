...
export function InlineMiniLeadForm({ topic }: { topic?: string }) {
  ...
  return (
    <MiniCapture
      ...
      blurb="Leave your details and a one-line summary. We match it to a firm from our specialist partner network, and an accountant who works with doctors replies, with no obligation."
