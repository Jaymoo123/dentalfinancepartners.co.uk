/**
 * Niche Config Loader - Loads niche-specific configuration from niche.config.json
 * This allows centralized management of niche settings while keeping site config dynamic.
 */
...
export const niche = nicheConfig as NicheConfig;

// Helper to get site URL (respects environment variable)
