/**
 * Kill-switch control library for the Medical Accountants UK lead-nurture system.
 *
 * Reads and writes the lead_nurture_control table, keyed on site_key='medical'
...
/**
 * Read the medical control row (site_key='medical'). FAIL-OPEN: returns
...
/**
 * Pause all nurture sends. Upserts site_key='medical' with paused=true,
...
/**
 * Resume nurture sends. Upserts site_key='medical' with paused=false and
...
/**
 * Record that a guardrail alert was fired. Upserts site_key='medical' updating
...
/**
 * Record that the hourly lead-nurture cron has fired. Upserts site_key='medical'
 ...
 * site_key='medical' updating only last_digest_run_at and updated_at.
