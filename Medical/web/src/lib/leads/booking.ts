 ...
 * call" flow. A slot is a weekday within the next 21 days plus one of three
 * call windows. No availability logic: the team calls the lead; the window
 * tells them when the lead said they would pick up.
 *
 * Pure and shared by the /book page (client picker), the thank-you inline
 * picker, and the POST /api/leads/book validator.
 */
...
/** "Tue 14 Jul, morning (9am to 12pm)" */
