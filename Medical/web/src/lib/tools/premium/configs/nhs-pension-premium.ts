...
export const nhsPensionPremiumConfig: PremiumToolConfig = {
  ...
  fields: [
    {
      ...
      max: 400000,
      step: 5000,
      help: "Broadly your taxable income minus your own pension contributions.",
    },
    {
      id: "pensionGrowth",
      ...
      max: 200000,
      step: 1000,
      help: "The capitalised growth in your NHS benefits, not the contributions you paid.",
    },
    {
      id: "taxBand",
  ...
  compute({ values }): PremiumResult {
    ...
    return {
      ...
      note:
        "2025/26 basis. The annual allowance is £60,000, tapering where threshold income exceeds £200,000 AND adjusted income exceeds £260,000, down to a £10,000 floor. This tool measures pension growth (input amount), not contributions you paid. Carry-forward of unused allowance from the previous three tax years can remove or reduce a charge and is not modelled here. Where the charge exceeds £2,000 and scheme growth exceeds £60,000, mandatory Scheme Pays can settle it (election deadline 31 July in the year after the charge). These are estimates, not advice.",
    };
  },
  explainer: {
