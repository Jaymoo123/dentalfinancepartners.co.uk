...
export const nhsPensionTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "NHS doctors are exposed to the pension tapered annual allowance for a structural reason rather than a personal one. The NHS scheme is defined benefit, so what adjusted income adds back is the capitalised growth in the benefits you accrued that year, not any contribution rate applied to your pay. A promotion, a large pay award or a jump in pensionable service can produce a pension input amount far bigger than anything that left your payslip, in a year when your cash income barely moved, and that is what pushes adjusted income over £260,000. On an Agenda for Change band 8a salary the taper rarely bites; on a salary of £120,000 with private practice on top, the threshold income annual allowance test is often the only thing keeping you out of it.",
