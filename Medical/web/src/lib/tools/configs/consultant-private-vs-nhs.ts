...
export const consultantPrivateVsNhsTool: GenericTool = {
  ...
  fields: [
    {
      ...
      max: 400_000,
      step: 5_000,
      help: "Your NHS salary or sessional pay that counts as pensionable. This counts toward threshold income.",
    },
    {
  ...
  compute(values) {
    ...
    const rows = [
      ...
      },
      {
        ...
        value: `${gbp(r.pensionInputAmount)} (from your annual allowance statement)`,
      },
    ];

    const note =
      taperNote +
      " 2026/27 basis. Threshold income is the sum of NHS pay, private income, and other income (own pension contributions reduce threshold income but are not captured here, so the estimate may be conservative). Adjusted income adds back the pension input amount you entered, per FA 2004 s.228ZA. The AA charge impact is modelled as the AA reduction multiplied by the marginal income-tax rate; your actual charge depends on whether total pension input for the year would otherwise have stayed within the allowance. Carry-forward of unused allowance from the prior three tax years may eliminate the charge entirely. Class 4 NI is applied to private income only. These are estimates, not advice. " +
      verdictNote;
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "The annual allowance taper is the subtlest and most damaging interaction. The NHS Pension standard annual allowance is £60,000. It tapers downward where BOTH of the following apply: threshold income (broadly all your taxable income) exceeds £200,000, AND adjusted income (threshold income plus your pension input amount for the year, the figure on your annual allowance statement) exceeds £260,000. For every £2 of adjusted income above £260,000, the allowance shrinks by £1, down to a minimum of £10,000. A consultant on £150,000 NHS pay and £70,000 existing private income, whose annual allowance statement shows a £35,000 pension input amount, has an adjusted income of £255,000 before any extra session. A single extra session worth £15,000 pushes adjusted income to £270,000, triggering the taper and reducing the annual allowance from £60,000 to £55,000. If total pension input for the year exceeds the tapered allowance, the reduction in allowance is charged to income tax at the marginal rate. At these income levels that rate is 45%, so the £5,000 AA reduction costs £2,250 in additional tax. The session that looked like £15,000 gross nets £5,700.",
      "The personal allowance taper adds a further complication between £100,000 and £125,140 of total income. In that band the personal allowance reduces by £1 for every £2 of additional income, creating an effective income-tax rate close to 60% on income in that range. This calculator models that interaction correctly by computing the personal allowance and income-tax bands dynamically rather than using a fixed higher-rate band width. Above £125,140 the effective income-tax rate drops back to 45%, but the AA taper and Class 4 NI can still push the combined effective marginal rate materially higher. The example above illustrates a combined effective rate of 62%.",
      "Worked example: consultant with NHS pensionable pay £150,000, existing private income £70,000 and a pension input amount of £35,000 on their annual allowance statement, considering a single extra session worth £15,000. Threshold income (with extra session): £150,000 plus £70,000 plus £15,000 equals £235,000. Adjusted income: £235,000 plus the £35,000 pension input amount equals £270,000, which exceeds £260,000, so the taper fires. Annual allowance falls from £60,000 to £60,000 minus (£270,000 minus £260,000) divided by 2 equals £55,000. Without the extra session, adjusted income is £255,000, below the £260,000 threshold, so no taper applies. AA reduction caused by the extra session: £5,000. Income tax on the extra £15,000 (all in the 45% additional-rate band at this income level): £6,750. Class 4 NI on the extra £15,000 (all above the £50,270 upper profits limit): £300. AA charge impact: £5,000 multiplied by 45% equals £2,250. Total cost: £9,300. Net retained: £5,700. Effective marginal rate: 62.0%. The £35,000 pension input amount is an assumption for the example; use your own statement figure.",
  ...
  faqs: [
    {
      ...
      answer:
        "The standard annual allowance for pension contributions is £60,000. For high earners it is reduced (tapered) where two conditions are both met: your threshold income exceeds £200,000, and your adjusted income exceeds £260,000. Adjusted income is threshold income plus your pension input amount for the year, which for a defined-benefit scheme such as the NHS scheme is the capitalised growth in your pension, not the contributions paid in. For every £2 of adjusted income above £260,000, the allowance shrinks by £1 to a minimum of £10,000. If the taper tips your pension input above the reduced allowance, you owe an AA charge at your marginal income-tax rate. For a consultant on £235,000 adjusted income, a single extra private session can be the trigger that fires this charge.",
    },
    {
    ...
    {
      question: "What is the pension input amount and why is it included?",
      answer:
        "The pension input amount is the growth in the value of your pension over the tax year, measured across every registered scheme you belong to. For a defined-benefit scheme such as the NHS Pension Scheme it is the capitalised increase in your accrued benefits, not the contributions that went in, and NHSBSA sends it to you on an annual allowance statement. Adjusted income is threshold income plus that pension input amount, so a year with a large pay rise or a big service increase can move you across the £260,000 line even when your cash income barely changed. Enter the figure from your statement rather than estimating it from your salary.",
    },
    {
