 ...
 * Both are imported directly from the local module (F5 RESOLVED).
 *
 ...
 *
 * FLAT routing: Medical uses flat /blog/[slug] routing; this loader is for
 * the /resources/[topic] route only (no flat-routing concern here).
 */
import fs from "fs";
