/**
 * Service-email shell for Medical Accountants UK lead-nurture follow-ups:
 * a centred white card on a #f6f7f8 canvas, MEDICAL ACCOUNTANTS UK wordmark
 * header band, 16px/1.6 body, blue-accented signature block, quiet footer.
 *
...
// Blue brand accent for Medical Accountants UK
const ACCENT = "#1d4ed8";
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">MEDICAL&nbsp;ACCOUNTANTS</div>
<div style="display:inline-block;border-top:2px solid ${ACCENT};margin-top:5px;padding-top:5px;font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">UK</div>
</td>
</tr>
<tr>
...
<div style="font-size:14px;font-weight:600;color:${ACCENT};line-height:1.5;">Medical Accountants UK</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://www.medicalaccounts.co.uk" style="color:#64748b;text-decoration:none;">medicalaccounts.co.uk</a></div>
</td>
</tr>
</table>
</td>
