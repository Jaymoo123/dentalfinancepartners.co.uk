# Wave 2 brief: uk-us-dta-property-tax-implications-landlords

**Site:** property
**Bucket:** Double Taxation Agreements (DTAs)
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/uk-us-dta-property-tax-implications-landlords.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/non-resident-landlord-tax/uk-us-dta-property-tax-implications-landlords

---

## Manager pre-decisions

- **Suggested slug:** `uk-us-dta-property-tax-implications-landlords`
- **Suggested category:** `non-resident-landlord-tax`
- **Bucket:** Double Taxation Agreements (DTAs)
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> The 2001/2002 UK-US treaty applied to property scenarios. The saving clause (Art 1(4)) — US citizens UK-resident still file US returns, foreign tax credit reduces double-tax burden. Art 6 (immovable property) and Art 13 (capital gains) — UK retains taxing rights over UK property. Article 24A elimination of double taxation. Worked example: US-citizen UK-resident with a Manchester BTL.
...
- https://uklandlordtax.co.uk/tax-guide/double-tax-agreements-dtas/ — general DTA framing; treat as the lateral-context source.
- https://www.gov.uk/government/publications/usa-tax-treaties — gov.uk USA treaty hub; the 2001 convention as amended by the 2002 protocol is the PDF here. Authoritative source for article numbers and saving-clause text.
- https://www.gov.uk/hmrc-internal-manuals/international-manual/intm150000 — HMRC INTM chapter on double-taxation-agreements; supplies the official interpretive framework HMRC officers apply.
- https://www.gov.uk/government/publications/non-residents-relief-under-double-taxation-agreements-hs304-self-assessment-helpsheet — HS304; the practical claim helpsheet, useful for the US-citizen-UK-resident worked example (where the FTC direction reverses).
- https://www.legislation.gov.uk/ukpga/2010/8/part/2 — TIOPA 2010 Part 2 (DT relief). Anchor for the credit method that operates alongside the treaty.
...
*Identified by Opus reasoning on the full 316-page Property inventory (2026-05-22 regen pass), not by token similarity. Token-scored list discarded because it returned unrelated AIA / capital-allowances / divorce pages with zero treaty or non-resident relevance.*

- `tax-treaties-property-investors-treaty-framework-guide` (Wave 2 sibling — Non-Resident Landlord Tax) — [reasoning: the treaty framework pillar this brief is the country-specific application of; link out for general OECD article map and credit-vs-exemption discussion rather than re-explaining.]
  - title: Tax Treaties for Property Investors: Treaty Framework Guide
- `uk-property-income-expats-tax-obligations-explained` (Non-Resident Landlord Tax) — [reasoning: descriptive expat-landlord pillar; the US-citizen-UK-resident worked example sits adjacent to it because the reverse-direction case (US person with UK property) is what this page targets.]
  - title: UK Property Income for Expats: Tax Obligations Explained
- `non-resident-landlord-scheme-uk-complete-guide` (Non-Resident Landlord Tax) — [reasoning: NRL pillar; the saving-clause framing means treaty residence doesn't displace UK statutory NRL withholding when the US citizen is non-UK-resident, so this is a load-bearing companion link.]
  - title: Non-Resident Landlord Scheme UK: Complete Guide for Overseas Property Investors
- `non-resident-cgt-uk-property-rates-reporting` (Non-Resident Landlord Tax) — [reasoning: NRCGT rates page; Art 13 capital gains allocation goes to UK as situs state regardless of saving clause, and NRCGT is the operational mechanism — direct link from the Art 13 walkthrough.]
  - title: Non-Resident CGT on UK Property: What Are the Rates and Reporting Requirements?
- `non-resident-cgt-selling-uk-property-overseas-guide` (Non-Resident Landlord Tax) — [reasoning: NRCGT applied / disposal-walkthrough version; readers using this brief to plan a Manchester BTL sale by a US-citizen UK-resident need the operational deeper page.]
  - title: Non-Resident CGT When Selling UK Property: Complete Tax Guide 2026
- `nrl-withholding-tax-20-percent-basic-rate-deduction` (Non-Resident Landlord Tax) — [reasoning: the 20% statutory withholding mechanic; relevant where the US citizen lands the worked example outside UK residence and the saving-clause-FTC interplay requires understanding gross-vs-net UK rent.]
  - title: NRL Withholding Tax: How the 20% Deduction Works (2026 Guide)
- `non-resident-landlord-self-assessment-filing-requirements` (Non-Resident Landlord Tax) — [reasoning: SA106 + UK SA filing for non-UK-resident landlords; the US-side filing burden has a UK-side mirror, so this is the operational neighbour for the compliance section.]
