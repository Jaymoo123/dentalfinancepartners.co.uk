...
- F-21 — existing IHT pillar should back-link to new A8 (same pattern as F-3, F-20)
- F-22 — forward-link from A8 to A9 pending A9 write (sibling-write cleanup, Session A handles when A9 ships)
