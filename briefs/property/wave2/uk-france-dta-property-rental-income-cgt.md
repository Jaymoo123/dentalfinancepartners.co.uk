# Wave 2 brief: uk-france-dta-property-rental-income-cgt

**Site:** property
**Bucket:** Double Taxation Agreements (DTAs)
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/uk-france-dta-property-rental-income-cgt.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/non-resident-landlord-tax/uk-france-dta-property-rental-income-cgt

---

## Manager pre-decisions

- **Suggested slug:** `uk-france-dta-property-rental-income-cgt`
- **Suggested category:** `non-resident-landlord-tax`
- **Bucket:** Double Taxation Agreements (DTAs)
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> The 2008 UK-France treaty applied to property. UK retains primary taxing rights on UK property income (Art 6) and gains (Art 24A). Where the landlord is French-resident, French tax-credit method gives credit for UK tax paid. Specific French wrinkles: contribution sociale (CSG/CRDS), French wealth tax (IFI) on UK property held by French residents, the UK-France IHT treaty (1963) and its tie-breakers.
...
- https://www.gov.uk/government/publications/france-tax-treaties — gov.uk hub for the UK-France treaty; the 2008 convention (in force 2009) and its MLI modifications. Anchor for any article-number citation.
- https://www.gov.uk/hmrc-internal-manuals/international-manual/intm151010 — HMRC INTM151010 on the concept and principles of double taxation; the official UK interpretive frame for how UK and French rules collide on a single rental stream.
- https://www.gov.uk/hmrc-internal-manuals/international-manual/intm153070 — HMRC INTM153070 on Art 6 (immovable property); supports the "UK retains primary taxing rights over UK rental income from a French-resident landlord" position.
- https://www.gov.uk/hmrc-internal-manuals/international-manual/intm161000 — HMRC INTM161000 on DT relief for UK residents with foreign income; the operational anchor for the UK-side FTC claim where a UK landlord owns French property.
- https://www.gov.uk/government/publications/non-residents-relief-under-double-taxation-agreements-hs304-self-assessment-helpsheet — HS304; the practical claim helpsheet for treaty-based relief, useful for both directions of the worked example.
...
*Identified by Opus reasoning on the full 316-page Property inventory (2026-05-22 regen pass), not by token similarity. Token-scored list discarded because it returned CGT-mechanics pages with no French / treaty angle.*

- `non-resident-landlord-scheme-uk-complete-guide` (Non-Resident Landlord Tax) — [reasoning: the NRL pillar; the French-resident leg of this brief's worked example operates inside NRL, so this page is the operational neighbour for the "what about the 20% withholding" reader question that will surface.]
  - title: Non-Resident Landlord Scheme UK: Complete Guide for Overseas Property Investors
- `nrl-withholding-tax-20-percent-basic-rate-deduction` (Non-Resident Landlord Tax) — [reasoning: the 20% withholding mechanics page; treaty residence in France does not displace NRL, and this brief should explicitly clarify that point with a link out.]
  - title: NRL Withholding Tax: How the 20% Deduction Works (2026 Guide)
- `nrl-approval-receive-rent-gross-hmrc-guide` (Non-Resident Landlord Tax) — [reasoning: the gross-payment NRL1/NRL2 application page; a French-resident landlord with a UK BTL will reach this page through the worked example, so link out rather than re-explain mechanics here.]
  - title: How to Apply for NRL Approval to Receive Rent Gross: Complete HMRC Guide
- `non-resident-cgt-uk-property-rates-reporting` (Non-Resident Landlord Tax) — [reasoning: NRCGT rates pillar; this brief touches Art 24A (capital gains), which the treaty allocates to UK but the statutory NRCGT regime imposes regardless, so this page is the operational reality the framework page references.]
  - title: Non-Resident CGT on UK Property: What Are the Rates and Reporting Requirements?
- `non-resident-cgt-selling-uk-property-overseas-guide` (Non-Resident Landlord Tax) — [reasoning: NRCGT applied / disposal page; for any reader actually planning a French-resident sale of UK property, this is the deeper operational neighbour.]
  - title: Non-Resident CGT When Selling UK Property: Complete Tax Guide 2026
- `uk-property-income-expats-tax-obligations-explained` (Non-Resident Landlord Tax) — [reasoning: expat-landlord obligations pillar; French-resident landlords land here on the "what do I owe?" question before reaching the treaty-specific page.]
  - title: UK Property Income for Expats: Tax Obligations Explained
- `tax-treaties-property-investors-treaty-framework-guide` (Non-Resident Landlord Tax) — [reasoning: the Wave 2 DTA pillar (sibling on same wave); this bilateral page is the applied version of that framework page, link UP to it as the parent rather than re-explain Art 4/6/13/23.]
  - title: Tax Treaties for Property Investors: Treaty Framework Guide
- `inheritance-tax-rental-property-uk-guide` (Landlord Tax Essentials) — [reasoning: the framing differentiator specifically calls out the UK-France IHT treaty (1963), a unique bilateral wrinkle; cross-link only on the IHT section so this brief doesn't drift into general IHT.]
