...
> **§16.35 BRIEF CORRECTION (B10 BRIEF_ERROR) 2026-05-23:** the framing differentiator below references "FA 2003 Sch 7 Part 2 acquisition relief" as the scope-mirror for Scottish acquisition relief. The operative Scottish statutory base is **LBTT(S)A 2013 Sch 11** ("Reconstruction relief and acquisition relief"). FA 2003 Sch 7 is the English SDLT parallel — useful as a cross-jurisdictional contrast cite but NOT the Scottish-side statutory anchor. The shipped B10 page uses LBTT(S)A 2013 Sch 11 throughout. Any future content generated from this brief MUST use LBTT(S)A 2013 Sch 11 as the operative Scottish acquisition-relief cite; FA 2003 Sch 7 may be referenced only as the English parallel.
