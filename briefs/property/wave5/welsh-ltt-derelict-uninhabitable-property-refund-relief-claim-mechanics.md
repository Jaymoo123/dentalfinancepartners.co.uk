...
> **§16.35 BRIEF CORRECTION (B5 BRIEF_ERROR) 2026-05-23:** the framing differentiator below cites "LTTA 2017 s.34 + Tax Collection and Management (Wales) Act 2016" for the time-limit for amending the LTT return. **LTTA 2017 s.34 is in fact unit trust schemes**, not return amendment. The correct citations are **TCMA 2016 s.41** (12-month return amendment) + **TCMA 2016 s.63** (overpayment relief claim) + **TCMA 2016 s.78** (4-year time limit). The shipped B5 page uses the TCMA 2016 cites throughout. Any future content generated from this brief MUST use TCMA 2016 s.41 / s.63 / s.78 for the return-amendment + overpayment-relief mechanics, NOT LTTA 2017 s.34.
