# Wave 3 brief: ated-overseas-companies-voluntary-compliance-otm-letters

**Site:** property
**Bucket:** ATED (Annual Tax on Enveloped Dwellings)
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/ated-overseas-companies-voluntary-compliance-otm-letters.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/ated-overseas-companies-voluntary-compliance-otm-letters

---

## Manager pre-decisions

- **Suggested slug:** `ated-overseas-companies-voluntary-compliance-otm-letters`
