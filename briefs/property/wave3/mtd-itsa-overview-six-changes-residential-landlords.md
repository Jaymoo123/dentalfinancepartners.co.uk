# Wave 3 brief: mtd-itsa-overview-six-changes-residential-landlords

**Site:** property
**Bucket:** MTD for ITSA
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/mtd-itsa-overview-six-changes-residential-landlords.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/making-tax-digital-mtd/mtd-itsa-overview-six-changes-residential-landlords

---

## Manager pre-decisions

- **Suggested slug:** `mtd-itsa-overview-six-changes-residential-landlords`
