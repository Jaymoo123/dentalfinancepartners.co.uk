# Wave 3 brief: mtd-itsa-major-tax-reform-context-policy-history

**Site:** property
**Bucket:** MTD for ITSA
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/mtd-itsa-major-tax-reform-context-policy-history.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/making-tax-digital-mtd/mtd-itsa-major-tax-reform-context-policy-history

---

## Manager pre-decisions

- **Suggested slug:** `mtd-itsa-major-tax-reform-context-policy-history`
