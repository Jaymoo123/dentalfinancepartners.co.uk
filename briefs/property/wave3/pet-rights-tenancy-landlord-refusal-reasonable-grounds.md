# Wave 3 brief: pet-rights-tenancy-landlord-refusal-reasonable-grounds

**Site:** property
**Bucket:** Renters Rights Act 2025 + Tenancies
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/pet-rights-tenancy-landlord-refusal-reasonable-grounds.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/pet-rights-tenancy-landlord-refusal-reasonable-grounds

---

## Manager pre-decisions

- **Suggested slug:** `pet-rights-tenancy-landlord-refusal-reasonable-grounds`
