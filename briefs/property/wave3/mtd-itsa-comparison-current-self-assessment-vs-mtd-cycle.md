# Wave 3 brief: mtd-itsa-comparison-current-self-assessment-vs-mtd-cycle

**Site:** property
**Bucket:** MTD for ITSA
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/mtd-itsa-comparison-current-self-assessment-vs-mtd-cycle.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/making-tax-digital-mtd/mtd-itsa-comparison-current-self-assessment-vs-mtd-cycle

---

## Manager pre-decisions

- **Suggested slug:** `mtd-itsa-comparison-current-self-assessment-vs-mtd-cycle`
