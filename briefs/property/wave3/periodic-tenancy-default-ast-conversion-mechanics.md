# Wave 3 brief: periodic-tenancy-default-ast-conversion-mechanics

**Site:** property
**Bucket:** Renters Rights Act 2025 + Tenancies
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/periodic-tenancy-default-ast-conversion-mechanics.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/periodic-tenancy-default-ast-conversion-mechanics

---

## Manager pre-decisions

- **Suggested slug:** `periodic-tenancy-default-ast-conversion-mechanics`
