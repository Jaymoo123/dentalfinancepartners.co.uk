# Wave 3 brief: ated-valuation-date-rules-2027-revaluation

**Site:** property
**Bucket:** ATED (Annual Tax on Enveloped Dwellings)
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/ated-valuation-date-rules-2027-revaluation.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/ated-valuation-date-rules-2027-revaluation

---

## Manager pre-decisions

- **Suggested slug:** `ated-valuation-date-rules-2027-revaluation`
