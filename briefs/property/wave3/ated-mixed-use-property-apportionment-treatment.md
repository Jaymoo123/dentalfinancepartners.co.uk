# Wave 3 brief: ated-mixed-use-property-apportionment-treatment

**Site:** property
**Bucket:** ATED (Annual Tax on Enveloped Dwellings)
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/ated-mixed-use-property-apportionment-treatment.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/ated-mixed-use-property-apportionment-treatment

---

## Manager pre-decisions

- **Suggested slug:** `ated-mixed-use-property-apportionment-treatment`
