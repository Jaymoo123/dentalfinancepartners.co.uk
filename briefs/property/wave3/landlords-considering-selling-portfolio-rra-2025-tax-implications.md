# Wave 3 brief: landlords-considering-selling-portfolio-rra-2025-tax-implications

**Site:** property
**Bucket:** Renters Rights Act 2025 + Tenancies
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/landlords-considering-selling-portfolio-rra-2025-tax-implications.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/landlords-considering-selling-portfolio-rra-2025-tax-implications

---

## Manager pre-decisions

- **Suggested slug:** `landlords-considering-selling-portfolio-rra-2025-tax-implications`
