# Wave 3 brief: mtd-itsa-accidental-landlords-do-i-need-to-file-digitally

**Site:** property
**Bucket:** MTD for ITSA
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/mtd-itsa-accidental-landlords-do-i-need-to-file-digitally.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/making-tax-digital-mtd/mtd-itsa-accidental-landlords-do-i-need-to-file-digitally

---

## Manager pre-decisions

- **Suggested slug:** `mtd-itsa-accidental-landlords-do-i-need-to-file-digitally`
