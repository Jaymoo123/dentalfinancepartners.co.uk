# Wave 4 brief: fic-property-corporate-governance-board-meetings-resolutions-discipline

**Site:** property
**Bucket:** LtdCo mechanics + FIC depth (FIC sub-thread)
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/fic-property-corporate-governance-board-meetings-resolutions-discipline.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/fic-property-corporate-governance-board-meetings-resolutions-discipline
...
**Stage 1 manager note:** FIC sub-thread, governance/discipline angle. Net-new framing on our site.
...
- `fic-vs-discretionary-trust-property-comparison` (Jaccard 0.15, category: `Incorporation & Company Structures`)
- `fic-complete-guide-property-wealth-transfer` (Jaccard 0.13, category: `Incorporation & Company Structures`)
- `fic-iht-treatment-bpr-myth` (Jaccard 0.11, category: `Incorporation & Company Structures`)
- `property-investment-tax-uk-complete-guide-2026` (Jaccard 0.11, category: `Landlord Tax Essentials`)
- `incorporating-property-portfolio-uk-2026` (Jaccard 0.10, category: `Incorporation & Company Structures`)
