# Wave 4 brief: fic-blended-family-protected-legacy-property-second-marriage

**Site:** property
**Bucket:** LtdCo mechanics + FIC depth (FIC sub-thread)
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/fic-blended-family-protected-legacy-property-second-marriage.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/fic-blended-family-protected-legacy-property-second-marriage
...
**Stage 1 manager note:** FIC sub-thread, blended-family use case. Net-new on our site; closest existing is the FIC-pillar.
...
- `fic-complete-guide-property-wealth-transfer` (Jaccard 0.21, category: `Incorporation & Company Structures`)
- `cgt-gifting-property-family-members-uk` (Jaccard 0.18, category: `Capital Gains Tax`)
- `family-investment-company-property-worth-it` (Jaccard 0.18, category: `Incorporation & Company Structures`)
