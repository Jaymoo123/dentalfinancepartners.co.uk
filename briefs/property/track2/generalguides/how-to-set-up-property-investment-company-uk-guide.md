...
- **§5 CGT on UK residential property 2026/27** [LOCKED]: 18%/24% on the transfer-existing fork; £3,000 AEA; s.162 incorporation relief applies where ALL business assets transfer for shares and the activity is a "business" (Ramsay [2013] threshold). **NOT automatic since FA 2026 s.39: for transfers on/after 6 Apr 2026 it must be CLAIMED** (new TCGA 1992 s.162(1)(b)), by the first anniversary of the 31 January following the tax year of the transfer; s.162A disapplication election REPEALED, so it is claim-or-no-relief. [Re-locked 2026-08-03; the previous "automatic" wording was stale and had propagated into live pages.] Quantify lightly here; cross-link to `incorporating-property-portfolio-uk-2026` for depth.
