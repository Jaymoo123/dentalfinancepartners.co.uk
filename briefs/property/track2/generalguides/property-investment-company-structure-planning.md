...
- **§5 CGT + s.162 incorporation relief + BADR** [LOCKED; re-locked 2026-08-03]: s.162 CGT relief on incorporation of a *business* (Ramsay v HMRC [2013] threshold, multi-property active management). **NOT automatic since FA 2026 s.39: for transfers on/after 6 Apr 2026 it must be CLAIMED** (new TCGA 1992 s.162(1)(b)), by the first anniversary of the 31 January following the tax year of the transfer; the s.162A disapplication election was REPEALED, so it is claim-or-no-relief. The previous "automatic" wording here was stale and had propagated into live pages. BADR does NOT apply to investment property; BADR rate 14% (6 Apr 2025) → 18% (6 Apr 2026), NOT 10%.
