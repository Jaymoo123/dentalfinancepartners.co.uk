# Track 1 brief: sdlt-sub-sale-relief-mechanics

**Site:** property
**Bucket:** SDLT — surcharges and reliefs
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/sdlt-sub-sale-relief-mechanics.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/sdlt-sub-sale-relief-mechanics

---

## Manager pre-decisions

- **Suggested slug:** `sdlt-sub-sale-relief-mechanics`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** SDLT — surcharges and reliefs
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Narrow application of section 45 FA 2003 — pre-completion contract transfer to a connected entity. Useful only for genuine pre-completion onward sales; common misunderstanding is that it can be used to retrofit a portfolio into a company SDLT-free (it cannot). Frame as a clarification piece.
...
- `section-24-tax-relief-complete-guide` (Section 24 & Tax Relief) — score 0.12
  - title: Section 24 Tax Relief for Landlords: Complete Guide
- `principal-private-residence-relief-landlords` (Capital Gains Tax) — score 0.11
