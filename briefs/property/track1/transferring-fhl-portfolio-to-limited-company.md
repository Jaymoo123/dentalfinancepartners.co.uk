# Track 1 brief: transferring-fhl-portfolio-to-limited-company

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/transferring-fhl-portfolio-to-limited-company.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/transferring-fhl-portfolio-to-limited-company

---

## Manager pre-decisions

- **Suggested slug:** `transferring-fhl-portfolio-to-limited-company`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Post-FHL-abolition (April 2025) decision: should former FHL owners incorporate? Loss of BADR on disposal, gain of S24 protection, ATED implications for high-value FHL stock, anti-forestalling rules during the transition. Worked example for a 3-property FHL portfolio.
...
- `buy-to-let-limited-company-complete-guide-uk` (Incorporation & Company Structures) — score 0.29
...
- `how-to-transfer-property-into-limited-company-uk` (Incorporation & Company Structures) — score 0.22
  - title: How to Transfer Property Into a Limited Company UK: Complete Guide for Landlords
- `limited-company-vs-personal-ownership-tax-comparison-2026` (Incorporation & Company Structures) — score 0.2
  - title: Limited Company vs. Personal Ownership: UK Property Tax Comparison 2026
- `buy-to-let-limited-company-mortgage-options` (Incorporation & Company Structures) — score 0.18
