# Track 1 brief: extracting-money-from-property-limited-company

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/extracting-money-from-property-limited-company.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/extracting-money-from-property-limited-company

---

## Manager pre-decisions

- **Suggested slug:** `extracting-money-from-property-limited-company`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Comparison of extraction routes from a property company: salary + employer pension contribution (efficient up to NI thresholds), dividends (after 2024/25 dividend allowance £500), director loan repayment (no further tax once balance settled), share buyback (rarely advantageous), liquidation under s.110 reorganisation (specialist). Worked example: extracting £40k/year from a £150k profits property company.
...
- `cgt-property-transfer-limited-company-calculate` (Capital Gains Tax) — score 0.38
  - title: CGT on Property Transfer to Limited Company: How to Calculate
- `how-to-transfer-property-into-limited-company-uk` (Incorporation & Company Structures) — score 0.38
  - title: How to Transfer Property Into a Limited Company UK: Complete Guide for Landlords
- `limited-company-vs-personal-ownership-tax-comparison-2026` (Incorporation & Company Structures) — score 0.33
  - title: Limited Company vs. Personal Ownership: UK Property Tax Comparison 2026
- `buy-to-let-limited-company-mortgage-options` (Incorporation & Company Structures) — score 0.3
