# Track 1 brief: substantial-shareholding-exemption-property-companies

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/substantial-shareholding-exemption-property-companies.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/substantial-shareholding-exemption-property-companies

---

## Manager pre-decisions

- **Suggested slug:** `substantial-shareholding-exemption-property-companies`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> When SSE (s.192A TCGA 1992) applies on a company's disposal of shares in a property-trading subsidiary. The 12-month minimum holding, 10% minimum stake, and the trading-company test. Why most property INVESTMENT companies don't qualify (Pawson reasoning) but property TRADING / development subsidiaries can.
...
- `accountant-payroll-services` (Incorporation & Company Structures) — score 0.18
  - title: Accountant Payroll Services for Property Investors
- `director-loan-property-company` (Incorporation & Company Structures) — score 0.17
  - title: Director Loans in Property Companies: Tax Rules and Implications
- `property-company-employer-pension-contributions-directors` (Incorporation & Company Structures) — score 0.17
