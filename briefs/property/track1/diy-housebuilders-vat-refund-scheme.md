# Track 1 brief: diy-housebuilders-vat-refund-scheme

**Site:** property
**Bucket:** VAT for landlords
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/diy-housebuilders-vat-refund-scheme.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/diy-housebuilders-vat-refund-scheme

---

## Manager pre-decisions

- **Suggested slug:** `diy-housebuilders-vat-refund-scheme`
- **Suggested category:** `property-types-and-specialist-tax`
- **Bucket:** VAT for landlords
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> The DIY housebuilders' refund scheme (VAT Notice 719): how a self-builder constructing their own dwelling can recover VAT on materials, when professional fees can be recovered, the 6-month claim window from completion, and the typical claim size. Not available for buy-to-let; aimed at owner-occupiers.
...
- `vat-calculator` (Property Types & Specialist Tax) — score 0.11
  - title: How to Use a VAT Calculator for UK Property Investors
- `vat-how-to-calculate` (Property Accountant Services) — score 0.11
  - title: VAT: How to Calculate It for Your Property Business
- `vat-tax-calculator` (Property Accountant Services) — score 0.11
