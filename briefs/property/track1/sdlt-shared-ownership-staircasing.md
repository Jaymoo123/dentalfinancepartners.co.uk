# Track 1 brief: sdlt-shared-ownership-staircasing

**Site:** property
**Bucket:** SDLT — surcharges and reliefs
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/sdlt-shared-ownership-staircasing.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/sdlt-shared-ownership-staircasing

---

## Manager pre-decisions

- **Suggested slug:** `sdlt-shared-ownership-staircasing`
- **Suggested category:** `landlord-tax-essentials`
- **Bucket:** SDLT — surcharges and reliefs
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> How SDLT works on shared-ownership purchases AND each subsequent staircasing increment. Specific HMRC rules: market-value election vs sequential payment, the 80% trigger point, interaction with additional dwellings surcharge. Worked example through a 25/50/80% acquisition.
...
- `section-24-joint-property-ownership-tax-split` (Section 24 & Tax Relief) — score 0.11
