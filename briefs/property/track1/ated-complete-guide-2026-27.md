# Track 1 brief: ated-complete-guide-2026-27

**Site:** property
**Bucket:** ATED
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/ated-complete-guide-2026-27.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/ated-complete-guide-2026-27

---

## Manager pre-decisions

- **Suggested slug:** `ated-complete-guide-2026-27`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** ATED
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Comprehensive ATED reference for 2026/27. Who's caught (non-natural persons with single dwellings over £500k), the 2026/27 bands with annual charges, all available reliefs (rental, dev, public-access, etc), the 30 April annual return deadline, and the late-filing penalty cascade. Pillar page for everything ATED.
...
- `capital-gains-tax-property-complete-guide-uk` (Capital Gains Tax) — score 0.17
  - title: Capital Gains Tax on UK Property: Complete Guide for Landlords (2026/27)
- `corporation-tax-rates-property-companies-2026-27` (Incorporation & Company Structures) — score 0.17
  - title: What Are Corporation Tax Rates for Property Companies in 2026/27?
- `income-tax-rates-landlords-2026-27-complete-guide` (Landlord Tax Essentials) — score 0.17
  - title: What Are the Income Tax Rates for Landlords in 2026/27?
- `cgt-rates-property-2026-27-current-rates-explained` (Capital Gains Tax) — score 0.14
  - title: What Are the CGT Rates for Property in 2026/27?
- `cgt-payment-deadlines-property-sales-2026` (Capital Gains Tax) — score 0.12
