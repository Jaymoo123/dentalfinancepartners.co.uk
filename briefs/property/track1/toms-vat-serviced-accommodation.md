# Track 1 brief: toms-vat-serviced-accommodation

**Site:** property
**Bucket:** VAT for landlords
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/toms-vat-serviced-accommodation.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/property-types-and-specialist-tax/toms-vat-serviced-accommodation

---

## Manager pre-decisions

- **Suggested slug:** `toms-vat-serviced-accommodation`
- **Suggested category:** `property-types-and-specialist-tax`
- **Bucket:** VAT for landlords
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Tour Operators' Margin Scheme (TOMS) and when a serviced-accommodation operator qualifies. The Sonder case (Upper Tribunal reversal of FTT, 2024) and what it means for short-let providers buying-in and on-selling room-nights. Implications for VAT registration threshold and cash flow.
...
- `serviced-accommodation-tax-fhl-abolition-april-2025` (Property Types & Specialist Tax) — score 0.2
  - title: How Does Serviced Accommodation Tax Work After FHL Abolition in April 2025?
- `serviced-accommodation-vs-buy-to-let-tax-comparison-2026` (Property Types & Specialist Tax) — score 0.17
  - title: Serviced Accommodation vs Buy-to-Let Tax: Which Strategy Costs Less in 2026?
- `vat-calculator` (Property Types & Specialist Tax) — score 0.12
  - title: How to Use a VAT Calculator for UK Property Investors
- `vat-how-to-calculate` (Property Accountant Services) — score 0.12
  - title: VAT: How to Calculate It for Your Property Business
- `vat-tax-calculator` (Property Accountant Services) — score 0.12
