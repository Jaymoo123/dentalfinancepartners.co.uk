# Track 1 brief: sdlt-group-relief-for-corporate-landlord-portfolios

**Site:** property
**Bucket:** SDLT — surcharges and reliefs
**Session:** A
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/sdlt-group-relief-for-corporate-landlord-portfolios.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/sdlt-group-relief-for-corporate-landlord-portfolios

---

## Manager pre-decisions

- **Suggested slug:** `sdlt-group-relief-for-corporate-landlord-portfolios`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** SDLT — surcharges and reliefs
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Schedule 7 FA 2003 group relief mechanics for transfers between 75%-owned group companies. When intra-group property transfers can be SDLT-free, the 3-year claw-back rule, and the anti-avoidance carve-outs. Practical for landlords restructuring multi-company holdings.
...
- `landlord-capital-allowances-tax-relief` (Section 24 & Tax Relief) — score 0.18
  - title: Landlord Capital Allowances: A Complete Guide to Tax Relief
- `landlord-incorporation-step-by-step-guide-uk` (Incorporation & Company Structures) — score 0.14
  - title: Landlord Incorporation: Step-by-Step Guide UK
- `landlord-tax-return-complete-guide-2026` (Landlord Tax Essentials) — score 0.14
  - title: Landlord Tax Return: Complete Guide 2026
- `multi-property-landlord-tax-planning-strategies-5-plus-properties` (Portfolio Management) — score 0.12
  - title: How Should Multi-Property Landlords Structure Tax Planning for 5+ Properties?
- `inheritance-tax-rental-property-uk-guide` (Landlord Tax Essentials) — score 0.11
