# Track 1 brief: domestic-reverse-charge-construction-vat-landlords

**Site:** property
**Bucket:** VAT for landlords
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/domestic-reverse-charge-construction-vat-landlords.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/landlord-tax-essentials/domestic-reverse-charge-construction-vat-landlords

---

## Manager pre-decisions

- **Suggested slug:** `domestic-reverse-charge-construction-vat-landlords`
- **Suggested category:** `landlord-tax-essentials`
- **Bucket:** VAT for landlords
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> How the construction industry domestic reverse charge (CIS-related, in force since March 2021) affects property developers and refurbishing landlords. When the landlord is the 'end user' (no DRC applies) vs when they're in a CIS chain (DRC applies, contractor doesn't charge VAT). Common cash-flow trap for property developers.
...
- `replacement-domestic-items-relief-uk-landlords-guide` (Section 24 & Tax Relief) — score 0.18
  - title: What Is Replacement Domestic Items Relief and What Can UK Landlords Claim?
- `section-24-child-benefit-high-income-charge-landlords` (Section 24 & Tax Relief) — score 0.13
  - title: How Does Section 24 Affect Child Benefit for High-Earning Landlords?
- `rental-income-tax-uk-complete-guide-landlords` (Section 24 & Tax Relief) — score 0.12
  - title: Rental Income Tax UK: Complete Guide for Landlords 2026
- `annual-investment-allowance-landlords-uk` (Section 24 & Tax Relief) — score 0.11
  - title: Annual Investment Allowance for UK Landlords: A Complete Guide
- `best-mtd-software-landlords-2026` (Making Tax Digital (MTD)) — score 0.11
