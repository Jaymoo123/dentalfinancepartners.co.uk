# Track 1 brief: close-investment-holding-company-property

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/close-investment-holding-company-property.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/close-investment-holding-company-property

---

## Manager pre-decisions

- **Suggested slug:** `close-investment-holding-company-property`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> What a Close Investment-Holding Company (CIHC) is, and why most pure-investment BTL companies do NOT fall into the special category that previously applied higher CT rates. The 'close company' status mechanics, the consequences for s.455 loan to participators charge, and IHT implications for shareholders.
...
- `property-investment-tax-uk-complete-guide-2026` (Landlord Tax Essentials) — score 0.4
  - title: Property Investment Tax UK: Complete Guide 2026
- `family-investment-company-property-worth-it` (Incorporation & Company Structures) — score 0.38
  - title: Family Investment Company for Property: Is It Worth It?
- `how-to-set-up-property-investment-company-uk-guide` (Incorporation & Company Structures) — score 0.38
  - title: How to Set Up a Property Investment Company: Complete UK Guide 2025
- `property-investment-company-structure-planning` (Incorporation & Company Structures) — score 0.38
  - title: Property Investment Company Structure Planning: A Complete Guide for UK Landlords
- `when-does-property-holding-company-structure-make-sense-uk-landlords` (Incorporation & Company Structures) — score 0.27
