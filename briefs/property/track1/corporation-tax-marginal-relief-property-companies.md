# Track 1 brief: corporation-tax-marginal-relief-property-companies

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/corporation-tax-marginal-relief-property-companies.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/corporation-tax-marginal-relief-property-companies

---

## Manager pre-decisions

- **Suggested slug:** `corporation-tax-marginal-relief-property-companies`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Mechanics of corporation tax marginal relief for property companies in the £50k–£250k augmented profits band. The associated-companies rule and how an SPV-per-property structure can push you into the 25% main rate prematurely. Worked example showing the effective marginal rate at £100k profits.
...
- `accountant-corporation-tax-property-companies` (Incorporation & Company Structures) — score 0.43
  - title: Corporation Tax Accountants for UK Property Companies
- `corporation-tax-rates-property-companies-2026-27` (Incorporation & Company Structures) — score 0.43
  - title: What Are Corporation Tax Rates for Property Companies in 2026/27?
- `incorporation-holdover-relief-property` (Incorporation & Company Structures) — score 0.22
  - title: Incorporation Holdover Relief for Property: Complete UK Guide
- `landlord-capital-allowances-tax-relief` (Section 24 & Tax Relief) — score 0.2
  - title: Landlord Capital Allowances: A Complete Guide to Tax Relief
- `tax-relief-mortgage-interest-rented-property-guide` (Section 24 & Tax Relief) — score 0.2
