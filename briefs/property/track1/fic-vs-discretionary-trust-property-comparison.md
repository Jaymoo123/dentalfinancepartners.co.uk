# Track 1 brief: fic-vs-discretionary-trust-property-comparison

**Site:** property
**Bucket:** Family Investment Companies
**Session:** C
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/fic-vs-discretionary-trust-property-comparison.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/fic-vs-discretionary-trust-property-comparison

---

## Manager pre-decisions

- **Suggested slug:** `fic-vs-discretionary-trust-property-comparison`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Family Investment Companies
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> Side-by-side comparison of FIC vs discretionary trust for transferring rental property wealth to the next generation. Control retention, IHT treatment (the trust 10-year and exit charges vs FIC share dilution mechanics), corporation tax inside the FIC vs 45% income tax inside a trust, settlor's rights, and the practical setup costs. Worked example for £1.5m of BTL equity.
...
- `limited-company-vs-personal-ownership-tax-comparison-2026` (Incorporation & Company Structures) — score 0.3
  - title: Limited Company vs. Personal Ownership: UK Property Tax Comparison 2026
- `property-investment-vs-stocks-shares-tax-comparison` (Landlord Tax Essentials) — score 0.25
  - title: Property Investment vs Stocks and Shares: Which Is Better for Tax?
- `property-accountant-vs-general-accountant` (Property Accountant Services) — score 0.22
  - title: Property Accountant vs General Accountant: What's the Difference?
- `hmo-vs-standard-buy-to-let-tax-comparison` (Property Types & Specialist Tax) — score 0.2
  - title: HMO vs Standard Buy-to-Let: Which Property Type Offers Better Tax Advantages?
- `property-company-profit-extraction-salary-vs-dividends` (Incorporation & Company Structures) — score 0.18
