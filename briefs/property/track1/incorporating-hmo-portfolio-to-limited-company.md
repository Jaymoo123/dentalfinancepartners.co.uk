# Track 1 brief: incorporating-hmo-portfolio-to-limited-company

**Site:** property
**Bucket:** Limited company / BTL operation
**Session:** B
**Brief type:** Net-new page (no existing markdown file)
**Source markdown path on launch:** `Property/web/content/blog/incorporating-hmo-portfolio-to-limited-company.md`
**Live URL on launch:** https://www.propertytaxpartners.co.uk/blog/incorporation-and-company-structures/incorporating-hmo-portfolio-to-limited-company

---

## Manager pre-decisions

- **Suggested slug:** `incorporating-hmo-portfolio-to-limited-company`
- **Suggested category:** `incorporation-and-company-structures`
- **Bucket:** Limited company / BTL operation
- **Framing differentiator (READ THIS CAREFULLY — defines what makes this page distinct):**

> HMO-specific incorporation factors: capital allowances on fixtures (cannot be claimed by individuals on residential lets but CAN by companies in some scenarios — see CAA 2001), mortgage market for ltd-co HMO (fewer lenders), licensing obligations transfer, and the practical sequence for moving a 5-bed HMO portfolio into a company.
...
- `incorporating-property-portfolio-uk-2026` (Incorporation & Company Structures) — score 0.33
