# Brief: locum-doctor-umbrella-company-2026-reforms

**Site:** medical
**Source file:** `Medical/web/content/blog/locum-doctor-umbrella-company-2026-reforms.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/locum-doctor-umbrella-company-2026-reforms
...
- **Category:** Locum Tax
- **Current body word count (approx):** 823
...
- **Primary query:** `Locum Umbrella Company Reforms 2026 | What's Changing`
...
1. **umbrellacompanies.org.uk** — [Umbrella Companies | Umbrella company locum doctors should be...](https://umbrellacompanies.org.uk/umbrella-company-locum-doctors-should-be-welcomed/)
   - *DDG snippet:* In the past year, annual spending on locum doctors for our hospitals has risen by almost £200 million and since 2007 the amount spent has nearly doubled. £250 million per year is spent just on surgical locums.
2. **umbrellacompanyuk.co.uk** — [Looking for an Umbrella Company for Locums?](https://umbrellacompanyuk.co.uk/umbrella-company-for-locums/)
   - *DDG snippet:* Umbrella Company UK is the perfect umbrella company for locums working throughout the UK. Having helped thousands of temporary workers (including plenty locum pharmacists and doctors) working in both the private and public sectors, we have you covered.
3. **mintumbrella.co.uk** — [Umbrella companies for nurses explained – Mint Umbrella](https://mintumbrella.co.uk/umbrella-companies-for-nurses-explained/)
   - *DDG snippet:* What is an umbrella company? Umbrella companies act as the middleman between the employee and the agency they are working for. The umbrella provider is responsible for processing payroll for the temporary worker – in this case, the locum nurse.
...
- `locum-doctor-limited-company-pros-and-cons` (overlap: company, doctor, locum)
- `locum-doctor-expenses-what-you-can-claim` (overlap: doctor, locum)
- `locum-doctor-ir35-what-you-need-to-know` (overlap: doctor, locum)
- `locum-doctor-self-assessment-filing-guide` (overlap: doctor, locum)
- `locum-doctor-tax-complete-guide` (overlap: doctor, locum)
