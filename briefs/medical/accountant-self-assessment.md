# Brief: accountant-self-assessment

**Site:** medical
**Source file:** `Medical/web/content/blog/accountant-self-assessment.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/accountant-self-assessment
...
- **Current body word count (approx):** 571
...
- **Primary query:** `Self Assessment for Doctors 2026/27`
...
1. **gov.uk** — [HS231 Doctors’ expenses (2026) - GOV.UK](https://www.gov.uk/government/publications/doctors-expenses-hs231-self-assessment-helpsheet/hs231-doctors-expenses-2026)
   - *DDG snippet:* For further information, see Helpsheet 222 How to calculate your taxable profits. 5. Contact Online forms, phone numbers and addresses for advice on Self Assessment.
2. **moneywisedoctor.com** — [Self assessment for doctors: Doctors self-assessment tax returns](https://moneywisedoctor.com/self-assessment-for-doctors/)
   - *DDG snippet:* Self-Assessment for Doctors: A Comprehensive Guide Self-assessment for doctors is probably not everyone’s favourite topic. As a doctor, nurse, or healthcare professional, balancing a demanding schedule with financial responsibilities can be overwhelming. However, understanding whether you need to fi
3. **kudosaccounting.co.uk** — [MTD for Income Tax Is Now Live: What GP Partners and Locum Doctors Must ...](https://kudosaccounting.co.uk/mtd-income-tax-gp-partners-locum-doctors-2026/)
   - *DDG snippet:* Making Tax Digital for Income Tax Self Assessment (MTD for ITSA) is no longer a future deadline to plan for — it is here. From 6 April 2026, sole traders and self-employed individuals with gross income above £50,000 are legally required to maintain digital records and submit quarterly updates to HMR
...
- `locum-doctor-self-assessment-filing-guide` (overlap: assessment, self)
