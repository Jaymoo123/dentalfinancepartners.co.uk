# Brief: locum-doctor-self-assessment-filing-guide

**Site:** medical
**Source file:** `Medical/web/content/blog/locum-doctor-self-assessment-filing-guide.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/locum-doctor-self-assessment-filing-guide
...
- **Category:** Locum Tax
- **Current body word count (approx):** 1056
...
- **Primary query:** `Locum Doctor Self Assessment 2026/27 | Filing Guide`
...
1. **ffiec.cfpb.gov** — [2025 FIG (Filing Instructions Guide) | HMDA Documentation](https://ffiec.cfpb.gov/documentation/fig/2025/overview)
   - *DDG snippet:* 2025 FIG (Filing Instructions Guide) 1. What's in the FIG? The 2025 Filing Instructions Guide (FIG) is a compendium of resources to help you file annual HMDA data collected in 2025 with the Consumer Financial Protection Bureau (Bureau) in 2026.
2. **irs.gov** — [About Publication 519, U.S. Tax Guide for Aliens](https://www.irs.gov/forms-pubs/about-publication-519)
   - *DDG snippet:* Apr 29, 2026 · Information about Publication 519, U.S. Tax Guide for Aliens, including recent updates. Publication 519 is used to help to determine an individual's status (nonresident alien or resident alien), and gives information needed to file returns.
3. **business-accounting.co.uk** — [Self Assessment for Locum Doctors | UK Tax Guide 2025](https://www.business-accounting.co.uk/blog/locum-doctors-self-assessment-tax-return)
   - *DDG snippet:* September 5, 2025 - The tax year runs from 6th April to 5th April the following year. For the 2025/26 tax year, key deadlines include: 5th October 2026: Register for Self Assessment if you're newly self-employed
...
- `accountant-self-assessment` (overlap: assessment, self)
...
- `locum-doctor-limited-company-pros-and-cons` (overlap: doctor, locum)
- `locum-doctor-tax-complete-guide` (overlap: doctor, locum)
- `locum-doctor-umbrella-company-2026-reforms` (overlap: doctor, locum)
