# Brief: locum-doctor-limited-company-pros-and-cons

**Site:** medical
**Source file:** `Medical/web/content/blog/locum-doctor-limited-company-pros-and-cons.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/locum-doctor-limited-company-pros-and-cons
...
- **Category:** Locum Tax
- **Current body word count (approx):** 671
...
- **Primary query:** `Locum Doctor Limited Company Pros and Cons | Medical Tax`
...
1. **moneywisedoctor.com** — [Limited Company for Doctors in 2025: A Comprehensive Guide for Locums](https://moneywisedoctor.com/limited-company-locum-doctors/)
   - *DDG snippet:* 9 Jul 2024 · Operating through a limited company can be more tax-efficient than being a sole trader. You pay corporation tax on profits, which is often lower ...
2. **gorillaaccounting.com** — [Setting up a limited company as a Locum Doctor or GP](https://gorillaaccounting.com/blog/limited-company-locum-doctor-gp/)
   - *DDG snippet:* Apr 24, 2018 · Setting up a limited company as a Locum Doctor or GP is likely a daunting prospect as you’ll require some in-depth understanding of business law and financial management. Good practice management will increase the ability of your business to survive over the long term. This starts wit
3. **messly.com** — [Should You Locum Through A Limited Company in 2023 ... - Messly](https://www.messly.com/blog/should-you-locum-through-a-limited-company-answering-your-key-questions)
   - *DDG snippet:* In this article, we discuss the pros and cons of locuming through a limited company in 2023 to help you decide whether this is the right approach for you.
...
- `locum-doctor-umbrella-company-2026-reforms` (overlap: company, doctor, locum)
- `gp-limited-company-tax-benefits-drawbacks` (overlap: company, limited)
