# Brief: locum-doctor-tax-complete-guide

**Site:** medical
**Source file:** `Medical/web/content/blog/locum-doctor-tax-complete-guide.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/locum-doctor-tax-complete-guide
...
- **Category:** Locum Tax
- **Current body word count (approx):** 655
...
- **Primary query:** `Locum Doctor Tax Guide 2026/27`
...
1. **uktaxdrag.co.uk** — [UK tax for medical locums 2026/27 — self-employment, agencies](https://uktaxdrag.co.uk/uk-tax-for-locums-2026-27.html)
   - *DDG snippet:* 12 May 2026 · Tax guide for UK medical locums in 2026/27: self-employed registration, mileage between sites, indemnity, VAT exemption, agency rules, ...
2. **armstrongwatson.co.uk** — [VAT on locum costs – Important update for GP practices and ...](https://www.armstrongwatson.co.uk/news/2026/04/vat-locum-costs-important-update-gp-practices-and-primary-care-networks)
   - *DDG snippet:* 23 Apr 2026 · A practice spending £150,000 a year on locums could be paying up to £30,000 in irrecoverable VAT; PCNs using multiple sessional and ARRS-style ...
3. **nasgp.org.uk** — [Financial advice for GP locums on tax, pensions and investments](https://www.nasgp.org.uk/money-matters/)
   - *DDG snippet:* Financial news and advice for GP locums on tax, IR35, pensions, superannuation, rates and fees from specialist medical accountants.
