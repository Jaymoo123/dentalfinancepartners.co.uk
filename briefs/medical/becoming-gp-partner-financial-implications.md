# Brief: becoming-gp-partner-financial-implications

**Site:** medical
**Source file:** `Medical/web/content/blog/becoming-gp-partner-financial-implications.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/becoming-gp-partner-financial-implications
...
- **Current body word count (approx):** 932
...
- **Primary query:** `accounting for gp partners`
...
|---|---|---|---|
| accounting for gp partners | 3 | 0 | 30.8 |
...
1. **larking-gowen.co.uk** — [Accounting GP Partnerships and Partners | Norfolk, Suffolk & Essex](https://www.larking-gowen.co.uk/what-we-offer/by-industry/medical-accounting/gp-partnerships-and-partners/)
   - *DDG snippet:* Larking Gowen is a premier provider of GP accounting services with the largest medical accounting team in East Anglia. We offer expert advice and support.
2. **lmc.org.uk** — [What to consider when looking at joining a GP partnership](https://www.lmc.org.uk/resources/what-to-consider-when-looking-at-joining-a-gp-partnership/)
   - *DDG snippet:* 19 Sept 2025 ... Partnership agreement · Business Transfer Agreement · Financial · Premises · Staff · Primary Care Network · Patient participation group · Documentation ...
3. **kudosaccounting.co.uk** — [GP Partnerships vs. Salaried Roles: Financial Pros and Cons](https://kudosaccounting.co.uk/gp-partnerships-vs-salaried-roles-financial-pros-and-cons/)
   - *DDG snippet:* 5 May 2025 ... GP partners are self-employed professionals who ... At Kudos Accounting, we specialise in working with GPs at all stages of their careers.
...
- `gp-financial-planning` (overlap: financial, gp)
- `gp-partner-vs-salaried-gp-tax-comparison` (overlap: gp, partner)
