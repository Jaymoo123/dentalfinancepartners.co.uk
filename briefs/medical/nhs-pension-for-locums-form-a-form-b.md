# Brief: nhs-pension-for-locums-form-a-form-b

**Site:** medical
**Source file:** `Medical/web/content/blog/nhs-pension-for-locums-form-a-form-b.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/nhs-pension-for-locums-form-a-form-b
...
- **Current body word count (approx):** 876
...
- **Primary query:** `NHS Pension for Locums: Form A & Form B Guide`
...
1. **nicholsmedical.co.uk** — [Forms A & B for Locums - Nichols Medical Accountants](https://nicholsmedical.co.uk/services/locums/locum-nhs-pension-review/forms-a-b-for-locums/)
   - *DDG snippet:* Home » Services » Locums » NHS Pension Guidance for Locums » Forms A & B for Locums.Furthermore, we guide you through calculating the correct tiered rates and maximising tax relief opportunities on these contributions. Ensuring proper pensionable earnings calculation.
2. **youtube.com** — [NHS GP Pensions | Locum Forms A & B Walkthrough - YouTube](https://www.youtube.com/watch?v=k2nyfhr4KtY)
   - *DDG snippet:* In this video I share with you something that they don't teach you at all in med school. Completing your NHS Pension forms for working as a GP Locum in the U...
3. **nss.nhs.scot** — [GP locum pension scheme forms | National Services Scotland](https://www.nss.nhs.scot/medical-services/gp-pension-forms-and-guidance/gp-locum-pension-scheme-forms/)
   - *DDG snippet:* The NHS pension scheme is available to locums who meet specific criteria. Get further guidance and fill in forms A and B.
