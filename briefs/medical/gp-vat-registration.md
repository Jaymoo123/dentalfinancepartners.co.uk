# Brief: gp-vat-registration

**Site:** medical
**Source file:** `Medical/web/content/blog/gp-vat-registration.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-vat-registration
...
- **Current body word count (approx):** 1093
...
- **Primary query:** `GP VAT Registration 2026: Thresholds & Exemptions`
...
1. **gov.uk** — [VAT liability of the supply of temporary medical staff - GOV.UK](https://www.gov.uk/government/publications/revenue-and-customs-brief-9-2025-vat-liability-of-the-supply-of-temporary-medical-staff-locum-doctors/vat-liability-of-the-supply-of-temporary-medical-staff)
   - *DDG snippet:* a VAT adviser Background Under Item 5, Group 7, Schedule 9, VAT Act 1994, “The provision of a deputy for a person registered in the register of medical practitioners,” is exempt from VAT.
2. **accotax.co.uk** — [VAT for GP Practices in the UK: The Complete 2026 Guide](https://accotax.co.uk/vat-for-gp-practices-in-uk/)
   - *DDG snippet:* Complete guide to VAT for GP practices UK. Discover VAT registration rules, exemptions, input tax recovery, and compliance requirements.
3. **kudosaccounting.co.uk** — [VAT and Locum Doctors: Essential Guide for GP Practices in UK (2026)](https://kudosaccounting.co.uk/vat-locum-doctors-gp-practices-2026/)
   - *DDG snippet:* Discover the latest 2026 VAT rules for locum doctors in the UK. Learn about exemptions, tribunal changes, VAT refunds, registration thresholds, e-invoicing, and compliance tips for GP practices.
