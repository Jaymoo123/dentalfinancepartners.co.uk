# Brief: gp-financial-planning

**Site:** medical
**Source file:** `Medical/web/content/blog/gp-financial-planning.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-financial-planning
...
- **Current body word count (approx):** 1641
- **Current FAQs in frontmatter:** 6

---

## Primary query

- **Primary query:** `GP Financial Planning: Pensions, Tax & Investments`
...
1. **kirkrice.co.uk** — [End of Year Tax Planning: Pensions & ISAs - Kirk Rice](https://www.kirkrice.co.uk/blog/tax-planning-pensions-isa/)
   - *DDG snippet:* The tax benefits of pension investments make them a key consideration in planning.ISAs are free of UK tax on investment income and capital gains. Anybody aged 18 or over can invest in any number of cash ISAs, stocks & shares ISAs or innovative finance ISAs.
2. **moneysavingexpert.com** — [Higher-rate taxpayer? Don't miss out on £1,000s pension tax relief](https://www.moneysavingexpert.com/pensions/tax-relief-pension-contributions/)
   - *DDG snippet:* Inheritance tax planning. Explore all tax & benefits information.Tax relief on pensions means that for every £80 you pay in, the state pays in at least £20 if you're a basic-rate taxpayer.
3. **hl.co.uk** — [Pension tax relief calculator | Hargreaves Lansdown](https://www.hl.co.uk/pensions/tax-relief/calculator)
   - *DDG snippet:* Our free pension tax relief calculator shows how much you could receive this tax year 2015/2016. 20%, 40% and 45% tax relief is available on contributions.
...
- `becoming-gp-partner-financial-implications` (overlap: financial, gp)
- `gp-partnership-profit-sharing-tax-planning` (overlap: gp, planning)
