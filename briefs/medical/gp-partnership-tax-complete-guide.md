# Brief: gp-partnership-tax-complete-guide

**Site:** medical
**Source file:** `Medical/web/content/blog/gp-partnership-tax-complete-guide.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-partnership-tax-complete-guide
...
- **Current body word count (approx):** 926
...
- **Primary query:** `GP Partnership Tax Guide 2026/27`
...
1. **gov.uk** — [Self Assessment: Partnership Tax Return (SA800) - GOV.UKAbout Form 1065, U.S. Return of Partnership IncomePartnership Tax Guide: K-1s, Allocations & More | SDO CPAPartnership Tax Return Guide - GOV.UK](https://www.gov.uk/government/publications/self-assessment-partnership-tax-return-sa800)
   - *DDG snippet:* Use form SA800 to file a Partnership Tax Return. See full list on gov.uk PDF, 204 KB, 8 pages This file may not be suitable for users of assistive technology. Request an accessible format. If you use assistive technology (such as a screen reader) and need a version of this document in a more accessi
2. **irs.gov** — [About Form 1065, U.S. Return of Partnership Income](https://www.irs.gov/forms-pubs/about-form-1065)
   - *DDG snippet:* Mar 30, 2026 · Information about Form 1065, U.S. Return of Partnership Income, including recent updates, related forms and instructions on how to file. Form 1065 is used to report the income of every domestic partnership and every foreign partnership doing business in the U.S. or getting income from
3. **assets.publishing.service.gov.uk** — [Partnership Tax Return Guide - GOV.UK](https://assets.publishing.service.gov.uk/media/660bce0491a3207f0582b07b/SA850-Notes-2024.pdf)
   - *DDG snippet:* We’ll use the information in the Partnership Tax Return to check that the partners pay the correct tax and Class 4 National Insurance contributions (NICs) due on their share of the...
...
- `gp-partnership-profit-sharing-tax-planning` (overlap: gp, partnership)
