...
**Site:** medical
**Source file:** `Medical/web/content/blog/gp-tax-return.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-tax-return
...
- **Current body word count (approx):** 1251
- **Current FAQs in frontmatter:** 5

---

## Primary query

- **Primary query:** `GP Tax Return 2026/27: Filing Guide for UK GPs`
...
1. **england.nhs.uk** — [Supplementary information to support changes to the 2026/27 GP contract](https://www.england.nhs.uk/long-read/supplementary-information-to-support-changes-to-the-2026-27-gp-contract/)
   - *DDG snippet:* This document provides supplementary information to support general practice and commissioners to implement the 2026/27 GP Contract requirements. It is intended to support practical delivery by describing the policy intent, operational expectations and implementation considerations for the changes .
2. **kudosaccounting.co.uk** — [The New GP Contract 2026/27: What the £485 Million Uplift Means for ...](https://kudosaccounting.co.uk/gp-contract-2026-27-practice-finances/)
   - *DDG snippet:* This guide cuts through the complexity to explain what the 2026/27 GP contract means in practical financial terms for your practice — how to account for the new income streams, what changes to expect in your monthly payment schedule, and where the planning opportunities and risks lie.
3. **otistax.co.uk** — [MTD for Doctors, GPs & Dentists Guide | Otis](https://otistax.co.uk/library/blogs/mtd-for-medical-professionals)
   - *DDG snippet:* A clear guide to Making Tax Digital for locum doctors, GPs and dentists. Learn who needs to comply, income thresholds, quarterly updates, and how to use spreadsheets with HMRC-approved bridging software like Otis.
