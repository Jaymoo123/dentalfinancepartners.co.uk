# Brief: gp-pension-contributions-tax-relief

**Site:** medical
**Source file:** `Medical/web/content/blog/gp-pension-contributions-tax-relief.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-pension-contributions-tax-relief
...
- **Current body word count (approx):** 622
...
- **Primary query:** `GP Pension Tax Relief 2026/27`
...
1. **bhp.co.uk** — [Estimate of Pensionable Profits for GP Practices: Why Checking ...](https://bhp.co.uk/news-events/blog/estimate-of-pensionable-profits-for-gp-practices-why-checking-your-figures-matters/)
   - *DDG snippet:* 15 Apr 2026 ... Tax relief is given on superannuation contributions in the tax year in which they are paid, not the year to which the contributions relate. If ...
2. **nasgp.org.uk** — [GP appraisers: How the 2026/27 change ensures a fairer NHS ...](https://www.nasgp.org.uk/resource/gp-appraisers-how-the-2026-27-change-ensures-a-fairer-nhs-pension/)
   - *DDG snippet:* 2 Mar 2026 ... The NHS Pension Service (NHSBSA) has released an important clarification for the 2026/27 pension year regarding how work performed as a GP ...
3. **nhsemployers.org** — [NHS Pension Scheme member contributions - NHS Employers](https://www.nhsemployers.org/publications/nhs-pension-scheme-member-contributions)
   - *DDG snippet:* NHS Pension Scheme member contribution rates for 2026/27 ... This is because those earning in the lowest tier will not benefit from tax relief on their pension ...
...
- `gp-home-office-expenses-tax-relief` (overlap: gp, relief)
