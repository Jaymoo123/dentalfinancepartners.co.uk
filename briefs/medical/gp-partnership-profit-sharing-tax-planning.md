# Brief: gp-partnership-profit-sharing-tax-planning

**Site:** medical
**Source file:** `Medical/web/content/blog/gp-partnership-profit-sharing-tax-planning.md`
**Live URL (when indexed):** https://www.medicalaccounts.co.uk/blog/gp-partnership-profit-sharing-tax-planning
...
- **Current body word count (approx):** 1046
...
- **Primary query:** `GP Partnership Profit Sharing Tax Planning 2026/27`
...
1. **armstrongwatson.co.uk** — [2026/27 GMS Contract: what's been imposed and how GP practices can ...](https://www.armstrongwatson.co.uk/news/2026/04/202627-gms-contract-whats-been-imposed-and-how-gp-practices-can-protect-finances)
   - *DDG snippet:* 29 Apr 2026 · The 2026/27 GMS contract, imposed on 1 April 2026, has brought about a number of changes impacting general practice in England.
2. **kudosaccounting.co.uk** — [Tax Advice for Doctors in Private Practice - Kudos Accounting](https://kudosaccounting.co.uk/tax-advice-for-doctors-in-private-practice/)
   - *DDG snippet:* 24 Nov 2025 · Useful for group practices where doctors share income and costs. However, tax planning must be coordinated to avoid surprises. How to decide.
3. **a2zaccounting.co.uk** — [5 April 2026 Tax Deadline: What UK Businesses Must Do - A2Z Accounting](https://a2zaccounting.co.uk/5-april-is-coming-what-uk-businesses-must-do-now-2026/)
   - *DDG snippet:* 4 Mar 2026 · 5 April 2026 is approaching. Discover what UK businesses must do now to reduce tax, stay HMRC compliant and prepare for the new tax year.
...
- `gp-financial-planning` (overlap: gp, planning)
- `gp-partnership-tax-complete-guide` (overlap: gp, partnership)
