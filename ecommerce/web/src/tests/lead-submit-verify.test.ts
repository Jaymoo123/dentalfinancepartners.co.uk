...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "ecommerce_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@sellerstore.co.uk",
  phone: "+447700900123",
  role: "Amazon (FBA or FBM)",
  message: "Selling on Amazon and Shopify, unsure how marketplace VAT should show in my accounts.",
  source: "ecommerce",
};
