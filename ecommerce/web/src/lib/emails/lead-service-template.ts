/**
 * Service-email shell for Ecommerce lead-nurture follow-ups.
 *
 * Renders a centred white card on a #f6f7f8 canvas with the Ecommerce Finance
 * wordmark, 16px/1.6 body, amber-accented signature block, quiet footer.
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">ECOMMERCE</div>
<div style="display:inline-block;border-top:2px solid #c9861b;margin-top:5px;padding-top:5px;font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">FINANCE</div>
</td>
</tr>
<tr>
...
<div style="border-top:1px solid #e5e7eb;padding-top:14px;font-family:${FONT};font-size:12px;line-height:1.6;color:#64748b;">${esc(e.footerNote)}${e.optOutUrl ? "<br>To opt out, just reply STOP." : ""}</div>
  ...
  const textLines = [
    ...
    e.signoff,
    "",
    "The team at Ecommerce Finance",
    "ecommercefinance.co.uk",
    "",
    e.footerNote,
