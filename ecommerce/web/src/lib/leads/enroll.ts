/**
 * Shared lead-nurture enrolment for the Ecommerce site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Ecommerce
 * sequence names.
 */
...
import {
  buildEcommerceLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildEcommerceLeadNurtureConfig(variant);
