 ...
 * House style: sharp corners, neutral ink with the amber brand accent, no em-dashes in copy.
 */
...
const chipSelected =
  "border-[var(--brand-primary)] bg-neutral-900 text-white";
    ...
    return (
      <div className="border-2 border-[var(--brand-primary)] bg-amber-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-neutral-700">
          ...
          A specialist will call you then. If your plans change, just reply to any of our
          messages.
        </p>
