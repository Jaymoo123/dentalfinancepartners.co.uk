...
// ponytail: static links, no client state. Add mobile hamburger when analytics show mobile nav use matters.
const navLinks = [
  ...
  return (
    <header className="border-b border-neutral-200 bg-white">
      <nav className={`${siteContainerLg} flex items-center justify-between gap-6 py-4`} aria-label="Primary">
        ...
        <Link
          href="/contact"
          className="md:hidden text-sm font-semibold text-[#c9861b]"
        >
          Contact
        </Link>
      </nav>
