/**
 * Inbound email webhook for Resend: processes replies to Ecommerce nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to an Ecommerce lead,
 ...
 *   Inbound routing domain: ecommercefinance.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.ecommercefinance.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to an Ecommerce lead (most recent match wins).
