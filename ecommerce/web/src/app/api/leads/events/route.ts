/**
 * Resend webhook sink for lead-nurture email engagement events (Ecommerce).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.ecommercefinance.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Ecommerce lead-nurture system.</p>
</div>`,
