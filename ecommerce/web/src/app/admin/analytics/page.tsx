/**
 * Ecommerce-site analytics console — main dashboard.
 *
  ...
  const experimentsSection = (
    <div className="space-y-6">
      <NotOperatedPanel
        ...
        reason="Not operated on this site. This site does not currently run A/B tests."
      />
      <NotOperatedPanel
  ...
  const conversionSection = (
    <div className="space-y-8">
      ...
      <NotOperatedPanel
        ...
        reason="Not operated on this site. No newsletter surface on this site."
      />
