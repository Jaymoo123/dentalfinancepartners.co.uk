      ...
      <div className="prose-blog mt-8 space-y-6">
          ...
          <ul>
            <li>
              ...
              online selling you do, your message, and the page you submitted from.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              general ecommerce tax and VAT information until you unsubscribe.
            </li>
            <li>
          ...
          <p>
            ...
            GDPR) to handle your enquiry and to share it with a relevant regulated firm from our specialist
            partner network, so that you can be connected with the specialist ecommerce tax help you have asked
