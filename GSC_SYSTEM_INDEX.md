...
2. **Quick Start**: `agents/GSC_QUICK_START.md`
...
**Get started quickly**
→ `agents/GSC_QUICK_START.md`

**Understand the system**
→ `agents/GSC_OPTIMIZATION_README.md`
...
**Troubleshoot issues**
→ `agents/GSC_OPTIMIZATION_README.md` (FAQ section)
...
1. Start: `agents/GSC_QUICK_START.md`
2. Learn: `agents/GSC_OPTIMIZATION_README.md`
