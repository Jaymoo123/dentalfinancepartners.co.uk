"""Construction Finance Partners (construction-cis) site configuration.
...
SITE_CONFIG: dict = {
    ...
    "display_name": "Construction Finance Partners",
    "domain": "www.construction-finance-partners.co.uk",
    "site_base_url": "https://www.construction-finance-partners.co.uk",
    "author_name": "Construction Finance Partners Editorial Team",
    ...
    "anchor_terms": [],
    "hallucination_zones": [],
    "blog_system_prompt": """You are an expert UK accountant writing for UK accountants for construction contractors and CIS subcontractors.""".strip(),

    "seo_persona": {
        "audience": "UK accountants for construction contractors and CIS subcontractors",
        "language_cues": [],
        "preferred_hooks": [],
