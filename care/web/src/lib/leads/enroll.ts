/**
 * Shared lead-nurture enrolment for the Care site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Care
 * sequence names.
 */
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildCareLeadNurtureConfig(variant);
