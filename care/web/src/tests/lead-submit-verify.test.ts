...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "care_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@oakfieldcarehome.co.uk",
  phone: "+447700900123",
  role: "Care home owner or director",
  message: "Sleep-in shifts and agency cover are pushing our payroll costs up. Need a review.",
  source: "care",
};
