  ...
  return (
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-700">
        ...
        <h3 className="mt-4 text-lg font-semibold text-neutral-800">Third-party analytics</h3>
        <p>
          This Site does not currently use Google Analytics or any other third-party analytics cookies. The only
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>Understand which pages are most useful to care providers and care home operators</li>
        ...
        <p>
          We do <strong>not</strong> use cookies for advertising, remarketing, or selling your data to third
          parties.
        </p>
