  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-16">
      <h1 className="text-3xl font-semibold tracking-tight text-[var(--ink)] sm:text-4xl">
        Care sector finance calculators
      </h1>
      <p className="mt-4 max-w-2xl text-lg text-[var(--ink-soft)]">
        Free tools built on current HMRC and NHS England rules for UK care providers. True care hour costs, sleep-in
        NMW compliance, staffing margins and funded nursing care fee-mix, all kept up to date.
      </p>
