  ...
  return (
    <div className="bg-white p-3 sm:p-4">
      ...
      <div className="mt-3 text-center">
        ...
        >
          Powered by <span className="font-bold text-[var(--ink)]">{site.name}</span> &middot; specialist UK care sector accountants
        </a>
      </div>
      <EmbedAutoResize messageType="care-embed-height" />
    </div>
  );
}
