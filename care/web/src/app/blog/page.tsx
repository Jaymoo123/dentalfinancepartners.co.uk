...
export const metadata: Metadata = {
  title: "Care Sector Finance Blog | UK Care Provider Guides",
  description: "Practical guides on care home accounts and funding, payroll and workforce costs, VAT, CQC financial compliance and running a UK care business.",
...
export default function BlogIndexPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="text-3xl font-semibold tracking-tight text-neutral-900">Care sector finance, explained.</h1>
      {categories.length > 0 && (
