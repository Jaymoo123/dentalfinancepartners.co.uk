...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/research/care-provider-business-index`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/research/uk-care-density-quality-index`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${base}/research/uk-care-business-survival-index`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
  ...
  const serviceRoutes: MetadataRoute.Sitemap = careServices.map((s) => ({
  ...
  const forRoutes: MetadataRoute.Sitemap = careHubs.map((h) => ({
    url: `${base}/for/${h.slug}`,
    lastModified: now,
    changeFrequency: "monthly" as const,
    priority: 0.75,
