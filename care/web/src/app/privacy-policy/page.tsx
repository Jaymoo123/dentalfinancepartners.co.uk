    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-700">
        ...
        <p>
          ...
          until you unsubscribe. Our records of what you were shown and any consent you gave are kept for up to six years, under access controls, so that we can demonstrate the lawful basis for using it.
        </p>
