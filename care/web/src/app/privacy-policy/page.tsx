    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-700">
        ...
        <p>
          ...
          UK GDPR)
          {partner
            ? ` to handle your enquiry and to share it with our specialist partner firm, so that you can be connected with the specialist care finance help you have asked for`
        ...
        {partner ? (
          <p>
            ...
            <strong>{partner.name}</strong>, so that they can contact you and provide the advice you asked for. As
            well as the details you give us (your name, contact details and your enquiry), this includes the result
            of our checks to confirm your contact details are valid, a short summary and priority rating we prepare
            to help route your enquiry, any messages you send us in response, a note of how you used our website in
            connection with your enquiry, where relevant publicly available information about your business, and any
            call time you book. We do this on the basis of our <strong>legitimate interests</strong> (see section
            4), and you can object at any time (see section 7). {partner.name} acts as an{" "}
            <strong>independent data controller</strong> of the information it receives, may share it within its own
            group of companies for the same purpose, and uses it under its own{" "}
          ...
          <p>
            Your enquiry is handled by us; we do <strong>not</strong> share it with any third-party advisory firm.
            We use the service providers listed below only as our processors, acting on our instructions.
          </p>
        )}
