    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-700">
        ...
        <p>
          ...
          <Link href="/contact" className="font-medium text-[#7d6b9e] underline">contact page</Link>.
        </p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            number, the type of care provider or care home operator you are, your message, and the page you submitted
            from.
          </li>
          <li>
          ...
          <li>
            ...
            <Link href="/cookie-policy" className="font-medium text-[#7d6b9e] underline">cookie policy</Link> for
            detail.
          </li>
        </ul>
        <p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            general care sector tax and finance information until you unsubscribe.
          </li>
          <li>
        ...
        <p>
          When you submit an enquiry, we rely on our <strong>legitimate interests</strong> (Article 6(1)(f) of the
          UK GDPR) to handle your enquiry and to share it with a relevant regulated firm from our specialist
          partner network, so that you can be connected with the specialist care finance help you have asked
          for. Where we need to take steps at your request to deal with your enquiry, we also rely on{" "}
          <strong>Article 6(1)(b)</strong>. You have the <strong>right to object</strong> to this processing at any
          time, under Article 21 (see your rights in section 7).
        </p>
        <p>
          For our <strong>email updates</strong> and other email sign-ups, we rely on your <strong>consent</strong>.
          You can withdraw your consent at any time (see your rights in section 7); withdrawing consent does not
        ...
        <p>
          When you submit an enquiry, we share information about you and your enquiry with a relevant regulated
          firm from our <strong>specialist partner network</strong>, so that it can respond and, if you want,
          provide the advice you asked for. The receiving firm acts as an <strong>independent data
          controller</strong> of the information it receives, will identify itself to you when it first contacts
          you, and uses your information under its own privacy policy. If that firm is unable to help, your
          enquiry may be passed to another firm in the network for the same purpose. We do this on the basis of
          our <strong>legitimate interests</strong> (see section 4), and you can object at any time (see section
          7). We share this information only for the purpose of arranging and providing the advice you asked for.
        </p>
        ...
        <p>
          ...
          until you unsubscribe. Our records of what you were shown and any consent you gave are kept for as long
          as we hold the related personal data, so that we can demonstrate the lawful basis for using it.
        </p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            <strong>Object</strong> to our processing that is based on legitimate interests, including our sharing
            of your enquiry with firms in our partner network, under Article 21.
          </li>
          <li>
        ...
        <p>
          ...
          <Link href="/contact" className="font-medium text-[#7d6b9e] underline">contact page</Link>. We will
        ...
        <p>
          ...
          <a
            ...
            className="font-medium text-[#7d6b9e] underline"
          >
        ...
        <p>
          ...
          <Link href="/cookie-policy" className="font-medium text-[#7d6b9e] underline">cookie policy</Link>.
        </p>

        <h2 className="text-xl font-semibold text-neutral-900">9. How we protect your data and international transfers</h2>
        <p>
          Form submissions are stored securely and access is restricted to authorised staff only. Some of our
          service providers (for example, Vercel) are based outside the UK and EEA. Where data is transferred
        ...
        <p>
          ...
          this page shows when it was last revised. We encourage you to review this policy periodically.
        </p>
