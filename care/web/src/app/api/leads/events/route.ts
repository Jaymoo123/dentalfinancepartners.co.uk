/**
 * Resend webhook sink for lead-nurture email engagement events (Care).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.carehometax.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Care lead-nurture system.</p>
</div>`,
