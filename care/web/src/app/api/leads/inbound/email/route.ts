/**
 * Inbound email webhook for Resend: processes replies to Care nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Care lead,
 ...
 *   Inbound routing domain: carehometax.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.carehometax.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Care lead (most recent match wins).
