    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-700">
        ...
        <p>
          ...
          <Link href="/contact" className="font-medium text-[#7d6b9e] underline">
            contact page
          </Link>
          .
        </p>
        ...
        <p>
          ...
          accounting, tax, financial, or legal advice. You should not rely on any content on the Site as a
          substitute for professional advice tailored to your specific circumstances.
        </p>
        <p>
          Formal engagements for professional services are subject to separate written engagement letters and terms
          of business. No accountant-client relationship is created by your use of this Site or submission of an
          enquiry form.
        </p>

        <h2 className="text-xl font-semibold text-neutral-900">3. Accuracy and changes</h2>
        <p>
          While we aim to keep information on the Site accurate and up to date, tax, regulatory and care-sector
          rules change frequently. We make no representations or warranties regarding the accuracy, completeness, or
          currency of any content.
        </p>
        <p>
        ...
        <p>
          To the fullest extent permitted by law, {siteConfig.legalName} excludes all liability for any loss or
          damage arising from your use of the Site, including but not limited to:
        </p>
        <ul className="list-disc space-y-2 pl-6">
        ...
        <p>
          You agree to indemnify and hold harmless {siteConfig.legalName}, its directors, employees, and agents
          from any claims, losses, damages, liabilities, and expenses (including legal fees) arising from your use
