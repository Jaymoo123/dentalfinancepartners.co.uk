    ...
    <div className={`${siteContainerLg} py-16 sm:py-24`}>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-lg border-2 border-neutral-300 bg-white px-6 py-3 text-base font-medium text-neutral-900 transition-colors hover:border-neutral-400 hover:bg-neutral-50"
          >
            Go home
          </Link>
        </div>
        ...
        <p className="mt-8 text-sm text-neutral-500">
          ...
          <Link href="/contact" className="font-medium text-[#7d6b9e] hover:underline">
            get in touch
          </Link>
          .
        </p>
