 ...
 * is telling us when a care sector accounts specialist should call, and the act of booking is
 * the contactability signal that promotes them for handoff.
 */

export const metadata: Metadata = {
  title: "Book your free review",
  description: "Pick a time for your free care business finance review call.",
      ...
      <div className={siteContainerLg}>
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-center text-lg leading-relaxed text-neutral-600">
            Pick a day and a time window that suits you. A care sector accounts specialist will call you then, no
            obligation.
          </p>
          <div className="mt-10">
            {token ? (
