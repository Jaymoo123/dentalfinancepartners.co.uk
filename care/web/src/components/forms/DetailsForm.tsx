 ...
 *
 * House style: care brand tokens, no em-dashes in copy.
 */
    ...
    return (
      <div className="border border-[var(--brand-primary)] bg-neutral-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-neutral-600">
          A care sector accounts specialist will be in touch shortly. If you would like to pick a time that suits
  ...
  return (
    <form onSubmit={onSubmit} className="text-left" noValidate aria-busy={status === "loading"}>
      ...
      <p className="mt-3 text-xs text-neutral-500">
        We only use this to arrange your free care business finance review. See our{" "}
        <a
          href="/privacy-policy"
          target="_blank"
