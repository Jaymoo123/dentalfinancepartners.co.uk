 ...
 * House style: sharp corners, care brand tokens, no em-dashes in copy.
 */
    ...
    return (
      <div className="border border-[var(--brand-primary)] bg-neutral-50 p-6 text-center">
        ...
        <p className="mt-2 text-base text-neutral-700">
          ...
          A care sector accounts specialist will call you then. If your plans change, just reply to any of our
          messages.
        </p>
    ...
    <div className="text-left">
      ...
      <div className="mt-6 text-center">
        ...
        <p className="mt-3 text-xs text-neutral-500">
          No obligation. A care sector accounts specialist will call you in your chosen window.
        </p>
      </div>
    </div>
  );
