...
/**
 * Probate Compass analytics provider wrapper. Composes the shared SDK
 * AnalyticsProvider with the probate-specific deriveTopic function. This thin
 ...
 * the shared provider.
 *
 * storagePrefix "wpc" is FROZEN: continuity for returning visitors.
