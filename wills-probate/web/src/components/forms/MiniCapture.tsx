 ...
 * Injects Probate Compass config + submit fn so all call-sites
 ...
 * Role segment options come from niche.lead_form (probate-specific roles).
 */
...
const miniCaptureConfig: MiniCaptureConfig = {
  sourceIdentifier: niche.content_strategy.source_identifier, // "wills-probate"
  consentText: siteConfig.leadConsentText,
  nicheId: niche.niche_id, // "wills-probate"
  leadForm: {
    roleLabel: niche.lead_form.role_label, // "I am..."
    roleOptions: niche.lead_form.role_options, // probate segments (executor / bereaved / IHT planning / etc.)
    placeholders: {
