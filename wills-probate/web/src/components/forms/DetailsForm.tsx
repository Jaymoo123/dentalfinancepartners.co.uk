...
/**
 * "Complete your details" form. Renders only the field(s) that are actually
 * missing (never email, never message). Posts to /api/leads/complete.
 * Probate palette: orange #f97316 + slate-900.
 */
