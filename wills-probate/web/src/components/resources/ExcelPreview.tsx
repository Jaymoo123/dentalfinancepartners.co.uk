...
// PLACEHOLDER — empty until the wills-probate calculator fleet (and matching
// resource models) ship in Phase 2. ExcelPreview no-ops (returns null) for
// any topic with no entry here, so this is safe as-is.
const SPECS: Partial<Record<TopicKey, PreviewSpec>> = {};

// Referenced only to keep the DEFAULT_TABS/DEFAULT_CAPTION exports "used" for
// Phase 2 authors porting real specs back in; safe no-op today.
void DEFAULT_TABS;
void DEFAULT_CAPTION;
