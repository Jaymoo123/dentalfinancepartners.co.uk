 ...
 *
 * Forward-compat shape: static copy lives in a single `offer` object so a later
 * personalisation phase can swap it out without restructuring the render path.
 */
...
export function StickyCTA() {
  ...
  const offer: StickyOffer = intentAction
    ? {
        ...
        label: intentAction.offer.kind === "tool" ? "Open calculator" : intentAction.offer.kind === "guide" ? "Get free guide" : "Book a free call",
      }
    : defaultOffer;
  ...
  return (
    <div
      role="region"
      aria-label="Talk to a probate specialist"
