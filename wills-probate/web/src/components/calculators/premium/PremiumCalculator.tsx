...
/**
 * Dependency-free premium calculator renderer for the wills-probate site.
 *
 ...
 *
 * TOKEN DISCIPLINE: wills-probate uses orange/slate tokens:
 *   - var(--accent): brand accent orange (active states, focus rings, bars, sliders)
 *   - var(--dark):   dark brand fill (toggle ON state, accent chip background)
            ...
            return (
              <button
                ...
                className={[
                  ...
                  active
                    ? "border-[var(--accent)] bg-[var(--accent)]/10 text-[var(--dark)] font-semibold"
      ...
      >
        ...
        <span
          className={[
            ...
            value ? "bg-[var(--dark)]" : "bg-[var(--border)]",
          ].join(" ")}
        >
          <input
            id={`pf-${field.id}`}
      ...
      {scenarios.map((s) => (
        ...
        >
          <div className="flex items-start justify-between gap-1">
            ...
            {s.best && (
              <span className="rounded-full bg-[var(--accent)]/10 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[var(--dark)]">
                Better
              </span>
            )}
          </div>
