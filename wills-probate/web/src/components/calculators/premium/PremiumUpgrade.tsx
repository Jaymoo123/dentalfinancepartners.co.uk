...
/**
 * Topic to premium tool bridge for the wills-probate site.
 *
 ...
 *   - var(--accent): brand accent orange
 *   - var(--dark):   dark brand fill (chip background)
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        {/* Dark (slate) chip: wills-probate brand fill, white label. No --navy. */}
