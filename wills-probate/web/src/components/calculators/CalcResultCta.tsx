...
/**
 * Calculator result CTA for wills-probate. Renders an inline qualified lead
  ...
  return (
    <div className="mt-6 border-t border-slate-200 pt-5">
      <MiniCapture
        ...
        heading="Confirm your figure with a probate specialist"
        blurb="Estimates get you close. A specialist confirms your exact inheritance tax position, what reliefs and nil-rate bands apply, and the quickest route to grant of probate. No obligation, and we reply within one working day."
