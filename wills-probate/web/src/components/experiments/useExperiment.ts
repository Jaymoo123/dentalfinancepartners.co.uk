...
/**
 * Probate Compass useExperiment hook -- re-export shim.
 *
...
// Resolved once at module load: the site experiment registry.
// ponytail: reuses the construction-cis registry key as a placeholder (no
// dedicated wills-probate registry exists yet in web-shared/experiments/registries).
const constructionRegistry = siteRegistries["construction-cis"];

/**
 * Assign + register the variant for a Probate Compass experiment. Returns null
