...
/**
 * Blog mid-scroll lead capture for Probate Compass.
...
export function InlineMiniLeadForm({ topic }: { topic?: string }) {
  ...
  return (
    <MiniCapture
      ...
      blurb="Leave your details and a one-line summary. A probate specialist will reply within 24 hours, with no obligation."
