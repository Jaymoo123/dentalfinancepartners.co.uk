...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `${cat.name} | Probate and Inheritance Tax Guides`;
  const description = `Practical guides on ${cat.name.toLowerCase()} for UK executors and families dealing with probate. Inheritance tax and estate administration explained by specialists.`;
      ...
      <section className="border-b border-neutral-200 bg-neutral-900 py-14 sm:py-18">
        <div className={siteContainerLg}>
          ...
          <p className="mt-4 text-base text-neutral-300">
            Practical guides on {cat.name.toLowerCase()} for UK executors and families dealing with probate.
          </p>
        </div>
      </section>
