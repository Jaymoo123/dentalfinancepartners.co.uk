...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: `How ${siteConfig.name} uses cookies and analytics, and how you can control them when browsing our probate advice site.`,
};
    ...
    <section className="bg-white">
      <div className={`${contentNarrow} ${sectionYLoose}`}>
        ...
        <div className="prose-blog mt-10 space-y-6">
          <p>
            This policy describes how Ashfield Trading Ltd (trading as {siteConfig.name}) uses cookies and similar
            technologies on our website. Cookies are small text files stored on your device that help us understand how
          ...
          <ul>
            <li>Understand which pages are most useful to executors and families dealing with probate</li>
