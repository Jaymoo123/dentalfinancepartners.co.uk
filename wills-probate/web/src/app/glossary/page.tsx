...
export const metadata: Metadata = {
  ...
  description:
    "Plain-English definitions of probate, wills and inheritance tax terms.",
  alternates: { canonical: `${siteConfig.url}/glossary` },
  openGraph: {
    title: "Glossary | Probate and Inheritance Tax Terms Explained",
    description:
      "Plain-English definitions for UK executors, administrators and people planning their estates.",
        ...
        <div className={siteContainerLg}>
          ...
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
              Probate and inheritance tax glossary
            </h1>
            <p className="mt-4 text-lg text-neutral-300 leading-relaxed">
              {entries.length > 0
                ? `${entries.length} plain-English definitions of the probate and inheritance tax terms UK executors and administrators actually need to understand.`
                : "Plain-English definitions of the terms UK executors and administrators need to understand. Definitions being added now."}
            </p>
          </div>
        </div>
      </section>
            ...
            {entries.length === 0 ? (
              <div className="border border-neutral-200 bg-white p-10 text-center">
                ...
                <p className="text-neutral-600 max-w-md mx-auto">
                  We are adding plain-English probate and inheritance tax definitions
