      ...
      <div className={`${contentNarrow} ${sectionYLoose}`}>
        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <p>
            ...
            from our specialist partner network (for example a specialist probate firm), so that it can respond and, if
            you want it, provide the advice you asked for. We do this on the basis of our{" "}
