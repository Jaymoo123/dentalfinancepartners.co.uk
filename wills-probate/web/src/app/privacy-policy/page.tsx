        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <ul>
            <li>
              ...
              probate or estate enquiry you have, your message, and the page you submitted from.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              general probate and inheritance tax information until you unsubscribe.
            </li>
            <li>
          ...
          <p>
            ...
            firms in the profession your enquiry concerns (for example a specialist probate firm) may take it up that way. Separately, up to{" "}
