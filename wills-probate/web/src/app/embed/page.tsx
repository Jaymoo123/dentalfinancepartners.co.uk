...
export const metadata: Metadata = {
  title: `Embed Our Free Probate Calculators | ${siteConfig.name}`,
  description:
    "Add our free, always-current UK probate and inheritance tax calculators to your own website. Estate value, nil-rate band, probate fees, and more. One iframe, mobile-friendly, no cost.",
  alternates: { canonical: `${siteConfig.url}/embed` },
  openGraph: {
    title: "Embed Our Free Probate Calculators",
    description:
      "Free, always-current probate calculators you can add to your own site in one line of HTML.",
      ...
      <section className="bg-slate-900 py-14 sm:py-20">
        <div className={siteContainerLg}>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-300">
            Free, mobile-friendly and always kept current with UK inheritance tax rules. If you
            advise or write for executors and families dealing with probate, drop any of these
            into your own pages with a single line of HTML. We keep them up to date; you keep your
            readers on your site.
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-400">
            Built for solicitor firms, probate advisers, estate planning bodies, and legal
            information blogs. The only condition is that you leave the small &ldquo;Powered by{" "}
        ...
        <div className={siteContainerLg}>
          <div className="mx-auto max-w-3xl bg-slate-900 p-8 text-center text-white sm:p-10">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-200">
              If you run a probate or legal information site and want a co-branded tool or a calculator
