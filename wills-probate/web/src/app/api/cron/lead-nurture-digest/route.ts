/**
 * Daily lead-nurture digest cron for Probate Compass: fires at 07:00 UTC
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("[lead-nurture-digest/probate] heartbeat write failed", err);
  }
  ...
  try {
    ...
    console.error("[lead-nurture-digest/probate] unexpected error", err);
