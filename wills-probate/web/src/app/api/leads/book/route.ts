...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[leads/book/probate] event insert failed", err);
  ...
  try {
    ...
    console.error("[leads/book/probate] nurture state promote failed (non-fatal)", err);
  }
  try {
    await adminUpdate(
      "leads",
    ...
    console.error("[leads/book/probate] lead promote failed (non-fatal)", err);
  }
