...
export const metadata: Metadata = {
  title: "Free Probate and Inheritance Tax Calculators | Estate Planning Tools",
  description:
    "Free probate calculators for UK executors and families. Estimate inheritance tax due, the nil-rate band available, estate value, and probate fees.",
      ...
      <section className="bg-slate-900 py-14 sm:py-20">
        <div className={siteContainerLg}>
          ...
          <h1 className="mt-6 max-w-3xl text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
            Free probate and inheritance tax calculators
          </h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-300">
            Free tools for UK executors and families dealing with probate. Estimate the inheritance tax
            due, check nil-rate band eligibility, and work out the value of the estate.
          </p>
        </div>
      </section>
        ...
        <div className={siteContainerLg}>
          ...
          <div className="mt-10 space-y-2 text-center">
            <p>
              ...
              >
                Run a probate or legal information site? Embed any of these calculators for free &rarr;
              </Link>
            </p>
          </div>
          ...
          <div className="mt-12 sm:mt-16 bg-slate-900 p-6 sm:p-10 text-center text-white">
            ...
            <p className="mt-3 sm:mt-4 text-base sm:text-lg leading-relaxed text-slate-200 max-w-3xl mx-auto">
              These calculators provide simplified estimates. For a full review of your estate,
              inheritance tax position, or probate application, speak to one of our probate
              specialists.
            </p>
