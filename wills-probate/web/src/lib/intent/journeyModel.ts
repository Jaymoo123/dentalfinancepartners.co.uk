/**
 * Journey model for Probate Compass (wills-probate) -- deterministic,
 * client-side, instant. Ported from Dentists/Property with the wpc storage
 * prefix.
 *
 ...
 * the wills-probate site (confirmed), so all flags are kept (no drops).
 *
