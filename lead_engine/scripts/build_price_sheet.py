...
STEPS = [
    ...
    "Leads arrive as redacted alerts: tier, case type, area, a one-line intent summary and the price.",
    "Claim a lead to receive the full verified details instantly.",
