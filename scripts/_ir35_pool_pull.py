"""Manager-run paid DataForSEO expansion for the contractors-ir35 fresh topic pool.

Pool exhausted 2026-07-14 (626/644 covered). Pattern: scripts/_trade_pool_pull.py.
...
OUT = Path("expansion_research/tier1_ir35/raw")
...
def main():
    ...
    (OUT / "dfs_ir35_universe.json").write_text(json.dumps(rows, indent=1), encoding="utf-8")
