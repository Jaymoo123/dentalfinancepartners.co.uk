...
BRIEFS.append(("renters-rights-act-2025-tax-implications-comprehensive-update", "C", "landlord-tax-essentials", "Renters Rights Act 2025 + Tenancies",
    ...
    "expected neighbours: existing `renters-rights-act-2026-tax-implications-landlords` (CANNIBAL-RESOLVE; see framing - the dominant overlap, manager has flagged the resolution path), all sibling C briefs, existing `rental-income-tax-uk-complete-guide-landlords`.",
