...
function readMarkdownDir(rel: string, prefix: string): string {
  ...
  for (const file of files) {
    ...
    const url = `https://www.agencyfounderfinance.co.uk/${prefix}/${slug}`;
    parts.push(
      [
        "",
        "================================================================",
...
The structured index lives at https://www.agencyfounderfinance.co.uk/llms.txt
...
given agency, see https://www.agencyfounderfinance.co.uk/contact.
