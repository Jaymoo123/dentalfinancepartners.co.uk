  ...
  return (
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <h3 className="mt-4 text-lg font-semibold text-neutral-900">Analytics cookies (Google Analytics)</h3>
        <p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>Understand which pages are most useful to founders and startup teams</li>
        ...
        <h3 className="mt-4 text-lg font-semibold text-neutral-900">Google Analytics opt-out</h3>
        <p>
