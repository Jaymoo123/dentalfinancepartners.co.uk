/**
 * Resend webhook sink for lead-nurture email engagement events (startups-tech).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.foundertaxpartners.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the startups-tech lead-nurture system.</p>
</div>`,
