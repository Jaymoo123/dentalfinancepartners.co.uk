/**
 * Inbound email webhook for Resend: processes replies to startups-tech nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a startups-tech lead,
 ...
 *   Inbound routing domain: foundertaxpartners.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.foundertaxpartners.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a startups-tech lead (most recent match wins).
