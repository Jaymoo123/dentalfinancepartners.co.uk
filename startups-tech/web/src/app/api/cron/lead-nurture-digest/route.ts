/**
 * startups-tech daily lead-nurture digest cron: fires at 07:00 UTC and sends a
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("[lead-nurture-digest/startups-tech] heartbeat write failed", err);
  }
  ...
  try {
    ...
    console.error("[lead-nurture-digest/startups-tech] unexpected error", err);
