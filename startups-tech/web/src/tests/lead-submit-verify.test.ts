...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "startups_tech_contactability",
}));
...
const VERIFY_OK = {
  ...
  email: { status: "deliverable", domain: "acmesaas.co.uk" },
  verify_pass: true,
  provider: "twilio",
  raw: {},
};
...
const BASE_BODY = {
  ...
  email: "priya@acmesaas.co.uk",
  phone: "+447700900123",
  role: "Funded startup founder",
  message: "We are closing a seed round and need our EMI scheme set up.",
  source: "startups-tech",
};
