/**
 * Shared lead-nurture enrolment for the startups-tech site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with startups-tech
 * sequence names.
 */
...
import {
  buildStartupsTechLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildStartupsTechLeadNurtureConfig(variant);
