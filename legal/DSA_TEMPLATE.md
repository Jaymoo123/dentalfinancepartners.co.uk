...
(A) The Supplier operates the website at propertytaxpartners.co.uk and related digital properties (the "Site"), through which people seeking specialist property-tax advice submit enquiries.

(B) The Supplier Refers enquiries to specialist accountancy and tax firms in its partner network. This agreement governs the sharing of the Personal Data contained in a Referred enquiry, between the Supplier and the Recipient as independent Controllers. It does not set the commercial terms of the referral, which the parties agree separately in writing.
...
"Permitted Purpose" means (a) enabling the Recipient, as a specialist firm, to receive and respond to the enquirer's property-tax enquiry and to provide the information or advice requested; and (b) the Supplier operating and administering its specialist partner network, including Referring a declined enquiry to another firm in the network for the purpose in (a).

"Referral" means the Supplier's disclosure of the Shared Data to the Nominated Address, and "Refer" and "Referred" are construed accordingly.

"Shared Data" means the Personal Data the Supplier discloses to the Recipient on a Referral: the enquirer's name; email address and/or telephone number; self-selected role and portfolio-size band; and any free-text enquiry message the enquirer chose to provide (which may include their property and tax circumstances). It is ordinary Personal Data only.
...
2.3 All processing takes place in the United Kingdom. Neither party will make a restricted transfer of the Shared Data outside the UK without a valid transfer mechanism under Articles 44 to 49 of the UK GDPR.
...
| Item | Supplier |
|---|---|
| Firm | Ashfield Trading Limited (company number 16358723), trading as Property Tax Partners |
| Data protection contact | Mohammed Junayd Moughal, junayd@ashfieldtrading.com |
| Published privacy policy URL | https://www.propertytaxpartners.co.uk/privacy-policy |
...
| Item | Detail |
|---|---|
| Data subjects | People enquiring through the Site (landlords, property investors and others seeking property-tax advice). |
| Personal Data shared | Name; email address and/or telephone number; the enquirer's self-selected role; self-selected portfolio-size band; and the enquiry message, which may include the enquirer's property and tax circumstances. General Personal Data only. |
...
| Method of transfer | Secure forwarding to the Nominated Address, encrypted in transit, with the relevant lawful-basis information. |
| Retention (Supplier) | Delete or anonymise the Shared Data within 3 months of the Referral (evidence and records carved out, clause 11.1). |
| Retention (Recipient) | As long as necessary for the Permitted Purpose or engagement, then delete or anonymise. |

## ANNEX B: PRIVACY NOTICE WORDING

B.1 Category-based disclosure. The Site identifies recipients only as a category, "a firm from our specialist partner network", and does not name the individual receiving firm.

B.2 Enquiry-form acknowledgement. The lawful basis for the share is legitimate interests (clause 3), and submitting the enquiry is the affirmative act, so the wording is presented as an acknowledgement rather than a consent tick-box. On each enquiry form the Supplier will display:
...
The receiving firm identifies itself to the enquirer in its own Article 14 notice at first contact (clause 5.2); the Site does not name it and does not link to any individual firm's privacy policy.

B.3 The Supplier may make amendments necessary to keep this wording legally accurate, provided that no amendment removes or materially weakens the disclosure that data is shared with the partner network without the Recipient's prior written consent (not to be unreasonably withheld or delayed).

B.4 Privacy notice. The Supplier's privacy policy will identify the Supplier; will describe the recipients as a category ("firms in our specialist partner network: accountancy and tax advisers"), without naming individual firms; and will give the Permitted Purpose, the lawful basis and, for legitimate interests, the legitimate interests pursued, the retention period, the enquirer's rights (including the right to object) and how to complain to the Supplier and to the Commissioner. It will explain that the specific firm contacting the enquirer will identify itself and provide its own privacy information.
