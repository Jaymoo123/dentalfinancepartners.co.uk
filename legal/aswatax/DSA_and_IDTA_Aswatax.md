...
(E) The international data transfer agreement at Schedule 1 (in the form issued by the Information Commissioner) forms part of this agreement and governs access to the Shared Data from outside the United Kingdom.
...
12.4 Clauses 12.1 to 12.3 restrict the Recipient only. They do not restrict the Supplier, which may Refer the same enquiry to other firms in its network within the limits in clause 3.2, and may supply enquiries by Bulk Supply, in each case as the Controller that collected the data. The Recipient acknowledges that it may not be the only firm that receives a given enquiry, that it is not told which other firms have received it, and that nothing in this agreement gives it exclusivity over any enquiry or over a Site's enquiry flow. Any exclusivity is a commercial matter agreed separately in writing.
...
Signature below binds the signing party to this agreement including the international data transfer agreement at Schedule 1, and constitutes that party's signature of the IDTA for the purposes of its Table 1.
...
## SCHEDULE 1: INTERNATIONAL DATA TRANSFER AGREEMENT

This is an international data transfer agreement in the form issued by the Information Commissioner under section 119A of the Data Protection Act 2018 (version A1.0, in force 21 March 2022) (the "IDTA"). It consists of the four tables below (Part one of the IDTA) together with the Mandatory Clauses (Part four of the IDTA) as published by the Information Commissioner, which are incorporated into this agreement by reference as permitted by the IDTA. The parties agree to be bound by those Mandatory Clauses as if set out in full here.

## TABLE 1: PARTIES AND SIGNATURES

| Item | Exporter | Importer |
|---|---|---|
| Parties' details | Ashfield Trading Limited, company number 16358723, registered office 20 Ashfield Avenue, Shipley, BD18 3AL, United Kingdom | Aswatax Ltd, company number 12923632, registered office 124 City Road, London, EC1V 2NX, United Kingdom, whose relevant personnel access the data from the Kingdom of Saudi Arabia |
| Key contact | Mohammed Junayd Moughal, Director, junayd@ashfieldtrading.com | The Recipient's notices and data protection contact in the Details table of this agreement, unless stated otherwise here: ............................................ |
| Importer data subject contact | Not applicable | The key contact above, unless stated otherwise here: ............................................ |
| Signature | Signed by execution of the signature block of the agreement to which this IDTA is Schedule 1 | Signed by execution of the signature block of the agreement to which this IDTA is Schedule 1 |
...
| The status of the parties | The Exporter is a controller. The Importer is a controller. The parties are independent controllers of the transferred data and neither is the other's processor. |
| Whether UK GDPR applies to the Importer | UK GDPR applies to the Importer's processing of the transferred data. |
| Linked Agreement | The Data Sharing Agreement to which this IDTA is Schedule 1, and the Referral Agreement between the parties signed alongside it. |
| Term | The IDTA starts on the date of the last signature of the agreement to which it is Schedule 1 and continues for as long as either Linked Agreement is in force and the Importer retains any transferred data. |
| Ending the IDTA when the Approved IDTA changes | The parties may end this IDTA as set out in the Mandatory Clauses if the Information Commissioner issues a revised Approved IDTA. |
| Can the Importer make further transfers of the transferred data? | The Importer may not transfer the data onwards to any other controller, except to the data subject or a person the data subject directs, or as required by law, consistently with clause 12 of the Data Sharing Agreement. The Importer may use its own processors under contracts meeting Article 28 of the UK GDPR. |
| Specific restrictions when the Importer may transfer on the transferred data | As above. No sale, list broking or further referral of the data. |
| Review dates | The parties will review this IDTA at least annually, alongside the annual review of the Linked Agreement. |

## TABLE 3: TRANSFERRED DATA

| Item | Detail |
|---|---|
| Transferred data | The shared data defined in the Linked Agreement: the enquirer's name, telephone number and email address; the enquiry message and its case type, tier label and one line intent summary; the enquirer's self selected role; the rough geographic area at county or region level; any practice or company name given; verification status and timestamps; the record of the enquirer's responses to verification and follow up messages and any booked callback time; the source site, page and capture surface; the date and time of the enquiry and the referral; the supplier's reference; and the data sharing notice shown at collection. |
| Special categories of personal data and criminal convictions and offences | None intended to be collected or transferred. The parties minimise and redact any sensitive detail in free text before sharing. |
| Relevant data subjects | People submitting enquiries through the Exporter's websites: individuals, landlords, business owners and others seeking professional advice. |
| Purpose | Enabling the Importer to receive and respond to the enquirer's enquiry and provide the advisory services requested, as set out in the Linked Agreement, and the administration of the referral arrangement between the parties. |

## TABLE 4: SECURITY REQUIREMENTS

| Item | Detail |
|---|---|
| Security of transmission | Transferred data is sent by a method that encrypts it in transit, such as a TLS secured connection. |
| Security of storage | The transferred data is held in systems hosted in the United Kingdom or the European Economic Area, protected by access controls and unique credentials. Personnel accessing the data from outside the United Kingdom do so through authenticated access to those systems, and do not maintain a separate local copy of the dataset. |
| Security of processing | Access limited to personnel who need it for the purpose, bound by confidentiality; multi factor authentication on accounts holding the data; devices used to access the data protected by encryption at rest and screen locking. |
| Organisational security measures | The security, breach notification, retention and deletion obligations of the Linked Agreement apply to the transferred data. Personal data breaches are notified between the parties without undue delay and within 24 hours. |
| Technical security minimum requirements | Encryption in transit for all transmission of the data; no transmission of the dataset over unencrypted channels. |
| Updates to the security requirements | The parties will keep these measures under review and update them as needed to remain appropriate to the risk, recording any change in writing. |
