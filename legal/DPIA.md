...
| R9 | AI grading is wrong, so an enquiry is mis-priced or offered to the wrong profession. | Medium | Low | The rubric is published and the grading recorded against the lead, so a firm can check it; grey-zone cases grade down, in the claiming firm's favour; a mis-described enquiry is a credit ground. No decision with legal or similarly significant effect is taken about the enquirer: grading affects which firm calls them, not their access to advice. | Low. |
