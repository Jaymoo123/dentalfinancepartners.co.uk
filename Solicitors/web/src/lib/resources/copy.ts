...
export function gateCopy(
  ...
  const magnetTitle = resource?.magnetTitle ?? "Free law-firm toolkit";
  ...
  const blurbTemplate =
    ...
    "A working Excel model with live formulas, plus the plain-English written guide. Enter your email to unlock both.";
