/**
 * Shared lead-nurture enrolment for Solicitors (Accounts for Lawyers).
 *
...
import {
  buildSolicitorsLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildSolicitorsLeadNurtureConfig(variant);
