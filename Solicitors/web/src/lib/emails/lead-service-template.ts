/**
 * Service-email shell for Solicitors (Accounts for Lawyers) lead-nurture
 * follow-ups: a centred white card on a #f6f7f8 canvas, ACCOUNTS FOR LAWYERS
 * wordmark header band, 16px/1.6 body, teal-accented signature block, quiet footer.
 *
...
// Teal brand accent for Accounts for Lawyers
const ACCENT = "#0f766e";
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">ACCOUNTS&nbsp;FOR</div>
<div style="display:inline-block;border-top:2px solid ${ACCENT};margin-top:5px;padding-top:5px;font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">LAWYERS</div>
</td>
</tr>
<tr>
...
<div style="font-size:14px;font-weight:600;color:${ACCENT};line-height:1.5;">Accounts for Lawyers</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://www.accountsforlawyers.co.uk" style="color:#64748b;text-decoration:none;">accountsforlawyers.co.uk</a></div>
</td>
</tr>
</table>
</td>
