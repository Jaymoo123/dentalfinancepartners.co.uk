...
export const partnerTaxReserveTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "Worked example: Rachel joins Elmwood Solicitors LLP as an equity partner in April 2026, with a profit share of £120,000 and annual drawings of £120,000. This is her first year in partnership (no prior year self-assessment liability). Income tax: the personal allowance tapers to £2,570 at this income level (£20,000 taper on the £20,000 excess above £100,000), leaving taxable income of £117,430. Tax is £37,700 x 20% = £7,540 plus £79,730 x 40% = £31,892, totalling £39,432. Class 4 NIC: 6% on £37,700 (between £12,570 and £50,270) = £2,262, plus 2% on £69,730 above the upper limit = £1,395, totalling £3,657. Combined self-assessment liability = £43,089 (effective rate 35.9%). First-year double hit: Rachel owes the full £43,089 plus a first payment on account of £21,545 (50% of £43,089), both due on 31 January 2028, a combined cash requirement of £64,634. Recommended monthly reserve: £120,000 / 12 x 37.7% (effective rate plus 5% buffer) = £3,770 per month.",
    ],
  },
  faqs: [
    {
