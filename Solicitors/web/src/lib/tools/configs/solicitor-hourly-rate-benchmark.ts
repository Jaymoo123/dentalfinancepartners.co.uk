...
export const solicitorHourlyRateBenchmarkTool: GenericTool = {
  ...
  compute(values) {
    ...
    return {
      ...
      note: "GHR figures are the rates effective from 1 January 2025 (Civil Justice Council). GHR are court cost-assessment guidelines, not a cap on what firms may charge their own clients. Salary benchmark uses the rule-of-thirds convention, not survey data.",
    };
  },
  explainer: {
    heading: "How the benchmark works, with worked examples",
    paragraphs: [
      "The Guideline Hourly Rates are published by the Civil Justice Council and adopted by the courts as the starting point for summary cost assessment. They are set by fee earner grade (A to D, broadly by post-qualification experience) and by region band (London 1 to 3 and National 1 to 2). Since 2024 they have been uprated annually in line with the SPPI inflation index, with the current table effective from 1 January 2025.",
      ...
      "Worked example 1: a Grade C solicitor (2 years PQE) in a major regional centre (National 1) charges £185 per hour, earns £48,000, and records 1,100 chargeable hours. The National 1 Grade C guideline rate is £196 per hour, so she is charging 94% of GHR, £11 per hour below guideline. Annual billings are £185 x 1,100 = £203,500. Employer NIC is 15% of (£48,000 - £5,000) = £6,450, giving a total employment cost of £54,450. Her cost coverage multiple is £203,500 / £54,450 = 3.74x, comfortably above the 3.0x rule-of-thirds target, and the billings-derived salary benchmark is £203,500 / 3 = £67,833. The data supports both a rate rise to at least guideline and headroom in salary negotiation.",
      "Worked example 2: a Grade A partner in central London (London 2) charges £450 per hour against a notional salary of £130,000, recording 1,000 chargeable hours. The London 2 Grade A guideline is £413 per hour, so the partner charges 109% of GHR, £37 per hour above guideline, which is common on solicitor-own-client terms. Billings are £450,000; employer NIC on the notional salary is £18,750, total cost £148,750, and the coverage multiple is 3.03x, right on the rule-of-thirds line. The rule-of-thirds salary benchmark is £150,000.",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "After a long freeze between 2010 and 2021, the rates were overhauled in 2021, revised again in January 2024, and are now uprated each January in line with the SPPI (Services Producer Price Index). This tool uses the table effective from 1 January 2025. Check judiciary.uk for the most recent uprating before relying on a figure in a costs schedule.",
    },
    {
