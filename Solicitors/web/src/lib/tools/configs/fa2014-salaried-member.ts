...
export const fa2014SalariedMemberTool: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "Worked example: Sarah is a fixed-share member of Halcyon Legal LLP. Her total annual reward is £105,000, of which £90,000 is a fixed monthly draw and £15,000 is a discretionary profit-linked bonus. Her capital account stands at £20,000 and she does not sit on the management committee. Condition A: £90,000 fixed of £105,000 total = 85.7%, above the 80% threshold, so Condition A is met. Condition B: no management committee seat and no meaningful influence over LLP affairs, so Condition B is met. Condition C: capital of £20,000 is 22.2% of fixed reward of £90,000, below the 25% threshold, so Condition C is met. All three conditions are met and Sarah is treated as an employee for tax purposes (PAYE applies). To break Condition C, Sarah would need to increase her capital account to at least £23,000 (25% of £90,000), requiring an additional contribution of just £3,000.",
    ],
  },
  faqs: [
    {
