/**
 * Lead-nurture cron for Solicitors (Accounts for Lawyers): fires due follow-up
...
import { buildSolicitorsLeadNurtureConfigs, buildLeadMessageContext } from "@/config/lead-nurture";
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  const configs = buildSolicitorsLeadNurtureConfigs();
