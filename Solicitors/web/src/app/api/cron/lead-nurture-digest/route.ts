/**
 * Daily lead-nurture digest cron for Solicitors (Accounts for Lawyers): fires at
 * 07:00 UTC and sends a plain-text operator summary covering the last 24 hours.
 * Quiet on dormant days (no sends, no stuck, no failures).
 *
 * Auth mirrors /api/cron/lead-nurture exactly (CRON_SECRET bearer,
