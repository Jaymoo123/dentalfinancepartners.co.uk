/**
 * Inbound email webhook for Resend: processes replies to Solicitors nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Solicitors lead,
 ...
 *   Inbound routing domain: accountsforlawyers.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.accountsforlawyers.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Solicitors lead (most recent match wins).
