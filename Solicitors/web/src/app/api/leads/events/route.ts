/**
 * Resend webhook sink for lead-nurture email engagement events (Solicitors).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.accountsforlawyers.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Solicitors lead-nurture system.</p>
</div>`,
