      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            {partner
              ? "to deal with your enquiry and, where appropriate, to pass it to a specialist partner firm in our network so that they can provide the advice you have requested."
        ...
        {partner ? (
          <p>
            When you submit an enquiry, we may share the details you provide with a specialist partner firm in our
            network, so that they can respond and provide the advice you asked for. Any such partner firm acts as an{" "}
