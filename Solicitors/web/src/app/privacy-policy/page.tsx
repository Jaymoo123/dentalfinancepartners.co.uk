  ...
  return (
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="prose-blog mt-8 space-y-6 text-[var(--ink-soft)]">
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">1. Who we are (data controller)</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">2. What information we collect</h2>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            you are about to leave a page), we collect your name, email address, phone number, the type of legal
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">3. Why we use your information</h2>
        <ul className="list-disc space-y-2 pl-6">
          <li>
          ...
          <li>
            ...
            accounting and tax information relevant to legal professionals until you unsubscribe.
          </li>
          <li>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">4. Our lawful basis</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">5. Who we share your information with</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">6. How long we keep your information</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">7. Your rights</h2>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">8. Cookies and analytics</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">9. How we protect your data and international transfers</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">10. Changes to this policy</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">11. Contact us</h2>
        <p>
