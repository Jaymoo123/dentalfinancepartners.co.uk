...
const data: AudienceStage = {
  ...
  concerns: [
    ...
    },
    {
      ...
      body: "Driven by the LLP agreement, the bank funding, and the FA 2014 audit. Going under 25% of your disguised salary triggers Condition C; going over substantially ties up cash that may earn more elsewhere. A specialist accountant helps calibrate to the FA 2014 line and the firm's working capital needs.",
    },
    {
    ...
    },
    {
      ...
      body: "Property income (Section 24 mortgage interest restriction etc.) reports separately on your self-assessment but the rates interact: a high partnership profit share pushes property income further into higher / additional rate. Both sit on one return, with the interactions modelled.",
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "The Finance Act 2014 introduced rules deeming a member of an LLP as an employee for tax purposes if all three conditions are met: Condition A — disguised salary is at least 80% of total reward; Condition B — limited rights to influence the LLP's affairs; Condition C — capital contribution less than 25% of disguised salary. If all three apply, PAYE runs on drawings. The audit is worth running quarterly because the position can drift as your role, bonuses, and capital evolve.",
    },
    {
