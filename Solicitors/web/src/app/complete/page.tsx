        ...
        inner = (
          <div className="rounded-xl border-2 border-[var(--primary)] bg-[var(--primary)]/5 p-6 text-center">
            ...
            <p className="mt-2 text-base text-[var(--muted)]">
              We have everything we need. A specialist accountant for solicitors will be in touch
      ...
      <div className={siteContainerLg}>
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-center text-lg leading-relaxed text-[var(--muted)]">
            Add the last detail we need and a specialist accountant for solicitors will be in touch
