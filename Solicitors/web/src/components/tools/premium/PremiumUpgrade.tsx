...
/**
 * Topic to premium tool bridge for the Solicitors site.
 *
 ...
 *
 * Styling: site CSS variable tokens only, no new npm dependencies.
 */
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        <span className="inline-block bg-[var(--primary)] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-white rounded">
