 ...
 *
 * Intent-aware: uses the behaviour-matched personalised offer when available
 * (treatment arm with a clear topic); falls back to the static default offer
 * for visitors with no topic. The offer shape is kept stable for future work.
 *
 * Styled with the site's CSS variable tokens (--primary, --ink, --border, etc.).
 */
