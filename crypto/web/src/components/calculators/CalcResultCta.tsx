  ...
  return (
    <div className="mt-6 border-t border-[var(--border)] pt-5">
      <MiniCapture
        ...
        blurb="A calculator gives you the shape of the answer. We confirm your exact figures, the reliefs you can claim, and what your business needs to file. No obligation."
