/**
 * Shared lead-nurture enrolment for the Crypto site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Crypto
 * sequence names.
 */
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildCryptoLeadNurtureConfig(variant);
