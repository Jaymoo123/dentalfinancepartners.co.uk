    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-[var(--ink-soft)]">
        <p>
          ...
          here as &quot;we&quot;, &quot;us&quot; and &quot;our&quot;, collects, uses and protects
          your personal information when you use the {siteConfig.name} website (the &quot;Site&quot;).
        ...
        <p>
          The data controller responsible for your personal data is {company.legalName}, which
          trades as {siteConfig.name}:
        </p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong>Enquiry forms:</strong> when you submit an enquiry, we collect your name, email
            address, phone number, the type of crypto investor or trader you are, your message, and
            the page you submitted from.
          </li>
          <li>
            <strong>Email sign-ups:</strong> if you subscribe to our updates or download a guide,
            we collect your email address (and, where relevant, the resource you requested).
          </li>
          <li>
            <strong>Acknowledgement and consent records:</strong> we keep a record of the exact
            wording shown to you and the date and time, so we can show what you were told when you
            submitted an enquiry, and that consent was given when you signed up to our email updates.
          </li>
          <li>
        ...
        <p>
          Providing this information is voluntary. You are not under a statutory or contractual
          obligation to provide it, but if you do not, we will not be able to respond to your
          enquiry or send you the updates or resources you have asked for.
        </p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            ...
            relevant regulated firm from our specialist partner network so that it can provide the
            advice you have requested.
          </li>
          <li>
            <strong>To send you updates you asked for:</strong> if you signed up to our email
            updates, to send you general crypto tax information until you unsubscribe.
          </li>
          <li>
            <strong>To improve and protect the Site:</strong> to understand how the Site is used
            and to keep it secure and working properly.
          </li>
        </ul>

        <h2 className="text-xl font-bold text-[var(--ink)]">4. Our lawful basis</h2>
        <p>
          When you submit an enquiry, we rely on our <strong>legitimate interests</strong> (Article
          6(1)(f) of the UK GDPR) to handle your enquiry and to share it with a relevant regulated
          firm from our specialist partner network, so that you can be connected with the specialist
          crypto tax help you have asked for. Where we need to take steps at your request to deal
          with your enquiry, we also rely on{" "}
          <strong>Article 6(1)(b)</strong>. You have the <strong>right to object</strong> to this
          processing at any time, under Article 21 (see your rights in section 7).
        </p>
        <p>
          For our <strong>email updates</strong> and other email sign-ups, we rely on your{" "}
          <strong>consent</strong>. You can withdraw your consent at any time (see your rights in
          section 7); withdrawing consent does not affect any processing that took place before you
          withdrew it.
        </p>
        <p>
          For website analytics, site improvement and security, we rely on our{" "}
          <strong>legitimate interests</strong>, specifically measuring and improving the Site and
          keeping it secure and protected against misuse.
        </p>

        <h2 className="text-xl font-bold text-[var(--ink)]">5. Who we share your information with</h2>
        <p>
          When you submit an enquiry, we share information about you and your enquiry with a
          relevant regulated firm from our <strong>specialist partner network</strong>, so that it
          can respond and, if you want, provide the advice you asked for. The receiving firm acts as
          an <strong>independent data controller</strong> of the information it receives, will
          identify itself to you when it first contacts you, and uses your information under its own
          privacy policy. If that firm is unable to help, your enquiry may be passed to another firm
          in the network for the same purpose. We do this on the basis of our{" "}
          <strong>legitimate interests</strong> (see section 4), and you can object at any time (see
          section 7). We share this information only for the purpose of arranging and providing the
        ...
        <p>
          We keep enquiry data for <strong>{company.enquiryRetentionMonths} months</strong> from
          the date of your enquiry, after which it is deleted. If you subscribe to our email
          updates, we keep your email address until you unsubscribe. Our records of what you were
          shown and any consent you gave are kept for as long as we hold the related personal data,
        ...
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            including our sharing of your enquiry with firms in our partner network, under
            Article 21.
          </li>
        ...
        <p>
          Form submissions are stored securely and access is restricted to authorised staff only.
          Some of our service providers (for example, Vercel) are based outside the UK and EEA.
          Where data is transferred internationally, we rely on appropriate safeguards such as the
          UK extension to the EU-US Data Privacy Framework or Standard Contractual Clauses.
        </p>

        <h2 className="text-xl font-bold text-[var(--ink)]">10. Changes to this policy</h2>
        <p>
          We may update this privacy policy from time to time. The &quot;Last updated&quot; date at
          the top of this page shows when it was last revised. We encourage you to review this
          policy periodically.
        </p>
