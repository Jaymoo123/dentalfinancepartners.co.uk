/**
 * Inbound email webhook for Resend: processes replies to Crypto nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Crypto lead,
 ...
 *   Inbound routing domain: cryptotaxpartners.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.cryptotaxpartners.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Crypto lead (most recent match wins).
