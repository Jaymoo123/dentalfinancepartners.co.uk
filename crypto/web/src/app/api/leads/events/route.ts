/**
 * Resend webhook sink for lead-nurture email engagement events (Crypto).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.cryptotaxpartners.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Crypto lead-nurture system.</p>
</div>`,
