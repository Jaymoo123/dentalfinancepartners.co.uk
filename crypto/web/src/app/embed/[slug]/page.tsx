  ...
  return (
    <div className="bg-white p-3 sm:p-4">
      ...
      <div className="mt-3 text-center">
        ...
        >
          Powered by <span className="font-bold text-[var(--ink)]">{site.name}</span> &middot; specialist UK crypto tax accountants
        </a>
      </div>
      <EmbedAutoResize messageType="crypto-embed-height" />
    </div>
  );
}
