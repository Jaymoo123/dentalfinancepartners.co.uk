...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "crypto_contactability",
}));
...
const BASE_BODY = {
  ...
  email: "jane@examplemail.org",
  phone: "+447700900123",
  role: "DeFi / staking participant",
  message:
    "HMRC sent me a nudge letter about crypto. I have four years of exchange history and some staking rewards to sort out.",
  source: "crypto",
};
