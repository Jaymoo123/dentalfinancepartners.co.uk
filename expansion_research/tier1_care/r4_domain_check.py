...
CANDIDATES = [
    "carehomefinancepartners", "carefinancepartners", "caretaxpartners",
    "careprovidertaxpartners", "carehometaxpartners", "caresectorfinancepartners",
    "domiciliarycareaccountants", "careprovideraccounts", "carehometaxspecialists",
    "careproviderfinancepartners", "caresectortaxspecialists", "carefinancespecialists",
]
