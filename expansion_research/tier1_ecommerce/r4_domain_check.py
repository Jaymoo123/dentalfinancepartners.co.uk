...
CANDIDATES = [
    "ecommercefinancepartners", "ecommercetaxpartners", "sellertaxpartners",
    "sellerfinancepartners", "marketplacetaxpartners", "marketplacefinancepartners",
    "onlinesellertaxpartners", "onlinesellerfinancepartners", "ecommercetaxspecialists",
    "sellertaxspecialists", "marketplacetaxspecialists", "onlineretailtaxpartners",
]
