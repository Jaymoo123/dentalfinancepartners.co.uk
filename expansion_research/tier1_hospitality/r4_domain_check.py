...
CANDIDATES = [
    "hospitalityfinancepartners", "hospitalitytaxpartners", "hospitalitytaxspecialists",
    "hospitalityfinancespecialists", "licensedtradetaxpartners", "licensedtradefinancepartners",
    "restaurantfinancepartners", "restauranttaxpartners", "cateringtaxpartners",
    "hospitalityaccountspartners", "innandtablefinance", "licensedtradeaccountants",
]
