...
CANDIDATES = [
    "cryptotaxpartners", "digitalassettaxpartners", "cryptofinancepartners",
    "digitalassetfinancepartners", "cryptoassettaxpartners", "digitalassettaxspecialists",
    "tokentaxpartners", "cryptotaxspecialists", "digitalassetaccountants",
    "blockchaintaxpartners", "cointaxpartners", "cryptoassetaccountants",
]
