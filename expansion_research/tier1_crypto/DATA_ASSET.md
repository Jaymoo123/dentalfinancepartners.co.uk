...
| [gov.uk CARF guidance: collecting cryptoasset user and transaction data](https://www.gov.uk/guidance/collecting-cryptoasset-user-and-transaction-data) | The 1 Jan 2026 collection start / 31 May 2027 first-report deadline that anchors the countdown | HTTP 200 (s6, phrase-checked) |
