"""R3 tier2 retail — Stage 3: Google Autocomplete expansion (free).

Retail-sector seeds x (blank + a-z). Writes raw/autocomplete_raw.json.
...
SEEDS = [
    ...
    "vat on shop ",
    "epos accounting ",
    "retail stock accounting ",
    "stocktake shop ",
    "retail gross margin ",
    "shop business rates ",
    "business rates relief shop ",
    "buying a convenience store ",
    "selling a shop business ",
    "shop payroll ",
    "retail bookkeeping ",
    "cash business hmrc ",
    "shop profit margin ",
