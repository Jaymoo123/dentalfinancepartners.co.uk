...
CANDIDATES = [
    "trusteefinancepartners", "charityfinancespecialists", "nonprofitfinancepartners",
    "charityaccountspartners", "trusteetaxpartners", "charitytaxpartners",
    "nonprofitaccountsspecialists", "charityreportingpartners", "thirdsectortaxspecialists",
    "trusteeaccountsspecialists", "charityfinancepartners", "nonprofittaxspecialists",
]
