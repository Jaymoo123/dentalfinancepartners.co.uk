"""R3 tier1 startups — Stage 4b: DataForSEO ranked_keywords (top rivals) + keyword_suggestions.
...
def flat_kw(items: list[dict]) -> list[dict]:
    out = []
    for it in items or []:
        kd = it.get("keyword_data") or it  # ranked_keywords nests; suggestions flat
