...
CANDIDATES = [
    "founderfinancepartners", "foundertaxpartners", "startuptaxpartners",
    "startupfinancepartners", "startuptaxspecialists", "scaleupfinancepartners",
    "scaleuptaxpartners", "venturefinancepartners", "venturetaxpartners",
    "techtaxpartners", "equityfinancepartners", "founderfinancespecialists",
]
