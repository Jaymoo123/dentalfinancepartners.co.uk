"""R3 tier1 manufacturing — Stage 3: Google Autocomplete expansion (free).

Manufacturing/engineering-accountancy seeds x (blank + a-z). Writes raw/autocomplete_raw.json.
...
SEEDS = [
    ...
    "factory costs ",
    "machinery finance ",
    "asset finance manufacturing ",
    "cbam ",
    "exporting manufacturer ",
    "customs duty manufacturing ",
