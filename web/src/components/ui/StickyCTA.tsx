    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 sm:gap-4 px-4 py-3 sm:py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link href="/free-health-check" className={`${btnPrimary} text-xs sm:text-sm bg-indigo-600 border-indigo-800 px-4 py-2 sm:px-6 sm:py-3 min-h-[44px] flex items-center`}>
