...
export const metadata: Metadata = {
  ...
  description: "Specialist accountants for UK performance marketing agency founders. Multi-channel attribution, revenue-share deals, media spend treatment. ICAEW qualified.",
