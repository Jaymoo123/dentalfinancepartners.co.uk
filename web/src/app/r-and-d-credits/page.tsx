...
const qualifying = [
  {
    icon: Bot,
    title: "AI agencies",
    body: "Custom model training, RAG pipelines, fine-tuning LLMs for specific industries, agent orchestration. Average claim: £40k-£150k+.",
  },
  {
    icon: Code,
    title: "SaaS / software agencies",
    body: "Custom architecture, novel integrations, performance optimisations beyond published benchmarks, bespoke developer tooling.",
  },
  {
    icon: LineChart,
    title: "Performance marketing agencies",
    body: "Custom attribution platforms, multi-touch reporting builds, API integrations between ad platforms and CRM, bespoke optimisation tools.",
  },
  {
    icon: Beaker,
    title: "Email & lifecycle agencies",
    body: "Custom Klaviyo flows beyond template configuration, AI-driven subject line testing, deliverability monitoring tools.",
  },
  {
    icon: Cpu,
    title: "Web design / dev agencies",
    body: "Custom CMS architecture, headless commerce builds, novel integrations between systems with no off-the-shelf connectors.",
  },
  {
    icon: FileSearch,
    title: "Crypto / Web3 agencies",
    body: "Novel smart contract patterns, ZK-proof implementations, custom DAO tooling, bridge security work, MEV-resistance systems.",
  },
];

const process = [
  { n: "01", title: "Eligibility assessment", body: "30-min call. We review your projects against HMRC's qualifying activity tests. Most agencies have more eligible work than they think." },
...
const faqs = [
  ...
  },
  {
    ...
    a: "HMRC's stated processing time is 40 working days for the merged scheme, though it's currently averaging 8-12 weeks. Enquiry rates have risen significantly post-2023 reform, so the quality of your technical narrative and costing schedule matters more than ever. We build claims to current HMRC standards.",
  },
];
      ...
      <section className="relative h-[480px] sm:h-[540px] overflow-hidden">
        ...
        <div className={`${siteContainerLg} relative z-10 h-full flex items-end pb-12 sm:pb-16`}>
          <div className="max-w-3xl">
            ...
            />
            <div className="mt-6 inline-flex items-center gap-2 bg-emerald-500 px-3 py-1.5 text-xs font-bold text-white uppercase tracking-wider mb-4">
              <Beaker className="h-3.5 w-3.5" />
              Specialist R&D claims · Post-April 2023 merged scheme
            </div>
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold leading-tight text-white">
              R&amp;D tax credits for <span className="text-indigo-400">UK agencies</span>
            </h1>
          ...
          <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-4">
            {[
              ...
              <div key={s.l} className="text-center">
                ...
                <div className="mt-1.5 text-xs sm:text-sm font-semibold text-indigo-200 uppercase tracking-wider">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className={siteContainerLg}>
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-slate-900 sm:text-4xl">Which agencies typically qualify?</h2>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {qualifying.map((q) => {
                const Icon = q.icon;
                return (
                  <div key={q.title} className="bg-slate-50 border border-slate-200 p-6 sm:p-7 hover:bg-white hover:border-indigo-600 hover:shadow-md transition-all">
      ...
      <section className="bg-white py-16 sm:py-20">
        <div className={siteContainerLg}>
          <div className="max-w-4xl mx-auto">
            <div className="bg-indigo-50 border-2 border-indigo-600 p-8 sm:p-10 text-center">
              ...
              <Link href="/calculators/rd-tax-credit-estimator" className="mt-6 inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 font-bold transition-colors">
                Open the calculator
