/**
 * Service-email shell for Trade Tax Specialists lead-nurture follow-ups.
 *
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">TRADE&nbsp;TAX</div>
<div style="display:inline-block;border-top:2px solid #059669;margin-top:5px;padding-top:5px;font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">SPECIALISTS</div>
</td>
</tr>
<tr>
...
<div style="font-size:16px;font-weight:600;color:#0f172a;line-height:1.5;">The team at Trade Tax Specialists</div>
<div style="font-size:14px;font-weight:600;color:#059669;line-height:1.5;">Trade Tax Specialists</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://www.tradetaxspecialists.co.uk" style="color:#64748b;text-decoration:none;">tradetaxspecialists.co.uk</a></div>
</td>
</tr>
</table>
</td>
...
<div style="border-top:1px solid #e5e7eb;padding-top:14px;font-family:${FONT};font-size:12px;line-height:1.6;color:#64748b;">${esc(e.footerNote)}${e.optOutUrl ? "<br>To opt out, just reply STOP." : ""}</div>
  ...
  const textLines = [
    ...
    e.signoff,
    "",
    "The team at Trade Tax Specialists",
