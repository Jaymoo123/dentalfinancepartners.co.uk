/**
 * Types and formatters for the UK Construction Survival Index research asset.
 *
 * Data is compiled from ONS Business Demography Table 4.2 (survival of
 * newly-born enterprises by broad industry group) and committed as
...
export interface SurvivalCohortRow {
  birth_year: number;
  construction: SurvivalCohortStats;
...
export interface SurvivalIndexSnapshot {
  ...
  headline: {
    ...
    latest_5yr_construction_pct: number | null;
    latest_5yr_all_industries_pct: number | null;
    latest_1yr_cohort_year: number | null;
    latest_1yr_construction_pct: number | null;
