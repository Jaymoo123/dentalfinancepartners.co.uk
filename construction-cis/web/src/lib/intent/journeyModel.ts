/**
 * Journey model for Trade Tax Specialists (construction-cis) -- deterministic,
 * client-side, instant. Ported from Dentists/Property with the bfp storage
 * prefix.
 *
 ...
 *
 * Storage key: bfp_journey (FROZEN, never ptp_/dfp_/cfp_).
 * Special-page flags: /about, /services, /contact -- all three routes exist on
 * the construction-cis site (confirmed), so all flags are kept (no drops).
 *
