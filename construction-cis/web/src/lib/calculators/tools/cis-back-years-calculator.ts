...
export const cisBackYearsCalculator: GenericTool = {
  ...
  explainer: {
    ...
    paragraphs: [
      ...
      "If a Self Assessment return has not been filed for a given year, you file it now, even if it is late. If the return has already been filed and you missed expenses or deductions, you submit an amendment online through your HMRC Personal Tax Account or via a paper SA100 with the corrected figures. HMRC does not publish a processing time for Self Assessment repayments and directs claimants to its weekly-updated \"Check when you can expect a reply from HMRC\" tool, with up to a further 12 weeks possible where a claim is selected for security checks. Where the repayment is for a year more than 12 months old, HMRC also pays repayment supplement (interest) on the amount refunded.",
    ],
  },
  faqs: [
    {
