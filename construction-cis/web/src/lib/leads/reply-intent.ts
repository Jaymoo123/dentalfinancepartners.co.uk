 ...
 *
 * Relevant obligation: Data Sharing Agreement Sch 2 section 6 requires opt-outs
 * and objections to be honoured immediately.
 */
...
// objections per Data Sharing Agreement Sch 2 section 6.
...
export function classifyReplyIntent(body: string): ReplyIntent {
  ...
  // ── Opt-out (must be checked first per DSA Sch 2 section 6) ──────────────
...
// bare STOP/OPT OUT keyword can NOT be trusted in a long body. Tiers:
