 ...
 * prefixes. Every marker below is load-bearing: a client that keeps the
 * whole quoted original (including our own "reply STOP" footer) must never
 * have the opt-out matcher read our footer as the lead's words.
 */
