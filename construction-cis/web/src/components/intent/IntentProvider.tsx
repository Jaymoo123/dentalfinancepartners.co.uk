 ...
 *
 * The personalisation A/B concluded 2026-07-05 (estate experiments wind-down):
 * treatment locked ON for every visitor, mirroring Property's concluded winner.
 * The personalization_shown/clicked/dismissed measurement events keep flowing.
 */
