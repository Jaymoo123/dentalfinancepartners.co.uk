...
/**
 * CIS-scoped EmbedAutoResize wrapper.
 *
 * The message type "cis-embed-height" is FROZEN -- third-party partner pages
...
export function EmbedAutoResize() {
  return <SharedEmbedAutoResize messageType="cis-embed-height" />;
}
