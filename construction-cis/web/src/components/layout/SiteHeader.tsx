...
export function SiteHeader() {
  ...
  return (
    <header
      className="sticky top-0 z-40 border-b border-neutral-200 bg-[#fafaf9]/95 backdrop-blur supports-[backdrop-filter]:bg-[#fafaf9]/80"
          ...
          >
            <div className="flex flex-col gap-3 border-b border-neutral-200 px-5 py-4">
              <div className="flex items-center justify-between gap-2">
                <p id={`${panelId}-title`} className="font-mono text-xs uppercase tracking-widest text-orange-600">
                  Menu
                </p>
                <button
                  type="button"
