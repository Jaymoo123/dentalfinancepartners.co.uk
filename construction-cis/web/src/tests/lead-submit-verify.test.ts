...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "cis_contactability",
}));
...
const BASE_BODY = {
  full_name: "Dave Carter",
  email: "dave@cartertrades.co.uk",
  phone: "+447700900123",
  role: "Subcontractor",
  message: "Been on the 20% CIS rate for three years, think I'm owed a refund.",
