/**
 * Lead-nurture cron for Trade Tax Specialists: fires due follow-up steps for
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("[lead-nurture-cron/cis] heartbeat write failed", err);
  }
  ...
  if (cronArmed) {
    try {
      ...
      console.error("[lead-nurture-cron/cis] guardrail scan failed", err);
    }
  }
