/**
 * Daily lead-nurture digest cron for Trade Tax Specialists: fires at 07:00 UTC
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    console.error("[lead-nurture-digest/cis] heartbeat write failed", err);
  }
  ...
  try {
    ...
    console.error("[lead-nurture-digest/cis] unexpected error", err);
