/**
 * Lead data retention cron: anonymises construction-cis leads whose PII has
 * exceeded the configured retention window. Runs daily at 03:30 UTC (quiet
 * period, outside any send window).
 *
 * Dormancy (two layers):
