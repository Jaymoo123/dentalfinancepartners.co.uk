 ...
 * resolve the sender to a construction-cis lead, and either record their reply
 * as a contactability signal or honour a STOP opt-out.
 *
 * No AI reply-drafting/concierge layer on this path (estate-central); a
 * positive reply always takes the plain acknowledgeReply branch.
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    if (intent === "opt_out") {
      ...
      // No concierge layer on this site: always the plain ack.
