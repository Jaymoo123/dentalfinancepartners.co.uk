...
<ul>
  ...
  <li><strong>Refund route.</strong> Refunds for sole traders come through Self Assessment. HMRC publishes no processing time for these repayments and asks you to use its weekly-updated "Check when you can expect a reply from HMRC" tool instead.</li>
...
<ul>
  <li><strong>Real-time reclaim via EPS.</strong> Unlike sole traders (who wait until after the tax year to reclaim via Self Assessment), a limited company can reclaim CIS deductions suffered <strong>in real time</strong> by offsetting them against PAYE and employer NIC liabilities owed on the company's monthly Employer Payment Summary. That is a self-service offset rather than a claim HMRC processes, so no HMRC turnaround applies to it: if deductions suffered exceed PAYE/NIC due, the surplus simply carries forward to the next month. Any credit still unabsorbed at the year end is reclaimed separately, and HMRC says it will usually respond to a limited-company CIS repayment claim within 8 weeks. This is a major cash-flow advantage over the sole-trader route.</li>
...
<p>Tax months run from the 6th to the 5th of the following calendar month. The CIS300 for each tax month must be <strong>filed by the 19th of the following month</strong>: payments made in the month ending 5 May are due to HMRC by 19 May. Payment of the deducted CIS must reach HMRC by the <strong>22nd electronically</strong> (or the 19th if paying by cheque). Missing the deadline by even one day triggers an automatic <strong>£100 penalty</strong>, rising to £200 at two months, then to £300 or 5% of the CIS deductions on that return (whichever is higher) at six months, and the same charge again at twelve months. The 100% figure some guides quote is not the twelve-month tier: it is a separate additional penalty that applies only where HMRC finds information was withheld deliberately.</p>
...
<p>The penalty ladder for a late nil return is identical to that for a substantive return: <strong>£100 for one day late</strong>, <strong>£200 at two months</strong>, <strong>£300 or 5% of the CIS deductions on the return (whichever is higher) at six months</strong>, and a further <strong>£300 or 5% (whichever is higher) at twelve months</strong>. Because a nil return reports no CIS deductions, the 5% element is always nil and the £300 floor applies instead, so the effective penalty for a nil return that is persistently missed escalates through £100, £200 and then two further charges of £300 each.</p>
...
<li><strong>6 months late:</strong> an additional £300 <em>or</em> 5% of the CIS deductions shown on the return, whichever is higher.</li>
<li><strong>12 months late:</strong> a further £300 <em>or</em> 5% of the CIS deductions shown on the return, whichever is higher.</li>
<li><strong>Deliberate withholding:</strong> where HMRC finds that information was withheld deliberately, a separate additional penalty applies on top of the ladder above, rising to the greater of 100% of the CIS deductions or £3,000 where the withholding was also concealed.</li>
</ul>
<p>Each monthly return is treated as a separate return for penalty purposes, so a contractor who misses three consecutive months immediately faces three separate £100 charges. The <strong>reinstatement of nil returns from 6 April 2026</strong> (they were removed in 2015) means contractors who assumed they had no obligation to file in quiet months are now accumulating penalties without realising it. Nil returns carry the same penalty ladder, though the 5% element is always nil on a return that reports no CIS deductions, so the £300 floor is what bites.</p>
...
<p>If HMRC determines the standard is met, the consequences include <strong>immediate GPS revocation with no advance notice</strong>, a <strong>five-year reapplication ban</strong>, and a penalty of <strong>20% of the relevant payment</strong> (FA 2004 s.62A) or, for a return, <strong>an amount equal to the sum the return treats as paid on account of the person's liabilities</strong>, that is <strong>100% of the sum returned with no percentage reduction</strong> (FA 2004 s.62B). The two quanta are different: s.62A takes a fifth of the payment, s.62B takes the whole of the sum the return treats as paid. For a contractor paying £200,000 a year in labour, the s.62A exposure alone is up to £40,000, and a single CIS300 reporting £150,000 of payments carries s.62B exposure of £150,000.</p>
...
<li><strong>Year-end claim:</strong> HMRC will usually respond to a limited-company CIS repayment claim within 8 weeks. The monthly EPS offset has no HMRC turnaround because it is not a claim.</li>
...
<p>For a <strong>sole-trader subcontractor</strong>, the refund comes through <strong>Self Assessment</strong>. You file your tax return after 5 April, declare your gross CIS income (before deductions) and all allowable expenses, and HMRC calculates whether you are owed money. The typical refund for a sole-trader subcontractor runs to around <strong>£2,000 to £3,000 a year</strong> (illustrative average; individual results vary). HMRC does not publish a processing time for Self Assessment repayments. It asks you to check its weekly-updated <a href="https://www.gov.uk/guidance/check-when-you-can-expect-a-reply-from-hmrc" rel="nofollow">"Check when you can expect a reply from HMRC"</a> tool for the current date, and a repayment picked up by its security checks can take up to a further 12 weeks on top of that.</p>
<p>For a <strong>limited-company subcontractor</strong>, there is a faster route. The company can offset CIS deductions suffered against the PAYE and NIC it owes each month via an <strong>Employer Payment Summary (EPS)</strong>, recovering the overpayment in real time rather than waiting for a year-end repayment. Where CIS suffered exceeds the company's PAYE liability, the surplus carries forward month to month; anything still unabsorbed at the year end is claimed back, and HMRC says it will usually respond to that claim within <strong>8 weeks</strong>.</p>
...
<li>If the cumulative CIS deductions exceed cumulative PAYE/NIC liabilities, the surplus carries forward automatically to the following month. Nothing is claimed and nothing is processed, so there is no HMRC turnaround to wait on. Any credit left unabsorbed at the year end is reclaimed separately, and HMRC says it will usually respond to that claim within <strong>8 weeks</strong>.</li>
</ul>
