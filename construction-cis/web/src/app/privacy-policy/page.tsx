      ...
      <div className={`${contentNarrow} ${sectionYLoose}`}>
        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <p>
            ...
            and email sign-ups{partner ? ", and to share your enquiry with our specialist partner network as described below" : ""}. You can
          ...
          {partner ? (
            <p>
              ...
              partner network, so that they can respond and provide the advice you asked for. The partner firm acts as
              an <strong>independent data controller</strong> of the information it receives, and its own use of your
