...
export const CITIES: Record<string, CityData> = {
  ...
  "birmingham": {
    ...
    "intro": "<p>Birmingham is in the middle of the most intense phase of construction investment in its modern history. HS2 Curzon Street station is rising from its foundations in the city centre, the £1.9 billion Smithfield regeneration is beginning enabling works, and a pipeline of residential and commercial schemes is responding to the city's population growth and post-Commonwealth Games momentum. Every trade on every one of these schemes operates under the Construction Industry Scheme, and the scale of the projects means CIS deductions are accumulating in large volumes. A Birmingham groundworker with £41,000 in gross CIS labour income in 2025/26 will have had £8,200 deducted at the registered 20% rate before expenses reduce the tax bill further, and in most cases a significant refund is owed after self-assessment.</p><p>We act for subcontractors across Birmingham and the wider West Midlands conurbation including Wolverhampton, Coventry, Dudley and Walsall. Our service is entirely remote, and we submit each claim as soon as your deduction statements and expense records are complete, so nothing on our side delays it. HMRC controls the repayment timetable from that point. Every new engagement includes a check on back-year entitlement covering up to four prior tax years, which for subcontractors who have not previously used a CIS accountant can produce a combined repayment well above the illustrative £2,000 annual average.</p>",
  ...
  "glasgow": {
    ...
    "localFaqs": [
      ...
      },
      {
        ...
        "answer": "Third-party reported averages put the annual refund for a registered CIS subcontractor at around £2,000 (illustrative, not guaranteed). The actual figure depends on your gross income, the labour-versus-materials split on your invoices, and the expenses you can legitimately claim (tools, PPE, mileage at 55p per mile from April 2026, use of home). We can look back up to four prior tax years if you have not claimed before."
      },
      {
  ...
  "sheffield": {
    ...
    "localFaqs": [
      ...
      },
      {
        ...
        "answer": "Third-party reported averages put the annual refund for a registered CIS subcontractor at around £2,000 (illustrative, not guaranteed), but the figure varies with your gross income, the share of labour versus materials in your invoices, and the expenses you can claim. A groundworker driving to multiple Sheffield sites daily may accumulate significant mileage at 55p per mile from April 2026, which reduces the taxable profit and increases the refund. We can estimate the figure once we see your payment and deduction statements."
      },
      {
  ...
  "newcastle": {
    ...
    "localFaqs": [
      ...
      },
      {
        ...
        "answer": "Third-party reported averages put the annual refund for a registered CIS subcontractor at around £2,000 (illustrative, not guaranteed). This varies with your gross income, the labour-versus-materials split on your invoices, and the expenses you claim. Mileage is one of the largest expense items for North East subcontractors travelling between sites, and at 55p per mile from April 2026 the deduction adds up quickly. We can estimate your likely refund once we see your payment and deduction statements."
      },
      {
      ...
      },
      {
        ...
        "answer": "We do not operate a walk-in office. All our work with Newcastle and North East subcontractors is handled remotely using secure document sharing. It means there is no local office overhead behind the work. You simply send us your payment and deduction statements and we do the rest."
      }
    ],
    "nearbyAreas": [
      "Gateshead",
