---
title: "How Much Should a Charity Hold in Reserves? Reserves Health by Cause"
slug: "how-much-should-a-charity-hold-in-reserves"
date: "2026-07-20"
...
faqs:
  ...
  - question: "Where can I find the full data?"
    answer: "Median reserves and the under-three-months share for all 24 charitable causes are set out in our UK Charity Cause Income and Reserves Health Index at /research/uk-charity-cause-income, built from the Charity Commission full register extract published under the Open Government Licence v3.0."
schema:
  "@type": "Article"
...
<h2>What free reserves are, and how we measure them</h2>

<p>Free reserves are the funds a charity could actually spend if it needed to: unrestricted funds, excluding money tied up in fixed assets or committed to restricted purposes. They are the buffer that keeps a charity running when income is interrupted.</p>

<p>To measure reserves health, we take each charity's free reserves from its most recent annual return (part B) and divide by its latest annual expenditure, then convert to months.<sup><a href="#ref-1">[1]</a></sup> A charity with free reserves equal to three months of expenditure could, in principle, keep operating for about three months if all income stopped. We report the median months for each cause, plus the share of charities in that cause holding under three months, a common informal marker for a thin position.</p>

<h2>The causes that hold the most reserves</h2>
...
<h2>The causes that hold the least</h2>
...
<h2>So how much should your charity hold?</h2>

<p>There is no universal answer, and the data makes that clear: a healthy level for a religious charity looks nothing like a healthy level for a grant-funded community charity. The Charity Commission does not set a required figure. What it expects is a written reserves policy that states the level the trustees aim to hold and the reasoning behind it.</p>

<p>A useful way to set that level is to work from risk rather than from a round number. Ask how long it would take to wind down responsibly if income stopped, how volatile your income is, and what commitments (salaries, leases, service promises) you could not switch off quickly. A charity with three months of predictable grant income and no staff may be perfectly safe on a thin reserve. A charity with employees and a lease may need considerably more.</p>

<p>The genuine warning sign in the data is not a low figure. It is a low figure with no policy behind it. If your charity is in the under-three-months group, the priority is not to rush to build reserves overnight; it is to write down why your level is what it is, and what you would do if income fell.</p>

<h2>What trustees should do next</h2>

<ul>
  <li>Write or review your reserves policy. It belongs in the trustees' annual report, and our <a href="/services/charity-accounts">charity accounts service</a> covers it as standard.</li>
  <li>Make sure your free reserves figure is calculated correctly, separating restricted funds and funds tied up in fixed assets. Clean records through our <a href="/services/charity-bookkeeping">charity bookkeeping service</a> make this straightforward.</li>
  <li>Benchmark against your own cause, not the sector as a whole. Compare your months of reserves to the median for your cause in the <a href="/research/uk-charity-cause-income">Cause Income and Reserves Health Index</a>.</li>
  <li>Check whether your income places you near a scrutiny threshold. Our <a href="/research/uk-charity-scrutiny-cliff">Charity Scrutiny Cliff-Edge Monitor</a> shows how many charities sit just below each gate.</li>
</ul>

<h2>A note on jurisdiction</h2>

<p>This analysis covers charities registered with the Charity Commission for England and Wales only. Scotland is regulated by OSCR and Northern Ireland by the Charity Commission for Northern Ireland, each with its own register and reserves expectations. Charities in those jurisdictions should refer to their own regulator.</p>

<h2>Where to go next</h2>

<p>The full dataset behind this article, covering reserves health and median income for all 24 charitable causes, is available in our <a href="/research/uk-charity-cause-income">UK Charity Cause Income and Reserves Health Index</a>. For a companion read on how income itself varies by cause, see <a href="/blog/charity-finance/which-charitable-causes-earn-the-most">which charitable causes earn the most</a>.</p>

<p>To discuss your reserves policy or your annual accounts, use the contact form. Our <a href="/services/charity-accounts">charity accounts service</a> covers the reserves policy, the trustees' annual report and the annual accounts in full.</p>
