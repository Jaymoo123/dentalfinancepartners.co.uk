/**
 * Shared lead-nurture enrolment for the Charities site.
 *
 ...
 * code path. Mirrors Property/web/src/lib/leads/enroll.ts with Charities
 * sequence names.
 */
...
import {
  buildCharitiesLeadNurtureConfig,
...
export async function enrollLead(
  ...
  if (deferFirstTouch) {
    ...
    const config = buildCharitiesLeadNurtureConfig(variant);
