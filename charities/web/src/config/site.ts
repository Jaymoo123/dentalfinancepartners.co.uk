/**
 * Site config — loaded from niche.config.json so BRAND_TBD placeholders flow
 * through config, never literals in code.
 */
...
// Pool model: enquiries are shared with a relevant regulated firm from our
