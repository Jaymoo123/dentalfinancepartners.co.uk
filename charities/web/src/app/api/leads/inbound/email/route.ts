/**
 * Inbound email webhook for Resend: processes replies to Charities nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a Charities lead,
 ...
 *   Inbound routing domain: trusteetax.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.trusteetax.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a Charities lead (most recent match wins).
