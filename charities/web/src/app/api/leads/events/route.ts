/**
 * Resend webhook sink for lead-nurture email engagement events (Charities).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.trusteetax.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the Trustee Tax lead-nurture system.</p>
</div>`,
