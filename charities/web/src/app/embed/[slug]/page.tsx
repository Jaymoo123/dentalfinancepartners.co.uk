...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    // Embed surface: do not index (canonical lives at /calculators/<slug>).
  ...
  return (
    <div className="bg-white p-3 sm:p-4">
      ...
      <div className="mt-3 text-center">
        ...
        >
          Powered by <span className="font-bold text-[var(--ink)]">{site.name}</span> &middot; specialist UK
          charity accountants
        </a>
      </div>
      <EmbedAutoResize messageType="charities-embed-height" />
    </div>
  );
}
