  ...
  return (
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <header className="border-b border-slate-200 pb-8">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">Terms of use</h1>
      ...
      <div className="mt-10 space-y-6 text-base leading-relaxed text-slate-700">
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">1. About us</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">2. No advice provided on the Site</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">3. Accuracy and changes</h2>
        <p>
          While we aim to keep information on the Site accurate and up to date, charity accounting rules, tax rates,
          and regulatory thresholds change over time. We make no representations or warranties regarding the accuracy,
          completeness, or currency of any content.
        </p>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">4. Acceptable use</h2>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">5. Intellectual property</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">6. Third-party links</h2>
        <p>
          The Site may contain links to third-party websites, including gov.uk, the Charity Commission and HMRC. We do
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">7. Limitation of liability</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">8. Disclaimer of warranties</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">9. Indemnity</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">10. Governing law and jurisdiction</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">11. Changes to these terms</h2>
        <p>
        ...
        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">12. Severability</h2>
        <p>
          If any provision of these terms is found to be invalid or unenforceable, the remaining provisions shall
          continue in full force and effect.
        </p>

        <h2 className="mt-10 text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">13. Contact us</h2>
        <p>
