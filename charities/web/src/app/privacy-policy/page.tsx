    ...
    <div className={`${contentNarrow} ${sectionY}`}>
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-neutral-600">
        ...
        <p>
          ...
          GDPR) to handle your enquiry and to share it with a relevant regulated firm from our specialist partner
          network, so that you can be connected with the specialist charity accounting help you have asked
        ...
        <p>
          When you submit an enquiry, we share information about you and your enquiry with a relevant regulated firm
          from our <strong>specialist partner network</strong>, so that it can respond and, if you want, provide the
          advice you asked for. The receiving firm acts as an <strong>independent data controller</strong> of the
          information it receives, will identify itself to you when it first contacts you, and uses your information
          under its own privacy policy. If that firm is unable to help, your enquiry may be passed to another firm in
          the network for the same purpose. We do this on the basis of our <strong>legitimate interests</strong> (see
          section 4), and you can object at any time (see section 7). We share this information only for the purpose
          of arranging and providing the advice you asked for.
        </p>
