 ...
 * strings. On this site --color-primary-600 is #1a5c4a, which measures 1.88 on the
 * primary-900 homepage hero, 2.27 on the kit's slate-900 footer and 1.86 on the slate-800
 * page strips, all under the 3.0 graphic floor. Keeping the local focusRing constant does
 * NOT protect against that, because the failing utility rides inside the recipe. If a
 * future edit re-exports a kit recipe raw, this fails. */
const recipes = ["btnPrimary", "btnSecondary", "btnOnDark", "btnOnCream", "focusRing", "linkArrow"] as const;
