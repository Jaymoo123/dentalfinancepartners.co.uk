...
vi.mock("@/config/lead-nurture", () => ({
  routePrimarySequence: () => "charities_contactability",
}));
...
const VERIFY_OK = {
  ...
  email: { status: "deliverable", domain: "examplecharity.org.uk" },
  verify_pass: true,
  provider: "twilio",
  raw: {},
};
...
const BASE_BODY = {
  ...
  email: "jane@examplecharity.org.uk",
  phone: "+447700900123",
  role: "Trustee",
  message: "We need an independent examination for our year end.",
  source: "charities",
};
