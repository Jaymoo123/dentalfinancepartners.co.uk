 ...
 *
 * ponytail: analytics/experiment wiring from the CIS original is omitted until
 * the charities analytics surface exists; visitor/session stitching is kept.
 */
        ...
        <form onSubmit={onSubmit} className="mt-5 grid gap-4 sm:grid-cols-2" noValidate>
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              placeholder="e.g. charity income around £120k, first independent examination due this year"
            />
