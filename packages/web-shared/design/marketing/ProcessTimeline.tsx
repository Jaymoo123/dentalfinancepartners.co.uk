 ...
 *
 * A rail runs behind the numbered nodes and a brand line draws down it,
...
export function ProcessTimeline({
  ...
  return (
    <ol ref={containerRef} className="relative mt-8 sm:mt-10">
      {/* The rail, and the brand line that draws down it. */}
      <div
        aria-hidden
        className="absolute left-6 top-6 bottom-6 w-px bg-slate-200 sm:left-8"
      >
        <div
          className="w-px bg-primary-600 transition-[height] duration-150 ease-out"
