...
function PromptCard({
  ...
  return (
    // Neutral card on purpose: red names the problem, brand is reserved for the
    ...
    >
      <div className="flex gap-4">
        {/* Red, not brand primary: these cards name the problem, and the section's
            brand colour belongs to the answer. red-600 is the existing --destructive
