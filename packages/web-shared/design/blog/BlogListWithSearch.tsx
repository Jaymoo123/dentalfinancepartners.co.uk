...
//
// Declared locally rather than derived from Property's types/blog `BlogPost`:
// that type is Property's own content-loader shape and cannot be imported
// here (T4). This is the minimal structural slice the component reads.
