/**
 * Excel model generator for the Contractor Tax Accountants gated resources system.
 *
 ...
 *
 *   npm run resources:xlsx --workspace contractors-ir35/web
 *
 ...
 * use (tax2026.ts), so workbook rates and on-site math always derive from one source.
 *
...
// scripts/resources -> contractors-ir35/web/public/resources
