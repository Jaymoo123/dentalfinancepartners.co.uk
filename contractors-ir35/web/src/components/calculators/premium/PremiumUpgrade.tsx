...
/**
 * Topic to premium tool bridge for the contractors-ir35 site.
 *
 ...
 *
 * TOKEN DISCIPLINE: cfp does NOT define --gold, --navy or --dark. The "Free
 * interactive tool" eyebrow chip uses bg-[var(--accent)] (petrol-cyan) with white
 * text. Loading placeholder skeleton uses var(--accent) accent bar and
 * var(--border) pulses.
 * No --gold, --navy or --dark anywhere.
 *
...
import { resourceForTopic } from "@/lib/calculators/premium/resources";
...
function ToolLoading() {
  return (
    <div
      ...
      aria-busy="true"
    >
      {/* Accent bar (cfp petrol-cyan; no --primary in cfp) */}
