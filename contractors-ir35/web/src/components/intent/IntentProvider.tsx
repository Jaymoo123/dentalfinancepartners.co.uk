 ...
 *
 * Personalisation is locked ON (no experiment assign block). The
 * personalization_shown/clicked/dismissed measurement events keep flowing.
 */
 ...
 *
 * The personalisation A/B concluded (estate experiments wind-down): treatment
 * locked ON for every visitor. The personalization_shown/clicked/dismissed
