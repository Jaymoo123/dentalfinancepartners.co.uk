/**
 * Service-email shell for Contractor Tax Accountants lead-nurture follow-ups.
 *
 * Centred white card on a #f6f7f8 canvas, Contractor Tax Accountants header,
 * blue-accented signature block, quiet footer. Table-based with inline styles
 * only; no images, no web fonts.
 *
...
export function renderLeadServiceEmail(e: LeadServiceEmail): { html: string; text: string } {
  ...
  const ctaHtml = e.cta
    ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:6px 0 22px 0;"><tr><td style="border-radius:6px;background-color:${ACCENT};">
<a href="${e.cta.href}" style="display:inline-block;font-family:${FONT};font-size:16px;font-weight:700;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:6px;background-color:${ACCENT};">${esc(e.cta.label)}</a>
</td></tr></table>
`
    : "";

  const secondaryHtml = e.secondary
    ? `<p style="margin:0 0 16px 0;font-size:14px;">Or ${esc(e.secondary.label)}: <a href="${e.secondary.href}" style="color:${ACCENT};">confirm here</a>.</p>
`
    : "";
...
<div style="font-family:${FONT};font-size:14px;font-weight:700;color:#0f172a;letter-spacing:0.22em;line-height:1.35;">CONTRACTOR&nbsp;TAX&nbsp;ACCOUNTANTS</div>
<div style="display:inline-block;border-top:2px solid ${ACCENT};margin-top:5px;padding-top:5px;font-family:${FONT};font-size:12px;color:#64748b;letter-spacing:0.12em;line-height:1.35;">IR35&nbsp;&amp;&nbsp;CONTRACTOR&nbsp;TAX</div>
</td>
</tr>
<tr>
...
<tr>
<td style="border-left:3px solid ${ACCENT};padding:2px 0 2px 14px;font-family:${FONT};">
<div style="font-size:16px;font-weight:600;color:#0f172a;line-height:1.5;">The team</div>
<div style="font-size:14px;font-weight:600;color:${ACCENT};line-height:1.5;">Contractor Tax Accountants</div>
<div style="font-size:13px;color:#64748b;line-height:1.6;"><a href="https://www.contractortaxaccountants.co.uk" style="color:#64748b;text-decoration:none;">contractortaxaccountants.co.uk</a></div>
</td>
</tr>
</table>
</td>
