...
export const corporationTaxPlannerConfig: PremiumToolConfig = {
  ...
  explainer: {
    ...
    paragraphs: [
      "Corporation tax in the UK is not a flat rate. Profits up to £50,000 are charged at the small profits rate of 19%. Profits above £250,000 are charged at the main rate of 25%. Profits between £50,000 and £250,000 fall in the marginal relief band: the tax is calculated at 25% and then reduced by a marginal relief fraction of 3/200 multiplied by the distance from the upper limit. This produces an effective (average) rate that rises from 19% to 25% across the band: at the £150,000 midpoint it is 24.0%, and it never exceeds 25%. What exceeds the headline rate is the effective marginal rate on each extra pound of profit in the band, which is roughly 26.5%.",
