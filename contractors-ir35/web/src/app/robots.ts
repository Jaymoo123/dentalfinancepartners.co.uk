 ...
 * some bots only honour their own entry. Mirrors the Property / Digital Agency
 * surface so contractors-ir35 is fully crawlable by answer engines (ChatGPT,
...
export default function robots(): MetadataRoute.Robots {
  ...
  const disallow = ["/thank-you", "/admin", "/api/"];
