    ...
    <>
      ...
      <section className="border-b border-neutral-200 bg-neutral-900 py-12 sm:py-16">
        <div className={siteContainerLg}>
          ...
          <p className="mt-4 max-w-2xl text-lg text-neutral-300">{tool.intro}</p>
        </div>
      </section>
      ...
      <section className="bg-white py-12 sm:py-16">
        <div className={siteContainerLg}>
          <div className="max-w-3xl">
            <h2 className="text-2xl font-bold text-neutral-900 sm:text-3xl">{tool.explainer.heading}</h2>
            ...
            <div
              id="get-expert-help"
              className="mt-12 scroll-mt-24 border-2 border-cyan-700/20 bg-gradient-to-br from-cyan-50 to-white p-8 sm:p-10 rounded-2xl"
            >
              <h2 className="text-2xl font-bold text-cyan-800 sm:text-3xl">
                Want to be sure of your position?
              </h2>
              <p className="mt-4 text-base leading-relaxed text-neutral-600">
                A calculator gives you the shape of the answer. We confirm your exact figure, your
                IR35 status and the reliefs that apply to you. Tell us about your situation for a
