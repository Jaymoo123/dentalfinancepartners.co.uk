/**
 * Lead-nurture cron for Contractor Tax Accountants: fires due follow-up steps
 * for leads that have not yet responded. Driven by Vercel Cron (hourly).
 *
 * Dormancy (two layers):
...
async function run(req: NextRequest): Promise<NextResponse> {
  ...
  const configs = buildIr35LeadNurtureConfigs();
