/**
 * Inbound email webhook for Resend: processes replies to contractors-ir35 nurture outreach.
 *
 * When a lead replies to a nurture email, Resend posts an email.received event here.
 * The route verifies the Svix signature, resolves the sender to a contractors-ir35 lead,
 ...
 *   Inbound routing domain: contractortaxaccountants.co.uk (or a reply.* subdomain)
 *   Endpoint URL: https://www.contractortaxaccountants.co.uk/api/leads/inbound/email
...
export async function POST(req: NextRequest) {
  ...
  // Resolve sender to a contractors-ir35 lead (most recent match wins).
