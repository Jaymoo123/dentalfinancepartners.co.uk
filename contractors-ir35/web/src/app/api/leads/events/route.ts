/**
 * Resend webhook sink for lead-nurture email engagement events (contractors-ir35).
 *
 ...
 * subscriber one:
 *   Endpoint URL: https://www.contractortaxaccountants.co.uk/api/leads/events
...
<p style="font-size:13px;color:#64748b;">Automated notification from the contractors-ir35 lead-nurture system.</p>
</div>`,
