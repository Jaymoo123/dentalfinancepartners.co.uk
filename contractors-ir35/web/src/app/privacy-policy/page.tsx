        ...
        <div className="prose-blog mt-10 space-y-6">
          ...
          <ul>
            <li>
              ...
              you are about to leave a page), we collect your name, email address, phone number, the type of contractor
              you are, your message, and the page you submitted from.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              contractor tax and accounting information until you unsubscribe.
            </li>
            <li>
